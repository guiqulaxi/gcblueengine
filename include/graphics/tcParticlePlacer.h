...
namespace osgParticle
{
    ...
    */
    ...
    protected:
        osg::Vector3d previousCenter;
        osg::Vector3d previousCenter2; ///< center before previousCenter
    ...
    inline void tcParticlePlacer::place(Particle *P) const
    {
		...
		osg::Vector3d cen = getCenter();
		osg::Vector3d p(a*cen._v[0] + b*previousCenter2._v[0],
	...
	*/
    inline void tcParticlePlacer::placeAlongPath(Particle *P, float a) const
    {
		...
		osg::Vector3d cen = getCenter();
		osg::Vector3d p(b*cen._v[0] + a*previousCenter._v[0],
	...
	{
		const osg::Vector3d& cen = getCenter();
