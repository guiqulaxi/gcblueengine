...
void BindPlatformInterface(module &m)
{
    ...
    .def(py::init<>())
        ...
        .def("Getintitude", &tcPlatformInterface::Getintitude)
        ...
        .def("Setintitude", &tcPlatformInterface::Setintitude)
        ...
        .def("GetPlatformDBObject", &tcPlatformInterface::GetPlatformDBObject)
        ;
}
