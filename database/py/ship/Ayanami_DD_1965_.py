...
def CreateDBObject():
    ...
    dbObj.mzClass='Ayanami DD(1965)'
    dbObj.natoClass='Ayanami DD(1965)'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','NOLR-1','OLT-1','OPS-1','OPS-15','OQS-14 Active']
    ...
    dbObj.launcherName=['','','','','','','','']
    dbObj.launcherFOV_deg=[320.000000,320.000000,0.000000,0.000000,10.000000,10.000000,10.000000,10.000000]
