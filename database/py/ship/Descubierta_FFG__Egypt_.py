...
def CreateDBObject():
    ...
    dbObj.mzClass='Descubierta FFG (Egypt)'
    dbObj.natoClass='Descubierta FFG (Egypt)'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=2470000128.000000
    dbObj.weight_kg=1482000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1984.390015
    ...
    dbObj.maLauncherClass=['SeaSparrow x8 Launcher','76 mm/62 Mark 75 Compact','Mk-141 Harpoon Launcher','Mk-141 Harpoon Launcher','40mm L70 Sea Trinity','40mm L70 Sea Trinity','Mk-32 3 Torpedo Mount','Mk-32 3 Torpedo Mount']
