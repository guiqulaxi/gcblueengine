...
def CreateDBObject():
    ...
    dbObj.mzClass='CVN-72 (Nimitz) USS Abraham Lincoln'
    dbObj.natoClass='CVN-72 (Nimitz) USS Abraham Lincoln'
    dbObj.mnModelType=2
    dbObj.mnType=22
    dbObj.cost=0.000000
    dbObj.weight_kg=102000000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1989.859985
    ...
    dbObj.damageEffect='CVN-72 (Nimitz) USS Abraham Lincoln durability'
