...
def CreateDBObject():
    ...
    dbObj.mzClass='Comandante Joao Belo FF'
    dbObj.natoClass='Comandante Joao Belo FF'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    sensorPlatformDBObject.sensorClass=['DRBC 31D','DRBV 22','DRBV 50','Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','SQS-17 Active']
    ...
    dbObj.maLauncherClass=['100mm/53 (3.9in) model 1953','100mm/53 (3.9in) model 1953','100mm/53 (3.9in) model 1953','40mm L70 Sea Trinity','40mm L70 Sea Trinity','Mk-32 3 Torpedo Mount','Mk-32 3 Torpedo Mount']
