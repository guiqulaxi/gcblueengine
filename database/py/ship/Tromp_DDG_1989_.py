...
def CreateDBObject():
    ...
    dbObj.mzClass='Tromp DDG(1989)'
    dbObj.natoClass='Tromp DDG(1989)'
    dbObj.mnModelType=2
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    dbObj.maLauncherClass=['Mk-13 Mod4 GMLS','Mk-141 Harpoon Launcher','Mk-141 Harpoon Launcher','SeaSparrow x8 Launcher','30mm/77 GAU-8/A Goalkeeper','12cm/50(4.7in) Model 1950','Mk-32 3 Torpedo Mount','Mk-32 3 Torpedo Mount']
    dbObj.maMagazineClass=['Lynx 1.3 Support','Mk-13 Mod4 Rotary Store 40','Sea Sparrow Reloads','12cm/50(4.7in) Model 1950 Magazine','Goalkeeper x1 Store']
    dbObj.magazineId=[3,1,2,0,4]
    dbObj.launcherId=[0,1,2,3,4,5,6,7]
    dbObj.launcherName=['','','','','','','','']
    dbObj.launcherFOV_deg=[320.000000,0.000000,0.000000,300.000000,340.000000,320.000000,30.000000,30.000000]
    dbObj.launcherAz_deg=[0.000000,90.000000,270.000000,180.000000,180.000000,0.000000,90.000000,270.000000]
    dbObj.launcherEl_deg=[40.000000,45.000000,45.000000,40.000000,0.000000,0.000000,0.000000,0.000000]
