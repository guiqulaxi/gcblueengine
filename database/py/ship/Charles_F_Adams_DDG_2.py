...
def CreateDBObject():
    ...
    dbObj.mzClass='Charles F Adams DDG-2'
    dbObj.natoClass='Charles F Adams DDG-2'
    dbObj.mnModelType=1
    dbObj.mnType=18
    dbObj.cost=0.000000
    dbObj.weight_kg=4500000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1959.310059
    ...
    dbObj.maLauncherClass=['Mk-11 GMLS','127mm/54 (5in) Mk42','127mm/54 (5in) Mk42','Mk-112 ASROC','Mk-32 3 Torpedo Mount','Mk-32 3 Torpedo Mount']
    dbObj.maMagazineClass=['127mm Mk-42 500 Rounds','Mk-11 Rotary Store 42','Mk-32 Torpedo Racks','Mk-112 ASROC Reloads']
