...
def CreateDBObject():
    ...
    dbObj.mzClass='Hamilton WHEC'
    dbObj.natoClass='Hamilton WHEC'
    dbObj.mnModelType=2
    dbObj.mnType=18
    dbObj.cost=0.000000
    dbObj.weight_kg=3300000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1967.130005
    ...
    dbObj.damageEffect='Hamilton WHEC durability'
    ...
    dbObj.maMagazineClass=['USCGS Helo Support','Hamilton Ammo Mag','Phalanx 1 x1 Store']
