...
def CreateDBObject():
    ...
    dbObj.mzClass='CVN-69 (Nimitz) USS Dwight D. Eisenhower'
    dbObj.natoClass='CVN-69 (Nimitz) USS Dwight D. Eisenhower'
    dbObj.mnModelType=2
    dbObj.mnType=22
    dbObj.cost=0.000000
    dbObj.weight_kg=91487000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1977.790039
    dbObj.finalYear=2001.750000
    dbObj.country='USA'
