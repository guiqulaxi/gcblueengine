...
def CreateDBObject():
    ...
    dbObj.mzClass='Shirane DDH'
    dbObj.natoClass='Shirane DDH'
    dbObj.mnModelType=2
    dbObj.mnType=17
    dbObj.cost=0.000000
    dbObj.weight_kg=6800000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1980.208984
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','NOLQ-1','OLR-9B','OPS-12','OPS-28','OQS-101 Active','OQS-101 Passive','SQS-35(J) VDS','WM-25']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,180.000000,0.000000]
    ...
    dbObj.maLauncherClass=['SeaSparrow x8 Launcher','127mm/54 (5in) Mk42','127mm/54 (5in) Mk42','Mk-32 3 Torpedo Mount','Mk-32 3 Torpedo Mount','Mk-112 ASROC']
    dbObj.maMagazineClass=['SH-3 3.3 Support','127mm Mk-42 500 Rounds','Sea Sparrow Reloads']
    dbObj.magazineId=[2,1,0]
    dbObj.launcherId=[0,1,2,3,4,5]
    dbObj.launcherName=['','','','','','']
    dbObj.launcherFOV_deg=[300.000000,320.000000,330.000000,30.000000,30.000000,300.000000]
    dbObj.launcherAz_deg=[180.000000,0.000000,180.000000,90.000000,270.000000,0.000000]
