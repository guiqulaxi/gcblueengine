...
def CreateDBObject():
    ...
    dbObj.mzClass='CV-59 (Forrestal) USS Forrestal(68)'
    dbObj.natoClass='CV-59 (Forrestal) USS Forrestal(68)'
    dbObj.mnModelType=2
    dbObj.mnType=22
    dbObj.cost=20000000.000000
    dbObj.weight_kg=75900000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1968.555054
    dbObj.finalYear=1982.874023
    dbObj.country='USA'
