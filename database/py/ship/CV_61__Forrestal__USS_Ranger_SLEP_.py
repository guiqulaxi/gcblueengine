...
def CreateDBObject():
    ...
    dbObj.mzClass='CV-61 (Forrestal) USS Ranger(SLEP)'
    dbObj.natoClass='CV-61 (Forrestal) USS Ranger(SLEP)'
    dbObj.mnModelType=2
    dbObj.mnType=22
    dbObj.cost=20000000.000000
    dbObj.weight_kg=75900000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1986.626953
    dbObj.finalYear=1993.520996
    dbObj.country='USA'
    ...
    dbObj.damageEffect='CV-61 (Forrestal) USS Ranger durability'
