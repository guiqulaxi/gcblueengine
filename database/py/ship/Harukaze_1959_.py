...
def CreateDBObject():
    ...
    dbObj.mzClass='Harukaze(1959)'
    dbObj.natoClass='Harukaze(1959)'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    dbObj.maLauncherClass=['5/38 Mark 12','5/38 Mark 12','5/38 Mark 12','40mm Bofors Mk12','40mm Bofors Mk12','533mm torpedo tube Japan','533mm torpedo tube Japan','Kgun x4','Kgun x4','DC Rack 12']
    dbObj.maMagazineClass=['127mm mk12/16 900 round','40mm Bofors x2 Magazine','Japanese ASW Magazine','Japanese Ship Torpedo Racks']
    ...
    dbObj.launcherFOV_deg=[300.000000,330.000000,300.000000,340.000000,340.000000,0.000000,0.000000,10.000000,10.000000,10.000000]
    dbObj.launcherAz_deg=[0.000000,180.000000,180.000000,0.000000,180.000000,20.000000,340.000000,90.000000,270.000000,180.000000]
