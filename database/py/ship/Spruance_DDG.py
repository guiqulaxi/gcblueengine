...
def CreateDBObject():
    ...
    dbObj.mzClass='Spruance DDG'
    dbObj.natoClass='Spruance DDG'
    dbObj.mnModelType=2
    dbObj.mnType=18
    dbObj.cost=0.000000
    dbObj.weight_kg=8040000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1975.719971
    dbObj.finalYear=1986.920044
    dbObj.country='USA'
    ...
    dbObj.maLauncherClass=['SeaSparrow x8 Launcher','5/54 Mark 45 Mods 0 - 2','5/54 Mark 45 Mods 0 - 2','20mm/99 M-61A1 Gatling OGB Mark 15 Block 1B','20mm/99 M-61A1 Gatling OGB Mark 15 Block 1B','Mk-141 Harpoon Launcher','Mk-141 Harpoon Launcher','Mk-112 ASROC']
    ...
    dbObj.launcherName=['','','','','','','','']
    dbObj.launcherFOV_deg=[300.000000,320.000000,290.000000,290.000000,220.000000,0.000000,0.000000,270.000000]
    dbObj.launcherAz_deg=[180.000000,0.000000,180.000000,45.000000,250.000000,90.000000,270.000000,0.000000]
    dbObj.launcherEl_deg=[40.000000,0.000000,0.000000,0.000000,0.000000,40.000000,40.000000,40.000000]
    dbObj.launcherFireControl=['Mk-91 FCS','SPS-55','SPS-55','Phalanx FC','Phalanx FC','','','']
    dbObj.launcherFireControl2=['','','','','','','','']
    dbObj.launcherIsReloadable=[False,True,True,True,True,False,False,False]
