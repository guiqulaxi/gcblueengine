...
def CreateDBObject():
    ...
    dbObj.mzClass='FF Class Mariscal Sucre'
    dbObj.natoClass='FF Class Mariscal Sucre'
    dbObj.mnModelType=2
    dbObj.mnType=17
    dbObj.cost=0.000000
    dbObj.weight_kg=2520000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1980.530029
    ...
    sensorPlatformDBObject.sensorClass=['EDO-610E ACT','EDO-610E PAS','Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','Furuno','INTRA','LAMBDA-F CME','LAMBDA-F MAE','PRT-401','RAN-10S','RAN-11L/X','RTN-10XPx2','RTN-20X-2']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,180.000000]
