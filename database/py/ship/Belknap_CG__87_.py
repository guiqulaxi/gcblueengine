...
def CreateDBObject():
    ...
    dbObj.mzClass='Belknap CG (87)'
    dbObj.natoClass='Belknap CG (87)'
    dbObj.mnModelType=2
    dbObj.mnType=18
    dbObj.cost=0.000000
    dbObj.weight_kg=7890000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1987.550049
    dbObj.finalYear=1994.290039
    dbObj.country='USA'
    dbObj.designation='CA'
    dbObj.imageList=''
    dbObj.iconFileName='none'
    dbObj.mz3DModelFileName='TicoMk26.xml'
    dbObj.notes='some ships have unknown start or finish dates for the NTU upgrade, assuming 1 year in these cases.'
    dbObj.length_m=167.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    sensorPlatformDBObject=pygcb.tcSensorPlatformDBObject()
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','SLQ-32(v)2 ESM B.1','SLQ-32(v)2 ESM B.2','SLQ-32(v)2 ESM B.3','SPG-55 4','SPS-10','SPS-43 AS','SPS-48(E) AS','SQS-26 Active','SQS-26 Passive']
