...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 051C DDG'
    dbObj.natoClass='Luzhou'
    dbObj.mnModelType=2
    dbObj.mnType=18
    dbObj.cost=0.000000
    ...
    dbObj.mz3DModelFileName='cn_type-051c_luzhou.xml'
    dbObj.notes=''
    dbObj.length_m=155.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    sensorPlatformDBObject=pygcb.tcSensorPlatformDBObject()
    sensorPlatformDBObject.sensorClass=['30N6E','Decca 1226','Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','MR-755 Fregat MAE-5','SJD-8 Active','SJD-9 Passive','Type 344','Type 346','Type 347','Type 826','Type 984-1/2']
    ...
    dbObj.damageEffect='Type 051C DDG durability'
    dbObj.mnNumLaunchers=8
    dbObj.maLauncherClass=['YJ-83 x4','YJ-83 x4','100mm/56 Type-79A Twin-mount','HQ-9 x48 VLS','30 mm/92(1/2in) Type 730 CIWS','30 mm/92(1/2in) Type 730 CIWS','324mm Torpedo Tube x3 (China)','324mm Torpedo Tube x3 (China)']
    ...
    dbObj.launcherFireControl=['','','Type 343G','30N6E','Type 347','Type 347','','']
    ...
    dbObj.TotalShaft_HP=56000.000000
