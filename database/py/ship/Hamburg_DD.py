...
def CreateDBObject():
    ...
    dbObj.mzClass='Hamburg DD'
    dbObj.natoClass='Hamburg DD'
    dbObj.mnModelType=1
    dbObj.mnType=18
    dbObj.cost=0.000000
    dbObj.weight_kg=4680000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1960.229980
    dbObj.finalYear=1977.010010
    ...
    dbObj.damageEffect='Hamburg DD durability'
    dbObj.mnNumLaunchers=10
    dbObj.maLauncherClass=['100mm/55 (3.9in) model 1964','100mm/55 (3.9in) model 1964','100mm/55 (3.9in) model 1964','100mm/55 (3.9in) model 1964','40 mm 2xL70 Bofors','40 mm 2xL70 Bofors','40 mm 2xL70 Bofors','40 mm 2xL70 Bofors','533mm Hamburg Tubes','533mm Hamburg Tubes']
    ...
    dbObj.launcherName=['','','','','','','','','','']
    dbObj.launcherFOV_deg=[300.000000,300.000000,300.000000,300.000000,170.000000,170.000000,170.000000,170.000000,0.000000,0.000000]
    dbObj.launcherAz_deg=[0.000000,0.000000,180.000000,180.000000,90.000000,90.000000,270.000000,270.000000,40.000000,320.000000]
