...
def CreateDBObject():
    ...
    dbObj.mzClass='Descubierta FFG (1987)'
    dbObj.natoClass='Descubierta FFG (1987)'
    dbObj.mnModelType=1
    dbObj.mnType=17
    ...
    dbObj.maLauncherClass=['SeaSparrow x8 Launcher','76 mm/62 Mark 75 Compact','Mk-141 Harpoon Launcher','Mk-141 Harpoon Launcher','20mm Meroka CIWS','20mm Meroka CIWS','Mk-32 3 Torpedo Mount','Mk-32 3 Torpedo Mount']
    dbObj.maMagazineClass=['Meroka x2 Store','76mm/62 mk75 240 rounds','Sea Sparrow Reloads','Mk-32 Torpedo Racks']
