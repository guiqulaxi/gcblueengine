...
def CreateDBObject():
    ...
    dbObj.mzClass='Virginia CGN B2'
    dbObj.natoClass='Virginia CGN B2'
    dbObj.mnModelType=1
    dbObj.mnType=18
    dbObj.cost=0.000000
    ...
    dbObj.maLauncherClass=['Mk-26 Mod0','Mk-26 Mod1','5/54 Mark 45 Mods 0 - 2','5/54 Mark 45 Mods 0 - 2','Mk-141 Harpoon Launcher','Mk-141 Harpoon Launcher','Mk-32 3 Torpedo Mount','Mk-32 3 Torpedo Mount']
    dbObj.maMagazineClass=['127mm Mk-45 1200 rounds','Mk-26 Mod0 + Mod1 Store','US Ship Torpedo Racks']
    dbObj.mnNumMagazines=3
    dbObj.magazineId=[1,0,2]
    dbObj.launcherId=[0,1,2,3,4,5,6,7]
    dbObj.launcherName=['','','','','','','','']
    dbObj.launcherFOV_deg=[300.000000,300.000000,270.000000,300.000000,0.000000,0.000000,40.000000,40.000000]
    dbObj.launcherAz_deg=[0.000000,180.000000,180.000000,0.000000,90.000000,270.000000,270.000000,90.000000]
    dbObj.launcherEl_deg=[40.000000,40.000000,0.000000,0.000000,40.000000,40.000000,0.000000,0.000000]
    dbObj.launcherFireControl=['SPG-51D 8','SPG-51D 8','','','','','','']
    dbObj.launcherFireControl2=['','','','','','','','']
    dbObj.launcherIsReloadable=[True,True,True,True,False,False,True,True]
