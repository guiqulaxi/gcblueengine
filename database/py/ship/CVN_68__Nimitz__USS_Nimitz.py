...
def CreateDBObject():
    ...
    dbObj.mzClass='CVN-68 (Nimitz) USS Nimitz'
    dbObj.natoClass='CVN-68 (Nimitz) USS Nimitz'
    dbObj.mnModelType=2
    dbObj.mnType=22
    dbObj.cost=0.000000
    dbObj.weight_kg=91487000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1975.250000
    dbObj.finalYear=1998.160034
    dbObj.country='USA'
    ...
    dbObj.damageEffect='CVN-68 (Nimitz) USS Nimitz durability'
