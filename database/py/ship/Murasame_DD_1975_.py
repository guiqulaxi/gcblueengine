...
def CreateDBObject():
    ...
    dbObj.mzClass='Murasame DD(1975)'
    dbObj.natoClass='Murasame DD(1975)'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    dbObj.maLauncherClass=['5/54 Mark 16','5/54 Mark 16','5/54 Mark 16','3/50 Mark 27 Twin','3/50 Mark 27 Twin','Mk-32 3 Torpedo Mount','Mk-32 3 Torpedo Mount']
    dbObj.maMagazineClass=['127mm mk12/16 900 round','76mm mk33 Store','Japanese Ship Torpedo Racks']
    dbObj.mnNumMagazines=3
    dbObj.magazineId=[0,1,3]
    dbObj.launcherId=[0,1,2,3,4,5,6]
    dbObj.launcherName=['','','','','','','']
    dbObj.launcherFOV_deg=[300.000000,300.000000,320.000000,340.000000,340.000000,30.000000,30.000000]
    dbObj.launcherAz_deg=[0.000000,180.000000,180.000000,0.000000,180.000000,90.000000,270.000000]
