...
def CreateDBObject():
    ...
    dbObj.mzClass='Hatsuyuki DDG(1988)'
    dbObj.natoClass='Hatsuyuki DDG(1988)'
    dbObj.mnModelType=2
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','FCS-2-21 1','NOLR-6','OLT-3','OPS-14','OPS-18','OQS-4 Active','OQS-4 Passive','Phalanx FC']
