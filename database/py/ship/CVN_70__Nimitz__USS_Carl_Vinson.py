...
def CreateDBObject():
    ...
    dbObj.mzClass='CVN-70 (Nimitz) USS Carl Vinson'
    dbObj.natoClass='CVN-70 (Nimitz) USS Carl Vinson'
    dbObj.mnModelType=2
    dbObj.mnType=22
    dbObj.cost=0.000000
    dbObj.weight_kg=91487000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1982.189941
    dbObj.finalYear=2005.579956
    dbObj.country='USA'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','Phalanx FC','SLQ-32(v)4 ECM','SLQ-32(v)4 ESM B.1','SLQ-32(v)4 ESM B.2','SLQ-32(v)4 ESM B.3','SPS-48(E) AS','SPS-49(v)5','SPS-67(V)3 SS']
    ...
    dbObj.damageEffect='CVN-70 (Nimitz) USS Carl Vinson durability'
    ...
    dbObj.launcherFireControl=['SPS-48(E) AS','SPS-48(E) AS','SPS-48(E) AS','Phalanx FC','Phalanx FC','Phalanx FC','Phalanx FC']
