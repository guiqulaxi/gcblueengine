...
def CreateDBObject():
    ...
    dbObj.mzClass='CV-62 (Forrestal) USS Independence(SLEP)'
    dbObj.natoClass='CV-62 (Forrestal) USS Independence(SLEP)'
    dbObj.mnModelType=2
    dbObj.mnType=22
    dbObj.cost=20000000.000000
    dbObj.weight_kg=75900000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1990.473999
    dbObj.finalYear=1998.744995
    dbObj.country='USA'
