...
def CreateDBObject():
    ...
    dbObj.mzClass='Charles F Adams DDG-15 1981'
    dbObj.natoClass='Charles F Adams DDG-15 1981'
    dbObj.mnModelType=1
    dbObj.mnType=18
    dbObj.cost=0.000000
    dbObj.weight_kg=4500000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1981.329956
    dbObj.finalYear=1992.750000
    dbObj.country='USA'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','SLQ-32(v)2 ESM B.1','SLQ-32(v)2 ESM B.2','SLQ-32(v)2 ESM B.3','SPG-51D 3','SPS-10','SPS-40B','SPS-52C AS','SQS-23 Active','SQS-23 Passive']
    ...
    dbObj.launcherFireControl=['SPG-51D 3','','','','','']
