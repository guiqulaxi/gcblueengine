...
def CreateDBObject():
    ...
    dbObj.mzClass='Ikazuchi DDE'
    dbObj.natoClass='Ikazuchi DDE'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    dbObj.launcherName=['','','','','','','','']
    dbObj.launcherFOV_deg=[300.000000,300.000000,280.000000,310.000000,10.000000,10.000000,10.000000,10.000000]
