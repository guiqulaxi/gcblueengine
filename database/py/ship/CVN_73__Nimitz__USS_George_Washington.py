...
def CreateDBObject():
    ...
    dbObj.mzClass='CVN-73 (Nimitz) USS George Washington'
    dbObj.natoClass='CVN-73 (Nimitz) USS George Washington'
    dbObj.mnModelType=2
    dbObj.mnType=22
    dbObj.cost=0.000000
    dbObj.weight_kg=102000000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1992.500000
    ...
    dbObj.mfAccel_ktsps=0.041823
    dbObj.mfTurnRate_degps=0.559988
    dbObj.mfFuelCapacity_kg=14280000.000000
    dbObj.mfFuelRate_kgps=0.000000
    dbObj.mfToughness=1000.000000
    dbObj.damageEffect='CVN-73 (Nimitz) USS George Washington durability'
    ...
    airDetectionDBObject.RCS_dBsm=64.675003
    airDetectionDBObject.RCS_Model='ShipRCS1'
    airDetectionDBObject.opticalCrossSection_dBsm=32.967999
    airDetectionDBObject.irSignature_dB=15.506000
    airDetectionDBObject.IR_ModelA='ShipIR1'
    airDetectionDBObject.IR_ModelB='ShipIR1'
    airDetectionDBObject.IR_ModelC='ShipIR1'
    airDetectionDBObject.effectiveHeight_m=35.000000
