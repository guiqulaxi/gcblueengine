...
def CreateDBObject():
    ...
    dbObj.mzClass='Osprey MHC'
    dbObj.natoClass='Osprey MHC'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    dbObj.weight_kg=930000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1993.890015
    dbObj.finalYear=2007.920044
    dbObj.country='USA'
    ...
    sensorPlatformDBObject.sensorClass=['ESM-1.5','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c','SPS-64 SS','SQQ-32(V)3 Active']
    ...
    dbObj.damageEffect='Osprey MHC durability'
