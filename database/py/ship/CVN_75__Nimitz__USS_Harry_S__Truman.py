...
def CreateDBObject():
    ...
    dbObj.mzClass='CVN-75 (Nimitz) USS Harry S. Truman'
    dbObj.natoClass='CVN-75 (Nimitz) USS Harry S. Truman'
    dbObj.mnModelType=2
    dbObj.mnType=22
    dbObj.cost=0.000000
    dbObj.weight_kg=102000000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1998.560059
    ...
    dbObj.damageEffect='CVN-75 (Nimitz) USS Harry S. Truman durability'
