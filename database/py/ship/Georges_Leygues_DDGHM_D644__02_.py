...
def CreateDBObject():
    ...
    dbObj.mzClass='Georges Leygues DDGHM(D644)(02)'
    dbObj.natoClass='Georges Leygues DDGHM(D644)(02)'
    dbObj.mnModelType=2
    dbObj.mnType=18
    dbObj.cost=0.000000
    dbObj.weight_kg=4580000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=2002.520020
    ...
    sensorPlatformDBObject.sensorClass=['ARBR 17','DRBV 15C','DRBV 26','DUBV-23 Active','DUBV-43 VDS Active','Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d']
