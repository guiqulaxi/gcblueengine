...
def CreateDBObject():
    ...
    dbObj.mzClass='Kortenaer FFG'
    dbObj.natoClass='Kortenaer FFG'
    dbObj.mnModelType=2
    dbObj.mnType=18
    dbObj.cost=0.000000
    dbObj.weight_kg=3785000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1978.819946
    ...
    dbObj.maLauncherClass=['SeaSparrow x8 Launcher','76 mm/62 Mark 75 Compact','76 mm/62 Mark 75 Compact','Mk-141 Harpoon Launcher','Mk-141 Harpoon Launcher','Mk-32 2 Torpedo Mount','Mk-32 2 Torpedo Mount']
    dbObj.maMagazineClass=['Lynx 2.2 Support','Sea Sparrow Reloads','76mm/62 mk75 x2 480 rounds']
    dbObj.magazineId=[0,1,2]
    dbObj.launcherId=[0,1,2,3,4,5,6]
    dbObj.launcherName=['','','','','','','']
    dbObj.launcherFOV_deg=[300.000000,300.000000,330.000000,0.000000,0.000000,30.000000,30.000000]
    dbObj.launcherAz_deg=[0.000000,0.000000,180.000000,90.000000,270.000000,90.000000,270.000000]
    dbObj.launcherEl_deg=[0.000000,0.000000,0.000000,20.000000,20.000000,0.000000,0.000000]
