...
def CreateDBObject():
    ...
    dbObj.mzClass='Allen M Sumner(1959)'
    dbObj.natoClass='Allen M Sumner(1959)'
    dbObj.mnModelType=2
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','SPR-1 ESM','SPS-10','SPS-6','SQS-4 Active']
    ...
    dbObj.maLauncherClass=['5/38 Mark 12 Twin','5/38 Mark 12 Twin','5/38 Mark 12 Twin','Mk-25 Single Torpedo Tube','Mk-25 Single Torpedo Tube','Mk-32 3 Torpedo Mount','Mk-32 3 Torpedo Mount','3/50 Mark 33','3/50 Mark 33','3/50 Mark 33','3/50 Mark 33']
    ...
    dbObj.launcherName=['','','','','','','','','','','']
    dbObj.launcherFOV_deg=[270.000000,270.000000,270.000000,10.000000,10.000000,30.000000,30.000000,270.000000,200.000000,200.000000,270.000000]
    dbObj.launcherAz_deg=[0.000000,0.000000,180.000000,45.000000,315.000000,90.000000,270.000000,0.000000,90.000000,270.000000,180.000000]
