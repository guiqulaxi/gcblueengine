...
def CreateDBObject():
    ...
    dbObj.mzClass='Karel Doorman DDG (1994) (Belgium)'
    dbObj.natoClass='Karel Doorman DDG (1994) (Belgium)'
    dbObj.mnModelType=2
    dbObj.mnType=17
    dbObj.cost=0.000000
    dbObj.weight_kg=3320000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=2005.973999
    ...
    sensorPlatformDBObject.sensorClass=['APECS II','AR-700(V)2','DSBV 61C','Decca 1229','Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','LW-08','PHS-32 Active','PHS-32 Passive','SMART-S','STIR 180']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,180.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000]
