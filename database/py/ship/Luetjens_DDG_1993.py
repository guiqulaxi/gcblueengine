...
def CreateDBObject():
    ...
    dbObj.mzClass='Luetjens DDG 1993'
    dbObj.natoClass='Luetjens DDG 1993'
    dbObj.mnModelType=1
    dbObj.mnType=18
    dbObj.cost=0.000000
    ...
    dbObj.maLauncherClass=['Mk-13 GMLS','127mm/54 (5in) Mk42','127mm/54 (5in) Mk42','Mk-112 ASROC','Mk-32 3 Torpedo Mount','Mk-32 3 Torpedo Mount','RIM-116A RAM x21','RIM-116A RAM x21']
    dbObj.maMagazineClass=['127mm Mk-42 500 Rounds','Mk-13 Rotary Store 40 Lutjens','Mk-32 Torpedo Racks','Mk-112 ASROC Reloads','RIM-116 21 x2 Store']
    dbObj.magazineId=[0,1,2,3,4]
    dbObj.launcherId=[0,1,2,3,4,5,6,7]
    dbObj.launcherName=['','','','','','','','']
    dbObj.launcherFOV_deg=[270.000000,270.000000,270.000000,360.000000,30.000000,30.000000,300.000000,300.000000]
    dbObj.launcherAz_deg=[0.000000,0.000000,180.000000,0.000000,90.000000,270.000000,0.000000,180.000000]
    ...
    dbObj.launcherIsReloadable=[True,True,True,False,True,True,True,True]
