...
def CreateDBObject():
    ...
    dbObj.mzClass='La Galite FACM'
    dbObj.natoClass='La Galite FACM'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    dbObj.weight_kg=425000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1970.000000
    dbObj.finalYear=3000.000000
    dbObj.country='Tunisia'
    dbObj.designation='PGG'
    dbObj.imageList='boat.jpg'
    dbObj.iconFileName='NONE'
    dbObj.mz3DModelFileName='pg-84.xml'
    dbObj.notes=''
    dbObj.length_m=56.799999
    ...
    dbObj.mfAccel_ktsps=0.244244
    dbObj.mfTurnRate_degps=5.814816
    dbObj.mfFuelCapacity_kg=43540.000000
    dbObj.mfFuelRate_kgps=0.100786
    dbObj.mfToughness=25.000000
    dbObj.damageEffect='La Galite FACM durability'
    ...
    airDetectionDBObject.opticalCrossSection_dBsm=18.474001
