...
def CreateDBObject():
    ...
    dbObj.mzClass='Minegumo DD(1978)'
    dbObj.natoClass='Minegumo DD(1978)'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    dbObj.maLauncherClass=['3/50 Mark 34','3/50 Mark 34','76 mm/62 Mark 75','Mk-32 3 Torpedo Mount','Mk-32 3 Torpedo Mount','Mk-112 ASROC','375mm Bofors ASRL']
    dbObj.maMagazineClass=['DASH 1.1 Support','76mm/62 mk75 240 rounds','76mm mk33 Store','Japanese ASW Magazine']
    dbObj.magazineId=[2,1,0,3]
    dbObj.launcherId=[0,1,2,3,4,5,6]
    dbObj.launcherName=['','','','','','','']
    dbObj.launcherFOV_deg=[300.000000,320.000000,300.000000,30.000000,30.000000,300.000000,300.000000]
    dbObj.launcherAz_deg=[0.000000,180.000000,180.000000,90.000000,270.000000,180.000000,0.000000]
    dbObj.launcherEl_deg=[0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000]
    dbObj.launcherFireControl=['','','','','','','']
    dbObj.launcherFireControl2=['','','','','','','']
    dbObj.launcherIsReloadable=[True,True,True,True,True,False,True]
