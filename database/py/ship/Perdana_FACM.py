...
def CreateDBObject():
    ...
    dbObj.mzClass='Perdana FACM'
    dbObj.natoClass='Perdana FACM'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    dbObj.weight_kg=265000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1972.972168
    dbObj.finalYear=3000.000000
    dbObj.country='Malaysia'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','THD 1040 Triton','Decca 1226','TRS 3220 Pollux','DR2000S']
    ...
    dbObj.mfAccel_ktsps=0.325322
    dbObj.mfTurnRate_degps=7.136406
    dbObj.mfFuelCapacity_kg=43540.000000
    dbObj.mfFuelRate_kgps=0.100786
    dbObj.mfToughness=25.000000
    dbObj.damageEffect='Perdana FACM durability'
    dbObj.mnNumLaunchers=4
    dbObj.maLauncherClass=['Exocet Twin Launcher','Exocet Twin Launcher','57 mm/70 (2.25in) Marks 2 - 3','40mm L70 Sea Trinity']
    dbObj.maMagazineClass=['57mm/70 Mks 2-3 Store','40mm L70 Trinity magazine']
    ...
    dbObj.TotalShaft_HP=14000.000000
