...
def CreateDBObject():
    ...
    dbObj.mzClass='Baleares FFG (1985)'
    dbObj.natoClass='Baleares FFG (1985)'
    dbObj.mnModelType=1
    dbObj.mnType=18
    dbObj.cost=0.000000
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','SPG-51D 1','SPS-10F','SPS-52C AS','SQS-23 Active','SQS-23 Passive']
    ...
    dbObj.maLauncherClass=['127mm/54 (5in) Mk42','Mk-22 GMLS','Mk-141 Harpoon Launcher','Mk-141 Harpoon Launcher','20mm Meroka CIWS','20mm Meroka CIWS','Mk-32 2 Torpedo Mount','Mk-32 2 Torpedo Mount','Mk-25 Single Torpedo Tube','Mk-25 Single Torpedo Tube']
    ...
    dbObj.launcherName=['','','','','','','','','','']
    dbObj.launcherFOV_deg=[320.000000,300.000000,0.000000,0.000000,170.000000,170.000000,0.000000,0.000000,0.000000,0.000000]
    dbObj.launcherAz_deg=[0.000000,0.000000,90.000000,270.000000,90.000000,270.000000,90.000000,270.000000,190.000000,170.000000]
    dbObj.launcherEl_deg=[0.000000,40.000000,20.000000,20.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000]
    dbObj.launcherFireControl=['','SPG-51D 1','','','','','','','','']
    dbObj.launcherFireControl2=['','','','','','','','','','']
    dbObj.launcherIsReloadable=[True,True,False,False,True,True,True,True,True,True]
