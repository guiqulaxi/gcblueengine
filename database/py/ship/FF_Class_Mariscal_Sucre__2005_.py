...
def CreateDBObject():
    ...
    dbObj.mzClass='FF Class Mariscal Sucre (2005)'
    dbObj.natoClass='FF Class Mariscal Sucre (2005)'
    dbObj.mnModelType=2
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    sensorPlatformDBObject.sensorClass=['ARPA M-25','Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','INTRA','NS9003A-V2','NS9005AV-2','PRT-401','RAN-10S','RAN-11L/X','RTN-10XPx2','RTN-20X-2']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,180.000000]
    dbObj.AddComponent(sensorPlatformDBObject)
    dbObj.mfMaxSpeed_kts=35.000000
    dbObj.mfAccel_ktsps=0.245937
    ...
    dbObj.maLauncherClass=['Otomat-Lupo','Albatros-Lupo','ILAS-3 Lupo','127 mm/54 (5in) Compact','Launcher 40/70L','Breda SCLAR']
    dbObj.maMagazineClass=['Lupo helo fuel','127/54 Compact polvorin Lupo','LUPO VCHAFF','Lupo torpedos']
    ...
    dbObj.launcherIsReloadable=[False,False,False,True,False,True]
    airDetectionDBObject=pygcb.tcAirDetectionDBObject()
    airDetectionDBObject.RCS_dBsm=40.567001
    airDetectionDBObject.RCS_Model='ShipRCS1'
    airDetectionDBObject.opticalCrossSection_dBsm=23.167000
