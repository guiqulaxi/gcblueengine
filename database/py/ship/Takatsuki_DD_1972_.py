...
def CreateDBObject():
    ...
    dbObj.mzClass='Takatsuki DD(1972)'
    dbObj.natoClass='Takatsuki DD(1972)'
    dbObj.mnModelType=2
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    dbObj.notes=''
    dbObj.length_m=136.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    sensorPlatformDBObject=pygcb.tcSensorPlatformDBObject()
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','NOLR-1','OLT-1','OPS-11','OPS-17','SQS-23 Active','SQS-23 Passive','SQS-35(J) VDS']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,180.000000]
