...
def CreateDBObject():
    ...
    dbObj.mzClass='Pr 1135M Burevestnik-M'
    dbObj.natoClass='Krivak II'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    dbObj.damageEffect='Pr 1135M Burevestnik-M durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['100 mm/70 (3.9in) AK-100','100 mm/70 (3.9in) AK-100','533mm torpedo x4 tubes','533mm torpedo x4 tubes','SA-N-4 x2 Launcher','SA-N-4 x2 Launcher','SS-N-14 x4 Launcher']
    dbObj.maMagazineClass=['Pr1135M Ammo Mag']
    dbObj.magazineId=[0]
    dbObj.launcherId=[0,1,2,3,4,5,6]
    dbObj.launcherName=['','','','','','','']
    dbObj.launcherFOV_deg=[240.000000,270.000000,0.000000,0.000000,300.000000,300.000000,0.000000]
    dbObj.launcherAz_deg=[180.000000,180.000000,90.000000,270.000000,0.000000,180.000000,0.000000]
