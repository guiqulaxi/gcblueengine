...
def CreateDBObject():
    ...
    dbObj.mzClass='Baleares FFG'
    dbObj.natoClass='Baleares FFG'
    dbObj.mnModelType=1
    dbObj.mnType=18
    dbObj.cost=0.000000
    dbObj.weight_kg=4177000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1973.729980
    ...
    dbObj.maLauncherClass=['127mm/54 (5in) Mk42','Mk-22 GMLS','Mk-32 2 Torpedo Mount','Mk-32 2 Torpedo Mount','Mk-25 Single Torpedo Tube','Mk-25 Single Torpedo Tube']
    dbObj.maMagazineClass=['127mm Mk-42 500 Rounds','Mk-22 GMLS Rotary Store','Mk-32 Torpedo Racks','Mk-37 Torpedo Racks']
    dbObj.mnNumMagazines=4
    dbObj.magazineId=[1,0,2,3]
    dbObj.launcherId=[0,1,2,3,4,5]
    dbObj.launcherName=['','','','','','']
    dbObj.launcherFOV_deg=[320.000000,300.000000,0.000000,0.000000,0.000000,0.000000]
    dbObj.launcherAz_deg=[0.000000,0.000000,90.000000,270.000000,190.000000,170.000000]
    dbObj.launcherEl_deg=[0.000000,40.000000,0.000000,0.000000,0.000000,0.000000]
