...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 053H1G'
    dbObj.natoClass='Jianghu V'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    dbObj.damageEffect='Type 053H1G durability'
    dbObj.mnNumLaunchers=10
    dbObj.maLauncherClass=['YJ-82 x3','YJ-82 x3','37mm/63(1.5in) Type 676','37mm/63(1.5in) Type 676','37mm/63(1.5in) Type 676','37mm/63(1.5in) Type 676','100mm/56 Type-79A Twin-mount','100mm/56 Type-79A Twin-mount','EDS-25A Mortar','EDS-25A Mortar']
    ...
    dbObj.launcherName=['','','','','','','','','','']
    dbObj.launcherFOV_deg=[240.000000,240.000000,300.000000,300.000000,300.000000,300.000000,320.000000,320.000000,10.000000,10.000000]
    dbObj.launcherAz_deg=[0.000000,0.000000,45.000000,135.000000,315.000000,225.000000,0.000000,180.000000,0.000000,0.000000]
