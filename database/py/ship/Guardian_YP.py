...
def CreateDBObject():
    ...
    dbObj.mzClass='Guardian YP'
    dbObj.natoClass='Guardian YP'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    dbObj.mfAccel_ktsps=0.506343
    dbObj.mfTurnRate_degps=47.637463
    dbObj.mfFuelCapacity_kg=600.000000
    dbObj.mfFuelRate_kgps=0.032361
    dbObj.mfToughness=0.440000
    dbObj.damageEffect='Guardian YP durability'
    dbObj.mnNumLaunchers=3
    dbObj.maLauncherClass=['0.30in GAU-17','0.30in GAU-17','0.50in/72 (12.7 mm) M3M FN Herstal MG (GAU-21)']
    dbObj.maMagazineClass=['Guardian Ammo Box']
    ...
    airDetectionDBObject.RCS_dBsm=-3.298000
    airDetectionDBObject.RCS_Model='ShipRCS1'
    airDetectionDBObject.opticalCrossSection_dBsm=10.260000
    airDetectionDBObject.irSignature_dB=16.136999
    ...
    dbObj.draft_m=0.400000
    dbObj.beam_m=2.500000
    dbObj.PowerPlantType=0.000000
    dbObj.TotalShaft_HP=350.000000
