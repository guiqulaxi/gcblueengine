...
def CreateDBObject():
    ...
    dbObj.mzClass='Allen M Sumner(1953)'
    dbObj.natoClass='Allen M Sumner(1953)'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','QHBa Active','SPR-1 ESM','SPS-10','SPS-6']
