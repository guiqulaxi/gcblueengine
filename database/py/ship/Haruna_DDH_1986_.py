...
def CreateDBObject():
    ...
    dbObj.mzClass='Haruna DDH(1986)'
    dbObj.natoClass='Haruna DDH(1986)'
    dbObj.mnModelType=2
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','FCS-2-21 1','NOLQ-1','OLR-9','OPS-11','OPS-28','OQS-3 Active','OQS-3 Passive','Phalanx FC']
    ...
    dbObj.maLauncherClass=['SeaSparrow x8 Launcher','127mm/54 (5in) Mk42','127mm/54 (5in) Mk42','20mm/76 M-61A1 Gatling Mark 15 Block 0','20mm/76 M-61A1 Gatling Mark 15 Block 0','Mk-32 3 Torpedo Mount','Mk-32 3 Torpedo Mount','Mk-112 ASROC']
    dbObj.maMagazineClass=['SH-3 3.3 Support','127mm Mk-42 500 Rounds','Sea Sparrow Reloads','Phalanx 0 x2 Store']
    dbObj.magazineId=[1,0,2,3]
    dbObj.launcherId=[0,1,2,3,4,5,6,7]
    dbObj.launcherName=['','','','','','','','']
    dbObj.launcherFOV_deg=[0.000000,320.000000,330.000000,170.000000,170.000000,30.000000,30.000000,300.000000]
    ...
    airDetectionDBObject.opticalCrossSection_dBsm=26.171000
