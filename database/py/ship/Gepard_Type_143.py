...
def CreateDBObject():
    ...
    dbObj.mzClass='Gepard Type 143'
    dbObj.natoClass='Gepard Type 143'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    dbObj.mfAccel_ktsps=0.276387
    dbObj.mfTurnRate_degps=6.033729
    ...
    dbObj.maLauncherClass=['76 mm/62 Mark 75','76 mm/62 Mark 75','Exocet Twin Launcher','Exocet Twin Launcher']
