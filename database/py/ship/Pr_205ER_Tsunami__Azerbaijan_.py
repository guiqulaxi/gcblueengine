...
def CreateDBObject():
    ...
    dbObj.mzClass='Pr 205ER Tsunami (Azerbaijan)'
    dbObj.natoClass='Osa II (Azerbaijan)'
    dbObj.mnModelType=1
    dbObj.mnType=17
    ...
    dbObj.country='Azerbaijan'
    dbObj.designation='PT'
    dbObj.imageList=''
    ...
    dbObj.magazineId=[]
    dbObj.launcherId=[1,2]
    dbObj.launcherName=['','']
    dbObj.launcherFOV_deg=[320.000000,240.000000]
