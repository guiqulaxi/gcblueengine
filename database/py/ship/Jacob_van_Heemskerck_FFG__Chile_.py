...
def CreateDBObject():
    ...
    dbObj.mzClass='Jacob van Heemskerck FFG (Chile)'
    dbObj.natoClass='Jacob van Heemskerck FFG (Chile)'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    dbObj.weight_kg=3048140.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=2005.540039
    dbObj.finalYear=2999.000000
    dbObj.country='Chile'
    dbObj.designation='FFG'
    dbObj.imageList='heemskerck_chile.jpg'
    dbObj.iconFileName='none'
    dbObj.mz3DModelFileName='type-22.xml'
    dbObj.notes='In 2005 Netherlands sold Jacob van Heemskerck to Chile as the Almirante Latorre and Witte de With as the CapitÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¿Ãƒâ€šÃ‚Â½n Prat. The helicopter was replaced by a Standard medium range SAM system and associated radars.'
