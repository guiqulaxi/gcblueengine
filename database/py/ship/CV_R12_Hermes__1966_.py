...
def CreateDBObject():
    ...
    dbObj.mzClass='CV R12 Hermes (1966)'
    dbObj.natoClass='CV R12 Hermes (1966)'
    dbObj.mnModelType=2
    dbObj.mnType=22
    dbObj.cost=20000000.000000
    dbObj.weight_kg=28700000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1966.329956
    dbObj.finalYear=1984.280029
    dbObj.country='UK'
    ...
    dbObj.damageEffect='CV R12 Hermes (1966) durability'
    dbObj.mnNumLaunchers=2
    dbObj.maLauncherClass=['Sea Cat Quad launcher','Sea Cat Quad launcher']
    dbObj.maMagazineClass=['Carrier Fuel Supply','Hermes Carrier Magazine','Sea Cat Store 48']
    dbObj.magazineId=[0,1,2]
    dbObj.launcherId=[0,1]
    dbObj.launcherName=['','']
    dbObj.launcherFOV_deg=[260.000000,260.000000]
    dbObj.launcherAz_deg=[315.000000,135.000000]
    dbObj.launcherEl_deg=[0.000000,0.000000]
    dbObj.launcherFireControl=['Type 984','Type 984']
