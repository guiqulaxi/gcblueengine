...
def CreateDBObject():
    ...
    dbObj.mzClass='Pr 205 Tsunami (Poland)'
    dbObj.natoClass='Osa I (Poland)'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=20000000.000000
    dbObj.weight_kg=171500.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1964.010010
    dbObj.finalYear=2006.250000
    dbObj.country='poland'
    ...
    dbObj.mfMaxSpeed_kts=38.500000
    dbObj.mfAccel_ktsps=0.376029
    dbObj.mfTurnRate_degps=8.610912
    dbObj.mfFuelCapacity_kg=24010.000000
    dbObj.mfFuelRate_kgps=0.051873
    dbObj.mfToughness=200.000000
    dbObj.damageEffect='Pr 205 Tsunami durability'
    ...
    airDetectionDBObject.opticalCrossSection_dBsm=16.448999
