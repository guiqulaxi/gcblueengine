...
def CreateDBObject():
    ...
    dbObj.mzClass='Pr 12341 Ovod-1'
    dbObj.natoClass='Nanuchka III'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    dbObj.weight_kg=639000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1977.989990
    dbObj.finalYear=3000.000000
    dbObj.country='Russia'
    dbObj.designation='FSG'
    dbObj.imageList='nanuchka3.jpg'
    ...
    dbObj.mfTurnRate_degps=4.688449
    dbObj.mfFuelCapacity_kg=89460.000000
    dbObj.mfFuelRate_kgps=0.085199
    dbObj.mfToughness=50.000000
    dbObj.damageEffect='Pr 12341 Ovod-1 durability'
    dbObj.mnNumLaunchers=5
    dbObj.maLauncherClass=['SS-N-9 x3 Launcher','SS-N-9 x3 Launcher','SA-N-4 x2 Launcher','76 mm/59 (3in) AK-176','30 mm/54 (1.2in) AK-630M']
    dbObj.maMagazineClass=['76mm AK-176 Magazine 152 Rounds','9K33 OSA Store']
    dbObj.magazineId=[1,0]
    dbObj.launcherId=[0,1,2,3,4]
    dbObj.launcherName=['','','','','']
    dbObj.launcherFOV_deg=[320.000000,0.000000,0.000000,300.000000,300.000000]
    dbObj.launcherAz_deg=[180.000000,0.000000,0.000000,0.000000,180.000000]
    dbObj.launcherEl_deg=[0.000000,20.000000,20.000000,40.000000,0.000000]
    dbObj.launcherFireControl=['MR-123 Vympel FC','','','Pop Group FC','MR-123 Vympel FC']
    dbObj.launcherFireControl2=['','','','','']
    dbObj.launcherIsReloadable=[True,False,False,True,False]
