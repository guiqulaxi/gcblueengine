...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 42 DDG Batch 2'
    dbObj.natoClass='Type 42 DDG Batch 2'
    dbObj.mnModelType=2
    dbObj.mnType=18
    dbObj.cost=20000000.000000
    dbObj.weight_kg=4100000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1980.719971
    ...
    dbObj.damageEffect='Type 42 DDG Batch 2 durability'
    dbObj.mnNumLaunchers=5
    dbObj.maLauncherClass=['20mm/76 M-61A1 Gatling Mark 15 Block 0','Sea Dart Twin Rail Launcher','Mk-32 3 Torpedo Mount','Mk-32 3 Torpedo Mount','114mm/55(4.5in) Mark 8 Mod 0']
    dbObj.maMagazineClass=['Lynx 1.2 Support','114mm/55(4.5in) mk8 800 rounds','Sea Dart magazine 22','Phalanx 0 x1 Store']
    dbObj.magazineId=[3,1,2,0]
    dbObj.launcherId=[0,1,2,3,4]
    dbObj.launcherName=['','','','','']
    dbObj.launcherFOV_deg=[270.000000,300.000000,40.000000,40.000000,330.000000]
