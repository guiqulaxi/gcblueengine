...
def CreateDBObject():
    ...
    dbObj.mzClass='Hauk PTGM 2001'
    dbObj.natoClass='Hauk PTGM 2001'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    dbObj.weight_kg=160000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=2001.250000
    dbObj.finalYear=2007.949951
    ...
    sensorPlatformDBObject.sensorClass=['Decca 1226','Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','VAMPIR IIRST']
