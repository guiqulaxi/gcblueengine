...
def CreateDBObject():
    ...
    dbObj.mzClass='Pr 205ER Tsunami(Libya)'
    dbObj.natoClass='Osa II (Libya)'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    dbObj.weight_kg=253000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1976.680054
    ...
    dbObj.mfAccel_ktsps=0.288102
    dbObj.mfTurnRate_degps=7.900562
    ...
    dbObj.maLauncherClass=['SS-N-2D x2 Launcher x2','30 mm/63 (1.2in) AK-230','30 mm/63 (1.2in) AK-230']
