...
def CreateDBObject():
    ...
    dbObj.mzClass='CV-60 (Forrestal) USS Saratoga(SLEP)'
    dbObj.natoClass='CV-60 (Forrestal) USS Saratoga(SLEP)'
    dbObj.mnModelType=2
    dbObj.mnType=22
    dbObj.cost=20000000.000000
    dbObj.weight_kg=75900000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1984.250977
    dbObj.finalYear=1994.833008
    dbObj.country='USA'
