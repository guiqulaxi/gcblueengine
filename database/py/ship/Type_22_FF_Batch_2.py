...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 22 FF Batch 2'
    dbObj.natoClass='Type 22 FF Batch 2'
    dbObj.mnModelType=2
    dbObj.mnType=17
    dbObj.cost=150000000.000000
    dbObj.weight_kg=4200000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1983.969971
    dbObj.finalYear=2002.869995
    dbObj.country='UK'
    dbObj.designation='FF'
    dbObj.imageList='type22_b2.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ESM-4.5','Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','Type 1006','Type 2016 Active','Type 2016 Passive','Type 2031 TA','Type 967/968']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,180.000000,0.000000]
    dbObj.AddComponent(sensorPlatformDBObject)
    dbObj.mfMaxSpeed_kts=30.000000
    dbObj.mfAccel_ktsps=0.221503
    dbObj.mfTurnRate_degps=1.875305
    dbObj.mfFuelCapacity_kg=588000.000000
    dbObj.mfFuelRate_kgps=0.653328
    dbObj.mfToughness=140.000000
    dbObj.damageEffect='Type 22 FF Batch 2 durability'
    ...
    airDetectionDBObject.opticalCrossSection_dBsm=25.722000
