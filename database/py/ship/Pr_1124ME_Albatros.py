...
def CreateDBObject():
    ...
    dbObj.mzClass='Pr 1124ME Albatros'
    dbObj.natoClass='Grisha V'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    dbObj.weight_kg=1200000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1982.939941
    ...
    dbObj.mfMaxSpeed_kts=36.169998
    dbObj.mfAccel_ktsps=0.370698
    dbObj.mfTurnRate_degps=3.746099
    dbObj.mfFuelCapacity_kg=168000.000000
    dbObj.mfFuelRate_kgps=0.249845
    dbObj.mfToughness=92.000000
    dbObj.damageEffect='Pr 1124ME Albatros durability'
    dbObj.mnNumLaunchers=5
    dbObj.maLauncherClass=['30 mm/54 (1.2in) AK-630M','533mm torpedo x2 tubes','533mm torpedo x2 tubes','76 mm/59 (3in) AK-176','SA-N-4 x2 Launcher']
    dbObj.maMagazineClass=['AK-630 x1 Store','Pr1124ME Ammo Mag']
    ...
    dbObj.launcherEl_deg=[0.000000,0.000000,0.000000,0.000000,4.000000]
