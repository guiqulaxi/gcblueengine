...
def CreateDBObject():
    ...
    dbObj.mzClass='Tromp DDG'
    dbObj.natoClass='Tromp DDG'
    dbObj.mnModelType=2
    dbObj.mnType=17
    dbObj.cost=0.000000
    dbObj.weight_kg=4308000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1975.755005
    ...
    sensorPlatformDBObject.sensorClass=['CWE 610 Active','CWE 610 Passive','Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','SPG-51D 1','SPS-01 AS','WM-25']
    ...
    dbObj.maLauncherClass=['Mk-13 Mod4 GMLS','SeaSparrow x8 Launcher','12cm/50(4.7in) Model 1950','Mk-32 3 Torpedo Mount','Mk-32 3 Torpedo Mount']
    ...
    dbObj.launcherName=['','','','','']
    dbObj.launcherFOV_deg=[320.000000,300.000000,320.000000,30.000000,30.000000]
    dbObj.launcherAz_deg=[0.000000,180.000000,0.000000,90.000000,270.000000]
    dbObj.launcherEl_deg=[40.000000,40.000000,0.000000,0.000000,0.000000]
