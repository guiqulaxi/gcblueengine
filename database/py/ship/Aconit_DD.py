...
def CreateDBObject():
    ...
    dbObj.mzClass='Aconit DD'
    dbObj.natoClass='Aconit DD'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    dbObj.weight_kg=3900000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1973.241943
    ...
    sensorPlatformDBObject.sensorClass=['DRBC 32B','DRBV 13','DRBV 22','DUBV-23 Active','DUBV-43 VDS Active','Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d']
    ...
    dbObj.maLauncherClass=['100mm/55 (3.9in) model 1968','100mm/55 (3.9in) model 1968','Malafon Launcher','533mm French L Torp Tubes x5','533mm French L Torp Tubes x5']
    dbObj.maMagazineClass=['100mm/55 Model 1968 1200 Rounds','L Torpedo Racks 20 Rounds','Malafon Reloads 12 Rounds']
    dbObj.magazineId=[0,1,2]
    dbObj.launcherId=[0,1,2,3,4]
    dbObj.launcherName=['','','','','']
    dbObj.launcherFOV_deg=[320.000000,300.000000,270.000000,30.000000,30.000000]
    dbObj.launcherAz_deg=[0.000000,180.000000,0.000000,90.000000,270.000000]
    dbObj.launcherEl_deg=[0.000000,0.000000,15.000000,0.000000,0.000000]
