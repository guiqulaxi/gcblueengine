...
def CreateDBObject():
    ...
    dbObj.mzClass='CV-551 Giuseppe Garibaldi(2003)'
    dbObj.natoClass='CV-551 Giuseppe Garibaldi(2003)'
    dbObj.mnModelType=2
    dbObj.mnType=22
    dbObj.cost=0.000000
    ...
    dbObj.notes=''
    dbObj.length_m=180.199997
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    sensorPlatformDBObject=pygcb.tcSensorPlatformDBObject()
    sensorPlatformDBObject.sensorClass=['DE-1160B Active','DE-1160B Passive','ELT 211 ESM','ELT 318 ECM','Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','RAN-10S','RAN-3L','RTN-20X','RTN-20X','RTN-20X','SPS-52C AS']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,135.000000,225.000000,0.000000]
    ...
    dbObj.maLauncherClass=['Albatross Launcher','Albatross Launcher','40mm Twin Fast Forty','40mm Twin Fast Forty','40mm Twin Fast Forty','533mm B-515 Torpedo Launcher x3','533mm B-515 Torpedo Launcher x3']
    ...
    dbObj.launcherName=['','','','','','','']
    dbObj.launcherFOV_deg=[300.000000,300.000000,170.000000,170.000000,260.000000,30.000000,30.000000]
    dbObj.launcherAz_deg=[0.000000,180.000000,85.000000,275.000000,180.000000,90.000000,270.000000]
