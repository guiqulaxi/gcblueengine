...
def CreateDBObject():
    ...
    dbObj.mzClass='Oslo FFGM (1977)'
    dbObj.natoClass='Oslo FFGM (1977)'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    dbObj.weight_kg=1762841.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1977.250000
    dbObj.finalYear=1991.079956
    dbObj.country='Norway'
    dbObj.designation='FF'
    dbObj.imageList='oslo_71.jpg'
    dbObj.iconFileName=''
    ...
    sensorPlatformDBObject.sensorClass=['DRBV 22','Decca 1229','Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','Mk-91 FCS','SQS-36 Active','SQS-36 Passive']
    ...
    dbObj.maLauncherClass=['Penguin SSM Launcher x6','SeaSparrow x8 Launcher','3/50 Mark 33','3/50 Mark 33','20mm Rh 202','20mm Rh 202','Mk-32 3 Torpedo Mount','Mk-32 3 Torpedo Mount']
    ...
    dbObj.launcherAz_deg=[0.000000,180.000000,0.000000,180.000000,90.000000,270.000000,90.000000,270.000000]
    dbObj.launcherEl_deg=[20.000000,0.000000,85.000000,85.000000,55.000000,55.000000,0.000000,0.000000]
