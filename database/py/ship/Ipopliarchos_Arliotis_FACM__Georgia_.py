...
def CreateDBObject():
    ...
    dbObj.mzClass='Ipopliarchos Arliotis FACM (Georgia)'
    dbObj.natoClass='Ipopliarchos Arliotis FACM (Georgia)'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    dbObj.mfTurnRate_degps=6.944917
