...
def CreateDBObject():
    ...
    dbObj.mzClass='Leahy CG (78)'
    dbObj.natoClass='Leahy CG (78)'
    dbObj.mnModelType=2
    dbObj.mnType=18
    dbObj.cost=0.000000
    dbObj.weight_kg=7590000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1978.199951
    dbObj.finalYear=1989.020020
    dbObj.country='USA'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','SPG-55 4','SPS-10','SPS-39B','SPS-43 AS','SQS-26 Active','SQS-26 Passive','WLR-1H ESM']
    ...
    dbObj.maLauncherClass=['Mk-10 GMLS','Mk-10 GMLS','Mk-112 ASROC','Mk-141 Harpoon Launcher','Mk-141 Harpoon Launcher','Mk-32 3 Torpedo Mount','Mk-32 3 Torpedo Mount']
    dbObj.maMagazineClass=['Mk-10 Store 80','Mk-32 Torpedo Racks']
    dbObj.magazineId=[0,1]
    dbObj.launcherId=[0,1,2,3,4,5,6]
    dbObj.launcherName=['','','','','','','']
    dbObj.launcherFOV_deg=[330.000000,330.000000,300.000000,0.000000,0.000000,40.000000,40.000000]
    dbObj.launcherAz_deg=[0.000000,180.000000,0.000000,350.000000,170.000000,270.000000,90.000000]
    dbObj.launcherEl_deg=[40.000000,40.000000,0.000000,20.000000,20.000000,0.000000,0.000000]
    dbObj.launcherFireControl=['SPG-55 4','SPG-55 4','','','','','']
    dbObj.launcherFireControl2=['','','','','','','']
    dbObj.launcherIsReloadable=[True,True,False,False,False,True,True]
