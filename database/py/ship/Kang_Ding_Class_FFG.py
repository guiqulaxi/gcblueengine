...
def CreateDBObject():
    ...
    dbObj.mzClass='Kang Ding Class FFG'
    dbObj.natoClass='Kang Ding Class FFG'
    dbObj.mnModelType=2
    dbObj.mnType=18
    ...
    dbObj.damageEffect='Kang Ding Class FFG durability'
    dbObj.mnNumLaunchers=5
    dbObj.maLauncherClass=['Crotale Naval','Hsiung Feng-II x8 Launcher','100mm/55 (3.9in) model 1968 CADAM','20 mm F2 Cannon','20 mm F2 Cannon']
    dbObj.maMagazineClass=['Kang Ding Helo Stores','100mm/55 Model 1968 600 rounds','Crotale Naval 26','Kang Ding Combat Stores']
    dbObj.magazineId=[1,2,3,4]
    dbObj.launcherId=[0,1,3,4,5]
    dbObj.launcherName=['','','','','']
    dbObj.launcherFOV_deg=[340.000000,30.000000,300.000000,120.000000,120.000000]
    dbObj.launcherAz_deg=[180.000000,90.000000,0.000000,90.000000,270.000000]
    dbObj.launcherEl_deg=[40.000000,12.000000,0.000000,0.000000,0.000000]
    dbObj.launcherFireControl=['','','','','']
    dbObj.launcherFireControl2=['','','','','']
    dbObj.launcherIsReloadable=[True,False,True,True,True]
