...
def CreateDBObject():
    ...
    dbObj.mzClass='Fishing Boat'
    dbObj.natoClass='Fishing Boat'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    dbObj.weight_kg=249000.000000
    ...
    dbObj.mfAccel_ktsps=0.129983
    dbObj.mfTurnRate_degps=4.197209
    dbObj.mfFuelCapacity_kg=34860.000000
    dbObj.mfFuelRate_kgps=0.000000
    dbObj.mfToughness=0.000000
    dbObj.damageEffect='Fishing Boat durability'
    ...
    airDetectionDBObject.RCS_dBsm=25.489000
    airDetectionDBObject.RCS_Model='ShipRCS1'
    airDetectionDBObject.opticalCrossSection_dBsm=17.969000
    airDetectionDBObject.irSignature_dB=12.169000
