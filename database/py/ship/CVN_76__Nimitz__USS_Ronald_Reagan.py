...
def CreateDBObject():
    ...
    dbObj.mzClass='CVN-76 (Nimitz) USS Ronald Reagan'
    dbObj.natoClass='CVN-76 (Nimitz) USS Ronald Reagan'
    dbObj.mnModelType=2
    dbObj.mnType=22
    dbObj.cost=0.000000
    dbObj.weight_kg=102000000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=2003.530029
    ...
    dbObj.damageEffect='CVN-76 (Nimitz) USS Ronald Reagan durability'
