...
def CreateDBObject():
    ...
    dbObj.mzClass='Georges Leygues DDGHM(D640)(79)'
    dbObj.natoClass='Georges Leygues DDGHM(D640)(79)'
    dbObj.mnModelType=2
    dbObj.mnType=18
    dbObj.cost=0.000000
    dbObj.weight_kg=4500000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1979.939941
    dbObj.finalYear=2002.520020
    ...
    sensorPlatformDBObject.sensorClass=['ARBR 17','DRBV 26','DRBV 51D','DUBV-23 Active','DUBV-43 VDS Active','Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d']
    ...
    dbObj.maLauncherClass=['Exocet Quad Launcher','Exocet Quad Launcher','Crotale Naval','Mistral Simbad','Mistral Simbad','100mm/55 (3.9in) model 1968 CADAM','20 mm F2 Cannon','20 mm F2 Cannon','KD59E Torp Launcher','KD59E Torp Launcher']
    dbObj.maMagazineClass=['Lynx 2.2 Support','Crotale Naval 26','100mm/55 Model 1968 600 rounds','Mistral Simbad Mag x2','French Combat Stores']
