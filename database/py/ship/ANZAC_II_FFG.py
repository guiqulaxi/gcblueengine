...
def CreateDBObject():
    ...
    dbObj.mzClass='ANZAC-II FFG'
    dbObj.natoClass='ANZAC-II FFG'
    dbObj.mnModelType=2
    dbObj.mnType=18
    dbObj.cost=0.000000
    ...
    sensorPlatformDBObject.sensorClass=['CEAFAR Array','CEAMOUNT Array','Centaur ESM','Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','Kariwarra Towed Array Sonar','Petrel MOAS 5425','Spherion B Mod 5','VAMPIR IIRST']
    ...
    dbObj.damageEffect='ANZAC-II FFG durability'
    dbObj.mnNumLaunchers=11
    dbObj.maLauncherClass=['5/54 Mark 45 Mods 0 - 2','ANZAC Mk-141 Launcher','ANZAC Mk-141 Launcher','ANZAC Mk-41 Mod 5 VLS','ANZAC Mk-41 Mod 5 VLS','20mm/76 M-61A1 Gatling Mark 15 Block 1','Mk-32 3 Torpedo Mount','Mk-32 3 Torpedo Mount','Mk-160 EDL x 4','Mk-137 SRBOC Launcher','Mk-137 SRBOC Launcher']
    ...
    dbObj.launcherFOV_deg=[300.000000,0.000000,0.000000,360.000000,360.000000,270.000000,45.000000,45.000000,360.000000,0.000000,0.000000]
    dbObj.launcherAz_deg=[0.000000,45.000000,45.000000,0.000000,0.000000,0.000000,270.000000,90.000000,45.000000,270.000000,90.000000]
    dbObj.launcherEl_deg=[0.000000,4.000000,4.000000,0.000000,0.000000,0.000000,0.000000,0.000000,80.000000,60.000000,60.000000]
    dbObj.launcherFireControl=['CEAMOUNT Array','','','CEAMOUNT Array','CEAMOUNT Array','','','','','','']
