...
def CreateDBObject():
    ...
    dbObj.mzClass='Tiger Type 148 FACM'
    dbObj.natoClass='Tiger Type 148 FACM'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    dbObj.maLauncherClass=['Exocet Twin Launcher','Exocet Twin Launcher','76 mm/62 Mark 75 Compact','40mm L70 Sea Trinity','Hotdog x6 Launcher','Hotdog x6 Launcher']
    dbObj.maMagazineClass=['40mm L70 Trinity magazine','76mm/62 mk75 240 rounds']
    dbObj.mnNumMagazines=2
    dbObj.magazineId=[1,0]
    dbObj.launcherId=[0,1,2,3,4,5]
    dbObj.launcherName=['','','','','','']
    dbObj.launcherFOV_deg=[0.000000,0.000000,240.000000,340.000000,180.000000,180.000000]
    dbObj.launcherAz_deg=[30.000000,330.000000,0.000000,180.000000,90.000000,270.000000]
    dbObj.launcherEl_deg=[20.000000,20.000000,0.000000,0.000000,45.000000,45.000000]
