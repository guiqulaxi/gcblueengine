...
def CreateDBObject():
    ...
    dbObj.mzClass='Hatsuyuki DDG'
    dbObj.natoClass='Hatsuyuki DDG'
    dbObj.mnModelType=2
    dbObj.mnType=17
    dbObj.cost=0.000000
    dbObj.weight_kg=3750000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1982.223022
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','FCS-2-21 1','NOLR-6','OLT-3','OPS-14','OPS-18','OQS-4 Active','OQS-4 Passive']
    ...
    dbObj.maLauncherClass=['Mk-141 Harpoon Launcher','Mk-141 Harpoon Launcher','SeaSparrow x8 Launcher','76 mm/62 Mark 75','Mk-32 3 Torpedo Mount','Mk-32 3 Torpedo Mount','Mk-112 ASROC']
    dbObj.maMagazineClass=['SH-3 1.1 Support','76mm/62 mk75 240 rounds','Sea Sparrow Reloads']
    dbObj.magazineId=[2,1,0]
    dbObj.launcherId=[0,1,2,3,4,5,6]
    dbObj.launcherName=['','','','','','','']
    dbObj.launcherFOV_deg=[0.000000,0.000000,330.000000,310.000000,30.000000,30.000000,300.000000]
    dbObj.launcherAz_deg=[30.000000,330.000000,180.000000,0.000000,90.000000,270.000000,0.000000]
