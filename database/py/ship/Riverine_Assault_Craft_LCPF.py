...
def CreateDBObject():
    ...
    dbObj.mzClass='Riverine Assault Craft LCPF'
    dbObj.natoClass='Riverine Assault Craft LCPF'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=0.000000
    ...
    dbObj.country='USA'
    dbObj.designation='LCP'
    dbObj.imageList=''
    dbObj.iconFileName='none'
    dbObj.mz3DModelFileName='burke.xml'
    dbObj.notes=''
    dbObj.length_m=10.700000
    ...
    dbObj.mfAccel_ktsps=0.844042
    dbObj.mfTurnRate_degps=35.597668
    dbObj.mfFuelCapacity_kg=2250.000000
    dbObj.mfFuelRate_kgps=0.044791
    dbObj.mfToughness=0.340000
    dbObj.damageEffect='Riverine Assault Craft LCPF durability'
    ...
    airDetectionDBObject.RCS_dBsm=2.672000
    airDetectionDBObject.RCS_Model='ShipRCS1'
    airDetectionDBObject.opticalCrossSection_dBsm=6.626000
    airDetectionDBObject.irSignature_dB=16.367001
    ...
    dbObj.draft_m=0.700000
    dbObj.beam_m=2.800000
    dbObj.PowerPlantType=0.000000
    dbObj.TotalShaft_HP=1200.000000
