...
def CreateDBObject():
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','SJC-IV Passive','SJD-2','Type 343G','Type 347','Type 354','Type 515','Type 707','Type 921-A ESM']
    ...
    dbObj.damageEffect='Type 051D DDG durability'
    dbObj.mnNumLaunchers=14
    dbObj.maLauncherClass=['3 HY-1','3 HY-1','130 mm/58 (5.1in) Type 76','130 mm/58 (5.1in) Type 76','37mm/63(1.5in) Type 676','37mm/63(1.5in) Type 676','37mm/63(1.5in) Type 676','37mm/63(1.5in) Type 676','25mm/60(1in) Type 61','25mm/60(1in) Type 61','EDS-25B Mortar','EDS-25B Mortar','DC Rack 8 Chn','DC Rack 8 Chn']
    dbObj.maMagazineClass=['37mm/63 Type 76 Magazine x4','130 mm/58 (5.1in) Type 76 x2 800 Rounds','25mm Type 61 Store x2 8000 Rounds','EDS-25B x2 36 Rounds']
