...
def CreateDBObject():
    ...
    dbObj.mzClass='Oliver Hazard Perry FFGHM(Bahrain)'
    dbObj.natoClass='Oliver Hazard Perry FFGHM(Bahrain)'
    dbObj.mnModelType=2
    dbObj.mnType=17
    dbObj.cost=0.000000
    dbObj.weight_kg=3513000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1996.699951
    dbObj.finalYear=2999.000000
    dbObj.country='Bahrain'
    dbObj.designation='FFG'
    dbObj.imageList='ohp.jpg'
    dbObj.iconFileName='none'
    dbObj.mz3DModelFileName='ffg-7.xml'
    dbObj.notes=''
    dbObj.length_m=138.000000
