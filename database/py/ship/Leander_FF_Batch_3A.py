...
def CreateDBObject():
    ...
    dbObj.mzClass='Leander FF Batch 3A'
    dbObj.natoClass='Leander FF Batch 3A'
    dbObj.mnModelType=2
    dbObj.mnType=18
    dbObj.cost=0.000000
    dbObj.weight_kg=3300000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1969.119995
    ...
    sensorPlatformDBObject.sensorClass=['ESM-6','Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','Type 1006','Type 2016 Active','Type 2016 Passive','Type 965','Type 978','Type 998']
    ...
    dbObj.maMagazineClass=['Lynx 1.2 Support','Sea Wolf Store 20','Leander A Ammo Mag']
    ...
    dbObj.launcherFireControl=['','Type 998','','','','','']
    dbObj.launcherFireControl2=['','Type 965','','','','','']
