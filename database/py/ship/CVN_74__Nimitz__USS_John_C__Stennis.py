...
def CreateDBObject():
    ...
    dbObj.mzClass='CVN-74 (Nimitz) USS John C. Stennis'
    dbObj.natoClass='CVN-74 (Nimitz) USS John C. Stennis'
    dbObj.mnModelType=2
    dbObj.mnType=22
    dbObj.cost=0.000000
    dbObj.weight_kg=102000000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1995.939941
    ...
    dbObj.damageEffect='CVN-74 (Nimitz) USS John C. Stennis durability'
