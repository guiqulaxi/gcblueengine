...
def CreateDBObject():
    ...
    dbObj.mz3DModelFileName='cn_type-053h3_jiangwei-ii.xml'
    dbObj.notes=''
    ...
    dbObj.damageEffect='Type 053H3 durability'
    dbObj.mnNumLaunchers=10
    dbObj.maLauncherClass=['HQ-7 Octuple Launcher','YJ-82 x4','YJ-82 x4','37mm/63(1.5in) Type 676','37mm/63(1.5in) Type 676','37mm/63(1.5in) Type 676','37mm/63(1.5in) Type 676','100mm/56 Type-79A Twin-mount','EDS-25A Mortar','EDS-25A Mortar']
    dbObj.maMagazineClass=['Z-9C 1.2 Support','HQ-7 Magazine','100mm/56 Type 79A Magazine 300 Rounds','37mm/63 Type 76 Magazine x4','EDS-25A x2 12 rounds']
