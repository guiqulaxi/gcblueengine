...
def CreateDBObject():
    ...
    dbObj.mzClass='Baptista de Andrade FSH'
    dbObj.natoClass='Baptista de Andrade FSH'
    dbObj.mnModelType=2
    dbObj.mnType=17
    dbObj.cost=0.000000
    dbObj.weight_kg=1380000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1974.884033
    ...
    sensorPlatformDBObject.sensorClass=['AWS-2','Decca TM 626','Diodon Active','Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','TRS-3020']
    ...
    dbObj.maLauncherClass=['100mm/55 (3.9in) model 1968','40 mm 2xL70 Bofors','Mk-32 2 Torpedo Mount','Mk-32 2 Torpedo Mount']
    dbObj.maMagazineClass=['40mm/70 x2 Magazine','100mm/55 Model 1968 600 rounds','Mk-32 Torpedo Racks']
    dbObj.magazineId=[1,0,2]
    dbObj.launcherId=[0,1,2,3]
    dbObj.launcherName=['','','','']
    dbObj.launcherFOV_deg=[320.000000,300.000000,30.000000,30.000000]
