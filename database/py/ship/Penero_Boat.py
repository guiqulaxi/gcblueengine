...
def CreateDBObject():
    ...
    dbObj.mzClass='Penero Boat'
    dbObj.natoClass='Penero Boat'
    dbObj.mnModelType=1
    dbObj.mnType=17
    dbObj.cost=89.000000
    dbObj.weight_kg=50000.000000
    ...
    dbObj.mfAccel_ktsps=0.113038
    dbObj.mfTurnRate_degps=13.802128
    dbObj.mfFuelCapacity_kg=7000.000000
    dbObj.mfFuelRate_kgps=0.000000
    dbObj.mfToughness=0.000000
    dbObj.damageEffect='Penero Boat durability'
    ...
    airDetectionDBObject.RCS_dBsm=15.030000
    airDetectionDBObject.RCS_Model='ShipRCS1'
    airDetectionDBObject.opticalCrossSection_dBsm=11.614000
    airDetectionDBObject.irSignature_dB=10.120000
