...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 052B DDG'
    dbObj.natoClass='Luyang'
    dbObj.mnModelType=2
    dbObj.mnType=18
    dbObj.cost=0.000000
    ...
    sensorPlatformDBObject.sensorClass=['Decca 1226','Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','MR-755 Fregat MAE-5','SJD-8 Active','SJD-9 Passive','Type 344','Type 345 4','Type 346','Type 347','Type 826','Type 984-1/2']
    ...
    dbObj.damageEffect='Type 052B DDG durability'
    dbObj.mnNumLaunchers=8
    dbObj.maLauncherClass=['YJ-83 x8','YJ-83 x8','100mm/56 Type-79A Twin-mount','HQ-16 VLS x48','30 mm/92(1/2in) Type 730 CIWS','30 mm/92(1/2in) Type 730 CIWS','324mm Torpedo Tube x3 (China)','324mm Torpedo Tube x3 (China)']
    ...
    dbObj.launcherFireControl=['','','','Type 345 4','Type 347','Type 347','','']
