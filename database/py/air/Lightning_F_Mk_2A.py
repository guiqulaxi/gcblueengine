...
def CreateDBObject():
    ...
    dbObj.mzClass='Lightning F.Mk.2A'
    dbObj.natoClass='Lightning F.Mk.2A'
    ...
    dbObj.iconFileName='air/AdvicoLightningMK2A.jpg'
    ...
    dbObj.damageEffect='Lightning F.Mk.2A durability'
