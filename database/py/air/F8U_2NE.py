...
def CreateDBObject():
    ...
    dbObj.mzClass='F8U-2NE'
    dbObj.natoClass='F8U-2NE'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=0.000000
    dbObj.weight_kg=8090.399902
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1961.451050
    dbObj.finalYear=1962.000000
    dbObj.country='USA'
    dbObj.designation='Fighter'
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoF8U2NE.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['APQ-94','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f']
    ...
    dbObj.damageEffect='F8U-2NE durability'
    dbObj.mnNumLaunchers=5
    dbObj.maLauncherClass=['20mm Colt Mk-12 Cannon (125) x2','20mm Colt Mk-12 Cannon (125) x2','F8U-2NE chin','F8U-2NE chin','F8U-2NE wings']
    ...
    dbObj.maxAltitude_m=15957.000000
