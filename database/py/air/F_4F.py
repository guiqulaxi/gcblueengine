...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoF4F.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['APQ-120','AVQ-26 LASER','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f']
    ...
    dbObj.damageEffect='F-4F durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['F-4F 1-9','F-4F 2-8','F-4F 3-7','F-4F 4-6','F-4F 5','ALE-29 CMs','ALE-29 CMs']
