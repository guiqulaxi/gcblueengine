...
def CreateDBObject():
    ...
    dbObj.mzClass='MiG-21 LanceR'
    dbObj.natoClass='Fishbed-F'
    ...
    dbObj.iconFileName='air/AdvicoMiG21LanceR.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['EL/M-2022(v)3','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','SPO-10 Serena RHAWS']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000,0.000000]
    dbObj.AddComponent(sensorPlatformDBObject)
    dbObj.mfMaxSpeed_kts=1230.000000
    dbObj.mfAccel_ktsps=20.000000
    dbObj.mfTurnRate_degps=16.000000
    dbObj.mfFuelCapacity_kg=2207.750000
    dbObj.mfFuelRate_kgps=1.375000
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='MiG-21 LanceR durability'
    dbObj.mnNumLaunchers=6
    dbObj.maLauncherClass=['MiG-21LanceR InnerPylon','23mm GSh-23L','MiG-21PFM Fuselage','MiG-21LanceR InnerPylon','CM Ejector','CM Ejector']
    dbObj.maMagazineClass=[]
    dbObj.magazineId=[]
    dbObj.launcherId=[0,1,2,3,4,5]
    dbObj.launcherName=['','','','','','']
    dbObj.launcherFOV_deg=[0.000000,20.000000,0.000000,0.000000,0.000000,0.000000]
    ...
    dbObj.launcherFireControl=['EL/M-2022(v)3','','','EL/M-2022(v)3','','']
