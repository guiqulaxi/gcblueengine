...
def CreateDBObject():
    ...
    dbObj.mzClass='F/A-18F(Australia)'
    dbObj.natoClass='F/A-18F(Australia)'
    ...
    sensorPlatformDBObject.sensorClass=['ALQ-214 ECM','ALR-67 RWR','AN/AAR-57 MAWS','APG-79','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','Litening LDP']
    ...
    dbObj.launcherFireControl=['APG-79','APG-79','APG-79','APG-79','APG-79','APG-79','APG-79','','']
