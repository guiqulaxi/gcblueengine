...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoCF18.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ALR-50 RWR','APG-65','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','Litening LDP']
    ...
    dbObj.damageEffect='CF-18 durability'
    dbObj.mnNumLaunchers=8
    dbObj.maLauncherClass=['F/A-18A Centerline','F/A-18A Nacelle','F/A-18A Inboard','F/A-18A Outboard','F/A-18 Wingtip','M61A Cannon','CM Ejector','CM Ejector']
    ...
    dbObj.launcherFireControl=['APG-65','APG-65','APG-65','APG-65','APG-65','','','']
