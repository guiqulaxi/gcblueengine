...
def CreateDBObject():
    ...
    dbObj.mzClass='AV-8B Harrier II NA'
    dbObj.natoClass='AV-8B Harrier II NA'
    ...
    dbObj.iconFileName='air/AdvicoHarrierAV8BNA.jpg'
    ...
    dbObj.damageEffect='AV-8B Harrier II NA durability'
