...
def CreateDBObject():
    ...
    dbObj.mzClass='Tornado ECR (Germany)'
    dbObj.natoClass='Tornado ECR (Germany)'
    ...
    sensorPlatformDBObject.sensorClass=['Decca Type72 Doppler','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','FLIR-80','Tornado ELS','ERWE RWR']
    ...
    dbObj.maLauncherClass=['Tornado IDS 1','Tornado IDS 9','Tornado IDS 2-8 shoulders','Tornado IDS 2-8 shoulders','Tornado ECR 2-8','Tornado ECR 2-8','Tornado ECR fuselage fwd/aft','Tornado ECR fuselage fwd/aft','Tornado ECR fuselage centerline']
