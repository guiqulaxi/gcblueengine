...
def CreateDBObject():
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoSU17M.jpg'
    ...
    dbObj.damageEffect='Su-17M durability'
    dbObj.mnNumLaunchers=6
    dbObj.maLauncherClass=['30mm NR-30 x2','Su-17 Fuselage','Su-17M W1','Su-17M W2','CM Ejector','CM Ejector']
