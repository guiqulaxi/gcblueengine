...
def CreateDBObject():
    ...
    dbObj.mzClass='FJ-2 Fury'
    dbObj.natoClass='FJ-2 Fury'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=0.000000
    dbObj.weight_kg=5355.000000
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoFJ2.jpg'
    ...
    dbObj.mfFuelCapacity_kg=1324.651001
    dbObj.mfFuelRate_kgps=0.670400
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='FJ-2 Fury durability'
    dbObj.mnNumLaunchers=5
    dbObj.maLauncherClass=['0.50in(12.7mm) Browning M2(300)(x2)','0.50in(12.7mm) Browning M2(300)(x2)','0.50in(12.7mm) Browning M2(300)(x2)','F-86 Wing1','F-86 Rockets']
    dbObj.maMagazineClass=[]
    dbObj.mnNumMagazines=0
    dbObj.magazineId=[]
    dbObj.launcherId=[0,1,2,3,4]
    dbObj.launcherName=['','','','','']
    dbObj.launcherFOV_deg=[10.000000,10.000000,10.000000,0.000000,0.000000]
    ...
    dbObj.maxTakeoffWeight_kg=8525.000000
    dbObj.maxAltitude_m=12700.000000
    ...
    dbObj.militaryThrust_N=26289.000000
    dbObj.militaryThrustSpeedSlope=0.003609
    dbObj.mfAfterburnThrust_N=26289.000000
    dbObj.abThrustSpeedSlope=0.003609
    dbObj.mfAfterburnFuelRate_kgps=0.670400
