...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoMiG29B.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','N-019 Sapfir-29 Slot Back','SPO-15 RWR']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000,0.000000]
    dbObj.AddComponent(sensorPlatformDBObject)
    dbObj.mfMaxSpeed_kts=1320.000000
    dbObj.mfAccel_ktsps=17.059999
    ...
    dbObj.damageEffect='MiG-29B durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['MiG-29 Centerline','MiG-29 W1','MiG-29 W2','MiG-29 W3','30mm NR-30','CM Ejector','CM Ejector']
    ...
    dbObj.launcherFireControl=['','N-019 Sapfir-29 Slot Back','N-019 Sapfir-29 Slot Back','N-019 Sapfir-29 Slot Back','','','']
    ...
    dbObj.maxTakeoffWeight_kg=16700.000000
    ...
    dbObj.militaryThrust_N=88920.000000
    dbObj.militaryThrustSpeedSlope=0.000000
    dbObj.mfAfterburnThrust_N=146520.000000
    dbObj.abThrustSpeedSlope=0.003000
    dbObj.mfAfterburnFuelRate_kgps=8.510000
