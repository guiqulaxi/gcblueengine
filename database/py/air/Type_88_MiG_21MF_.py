...
def CreateDBObject():
    ...
    dbObj.mzClass='Type-88(MiG-21MF)'
    dbObj.natoClass='Fishbed-J'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=1800000.000000
    dbObj.weight_kg=5690.000000
    ...
    dbObj.iconFileName='air/AdvicoType88.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','RP-22 Sapfir','Sirena-3M RWR']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000,0.000000]
    dbObj.AddComponent(sensorPlatformDBObject)
    dbObj.mfMaxSpeed_kts=1270.000000
    dbObj.mfAccel_ktsps=20.000000
    dbObj.mfTurnRate_degps=18.000000
    dbObj.mfFuelCapacity_kg=2247.899902
    dbObj.mfFuelRate_kgps=1.000000
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='MiG-21MF durability'
    dbObj.mnNumLaunchers=6
    dbObj.maLauncherClass=['MiG-21MF OuterPylon','MiG-21MF InnerPylon','23mm GSh-23L','MiG-21S Fuselage','MiG-21MF InnerPylon','MiG-21MF OuterPylon']
    ...
    dbObj.launcherFireControl=['RP-22 Sapfir','RP-22 Sapfir','','','RP-22 Sapfir','RP-22 Sapfir']
    ...
    dbObj.maxTakeoffWeight_kg=9872.000000
    dbObj.maxAltitude_m=17700.000000
    ...
    dbObj.militaryThrust_N=39900.000000
    dbObj.militaryThrustSpeedSlope=-0.000800
    dbObj.mfAfterburnThrust_N=63700.000000
    ...
    dbObj.cruiseSpeed_mps=130.000000
