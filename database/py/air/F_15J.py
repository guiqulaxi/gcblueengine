...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoF15J.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['APG-63','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','J/APR-4 RWR']
    ...
    dbObj.damageEffect='F-15J durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['F-15J Fuselage','F-15J W1','F-15J W2','F-15 Tanks','CM Ejector','CM Ejector','M61A Cannon']
