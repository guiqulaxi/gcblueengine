...
def CreateDBObject():
    ...
    dbObj.mzClass='F-8K'
    dbObj.natoClass='F-8K'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=0.000000
    dbObj.weight_kg=8216.500000
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoF8K.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ALQ-51','APQ-125','APR-30 RWR','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000]
    dbObj.AddComponent(sensorPlatformDBObject)
    dbObj.mfMaxSpeed_kts=1020.000000
    ...
    dbObj.damageEffect='F-8K durability'
    ...
    dbObj.maxTakeoffWeight_kg=13734.000000
    dbObj.maxAltitude_m=16002.000000
    dbObj.climbRate_mps=129.300003
    dbObj.gmax=8.000000
    dbObj.minimumRunway_m=1259.000000
    ...
    dbObj.mfAfterburnThrust_N=75200.000000
    dbObj.abThrustSpeedSlope=0.002175
    dbObj.mfAfterburnFuelRate_kgps=5.964600
    ...
    dbObj.stallSpeed_mps=56.799999
