...
def CreateDBObject():
    ...
    dbObj.mfMaxSpeed_kts=1000.000000
    ...
    dbObj.damageEffect='F8U-1 durability'
    dbObj.mnNumLaunchers=4
    dbObj.maLauncherClass=['20mm Colt Mk-12 Cannon (125) x2','20mm Colt Mk-12 Cannon (125) x2','F8U-1 chin','F8U-1 belly']
