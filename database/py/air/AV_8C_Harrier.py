...
def CreateDBObject():
    ...
    dbObj.mzClass='AV-8C Harrier'
    dbObj.natoClass='AV-8C Harrier'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=15000000.000000
    dbObj.weight_kg=5670.000000
    ...
    dbObj.iconFileName='air/AdvicoHarrierAV8C.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ALR-45 RWR','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','Laser-20km']
    ...
    dbObj.damageEffect='AV-8C Harrier durability'
    dbObj.mnNumLaunchers=5
    dbObj.maLauncherClass=['AV-8A 1-5','AV-8A 2-4','AV-8A 3','ALE-39 CMD','ALE-39 CMD']
    ...
    dbObj.maxTakeoffWeight_kg=12500.000000
