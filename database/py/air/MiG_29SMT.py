...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoMiG29SMT.jpg'
    ...
    dbObj.damageEffect='MiG-29SMT durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['MiG-29K Centerline','MiG-29K W1','MiG-29K W2','MiG-29K W3','30mm NR-30','CM Ejector','CM Ejector']
    ...
    dbObj.launcherFireControl=['','N-010 Zhuk-M','N-010 Zhuk-M','N-010 Zhuk-M','','','']
