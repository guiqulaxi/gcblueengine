...
def CreateDBObject():
    ...
    dbObj.mzClass='F-16C/D Blk 50+'
    dbObj.natoClass='F-16C/D Blk 50+'
    ...
    dbObj.iconFileName='air/AdvicoF16CD50+.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ALR-69 RWR','APG-68(v)9','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','LANTIRN']
    ...
    dbObj.mfFuelRate_kgps=1.372440
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='F-16C/D Blk 50+ durability'
    dbObj.mnNumLaunchers=8
    dbObj.maLauncherClass=['F-16 Blk40 2-8','F-16 Blk40 2-8','F-16 Blk50+ 3-7','F-16 Blk50+ 4-6','F-16 Blk1 5','ALE-40 CMD','ALE-40 CMD','M61A Cannon']
    ...
    dbObj.launcherFireControl=['APG-68(v)9','APG-68(v)9','APG-68(v)9','APG-68(v)9','APG-68(v)9','','','APG-68(v)9']
    dbObj.launcherFireControl2=['LANTIRN','LANTIRN','LANTIRN','LANTIRN','LANTIRN','','','']
    ...
    dbObj.militaryThrust_N=75700.000000
    dbObj.militaryThrustSpeedSlope=0.000000
    dbObj.mfAfterburnThrust_N=129000.000000
    dbObj.abThrustSpeedSlope=0.002590
    dbObj.mfAfterburnFuelRate_kgps=6.212600
    dbObj.mfCdpsub=0.925000
    dbObj.mfCdptran=1.618800
    dbObj.mfCdpsup=1.850000
