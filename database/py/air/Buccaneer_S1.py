...
def CreateDBObject():
    ...
    dbObj.mzClass='Buccaneer S1'
    dbObj.natoClass='Buccaneer S1'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=0.000000
    dbObj.weight_kg=13608.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1962.599976
    dbObj.finalYear=1971.000000
    dbObj.country='UK'
    dbObj.designation='Bomber'
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoBUCS1.jpg'
    ...
    dbObj.mfFuelRate_kgps=1.585900
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='Buccaneer S1 durability'
    dbObj.mnNumLaunchers=4
    dbObj.maLauncherClass=['Buccaneer S1 Bay','Buccaneer S1 1-4','Buccaneer S1 1.5-3.5','Buccaneer S1 2-3']
    ...
    dbObj.militaryThrust_N=71200.000000
    dbObj.militaryThrustSpeedSlope=0.001000
    dbObj.mfAfterburnThrust_N=71200.000000
    dbObj.abThrustSpeedSlope=0.001000
    dbObj.mfAfterburnFuelRate_kgps=1.585900
    ...
    dbObj.thrustTable=[0.950000,0.900000,0.850000,0.760000,0.650000,0.500000,0.220000,0.040000,0.000000,0.000000]
