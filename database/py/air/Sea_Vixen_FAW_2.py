...
def CreateDBObject():
    ...
    dbObj.mzClass='Sea Vixen FAW.2'
    dbObj.natoClass='Sea Vixen FAW.2'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=0.000000
    dbObj.weight_kg=11795.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1963.849976
    dbObj.finalYear=1972.000000
    dbObj.country='UK'
    dbObj.designation='Fighter'
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoSeaVixenFAW2.jpg'
    ...
    dbObj.damageEffect='Sea Vixen FAW.2 durability'
    dbObj.mnNumLaunchers=4
    dbObj.maLauncherClass=['Sea Vixen Belly','Sea Vixen.2 2-3','Sea Vixen Tanks','Sea Vixen.2 1-4']
