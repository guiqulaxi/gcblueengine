...
def CreateDBObject():
    ...
    dbObj.mzClass='F-16A/B Blk 20'
    dbObj.natoClass='F-16A/B Blk 20'
    ...
    dbObj.iconFileName='air/AdvicoF16AB20.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ALR-69 RWR','APG-66(v)3','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f']
    ...
    dbObj.damageEffect='F-16A/B Blk 20 durability'
    dbObj.mnNumLaunchers=8
    dbObj.maLauncherClass=['F-16 Blk20 2-8','F-16 Blk20 2-8','F-16 Blk20 3-7','F-16 Blk20 4-6','F-16 Blk1 5','ALE-40 CMD','ALE-40 CMD','M61A Cannon']
    ...
    dbObj.launcherFireControl=['APG-66(v)3','APG-66(v)3','APG-66(v)3','APG-66(v)3','APG-66(v)3','','','APG-66(v)3']
