...
def CreateDBObject():
    ...
    dbObj.mzClass='Lightning F.Mk.2'
    dbObj.natoClass='Lightning F.Mk.2'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=15000000.000000
    dbObj.weight_kg=12258.000000
    ...
    dbObj.iconFileName='air/AdvicoLightningMK2.jpg'
    ...
    dbObj.damageEffect='Lightning F.Mk.2 durability'
    ...
    dbObj.climbRate_mps=369.380005
    dbObj.gmax=5.000000
