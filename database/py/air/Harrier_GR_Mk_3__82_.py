...
def CreateDBObject():
    ...
    dbObj.mzClass='Harrier GR.Mk.3 (82)'
    dbObj.natoClass='Harrier GR.Mk.3 (82)'
    ...
    dbObj.maLauncherClass=['Harrier GR.3 1-5','Harrier GR.3 2-4','Harrier GR.3 3','CM Ejector','CM Ejector']
