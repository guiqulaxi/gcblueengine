...
def CreateDBObject():
    ...
    dbObj.mzClass='Lightning F.Mk.3A'
    dbObj.natoClass='Lightning F.Mk.3A'
    ...
    dbObj.iconFileName='air/AdvicoLightningMK3A.jpg'
    ...
    dbObj.damageEffect='Lightning F.Mk.3A durability'
