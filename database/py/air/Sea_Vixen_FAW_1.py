...
def CreateDBObject():
    ...
    dbObj.mzClass='Sea Vixen FAW.1'
    dbObj.natoClass='Sea Vixen FAW.1'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=0.000000
    dbObj.weight_kg=11795.000000
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoSeaVixenFAW1.jpg'
    ...
    dbObj.mfTurnRate_degps=17.299999
    dbObj.mfFuelCapacity_kg=1200.000000
    dbObj.mfFuelRate_kgps=1.340000
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='Sea Vixen FAW.1 durability'
    dbObj.mnNumLaunchers=4
    dbObj.maLauncherClass=['Sea Vixen Belly','Sea Vixen 2-3','Sea Vixen Tanks','Sea Vixen 1-4']
    ...
    dbObj.maxTakeoffWeight_kg=16785.000000
    ...
    dbObj.militaryThrust_N=100030.398438
    dbObj.militaryThrustSpeedSlope=0.001000
    dbObj.mfAfterburnThrust_N=100030.398438
    dbObj.abThrustSpeedSlope=0.001000
    dbObj.mfAfterburnFuelRate_kgps=1.340000
    dbObj.mfCdpsub=0.850000
