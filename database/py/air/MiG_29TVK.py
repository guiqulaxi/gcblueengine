...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoMiG29TVK.jpg'
    ...
    dbObj.damageEffect='MiG-29TVK durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['MiG-29SD Centerline','MiG-29SD W1','MiG-29SD W2','MiG-29SD W3','30mm NR-30','CM Ejector','CM Ejector']
