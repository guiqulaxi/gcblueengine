...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoMiG21PFMA.jpg'
    ...
    dbObj.damageEffect='MiG-21PFMA durability'
    dbObj.mnNumLaunchers=3
    dbObj.maLauncherClass=['MiG-21PFM InnerPylon','MiG-21PFM Fuselage','MiG-21PFM InnerPylon']
