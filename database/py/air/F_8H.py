...
def CreateDBObject():
    ...
    dbObj.mzClass='F-8H'
    dbObj.natoClass='F-8H'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=0.000000
    dbObj.weight_kg=8538.599609
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoF8H.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ALQ-51','APQ-94','APR-30 RWR','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000]
    dbObj.AddComponent(sensorPlatformDBObject)
    dbObj.mfMaxSpeed_kts=1085.000000
    ...
    dbObj.damageEffect='F-8H durability'
    ...
    dbObj.maxTakeoffWeight_kg=15549.000000
    dbObj.maxAltitude_m=15728.000000
    dbObj.climbRate_mps=118.400002
    dbObj.gmax=8.000000
    ...
    dbObj.stallSpeed_mps=60.700001
