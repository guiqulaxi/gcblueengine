...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoF4B.jpg'
    ...
    dbObj.damageEffect='F-4B durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['F-4B 1-9','F-4B 2-8','F-4B 3-7','F-4B 4-6','F-4B 5','ALE-29 CMs','ALE-29 CMs']
