...
def CreateDBObject():
    ...
    dbObj.imageList='mig29g.jpg'
    dbObj.iconFileName='air/AdvicoMiG29G.jpg'
    ...
    dbObj.mfAccel_ktsps=15.480000
    dbObj.mfTurnRate_degps=36.400002
    dbObj.mfFuelCapacity_kg=3595.000000
    dbObj.mfFuelRate_kgps=2.500000
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='MiG-29G durability'
