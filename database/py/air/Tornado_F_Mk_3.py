...
def CreateDBObject():
    ...
    dbObj.mzClass='Tornado F.Mk.3'
    dbObj.natoClass='Tornado F.Mk.3'
    ...
    dbObj.iconFileName='air/AdvicoTornadoF3.jpg'
    ...
    dbObj.damageEffect='Tornado F.Mk.3 durability'
    dbObj.mnNumLaunchers=6
    dbObj.maLauncherClass=['Tornado F3 wing shoulder','Tornado F2 wing','Tornado F3 fuselage','27mm BK27-Cannon(180)','ALE-40 FD','ALE-40 CD']
