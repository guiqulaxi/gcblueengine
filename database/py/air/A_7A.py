...
def CreateDBObject():
    ...
    dbObj.damageEffect='A-7A durability'
    ...
    dbObj.militaryThrust_N=50488.171875
    dbObj.militaryThrustSpeedSlope=0.002200
    dbObj.mfAfterburnThrust_N=50488.171875
