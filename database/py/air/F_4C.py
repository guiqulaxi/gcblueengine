...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoF4C.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['APQ-100','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','Laser-10km']
    ...
    dbObj.damageEffect='F-4C durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['F-4C 1-9','F-4C 2-8','F-4C 3-7','F-4C 4-6','F-4C 5','ALE-29 CMs','ALE-29 CMs']
    ...
    dbObj.launcherFireControl=['APQ-100','APQ-100','APQ-100','APQ-100','APQ-100','','']
