...
def CreateDBObject():
    ...
    dbObj.mzClass='Tornado F.Mk.2'
    dbObj.natoClass='Tornado F.Mk.2'
    ...
    dbObj.iconFileName='air/AdvicoTornadoF2.jpg'
    ...
    dbObj.mfMaxSpeed_kts=1262.000000
    dbObj.mfAccel_ktsps=9.190000
    dbObj.mfTurnRate_degps=26.389999
    dbObj.mfFuelCapacity_kg=5090.000000
    dbObj.mfFuelRate_kgps=2.100000
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='Tornado F.Mk.2 durability'
    dbObj.mnNumLaunchers=4
    dbObj.maLauncherClass=['Tornado F2 wing shoulder','Tornado F2 wing','Tornado F2 fuselage','27mm BK27-Cannon(180)']
    ...
    dbObj.launcherFireControl=['','','Airpass 24','']
    ...
    dbObj.climbRate_mps=152.020004
    dbObj.gmax=7.500000
