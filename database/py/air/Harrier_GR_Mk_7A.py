...
def CreateDBObject():
    ...
    dbObj.mzClass='Harrier GR.Mk.7A'
    dbObj.natoClass='Harrier GR.Mk.7A'
    ...
    dbObj.iconFileName='air/AdvicoHarrierGR7A.jpg'
    ...
    dbObj.damageEffect='Harrier GR.Mk.7A durability'
