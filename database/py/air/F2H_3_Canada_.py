...
def CreateDBObject():
    ...
    dbObj.mzClass='F2H-3(Canada)'
    dbObj.natoClass='F2H-3(Canada)'
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoF2H3.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['APG-37','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f']
    ...
    dbObj.mfFuelRate_kgps=1.426093
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='F2H-3 durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['F2H-3 tips','20mm Hispano Cannon (235)','20mm Hispano Cannon (235)','F2H-2 pylon 1','F2H-2 pylon 1','F2H-2 pylon 1','F2H-2 pylon 2']
    ...
    dbObj.maxAltitude_m=14200.000000
    ...
    dbObj.militaryThrust_N=30240.000000
    dbObj.militaryThrustSpeedSlope=0.002000
    dbObj.mfAfterburnThrust_N=30240.000000
    dbObj.abThrustSpeedSlope=0.002000
    dbObj.mfAfterburnFuelRate_kgps=1.426093
