...
def CreateDBObject():
    ...
    dbObj.mzClass='Sea Harrier FRS.Mk.51'
    dbObj.natoClass='Sea Harrier FRS.Mk.51'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=15000000.000000
    dbObj.weight_kg=6400.000000
    ...
    dbObj.iconFileName='air/AdvicoHarrierFRS51.jpg'
    dbObj.mz3DModelFileName='harrier-gr3.xml'
    dbObj.notes='copied from F-4E Phantom II'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    sensorPlatformDBObject=pygcb.tcSensorPlatformDBObject()
    sensorPlatformDBObject.sensorClass=['ALR-67 RWR','Blue Fox','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000,0.000000]
    dbObj.AddComponent(sensorPlatformDBObject)
    dbObj.mfMaxSpeed_kts=574.830017
    dbObj.mfAccel_ktsps=22.480000
    ...
    dbObj.damageEffect='Sea Harrier FRS.Mk.51 durability'
    dbObj.mnNumLaunchers=5
    dbObj.maLauncherClass=['Harrier FRS.51 1-5','Harrier FRS.1a 2-4','Harrier FRS.1 3','CM Ejector','CM Ejector']
    ...
    dbObj.launcherFireControl=['Blue Fox','Blue Fox','Blue Fox','Blue Fox','Blue Fox']
    ...
    dbObj.maxTakeoffWeight_kg=11900.000000
    dbObj.maxAltitude_m=15500.000000
    dbObj.climbRate_mps=401.109985
    dbObj.gmax=8.000000
