...
def CreateDBObject():
    ...
    dbObj.mzClass='Lightning F.Mk.1'
    dbObj.natoClass='Lightning F.Mk.1'
    ...
    dbObj.iconFileName='air/AdvicoLightningMK1.jpg'
    ...
    dbObj.damageEffect='Lightning F.Mk.1 durability'
