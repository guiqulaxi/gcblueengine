...
def CreateDBObject():
    ...
    dbObj.mzClass='F-16A/B'
    dbObj.natoClass='F-16A/B'
    ...
    dbObj.iconFileName='air/AdvicoF16AB.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ALR-69 RWR','APG-66','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f']
    ...
    dbObj.damageEffect='F-16A/B durability'
    dbObj.mnNumLaunchers=8
    dbObj.maLauncherClass=['F-16 Blk1 2-8','F-16 Blk1 2-8','F-16 Blk1 3-7','F-16 Blk1 4-6','F-16 Blk1 5','ALE-40 CMD','ALE-40 CMD','M61A Cannon']
    ...
    dbObj.launcherFireControl=['APG-66','APG-66','APG-66','APG-66','APG-66','','','APG-66']
