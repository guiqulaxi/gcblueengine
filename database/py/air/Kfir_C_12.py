...
def CreateDBObject():
    ...
    dbObj.mzClass='Kfir C.12'
    dbObj.natoClass='Kfir C.12'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=0.000000
    dbObj.weight_kg=7700.000000
    ...
    dbObj.iconFileName='air/AdvicoKFIRC12.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['EL/M-2001B AA','EL/M-2001B AG','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','Litening-3 LDP','SPS-2000']
    ...
    dbObj.damageEffect='Kfir C.12 durability'
    ...
    dbObj.launcherFireControl=['EL/M-2001B AA','EL/M-2001B AA','EL/M-2001B AA','EL/M-2001B AA','','']
    dbObj.launcherFireControl2=['Litening-3 LDP','Litening-3 LDP','Litening-3 LDP','Litening-3 LDP','','']
