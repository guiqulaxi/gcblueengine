...
def CreateDBObject():
    ...
    dbObj.mzClass='F-111F'
    dbObj.natoClass='F-111F'
    ...
    dbObj.iconFileName='air/AdvicoF111F.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ALQ-161A ESM','APQ-164','AVQ-26 LASER','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000,0.000000]
    dbObj.AddComponent(sensorPlatformDBObject)
    dbObj.mfMaxSpeed_kts=1432.000000
    dbObj.mfAccel_ktsps=10.330000
    dbObj.mfTurnRate_degps=20.950001
    dbObj.mfFuelCapacity_kg=15325.700195
    dbObj.mfFuelRate_kgps=3.900000
    dbObj.mfToughness=3.000000
    dbObj.damageEffect='F-111F durability'
    ...
    dbObj.launcherFireControl2=['AVQ-26 LASER','AVQ-26 LASER','AVQ-26 LASER','AVQ-26 LASER','','']
    ...
    dbObj.militaryThrust_N=134162.796875
    dbObj.militaryThrustSpeedSlope=0.000000
    dbObj.mfAfterburnThrust_N=220725.000000
