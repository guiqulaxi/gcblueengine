...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoMiG21M.jpg'
    ...
    dbObj.damageEffect='MiG-21M durability'
    dbObj.mnNumLaunchers=6
    dbObj.maLauncherClass=['MiG-21M OuterPylon','MiG-21M InnerPylon','23mm GSh-23L','MiG-21S Fuselage','MiG-21M InnerPylon','MiG-21M OuterPylon']
    ...
    dbObj.launcherFireControl=['RP-21 Sapfir','RP-21 Sapfir','','','RP-21 Sapfir','RP-21 Sapfir']
