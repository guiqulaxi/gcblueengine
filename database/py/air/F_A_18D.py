...
def CreateDBObject():
    ...
    dbObj.mzClass='F/A-18D'
    dbObj.natoClass='F/A-18D'
    ...
    dbObj.imageList='fa18d.jpg'
    dbObj.iconFileName='air/AdvicoFA18D.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ALR-67 RWR','APG-73','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','Litening LDP']
    ...
    dbObj.damageEffect='F/A-18D durability'
    dbObj.mnNumLaunchers=8
    dbObj.maLauncherClass=['F/A-18 Centerline','F/A-18 Nacelle','F/A-18 Inboard','F/A-18 Outboard','F/A-18 Wingtip','M61A Cannon','CM Ejector','CM Ejector']
    dbObj.maMagazineClass=[]
    dbObj.magazineId=[]
    dbObj.launcherId=[0,1,2,3,4,5,6,7]
    dbObj.launcherName=['Cen','Nac','IW','OW','Tips','Gun','CM1','CM2']
