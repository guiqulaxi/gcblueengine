...
def CreateDBObject():
    ...
    dbObj.mzClass='Type-77(MiG-21FL)'
    ...
    dbObj.iconFileName='air/AdvicoType77.jpg'
    ...
    dbObj.damageEffect='MiG-21FL durability'
    dbObj.mnNumLaunchers=3
    dbObj.maLauncherClass=['MiG-21FL InnerPylon','MiG-21F-13 Fuselage','MiG-21FL InnerPylon']
