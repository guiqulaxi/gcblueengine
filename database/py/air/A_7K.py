...
def CreateDBObject():
    ...
    dbObj.mzClass='A-7K'
    dbObj.natoClass='A-7K'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=28000000.000000
    dbObj.weight_kg=9662.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1981.246948
    dbObj.finalYear=1993.500000
    dbObj.country='USA'
    dbObj.designation='Strike Fighter'
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoA7K.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','APQ-126','ALR-46 RWR','AAS-35 PAVE-PENNY']
    ...
    dbObj.damageEffect='A-7K durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['A72 1-8','A72 2-7','A72 3-6','A7 Chin','M61A Cannon(1000)','ALE-40 CMD','ALE-40 CMD']
    ...
    dbObj.militaryThrust_N=64500.000000
    dbObj.militaryThrustSpeedSlope=0.002200
    dbObj.mfAfterburnThrust_N=64500.000000
