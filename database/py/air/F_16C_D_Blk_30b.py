...
def CreateDBObject():
    ...
    dbObj.mzClass='F-16C/D Blk 30b'
    dbObj.natoClass='F-16C/D Blk 30b'
    ...
    dbObj.iconFileName='air/AdvicoF16CD30b.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ALR-69 RWR','APG-68','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f']
    ...
    dbObj.damageEffect='F-16C/D Blk 30b durability'
    dbObj.mnNumLaunchers=8
    dbObj.maLauncherClass=['F-16 Blk30b 2-8','F-16 Blk30b 2-8','F-16 Blk30b 3-7','F-16 Blk25 4-6','F-16 Blk1 5','ALE-40 CMD','ALE-40 CMD','M61A Cannon']
