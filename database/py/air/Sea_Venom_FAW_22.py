...
def CreateDBObject():
    ...
    dbObj.mzClass='Sea Venom FAW.22'
    dbObj.natoClass='Sea Venom FAW.22'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=0.000000
    dbObj.weight_kg=3304.000000
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoSeaVenomFAW22.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['AI 21','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f']
    ...
    dbObj.mfFuelRate_kgps=0.282700
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='Sea Venom FAW.22 durability'
    dbObj.mnNumLaunchers=5
    dbObj.maLauncherClass=['20mm Hispano Cannon - Sea Venom','20mm Hispano Cannon - Sea Venom','20mm Hispano Cannon - Sea Venom','20mm Hispano Cannon - Sea Venom','Sea Venom FAW.22 Wings']
    ...
    dbObj.maxTakeoffWeight_kg=7167.000000
    dbObj.maxAltitude_m=13050.000000
    dbObj.climbRate_mps=29.200001
    dbObj.gmax=3.500000
    ...
    dbObj.militaryThrust_N=23600.000000
    dbObj.militaryThrustSpeedSlope=0.001000
    dbObj.mfAfterburnThrust_N=23600.000000
    dbObj.abThrustSpeedSlope=0.001000
    dbObj.mfAfterburnFuelRate_kgps=0.282700
    ...
    dbObj.thrustTable=[0.950000,0.900000,0.880000,0.760000,0.680000,0.500000,0.220000,0.040000,0.000000,0.000000]
