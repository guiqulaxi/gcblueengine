...
def CreateDBObject():
    ...
    dbObj.mzClass='Harrier GR.Mk.7 (01)'
    dbObj.natoClass='Harrier GR.Mk.7 (01)'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=15000000.000000
    dbObj.weight_kg=9500.000000
    ...
    dbObj.iconFileName='air/AdvicoHarrierGR7.jpg'
    ...
    dbObj.damageEffect='Harrier GR.Mk.7 durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['Harrier GR.7 1-9','Harrier GR.7 2-8','Harrier GR.7 3-7','Harrier GR.5 4-6','Harrier GR.7 5','CM Ejector','CM Ejector']
