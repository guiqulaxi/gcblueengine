...
def CreateDBObject():
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoSU22M.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','Fon LRFD','SPO-10 Serena RHAWS']
    ...
    dbObj.damageEffect='Su-22M durability'
