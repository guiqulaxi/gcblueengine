...
def CreateDBObject():
    ...
    dbObj.mzClass='Tornado GR.Mk.4'
    dbObj.natoClass='Tornado GR.Mk.4'
    ...
    dbObj.iconFileName='air/AdvicoTornadoGR4.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['Decca Type72 Doppler','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','TIALD','Zeus RWR','Laser-30km']
    ...
    dbObj.mfTurnRate_degps=27.139999
    dbObj.mfFuelCapacity_kg=5090.000000
    dbObj.mfFuelRate_kgps=2.100000
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='Tornado GR.Mk.4 durability'
    dbObj.mnNumLaunchers=10
    dbObj.maLauncherClass=['Tornado GR.4 1','Tornado GR.4 9','Tornado GR.4 2-8 shoulders','Tornado GR.4 2-8 shoulders','Tornado GR.4 2-8','Tornado GR.4 2-8','Tornado GR.4 fuselage fwd/aft','Tornado GR.4 fuselage fwd/aft','Tornado GR.1 fuselage centerline','27mm BK27-Cannon(180)']
    ...
    dbObj.launcherFireControl2=['Laser-30km','Laser-30km','Laser-30km','Laser-30km','Laser-30km','Laser-30km','Laser-30km','Laser-30km','Laser-30km','']
    ...
    dbObj.climbRate_mps=169.490005
    dbObj.gmax=7.500000
    ...
    dbObj.militaryThrust_N=76960.000000
