...
def CreateDBObject():
    ...
    dbObj.mzClass='Lightning F.Mk.1A'
    dbObj.natoClass='Lightning F.Mk.1A'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=15000000.000000
    dbObj.weight_kg=11692.000000
    ...
    dbObj.iconFileName='air/AdvicoLightningMK1A.jpg'
    ...
    dbObj.mfMaxSpeed_kts=975.000000
    dbObj.mfAccel_ktsps=17.120001
    dbObj.mfTurnRate_degps=15.530000
    dbObj.mfFuelCapacity_kg=2544.000000
    dbObj.mfFuelRate_kgps=3.300000
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='Lightning F.Mk.1A durability'
    ...
    dbObj.maxTakeoffWeight_kg=18182.000000
    dbObj.maxAltitude_m=26600.000000
    dbObj.climbRate_mps=389.899994
    dbObj.gmax=5.000000
    ...
    dbObj.militaryThrust_N=100317.062500
    dbObj.militaryThrustSpeedSlope=0.000000
    dbObj.mfAfterburnThrust_N=128687.578125
    dbObj.abThrustSpeedSlope=0.002800
    dbObj.mfAfterburnFuelRate_kgps=10.340000
