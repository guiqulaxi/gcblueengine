...
def CreateDBObject():
    ...
    dbObj.mzClass='Tornado IDS (Saudi Arabia)'
    dbObj.natoClass='Tornado IDS (Saudi Arabia)'
    ...
    dbObj.iconFileName='air/AdvicoTornadoIDS.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['Decca Type72 Doppler','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','Laser-20km','ARI 18241 RWR']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000]
    dbObj.AddComponent(sensorPlatformDBObject)
    dbObj.mfMaxSpeed_kts=1215.000000
    dbObj.mfAccel_ktsps=9.190000
    dbObj.mfTurnRate_degps=27.420000
    dbObj.mfFuelCapacity_kg=5090.000000
    dbObj.mfFuelRate_kgps=2.000000
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='Tornado IDS durability'
    dbObj.mnNumLaunchers=11
    dbObj.maLauncherClass=['Tornado IDSs 1','Tornado IDSs 9','Tornado IDSs 2-8 shoulders','Tornado IDSs 2-8 shoulders','Tornado IDSs 2-8','Tornado IDSs 2-8','Tornado IDSs fuselage fwd/aft','Tornado IDSs fuselage fwd/aft','Tornado IDSs fuselage centerline','27mm BK27-Cannon(180)','27mm BK27-Cannon(180)']
    ...
    dbObj.launcherFireControl=['Decca Type72 Doppler','Decca Type72 Doppler','Decca Type72 Doppler','Decca Type72 Doppler','Decca Type72 Doppler','Decca Type72 Doppler','Decca Type72 Doppler','Decca Type72 Doppler','Decca Type72 Doppler','','']
    dbObj.launcherFireControl2=['Laser-20km','Laser-20km','Laser-20km','Laser-20km','Laser-20km','Laser-20km','Laser-20km','Laser-20km','Laser-20km','','']
    ...
    dbObj.climbRate_mps=151.089996
    dbObj.gmax=7.500000
    ...
    dbObj.militaryThrust_N=75400.000000
    dbObj.militaryThrustSpeedSlope=0.000000
    dbObj.mfAfterburnThrust_N=132200.000000
    dbObj.abThrustSpeedSlope=0.002500
    dbObj.mfAfterburnFuelRate_kgps=7.500000
