...
def CreateDBObject():
    ...
    dbObj.mzClass='Tornado GR.Mk.1B'
    dbObj.natoClass='Tornado GR.Mk.1B'
    ...
    dbObj.iconFileName='air/AdvicoTornadoGR1B.jpg'
    ...
    dbObj.damageEffect='Tornado GR.Mk.1B durability'
    dbObj.mnNumLaunchers=11
    dbObj.maLauncherClass=['Tornado GR.1 1','Tornado GR.1 9','Tornado GR.1 2-8 shoulders','Tornado GR.1 2-8 shoulders','Tornado GR.1B 2-8','Tornado GR.1B 2-8','Tornado GR.1B fuselage fwd/aft','Tornado GR.1B fuselage fwd/aft','Tornado GR.1 fuselage centerline','27mm BK27-Cannon(180)','27mm BK27-Cannon(180)']
