...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoF4E.jpg'
    dbObj.mz3DModelFileName='f-4.xml'
    dbObj.notes='Internal fuel reduced to 7022 liters for F-4E vs 7544 liters for F-4D Ref: Francillon. McDonnell Douglas Aircraft since 1920. Used wikipedia ferry range 2600 km with 3 external fuel tanks (1420 liters each) gives about 1600 km with internal fuel only. Call it 1700-1800 km with bingo reserve.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    sensorPlatformDBObject=pygcb.tcSensorPlatformDBObject()
    sensorPlatformDBObject.sensorClass=['APQ-120','AVQ-12 LASER','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f']
    ...
    dbObj.damageEffect='F-4E durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['F-4E 1-9','F-4E 2-8','F-4E 3-7','F-4E 4-6','F-4E 5','ALE-29 CMs','ALE-29 CMs']
    ...
    dbObj.launcherFireControl2=['AVQ-12 LASER','AVQ-12 LASER','AVQ-12 LASER','AVQ-12 LASER','AVQ-12 LASER','','']
