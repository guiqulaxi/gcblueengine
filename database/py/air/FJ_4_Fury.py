...
def CreateDBObject():
    ...
    dbObj.mzClass='FJ-4 Fury'
    dbObj.natoClass='FJ-4 Fury'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=0.000000
    dbObj.weight_kg=5990.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1955.099976
    dbObj.finalYear=1960.000000
    dbObj.country='USA'
    dbObj.designation='Fighter'
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoFJ4.jpg'
    ...
    dbObj.damageEffect='FJ-4 Fury durability'
    dbObj.mnNumLaunchers=6
    dbObj.maLauncherClass=['0.50in(12.7mm) Browning M2(300)(x2)','0.50in(12.7mm) Browning M2(300)(x2)','0.50in(12.7mm) Browning M2(300)(x2)','FJ4 Wing2','F-86 Rockets','FJ4 Wing3']
    ...
    dbObj.maxTakeoffWeight_kg=10416.000000
