...
def CreateDBObject():
    ...
    dbObj.mzClass='F-86H'
    dbObj.natoClass='F-86H'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=0.000000
    dbObj.weight_kg=4940.000000
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoF86H.jpg'
    ...
    dbObj.mfMaxSpeed_kts=794.000000
    dbObj.mfAccel_ktsps=22.389999
    dbObj.mfTurnRate_degps=14.000000
    dbObj.mfFuelCapacity_kg=1536.595947
    dbObj.mfFuelRate_kgps=1.043600
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='F-86H durability'
    ...
    dbObj.maxTakeoffWeight_kg=9234.000000
    ...
    dbObj.militaryThrust_N=40923.000000
    dbObj.militaryThrustSpeedSlope=0.002145
    dbObj.mfAfterburnThrust_N=40923.000000
    dbObj.abThrustSpeedSlope=0.002145
    dbObj.mfAfterburnFuelRate_kgps=1.043600
    dbObj.mfCdpsub=0.516670
    dbObj.mfCdptran=0.775000
    dbObj.mfCdpsup=0.620000
