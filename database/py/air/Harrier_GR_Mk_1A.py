...
def CreateDBObject():
    ...
    dbObj.mzClass='Harrier GR.Mk.1A'
    dbObj.natoClass='Harrier GR.Mk.1A'
    ...
    dbObj.iconFileName='air/AdvicoHarrierGR1A.jpg'
    ...
    dbObj.mfMaxSpeed_kts=559.969971
    dbObj.mfAccel_ktsps=23.600000
    dbObj.mfTurnRate_degps=30.670000
    dbObj.mfFuelCapacity_kg=1914.500000
    dbObj.mfFuelRate_kgps=1.300000
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='Harrier GR.Mk.1A durability'
    dbObj.mnNumLaunchers=3
    dbObj.maLauncherClass=['Harrier GR.Mk.1 1-5','Harrier GR.Mk.1 2-4','Harrier GR.Mk.1 3']
    ...
    dbObj.climbRate_mps=422.320007
    dbObj.gmax=8.000000
    ...
    dbObj.militaryThrust_N=91233.000000
    dbObj.militaryThrustSpeedSlope=0.000000
    dbObj.mfAfterburnThrust_N=100360.000000
