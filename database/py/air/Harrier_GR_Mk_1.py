...
def CreateDBObject():
    ...
    dbObj.mzClass='Harrier GR.Mk.1'
    dbObj.natoClass='Harrier GR.Mk.1'
    ...
    dbObj.iconFileName='air/AdvicoHarrierGR1.jpg'
    ...
    dbObj.mfMaxSpeed_kts=538.400024
    dbObj.mfAccel_ktsps=21.820000
    dbObj.mfTurnRate_degps=31.900000
    dbObj.mfFuelCapacity_kg=1914.500000
    dbObj.mfFuelRate_kgps=1.300000
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='Harrier GR.Mk.1 durability'
    ...
    dbObj.climbRate_mps=377.519989
    dbObj.gmax=8.000000
    ...
    dbObj.militaryThrust_N=84366.000000
    dbObj.militaryThrustSpeedSlope=0.000000
    dbObj.mfAfterburnThrust_N=92800.000000
