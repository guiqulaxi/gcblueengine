...
def CreateDBObject():
    ...
    dbObj.mzClass='F-8J'
    dbObj.natoClass='F-8J'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=0.000000
    dbObj.weight_kg=8988.099609
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoF8J.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ALQ-51','APQ-124','APR-30 RWR','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f']
    ...
    dbObj.damageEffect='F-8J durability'
    ...
    dbObj.maxTakeoffWeight_kg=15422.000000
    dbObj.maxAltitude_m=15545.000000
    dbObj.climbRate_mps=113.300003
    dbObj.gmax=8.000000
    dbObj.minimumRunway_m=1219.000000
    ...
    dbObj.stallSpeed_mps=56.700001
