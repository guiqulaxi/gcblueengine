...
def CreateDBObject():
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoF2H1.jpg'
    ...
    dbObj.mfFuelRate_kgps=1.306714
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='F2H-1 durability'
    dbObj.mnNumLaunchers=3
    dbObj.maLauncherClass=['F2H-1 tips','20mm Hispano Cannon (150)','20mm Hispano Cannon (150)']
    ...
    dbObj.militaryThrust_N=26600.000000
    dbObj.militaryThrustSpeedSlope=0.002000
    dbObj.mfAfterburnThrust_N=26600.000000
    dbObj.abThrustSpeedSlope=0.002000
    dbObj.mfAfterburnFuelRate_kgps=1.306714
