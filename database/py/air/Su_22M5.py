...
def CreateDBObject():
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoSU22M5.jpg'
    ...
    dbObj.damageEffect='Su-22M5 durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['30mm NR-30 x2','Su-22M5 Fuselage','Su-22M5 W1','Su-22M5 W2','Su-22M5 W3','CM Ejector','CM Ejector']
