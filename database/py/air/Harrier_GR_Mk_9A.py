...
def CreateDBObject():
    ...
    dbObj.mzClass='Harrier GR.Mk.9A'
    dbObj.natoClass='Harrier GR.Mk.9A'
    ...
    dbObj.iconFileName='air/AdvicoHarrierGR9A.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ALR-69 RWR','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','Ferranti Type 106 LRMTS','Marconi 1010 FLIR','TIALD']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000]
    dbObj.AddComponent(sensorPlatformDBObject)
    dbObj.mfMaxSpeed_kts=538.760010
    ...
    dbObj.damageEffect='Harrier GR.Mk.9A durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['Harrier GR.9 1-9','Harrier GR.9 2-8','Harrier GR.9 3-7','Harrier GR.9 4-6','Harrier GR.9 5','CM Ejector','CM Ejector']
    ...
    dbObj.climbRate_mps=390.910004
    dbObj.gmax=8.000000
    ...
    dbObj.militaryThrust_N=107910.000000
    dbObj.militaryThrustSpeedSlope=0.000000
    dbObj.mfAfterburnThrust_N=118700.000000
