...
def CreateDBObject():
    ...
    dbObj.mzClass='Sea Harrier FRS.Mk.1'
    dbObj.natoClass='Sea Harrier FRS.Mk.1'
    ...
    dbObj.iconFileName='air/AdvicoHarrierFRS1.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ARI-18223 RWR','Blue Fox','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f']
    ...
    dbObj.damageEffect='Sea Harrier FRS.Mk.1 durability'
    dbObj.mnNumLaunchers=3
    dbObj.maLauncherClass=['Harrier FRS.1 1-5','Harrier FRS.1 2-4','Harrier FRS.1 3']
    ...
    dbObj.launcherFireControl=['Blue Fox','Blue Fox','Blue Fox']
