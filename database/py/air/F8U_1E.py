...
def CreateDBObject():
    ...
    dbObj.mzClass='F8U-1E'
    dbObj.natoClass='F8U-1E'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=0.000000
    dbObj.weight_kg=7036.700195
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1958.703003
    dbObj.finalYear=1962.000000
    dbObj.country='USA'
    dbObj.designation='Fighter'
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoF8U1E.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['APS-67','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000]
    dbObj.AddComponent(sensorPlatformDBObject)
    dbObj.mfMaxSpeed_kts=990.000000
    ...
    dbObj.damageEffect='F8U-1E durability'
    dbObj.mnNumLaunchers=3
    dbObj.maLauncherClass=['20mm Colt Mk-12 Cannon (125) x2','20mm Colt Mk-12 Cannon (125) x2','F8U-1E chin']
    ...
    dbObj.maxTakeoffWeight_kg=12474.000000
