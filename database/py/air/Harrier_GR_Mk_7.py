...
def CreateDBObject():
    ...
    dbObj.mzClass='Harrier GR.Mk.7'
    dbObj.natoClass='Harrier GR.Mk.7'
    ...
    dbObj.maLauncherClass=['Harrier GR.5 1-7','Harrier GR.5 2-6','Harrier GR.3 2-4','Harrier GR.5 4-6','Harrier GR.3 3','CM Ejector','CM Ejector']
