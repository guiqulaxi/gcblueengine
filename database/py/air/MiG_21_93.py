...
def CreateDBObject():
    ...
    dbObj.mzClass='MiG-21-93'
    dbObj.natoClass='MiG-21-93'
    ...
    dbObj.iconFileName='air/AdvicoMiG2193.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','SPO-15 RWR','Super Kopyo']
    ...
    dbObj.damageEffect='MiG-21-93 durability'
    dbObj.mnNumLaunchers=8
    dbObj.maLauncherClass=['MiG-21-93 OuterPylon','MiG-21-93 InnerPylon','23mm GSh-23L','MiG-21S Fuselage','MiG-21-93 InnerPylon','MiG-21-93 OuterPylon','CM Ejector','CM Ejector']
    dbObj.maMagazineClass=[]
    dbObj.mnNumMagazines=0
    dbObj.magazineId=[]
    dbObj.launcherId=[0,1,2,3,4,5,6,7]
    dbObj.launcherName=['','','','','','','','']
    dbObj.launcherFOV_deg=[0.000000,0.000000,20.000000,0.000000,0.000000,0.000000,0.000000,0.000000]
    ...
    dbObj.launcherFireControl=['Super Kopyo','Super Kopyo','','','Super Kopyo','Super Kopyo','','']
