...
def CreateDBObject():
    ...
    dbObj.mzClass='F-16AM/BM Blk 15 MLU'
    dbObj.natoClass='F-16AM/BM Blk 15 MLU'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=0.000000
    dbObj.weight_kg=7387.000000
    ...
    dbObj.iconFileName='air/AdvicoF16MLU.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ALR-69 RWR','APG-68(v)2','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','LANTIRN']
    ...
    dbObj.mfFuelCapacity_kg=3257.800049
    dbObj.mfFuelRate_kgps=1.312440
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='F-16AM/BM Blk 15 MLU durability'
    dbObj.mnNumLaunchers=8
    dbObj.maLauncherClass=['F-16 Blk15OCU 2-8','F-16 Blk15OCU 2-8','F-16 Blk50+ 3-7','F-16 Blk50+ 4-6','F-16 Blk1 5','ALE-40 CMD','ALE-40 CMD','M61A Cannon']
    ...
    dbObj.launcherFireControl=['APG-68(v)2','APG-68(v)2','APG-68(v)2','APG-68(v)2','APG-68(v)2','','','APG-68(v)2']
    dbObj.launcherFireControl2=['LANTIRN','LANTIRN','LANTIRN','LANTIRN','LANTIRN','','','LANTIRN']
    ...
    dbObj.maxTakeoffWeight_kg=16057.000000
    ...
    dbObj.militaryThrust_N=65260.000000
    dbObj.militaryThrustSpeedSlope=0.000000
    dbObj.mfAfterburnThrust_N=100530.000000
    dbObj.abThrustSpeedSlope=0.003050
    dbObj.mfAfterburnFuelRate_kgps=5.477880
