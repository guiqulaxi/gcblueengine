...
def CreateDBObject():
    ...
    dbObj.mzClass='Sea Harrier FRS.Mk.1 (83)'
    dbObj.natoClass='Sea Harrier FRS.Mk.1 (83)'
    ...
    dbObj.maLauncherClass=['Harrier FRS.1 1-5','Harrier FRS.1 2-4','Harrier FRS.1 3','CM Ejector','CM Ejector']
