...
def CreateDBObject():
    ...
    dbObj.mzClass='Tornado IDS (Germany)'
    dbObj.natoClass='Tornado IDS (Germany)'
    ...
    sensorPlatformDBObject.sensorClass=['Decca Type72 Doppler','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','Laser-20km','ERWE RWR']
    ...
    dbObj.maLauncherClass=['Tornado IDS 1','Tornado IDS 9','Tornado IDS 2-8 shoulders','Tornado IDS 2-8 shoulders','Tornado IDS 2-8','Tornado IDS 2-8','Tornado IDS fuselage fwd/aft','Tornado IDS fuselage fwd/aft','Tornado IDS fuselage centerline','27mm BK27-Cannon(180)','27mm BK27-Cannon(180)']
