...
def CreateDBObject():
    ...
    dbObj.mzClass='MiG-21 Bison'
    dbObj.natoClass='MiG-21 Bison'
    ...
    dbObj.iconFileName='air/AdvicoMiG21Bison.jpg'
    ...
    dbObj.damageEffect='MiG-21 Bison durability'
    dbObj.mnNumLaunchers=8
    dbObj.maLauncherClass=['MiG-21Bison OuterPylon','MiG-21Bison InnerPylon','23mm GSh-23L','MiG-21S Fuselage','MiG-21Bison InnerPylon','MiG-21Bison OuterPylon','CM Ejector','CM Ejector']
    ...
    dbObj.launcherFireControl=['Kopyo','Kopyo','','','Kopyo','Kopyo','','']
