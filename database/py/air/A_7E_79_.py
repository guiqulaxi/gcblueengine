...
def CreateDBObject():
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','APQ-126','ALR-46 RWR','AAS-35 PAVE-PENNY','AAR-45 FLIR','AAR-45 LLTV']
