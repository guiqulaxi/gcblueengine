...
def CreateDBObject():
    ...
    dbObj.mzClass='Tornado ADV'
    dbObj.natoClass='Tornado ADV'
    ...
    dbObj.maLauncherClass=['Tornado ADV wing shoulder','Tornado F2 wing','Tornado F3 fuselage','27mm BK27-Cannon(180)','ALE-40 FD','ALE-40 CD']
