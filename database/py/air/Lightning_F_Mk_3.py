...
def CreateDBObject():
    ...
    dbObj.mzClass='Lightning F.Mk.3'
    dbObj.natoClass='Lightning F.Mk.3'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=15000000.000000
    dbObj.weight_kg=12215.000000
    ...
    dbObj.iconFileName='air/AdvicoLightningMK3.jpg'
    ...
    dbObj.damageEffect='Lightning F.Mk.3 durability'
    ...
    dbObj.climbRate_mps=477.339996
    dbObj.gmax=5.000000
    ...
    dbObj.militaryThrust_N=113187.781250
