...
def CreateDBObject():
    ...
    dbObj.mzClass='FJ-4B Fury'
    dbObj.natoClass='FJ-4B Fury'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=0.000000
    dbObj.weight_kg=5990.000000
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoFJ4B.jpg'
    ...
    dbObj.damageEffect='FJ-4B Fury durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['0.50in(12.7mm) Browning M2(300)(x2)','0.50in(12.7mm) Browning M2(300)(x2)','0.50in(12.7mm) Browning M2(300)(x2)','FJ4B Wing1','FJ4B Wing2','F-86 Rockets','FJ4 Wing3']
    dbObj.maMagazineClass=[]
    dbObj.magazineId=[]
    dbObj.launcherId=[0,1,2,3,4,5,6]
    dbObj.launcherName=['','','','','','','']
    dbObj.launcherFOV_deg=[10.000000,10.000000,10.000000,0.000000,0.000000,0.000000,0.000000]
    ...
    dbObj.maxAltitude_m=14270.000000
