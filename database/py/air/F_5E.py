...
def CreateDBObject():
    ...
    dbObj.mzClass='F-5E'
    dbObj.natoClass='F-5E'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=21000000.000000
    dbObj.weight_kg=4350.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1974.000000
    dbObj.finalYear=2999.000000
    dbObj.country='USA'
    dbObj.designation='Fighter'
    dbObj.imageList='f5e.jpg'
    dbObj.iconFileName='air/AdvicoF5E.jpg'
    dbObj.mz3DModelFileName='F-5.xml'
    dbObj.notes='2563 liters internal with up to 3 x 1040 lliter external tanks. Range with tanks 3700 km. Internal ferry range about 1700-1800 km.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    sensorPlatformDBObject=pygcb.tcSensorPlatformDBObject()
    sensorPlatformDBObject.sensorClass=['ALR-47 ESM','APQ-153','AVQ-26 LASER','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000]
    dbObj.AddComponent(sensorPlatformDBObject)
    dbObj.mfMaxSpeed_kts=930.000000
    dbObj.mfAccel_ktsps=20.000000
    dbObj.mfTurnRate_degps=18.000000
    dbObj.mfFuelCapacity_kg=2090.000000
    dbObj.mfFuelRate_kgps=0.850000
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='F-5E durability'
    dbObj.mnNumLaunchers=6
    dbObj.maLauncherClass=['F-5 W1','F-5 W2','F-5 W3','F-5 F1','M61A Cannon','M61A Cannon']
    dbObj.maMagazineClass=[]
    dbObj.mnNumMagazines=0
    dbObj.magazineId=[]
    dbObj.launcherId=[0,1,2,3,4,5]
    dbObj.launcherName=['WT','MW','IW','','','']
    ...
    dbObj.launcherFireControl=['APQ-153','APQ-153','APQ-153','APQ-153','','']
    ...
    airDetectionDBObject.opticalCrossSection_dBsm=6.300000
    ...
    dbObj.maxTakeoffWeight_kg=11200.000000
    dbObj.maxAltitude_m=15800.000000
    dbObj.climbRate_mps=175.000000
    dbObj.gmax=9.000000
    ...
    dbObj.militaryThrust_N=52000.000000
    dbObj.militaryThrustSpeedSlope=0.000000
    dbObj.mfAfterburnThrust_N=110000.000000
    ...
    dbObj.thrustTable=[1.000000,0.900000,0.800000,0.750000,0.730000,0.720000,0.350000,0.100000,0.050000,0.000000]
