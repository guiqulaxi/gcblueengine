...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoF4D.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['APQ-109','AVQ-12 LASER','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f']
    ...
    dbObj.damageEffect='F-4D durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['F-4D 1-9','F-4D 2-8','F-4D 3-7','F-4D 4-6','F-4D 5','ALE-29 CMs','ALE-29 CMs']
    ...
    dbObj.launcherFireControl=['APQ-109','APQ-109','APQ-109','APQ-109','APQ-109','','']
    ...
    dbObj.militaryThrust_N=97006.000000
    dbObj.militaryThrustSpeedSlope=0.000000
    dbObj.mfAfterburnThrust_N=151294.000000
