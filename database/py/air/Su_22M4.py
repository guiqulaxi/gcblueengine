...
def CreateDBObject():
    ...
    dbObj.mzClass='Su-22M4'
    dbObj.natoClass='Fitter-K'
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoSU22M4.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','Klyon-54 LRMTS','SPO-15 RWR']
    ...
    dbObj.damageEffect='Su-22M4 durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['30mm NR-30 x2','Su-17M4 Fuselage','Su-17M4 W1','Su-17M3 W2','Su-17M4 W3','CM Ejector','CM Ejector']
    ...
    dbObj.launcherFireControl=['','Klyon-54 LRMTS','Klyon-54 LRMTS','Klyon-54 LRMTS','Klyon-54 LRMTS','','']
    dbObj.launcherFireControl2=['','Klyon-54 LRMTS','Klyon-54 LRMTS','Klyon-54 LRMTS','Klyon-54 LRMTS','','']
