...
def CreateDBObject():
    ...
    dbObj.mzClass='F-16C/D Blk 40'
    dbObj.natoClass='F-16C/D Blk 40'
    ...
    dbObj.iconFileName='air/AdvicoF16CD40.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ALR-69 RWR','APG-68','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','LANTIRN']
    ...
    dbObj.mfFuelRate_kgps=1.748000
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='F-16C/D Blk 40 durability'
    dbObj.mnNumLaunchers=8
    dbObj.maLauncherClass=['F-16 Blk40 2-8','F-16 Blk40 2-8','F-16 Blk40 3-7','F-16 Blk40 4-6','F-16 Blk1 5','ALE-40 CMD','ALE-40 CMD','M61A Cannon']
    ...
    dbObj.launcherFireControl=['APG-68','APG-68','APG-68','APG-68','APG-68','','','APG-68']
    ...
    dbObj.militaryThrust_N=78060.000000
    dbObj.militaryThrustSpeedSlope=0.000000
    dbObj.mfAfterburnThrust_N=124600.000000
    dbObj.abThrustSpeedSlope=0.002730
    dbObj.mfAfterburnFuelRate_kgps=7.260720
