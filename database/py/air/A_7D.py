...
def CreateDBObject():
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','APQ-126','APR-40 RWR','AAS-35 PAVE-PENNY','AAR-45 FLIR','AAR-45 LLTV']
    ...
    dbObj.damageEffect='A-7D durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['A72 1-8','A72 2-7','A72 3-6','A7 Chin','M61A Cannon(1000)','ALE-29 CMs','ALE-29 CMs']
