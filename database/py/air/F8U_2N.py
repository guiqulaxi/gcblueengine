...
def CreateDBObject():
    ...
    dbObj.mzClass='F8U-2N'
    dbObj.natoClass='F8U-2N'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=0.000000
    dbObj.weight_kg=7956.600098
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1960.121948
    dbObj.finalYear=1962.000000
    dbObj.country='USA'
    dbObj.designation='Fighter'
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoF8U2N.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['APQ-83','Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f']
    ...
    dbObj.damageEffect='F8U-2N durability'
    dbObj.mnNumLaunchers=4
    dbObj.maLauncherClass=['20mm Colt Mk-12 Cannon (125) x2','20mm Colt Mk-12 Cannon (125) x2','F8U-1E chin','F8U-1E chin']
    ...
    dbObj.maxTakeoffWeight_kg=13381.000000
    dbObj.maxAltitude_m=16474.000000
    dbObj.climbRate_mps=176.000000
    dbObj.gmax=8.000000
    dbObj.minimumRunway_m=1280.000000
    ...
    dbObj.stallSpeed_mps=57.500000
