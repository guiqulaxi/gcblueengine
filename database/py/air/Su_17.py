...
def CreateDBObject():
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoSU17.jpg'
    ...
    dbObj.mfFuelCapacity_kg=2760.000000
    dbObj.mfFuelRate_kgps=1.843300
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='Su-17 durability'
    dbObj.mnNumLaunchers=6
    dbObj.maLauncherClass=['30mm NR-30 x2','Su-17 Fuselage','Su-17 W1','Su-17 W2','CM Ejector','CM Ejector']
    ...
    dbObj.launcherFireControl=['','SRD-5M','SRD-5M','SRD-5M','','']
    ...
    dbObj.maxTakeoffWeight_kg=16949.000000
    dbObj.maxAltitude_m=16300.000000
    dbObj.climbRate_mps=200.000000
    dbObj.gmax=6.500000
    dbObj.minimumRunway_m=1100.000000
    dbObj.isCarrierCompatible=False
    dbObj.outFuelPods=0
    dbObj.fuelOut_kgps=0.000000
    dbObj.fuelIn_kgps=5.000000
    dbObj.maintenanceMin_s=3600.000000
    dbObj.maintenanceMax_s=10800.000000
    dbObj.militaryThrust_N=67100.000000
    dbObj.militaryThrustSpeedSlope=0.000000
    dbObj.mfAfterburnThrust_N=98100.000000
    dbObj.abThrustSpeedSlope=0.003000
    dbObj.mfAfterburnFuelRate_kgps=6.240000
    dbObj.mfCdpsub=1.000000
    dbObj.mfCdptran=1.600000
    dbObj.mfCdpsup=1.855000
    dbObj.mfMcm=0.900000
    dbObj.mfMsupm=1.150000
    dbObj.cruiseSpeed_mps=100.000000
    dbObj.stallSpeed_mps=50.000000
    dbObj.thrustTable=[1.000000,1.000000,1.000000,1.000000,1.000000,0.740000,0.227000,0.100000,0.005000,0.001000]
    dbObj.fuelEfficiencyTable=[1.000000,1.000000,1.000000,1.040000,1.078000,1.300000,1.900000,3.000000,6.000000,6.000000]
