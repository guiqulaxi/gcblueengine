...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoMiG21SN.jpg'
    ...
    dbObj.damageEffect='MiG-21SN durability'
    dbObj.mnNumLaunchers=6
    dbObj.maLauncherClass=['MiG-21S OuterPylon','MiG-21S InnerPylon','23mm GSh-23L','MiG-21SN Fuselage','MiG-21S InnerPylon','MiG-21S OuterPylon']
