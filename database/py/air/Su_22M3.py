...
def CreateDBObject():
    ...
    dbObj.mzClass='Su-22M3'
    dbObj.natoClass='Fitter-J'
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoSU22M3.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/10','Eyeball 20/10d','Eyeball 20/10e','Eyeball 20/10f','Klyon-PS LRMTS','SPO-15 RWR']
    ...
    dbObj.damageEffect='Su-22M3 durability'
    ...
    dbObj.launcherFireControl=['','Klyon-PS LRMTS','Klyon-PS LRMTS','Klyon-PS LRMTS','','']
    ...
    dbObj.maxTakeoffWeight_kg=19400.000000
    ...
    dbObj.abThrustSpeedSlope=0.004100
