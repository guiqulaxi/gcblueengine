...
def CreateDBObject():
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoA4P.jpg'
    ...
    dbObj.damageEffect='A-4P durability'
    dbObj.mnNumLaunchers=4
    dbObj.maLauncherClass=['20mm Colt Mk-12 Cannon (200)','20mm Colt Mk-12 Cannon (200)','A-4B 2-4','A-4P 3']
