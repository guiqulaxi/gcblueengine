...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoMiG21S.jpg'
    ...
    dbObj.damageEffect='MiG-21S durability'
    dbObj.mnNumLaunchers=6
    dbObj.maLauncherClass=['MiG-21S OuterPylon','MiG-21S InnerPylon','23mm GSh-23L','MiG-21S Fuselage','MiG-21S InnerPylon','MiG-21S OuterPylon']
