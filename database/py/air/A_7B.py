...
def CreateDBObject():
    ...
    dbObj.mzClass='A-7B'
    dbObj.natoClass='A-7B'
    dbObj.mnModelType=12
    dbObj.mnType=33
    dbObj.cost=28000000.000000
    dbObj.weight_kg=7318.000000
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoA7B.jpg'
    ...
    dbObj.mfFuelCapacity_kg=4558.500000
    dbObj.mfFuelRate_kgps=0.950000
    dbObj.mfToughness=1.000000
    dbObj.damageEffect='A-7B durability'
