...
def CreateDBObject():
    ...
    dbObj.mzClass='DRBV 15C'
    dbObj.natoClass='DRBV 15C'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.ERPpeak_dBW=77.000000
    dbObj.ERPaverage_dBW=67.000000
