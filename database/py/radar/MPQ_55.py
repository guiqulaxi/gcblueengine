...
def CreateDBObject():
    ...
    dbObj.mzClass='MPQ-55'
    dbObj.natoClass='MPQ-55'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='needs updating with accurate details.  Current info \'generated\' mathematically.  Output doubled over MPQ-48, increases ref_range accordingly, estimates increase at 18.9%.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=80.000000
    dbObj.mfRefRange_km=61.830002
