...
def CreateDBObject():
    ...
    dbObj.mzClass='Gun Dish'
    dbObj.natoClass='Gun Dish'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='i know nothing of this radar except that its effective out to 20km, and can track from 10km onwards.  GCB offers no track/scan differentiation, so im going to 15km overall.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=15.000000
    dbObj.mfRefRange_km=20.000000
