...
def CreateDBObject():
    ...
    dbObj.mzClass='MR-755 Fregat MAE-5'
    dbObj.natoClass='MR-755 Fregat MAE-5'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
