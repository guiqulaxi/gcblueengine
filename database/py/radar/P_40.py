...
def CreateDBObject():
    ...
    dbObj.notes='needs updating with accurate details.  Current info \'generated\' mathematically.  ERP and lookdowns need work.  Range, Range/Bearing accuracy, scan rate accurate.'
