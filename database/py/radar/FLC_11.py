...
def CreateDBObject():
    ...
    dbObj.mzClass='FLC-11'
    dbObj.natoClass='FLC-11'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='1.5µs and 0.25µs pulses @ 1200, 600, and 300pps.  peak power of 108kWclaimed range is 28nm on a periscope, 60nm on a patrol boat, and 130nm on a medium sized ship, all in sea state 3 or 4.  This is the Chinese version of Agrion 15.'
