...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 1006'
    dbObj.natoClass='Type 1006'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
