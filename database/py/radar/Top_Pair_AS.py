...
def CreateDBObject():
    ...
    dbObj.mzClass='Top Pair AS'
    dbObj.natoClass='Top Pair AS'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.mfMaxRange_km=366.000000
    dbObj.mfRefRange_km=101.360001
    ...
    dbObj.ERPpeak_dBW=91.000000
    dbObj.ERPaverage_dBW=81.000000
