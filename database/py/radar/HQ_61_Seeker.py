...
def CreateDBObject():
    ...
    dbObj.mzClass='HQ-61 Seeker'
    dbObj.natoClass='HQ-61 Seeker'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='aligned for 5m² target at 25km'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=25.000000
    dbObj.mfRefRange_km=16.718510
    ...
    dbObj.ERPpeak_dBW=0.000000
    dbObj.ERPaverage_dBW=-99.000000
