...
def CreateDBObject():
    ...
    dbObj.mzClass='C-704 Seeker'
    dbObj.natoClass='C-704 Seeker'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='set to detect a 25dB target at 40km'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=20.000000
    dbObj.mfRefRange_km=10.430000
    ...
    dbObj.angleError_deg=5.740000
    dbObj.elevationError_deg=3.820000
