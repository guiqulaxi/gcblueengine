...
def CreateDBObject():
    ...
    dbObj.mzClass='ORB 31D'
    dbObj.natoClass='ORB 31D'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='this is the Heracles I radar, used on the French Super Frelon helos, among others, detection of 1000m² ship is 80km.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=157.000000
    dbObj.mfRefRange_km=14.226000
    ...
    dbObj.ERPpeak_dBW=74.269997
    dbObj.ERPaverage_dBW=44.810001
