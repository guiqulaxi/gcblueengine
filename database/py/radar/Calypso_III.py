...
def CreateDBObject():
    ...
    dbObj.mzClass='Calypso-III'
    dbObj.natoClass='Calypso-III'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Marcos-modified by Amram.  Effective range vs 10m² target is 18nm, so, 18.746km.  Effective range vs a 200m² target is thus '
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=70.500000
    dbObj.mfRefRange_km=18.746000
