...
def CreateDBObject():
    ...
    dbObj.mzClass='MPQ-50'
    dbObj.natoClass='MPQ-50'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='needs updating with accurate details.  Current info \'generated\' mathematically.  Ref Range is Accurate.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=125.000000
    dbObj.mfRefRange_km=79.000000
