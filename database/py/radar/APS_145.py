...
def CreateDBObject():
    ...
    dbObj.mzClass='APS-145'
    dbObj.natoClass='APS-145'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='regarded as capable of detecting and trackign targets at up to 40% greater range.  direct extrapolation yields the given ref range value.'
    ...
    dbObj.lookdownWater_dB=-2.000000
    dbObj.lookdownLand_dB=-20.000000
