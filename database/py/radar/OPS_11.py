...
def CreateDBObject():
    ...
    dbObj.mzClass='OPS-11'
    dbObj.natoClass='OPS-11'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='broadly equivalent to SPS-40, setting it as such'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=370.000000
    dbObj.mfRefRange_km=214.052994
    dbObj.mfFieldOfView_deg=370.000000
    dbObj.minElevation_deg=-90.000000
    dbObj.maxElevation_deg=38.000000
    dbObj.mfScanPeriod_s=8.000000
    dbObj.damageEffect='GenericSensor'
    dbObj.rangeError=1.000000
    dbObj.angleError_deg=0.500000
    dbObj.elevationError_deg=1.190000
