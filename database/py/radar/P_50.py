...
def CreateDBObject():
    ...
    dbObj.notes='Data needs updating.  Range is accurate, remainder extrapolated form P-35 based on increase in range.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=450.000000
    dbObj.mfRefRange_km=258.000000
    dbObj.mfFieldOfView_deg=360.000000
    dbObj.minElevation_deg=-90.000000
    dbObj.maxElevation_deg=28.000000
    dbObj.mfScanPeriod_s=12.900000
