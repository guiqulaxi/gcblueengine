...
def CreateDBObject():
    ...
    dbObj.mzClass='SPS-43 AS'
    dbObj.natoClass='SPS-43 AS'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.mfMaxRange_km=482.000000
    dbObj.mfRefRange_km=133.490005
    ...
    dbObj.angleError_deg=0.210000
    dbObj.elevationError_deg=0.140000
    dbObj.minFrequency_Hz=3000000000.000000
    dbObj.maxFrequency_Hz=3500000000.000000
    dbObj.idThreshold_dB=9999.000000
    dbObj.counterMeasureFactor=1.000000
    dbObj.isSurveillance=True
    dbObj.ERPpeak_dBW=96.000000
    dbObj.ERPaverage_dBW=86.000000
