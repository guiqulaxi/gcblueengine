...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 347 (Fore)'
    dbObj.natoClass='Type 347 (Fore)'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
