...
def CreateDBObject():
    ...
    dbObj.mzClass='MPQ-62'
    dbObj.natoClass='MPQ-62'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='needs updating with accurate details.  Current info \'generated\' mathematically.  No changes in performance over MPQ-55 in GCB terms.'
