...
def CreateDBObject():
    ...
    dbObj.mzClass='RP-21 Sapfir'
    dbObj.natoClass='RP-21 Sapfir'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='fighter size targets at 20km, so assuming 5m at 20km., 60deg FoV, 20 deg vertical'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=20.000000
    dbObj.mfRefRange_km=7.000000
    ...
    dbObj.lookdownLand_dB=-39.000000
