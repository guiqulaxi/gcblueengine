...
def CreateDBObject():
    ...
    dbObj.mzClass='RTN-10XP popa'
    dbObj.natoClass='RTN-10XP popa'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.ERPpeak_dBW=42.000000
    dbObj.ERPaverage_dBW=32.000000
    ...
    dbObj.elevationBeamwidth_deg=1.900000
