...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 364'
    dbObj.natoClass='Seagull'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.mfMaxRange_km=268.000000
