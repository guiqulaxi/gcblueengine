...
def CreateDBObject():
    ...
    dbObj.mzClass='9LV 453 TIR'
    dbObj.natoClass='9LV 453 TIR'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.maxFrequency_Hz=6000000000.000000
    dbObj.idThreshold_dB=9999.000000
    dbObj.counterMeasureFactor=1.000000
    dbObj.isSurveillance=False
    dbObj.ERPpeak_dBW=66.000000
    dbObj.ERPaverage_dBW=56.000000
