...
def CreateDBObject():
    ...
    dbObj.mzClass='MPQ-34'
    dbObj.natoClass='MPQ-34'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='needs updating with accurate details.  Current info \'generated\' mathematically.  Extrapolated Ref Range from MPQ-48(it doubled output power, so its deteciton ranges should exceed MPQ-34 by 18.9%, thus, MPQ-48 ref range -18.9%=MPQ-34 Ref Range.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=74.000000
    dbObj.mfRefRange_km=30.000000
