...
def CreateDBObject():
    ...
    dbObj.mzClass='Generic Radar 20km SS'
    dbObj.natoClass='Generic Radar 20km SS'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.angleError_deg=1.020000
    dbObj.elevationError_deg=0.680000
