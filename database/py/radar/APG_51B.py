...
def CreateDBObject():
    ...
    dbObj.mzClass='APG-51B'
    dbObj.natoClass='APG-51B'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='http://www.carrierbuilders.net/articles/20050323_F3H_Demon/f3h_demon2.htm.  20nm vs 25m2 target.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=71.000000
    dbObj.mfRefRange_km=16.565001
