...
def CreateDBObject():
    ...
    dbObj.mzClass='MPQ-64'
    dbObj.natoClass='MPQ-64'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='needs updating with accurate details.  Current info \'generated\' mathematically.  Range, scan rate, and elevations are accurate.'
