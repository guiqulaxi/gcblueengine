...
def CreateDBObject():
    ...
    dbObj.mzClass='RP-SM Smerch-M'
    dbObj.natoClass='RP-SM Smerch-M'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='Bomber at 80km, track at 50km, engage at 32km.  Can\'t make such a distinction in GCB as yet.  Instead, bomber will be tracked at 80km.  the missile itself is limiting the engagement range to about 40km for most targets..  Near elimination of the look down penalties'
