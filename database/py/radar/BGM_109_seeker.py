...
def CreateDBObject():
    ...
    dbObj.mzClass='BGM-109 seeker'
    dbObj.natoClass='BGM-109 seeker'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='Amram\'s notes: Had no luck with waypoint only targeting-appeared to hit but no dmg done so a very shortrange homing solution to finalise the impact.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=60.000000
    dbObj.mfRefRange_km=1.187000
    ...
    dbObj.angleError_deg=10.720000
    dbObj.elevationError_deg=7.150000
    dbObj.minFrequency_Hz=3000000000.000000
    dbObj.maxFrequency_Hz=3500000000.000000
    dbObj.idThreshold_dB=9999.000000
    dbObj.counterMeasureFactor=1.000000
    dbObj.isSurveillance=False
    dbObj.ERPpeak_dBW=36.000000
    dbObj.ERPaverage_dBW=26.000000
