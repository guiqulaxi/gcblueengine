...
def CreateDBObject():
    ...
    dbObj.mzClass='Top Plate AS/SS'
    dbObj.natoClass='Top Plate AS/SS'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='error level assigned to suport SA-N-9, 9M330 Kinzhal, command guided to 7.2km, 11.4m det range, 11.44m error assigned at 7.2km.  Also boosted update rate'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=250.000000
    dbObj.mfRefRange_km=130.000000
