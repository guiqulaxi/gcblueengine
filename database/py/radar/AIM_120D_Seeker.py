...
def CreateDBObject():
    ...
    dbObj.mzClass='AIM-120D Seeker'
    dbObj.natoClass='AIM-120D Seeker'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.maxFrequency_Hz=14499999744.000000
    ...
    dbObj.bandwidth_Hz=6000000.000000
    dbObj.azimuthBeamwidth_deg=4.000000
