...
def CreateDBObject():
    ...
    dbObj.mfMaxRange_km=68.699997
    dbObj.mfRefRange_km=9.487000
    ...
    dbObj.ERPpeak_dBW=71.989998
    dbObj.ERPaverage_dBW=58.980000
    dbObj.maxFireControlTracks=0
    dbObj.isSemiactive=False
    dbObj.blindSpeed_mps=2.500000
    dbObj.lookdownWater_dB=-14.574000
    dbObj.lookdownLand_dB=-23.573999
