...
def CreateDBObject():
    ...
    dbObj.notes='needs updating with accurate details.  Current info \'generated\' mathematically. Max range, elevation limits, scan rate, range error, angle error are accurate'
