...
def CreateDBObject():
    ...
    dbObj.mzClass='NIIP N-012'
    dbObj.natoClass='NIIP N-012'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.mfMaxRange_km=125.000000
    dbObj.mfRefRange_km=39.500000
    ...
    dbObj.ERPpeak_dBW=58.080002
    dbObj.ERPaverage_dBW=48.080002
    dbObj.maxFireControlTracks=4
    dbObj.isSemiactive=False
    dbObj.blindSpeed_mps=2.500000
    dbObj.lookdownWater_dB=-5.000000
    dbObj.lookdownLand_dB=-6.700000
