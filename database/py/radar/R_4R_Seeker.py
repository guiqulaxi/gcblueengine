...
def CreateDBObject():
    ...
    dbObj.mzClass='R-4R Seeker'
    dbObj.natoClass='R-4R Seeker'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='Aligned to detect a 100m² target(large bomber) at 40km, but capable of exceeding this, the missile itself can headon a 550kt target from 68km...'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=70.000000
    dbObj.mfRefRange_km=12.650000
