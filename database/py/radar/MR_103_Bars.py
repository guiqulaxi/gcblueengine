...
def CreateDBObject():
    ...
    dbObj.mzClass='MR-103 Bars'
    dbObj.natoClass='Muff Cobb'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='FC for the AK-725 57mm'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=40.000000
    dbObj.mfRefRange_km=0.857000
    ...
    dbObj.minFrequency_Hz=4000000000.000000
    dbObj.maxFrequency_Hz=8000000000.000000
