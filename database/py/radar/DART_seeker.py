...
def CreateDBObject():
    ...
    dbObj.mzClass='DART seeker'
    dbObj.natoClass='DART seeker'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='as its a beam rider, it doesn\'t actually track its target, so its been assigned VERY high ref range.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=6.000000
    dbObj.mfRefRange_km=600.000000
