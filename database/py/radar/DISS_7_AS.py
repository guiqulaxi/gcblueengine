...
def CreateDBObject():
    ...
    dbObj.mzClass='DISS-7 AS'
    dbObj.natoClass='DISS-7 AS'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.mfMaxRange_km=190.000000
    dbObj.mfRefRange_km=41.540001
    dbObj.mfFieldOfView_deg=60.000000
    dbObj.minElevation_deg=-90.000000
    dbObj.maxElevation_deg=30.000000
    dbObj.mfScanPeriod_s=2.130000
    dbObj.damageEffect='GenericSensor'
    dbObj.rangeError=1.000000
    dbObj.angleError_deg=0.600000
