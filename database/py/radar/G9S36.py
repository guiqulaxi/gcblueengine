...
def CreateDBObject():
    ...
    dbObj.notes='needs updating with accurate details.  Current info \'generated\' mathematically.  Range, elevations are accurate.'
