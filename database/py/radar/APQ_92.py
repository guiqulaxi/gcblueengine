...
def CreateDBObject():
    ...
    dbObj.mzClass='APQ-92'
    dbObj.natoClass='APQ-92'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='No info, just downgrading APQ-99 by 20%.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=70.000000
    dbObj.mfRefRange_km=22.135941
    ...
    dbObj.angleError_deg=0.143000
    dbObj.elevationError_deg=0.176000
