...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 517h-1'
    dbObj.natoClass='Beam Sticks'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='copied form Spoon rest, P-12.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=275.000000
    dbObj.mfRefRange_km=66.529999
    ...
    dbObj.minFrequency_Hz=300000000.000000
    dbObj.maxFrequency_Hz=400000000.000000
