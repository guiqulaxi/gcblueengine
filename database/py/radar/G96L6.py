...
def CreateDBObject():
    ...
    dbObj.notes='needs updating with accurate details.  Current info \'generated\' mathematically.  Elevation limits,max range, and scan rate are accurate.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=300.000000
    dbObj.mfRefRange_km=110.919998
