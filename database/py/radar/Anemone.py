...
def CreateDBObject():
    ...
    dbObj.mzClass='Anemone'
    dbObj.natoClass='Anemone'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.mfMaxRange_km=278.000000
    dbObj.mfRefRange_km=63.715000
    ...
    dbObj.minFrequency_Hz=8899999744.000000
    dbObj.maxFrequency_Hz=9400000512.000000
