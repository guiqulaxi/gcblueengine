...
def CreateDBObject():
    ...
    dbObj.mzClass='Mk-92 STIR Mod6'
    dbObj.natoClass='Mk-92 STIR Mod6'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='Only permits engagement of a single target at a time, this will seriously hobble the perry\'s compared tot heir current state, which is apparently overpowered, some scenarios will be more difficult to survive as a result.  broken for some damned reason.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=474.000000
    dbObj.mfRefRange_km=47.368000
