...
def CreateDBObject():
    ...
    dbObj.mzClass='MR-710 Fregat-M2'
    dbObj.natoClass='MR-710 Fregat-M2'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='higher frequency version of Top Sail(Voskhod), which is quoted capable of 5m²@200km.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=300.000000
    dbObj.mfRefRange_km=159.520004
    ...
    dbObj.angleError_deg=0.190000
    dbObj.elevationError_deg=0.120000
