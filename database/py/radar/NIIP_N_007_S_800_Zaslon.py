...
def CreateDBObject():
    ...
    dbObj.mzClass='NIIP N-007 S-800 Zaslon'
    dbObj.natoClass='NIIP N-007 S-800 Zaslon'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.mfRefRange_km=142.600006
    ...
    dbObj.ERPpeak_dBW=73.910004
    dbObj.ERPaverage_dBW=63.910000
