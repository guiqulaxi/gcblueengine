...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 967M'
    dbObj.natoClass='Type 967M'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='Due to a shortage of time, im cheating on this radar.  Duplicated the Type 967/968, and stripped the 968 functionality(SS).'
