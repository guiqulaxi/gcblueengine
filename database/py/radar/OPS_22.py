...
def CreateDBObject():
    ...
    dbObj.mzClass='OPS-22'
    dbObj.natoClass='OPS-22'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='I don\'t know anything about this radar, assuming equivalent to SPS-55, as such, copied directly.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=67.500000
    dbObj.mfRefRange_km=6.025000
