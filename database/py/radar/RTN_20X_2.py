...
def CreateDBObject():
    ...
    dbObj.mzClass='RTN-20X-2'
    dbObj.natoClass='RTN-20X-2'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Marcos  -Amram -beam is 2.2°, gain 37dB, target acquisition is usually 2-6nm, 3 arc minutes of angular accuracy, 3m range accuracy.  Jane\'s cites 15km, setting that as instrumented and ref at 6nm.  200kW power, 0.5µs pulses at 2000pps.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=15.000000
    dbObj.mfRefRange_km=11.120000
