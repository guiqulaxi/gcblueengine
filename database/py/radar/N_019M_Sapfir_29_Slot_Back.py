...
def CreateDBObject():
    ...
    dbObj.mzClass='N-019M Sapfir-29 Slot Back'
    dbObj.natoClass='N-019M Sapfir-29 Slot Back'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.mfRefRange_km=41.119999
    dbObj.mfFieldOfView_deg=134.000000
    ...
    dbObj.ERPpeak_dBW=44.110001
    dbObj.ERPaverage_dBW=34.110001
