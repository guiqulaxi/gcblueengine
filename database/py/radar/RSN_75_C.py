...
def CreateDBObject():
    ...
    dbObj.mzClass='RSN-75-C'
    dbObj.natoClass='Fan Song-C'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='needs updating with accurate details.  Current info \'generated\' mathematically.  Max range, elevation limits, scan rate are accurate'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=120.000000
    dbObj.mfRefRange_km=28.830000
    ...
    dbObj.elevationBeamwidth_deg=7.500000
