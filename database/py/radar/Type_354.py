...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 354'
    dbObj.natoClass='Type 354'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.mfMaxRange_km=198.000000
    dbObj.mfRefRange_km=62.500000
    ...
    dbObj.angleError_deg=4.300000
    dbObj.elevationError_deg=4.300000
    dbObj.minFrequency_Hz=3000000000.000000
    dbObj.maxFrequency_Hz=3500000000.000000
    dbObj.idThreshold_dB=9999.000000
    dbObj.counterMeasureFactor=1.000000
    dbObj.isSurveillance=True
    dbObj.ERPpeak_dBW=28.000000
    dbObj.ERPaverage_dBW=18.000000
