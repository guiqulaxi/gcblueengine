...
def CreateDBObject():
    ...
    dbObj.mzClass='RBE2-AA'
    dbObj.natoClass='RBE2-AA'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.mfRefRange_km=84.250000
    dbObj.mfFieldOfView_deg=160.000000
    ...
    dbObj.ERPpeak_dBW=56.509998
    dbObj.ERPaverage_dBW=46.509998
