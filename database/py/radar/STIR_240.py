...
def CreateDBObject():
    ...
    dbObj.mzClass='STIR 240'
    dbObj.natoClass='STIR 240'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.mfRefRange_km=140.000000
    ...
    dbObj.angleError_deg=0.670000
    dbObj.elevationError_deg=0.700000
    dbObj.minFrequency_Hz=3000000000.000000
    dbObj.maxFrequency_Hz=3500000000.000000
    dbObj.idThreshold_dB=9999.000000
    dbObj.counterMeasureFactor=1.000000
    dbObj.isSurveillance=True
    dbObj.ERPpeak_dBW=90.599998
    dbObj.ERPaverage_dBW=63.610001
