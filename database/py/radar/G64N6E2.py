...
def CreateDBObject():
    ...
    dbObj.mzClass='64N6E2'
    dbObj.natoClass='Big Bird'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Data needs updating.  Range and ref range are acurate.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=650.000000
    dbObj.mfRefRange_km=278.910004
    dbObj.mfFieldOfView_deg=360.000000
    dbObj.minElevation_deg=-90.000000
    dbObj.maxElevation_deg=39.000000
    dbObj.mfScanPeriod_s=11.030000
