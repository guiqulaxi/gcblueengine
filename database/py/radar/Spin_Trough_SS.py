...
def CreateDBObject():
    ...
    dbObj.mzClass='Spin Trough SS'
    dbObj.natoClass='Spin Trough SS'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
