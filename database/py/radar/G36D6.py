...
def CreateDBObject():
    ...
    dbObj.notes='needs updating with accurate details.  Current info \'generated\' mathematically. Max range, ref range, elevation limits are accurate'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=200.000000
    dbObj.mfRefRange_km=311.220001
