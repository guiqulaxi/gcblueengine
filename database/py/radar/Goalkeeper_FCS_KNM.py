...
def CreateDBObject():
    ...
    dbObj.mzClass='Goalkeeper FCS-KNM'
    dbObj.natoClass='Goalkeeper FCS-KNM'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.mfMaxRange_km=5.600000
    dbObj.mfRefRange_km=5.600000
    ...
    dbObj.ERPpeak_dBW=30.000000
    dbObj.ERPaverage_dBW=20.000000
