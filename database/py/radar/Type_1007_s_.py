...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 1007(s)'
    dbObj.natoClass='Type 1007(s)'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='Submarine Version using a considerably smaller antenna and transmitter.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=60.000000
    dbObj.mfRefRange_km=17.000000
