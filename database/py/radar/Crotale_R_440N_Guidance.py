...
def CreateDBObject():
    ...
    dbObj.mzClass='Crotale R.440N Guidance'
    dbObj.natoClass='Crotale R.440N Guidance'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.angleError_deg=2.460000
    dbObj.elevationError_deg=1.640000
    ...
    dbObj.ERPaverage_dBW=55.000000
