...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 707'
    dbObj.natoClass='Type 707'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='Chinese copy of Decca 707, possibly license produced, or purchased, but assumed not a reverse engineered set, thus identical performance.'
