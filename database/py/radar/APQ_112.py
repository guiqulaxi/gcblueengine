...
def CreateDBObject():
    ...
    dbObj.mzClass='APQ-112'
    dbObj.natoClass='APQ-112'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='No Info, uprating APQ-99 for now.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=90.000000
    dbObj.mfRefRange_km=27.257999
    ...
    dbObj.angleError_deg=0.118182
    dbObj.elevationError_deg=0.145455
