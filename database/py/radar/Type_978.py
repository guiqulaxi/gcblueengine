...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 978'
    dbObj.natoClass='Type 978'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='A direct duplication of the SPS-55, with a slight down turn in maximum range.  If anyone has better info, by all means rework this radar, i lack the time to do it properly at current.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=60.000000
    dbObj.mfRefRange_km=5.357000
