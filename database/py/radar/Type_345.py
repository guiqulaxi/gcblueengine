...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 345'
    dbObj.natoClass='Type 345'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.angleError_deg=0.064000
    dbObj.elevationError_deg=0.032000
    dbObj.minFrequency_Hz=3000000000.000000
    dbObj.maxFrequency_Hz=3500000000.000000
    dbObj.idThreshold_dB=9999.000000
    dbObj.counterMeasureFactor=1.000000
    dbObj.isSurveillance=False
    dbObj.ERPpeak_dBW=63.000000
    dbObj.ERPaverage_dBW=53.000000
