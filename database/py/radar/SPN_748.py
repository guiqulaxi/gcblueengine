...
def CreateDBObject():
    ...
    dbObj.mzClass='SPN-748'
    dbObj.natoClass='SPN-748'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Just copied furuno'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=86.400002
    dbObj.mfRefRange_km=4.286000
    ...
    dbObj.ERPpeak_dBW=44.290001
    dbObj.ERPaverage_dBW=34.290001
