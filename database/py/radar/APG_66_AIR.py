...
def CreateDBObject():
    ...
    dbObj.mzClass='APG-66 AIR'
    dbObj.natoClass='APG-66 AIR'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.mfMaxRange_km=140.000000
    dbObj.mfRefRange_km=40.000000
