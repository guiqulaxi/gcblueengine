...
def CreateDBObject():
    ...
    dbObj.mzClass='Command Guidance V-750 Seeker'
    dbObj.natoClass='Command Guidance V-750 Seeker'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='going to render this ineffective and useless as a radar, to test command Guidance.  Original values were:rax range=70,ref=124.5,scan period=2,detects air, detects missile.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=70.000000
    dbObj.mfRefRange_km=124.500000
    dbObj.mfFieldOfView_deg=360.000000
    dbObj.minElevation_deg=-180.000000
