...
def CreateDBObject():
    ...
    dbObj.mzClass='AEW radar 2'
    dbObj.natoClass='AEW radar 2'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='Radar aligned for detection of a 5000m²(37 RCS dBsm) target at maximum range.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=550.000000
    dbObj.mfRefRange_km=28.013000
