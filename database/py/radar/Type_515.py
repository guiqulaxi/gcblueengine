...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 515'
    dbObj.natoClass='Pea Sticks'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Copied from Knife Rest, P-8'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=200.000000
    dbObj.mfRefRange_km=47.669998
    dbObj.mfFieldOfView_deg=360.000000
    dbObj.minElevation_deg=-90.000000
    dbObj.maxElevation_deg=29.430000
    dbObj.mfScanPeriod_s=9.000000
