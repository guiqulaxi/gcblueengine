...
def CreateDBObject():
    ...
    dbObj.mzClass='Fighter radar'
    dbObj.natoClass='Fighter radar'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.mfMaxRange_km=130.000000
    dbObj.mfRefRange_km=36.000000
    ...
    dbObj.angleError_deg=0.530000
    dbObj.elevationError_deg=0.350000
