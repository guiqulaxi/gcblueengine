...
def CreateDBObject():
    ...
    dbObj.mzClass='Decca TM 626'
    dbObj.natoClass='Decca TM 626'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='Assuming roughly 50% the capabilities of the Decca 1229.  '
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=46.299999
    dbObj.mfRefRange_km=3.625000
