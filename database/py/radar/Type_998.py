...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 998'
    dbObj.natoClass='Type 998'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.lookdownLand_dB=-36.130001
