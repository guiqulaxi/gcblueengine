...
def CreateDBObject():
    ...
    dbObj.mzClass='MPQ-35'
    dbObj.natoClass='MPQ-35'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='needs updating with accurate details.  Current info \'generated\' mathematically.  Output less than half of MPQ-50, decreases ref_range accordingly, estimate decrease at 22.095%.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=110.000000
    dbObj.mfRefRange_km=61.549999
