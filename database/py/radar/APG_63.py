...
def CreateDBObject():
    ...
    dbObj.mzClass='APG-63'
    dbObj.natoClass='APG-63'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Copied APG-70.  As APG-70 is essentially reliability improvements in MTBF and MTTR, i have left it functionally identical.'
