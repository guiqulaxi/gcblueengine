...
def CreateDBObject():
    ...
    dbObj.mzClass='SPS-48(E) AS'
    dbObj.natoClass='SPS-48(E) AS'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.mfMaxRange_km=408.000000
    dbObj.mfRefRange_km=272.850006
    ...
    dbObj.ERPpeak_dBW=49.730000
    dbObj.ERPaverage_dBW=39.730000
