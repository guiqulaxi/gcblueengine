...
def CreateDBObject():
    ...
    dbObj.notes='100 km detection range on 12 dBsm target http://www.acig.org/artman/publish/article_295.shtml'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=150.000000
    dbObj.mfRefRange_km=50.000000
