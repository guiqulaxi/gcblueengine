...
def CreateDBObject():
    ...
    dbObj.mzClass='Head Lights FC'
    dbObj.natoClass='Head Lights FC'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='Naval Institute Guide to Soviet Navy indicates 74 km range. Assuming 74 km range vs 10 dBsm target (42 km ref range). G/H bands'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=150.000000
    dbObj.mfRefRange_km=42.000000
    ...
    dbObj.lookdownLand_dB=-25.000000
