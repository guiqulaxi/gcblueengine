...
def CreateDBObject():
    ...
    dbObj.mzClass='Uspekh 1A'
    dbObj.natoClass='Big Bulge'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='credited with a maximum range of 225nm, also assumed to be superior in gain to the Uspekh-2, which is a smaller system mounted below a Ka-25 hormone.  Boosting Ref range by 10%'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=417.000000
    dbObj.mfRefRange_km=9.428000
    ...
    dbObj.elevationError_deg=0.470000
