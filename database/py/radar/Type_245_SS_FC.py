...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 245 SS/FC'
    dbObj.natoClass='Type 245 SS/FC'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='Surface search radar for H-6D bomber'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=220.000000
    dbObj.mfRefRange_km=26.112000
