...
def CreateDBObject():
    ...
    dbObj.mzClass='RP-22 Sapfir'
    dbObj.natoClass='RP-22 Sapfir'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.mfMaxRange_km=42.000000
    dbObj.mfRefRange_km=13.000000
    dbObj.mfFieldOfView_deg=60.000000
    dbObj.minElevation_deg=-90.000000
    dbObj.maxElevation_deg=20.000000
    dbObj.mfScanPeriod_s=3.500000
    ...
    dbObj.ERPpeak_dBW=69.000000
    dbObj.ERPaverage_dBW=59.000000
