...
def CreateDBObject():
    ...
    dbObj.mzClass='MR-750 Fregat M2EM'
    dbObj.natoClass='MR-750 Fregat M2EM'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.notes='Range on a fighter is 230km, assuming 5m² target.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=565.000000
    dbObj.mfRefRange_km=153.809998
    ...
    dbObj.ERPpeak_dBW=61.000000
    dbObj.ERPaverage_dBW=51.000000
