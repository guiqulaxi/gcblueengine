...
def CreateDBObject():
    ...
    dbObj.mzClass='P-500 Seeker'
    dbObj.natoClass='SS-N-12 Seeker'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=1.000000
    ...
    dbObj.mfRefRange_km=2.143000
    dbObj.mfFieldOfView_deg=30.000000
    dbObj.minElevation_deg=-90.000000
    dbObj.maxElevation_deg=40.000000
    dbObj.mfScanPeriod_s=3.000000
    dbObj.damageEffect='GenericSensor'
    dbObj.rangeError=999.000000
    dbObj.angleError_deg=999.000000
    dbObj.elevationError_deg=999.000000
