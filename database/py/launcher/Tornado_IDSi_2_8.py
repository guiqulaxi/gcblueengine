...
def CreateDBObject():
    ...
    dbObj.mzClass='Tornado IDSi 2-8'
    dbObj.natoClass=''
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.childClassList=['330 gallon wing tank','AGM-65D','AGM-88B','AS.34 Kormoran','AS.34 Kormoran II','Storm Shadow','Mk-81','Mk-82','Mk-83']
