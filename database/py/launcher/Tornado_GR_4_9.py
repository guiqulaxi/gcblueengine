...
def CreateDBObject():
    ...
    dbObj.childClassList=['Flare-1','Chaff-1','330 gallon wing tank','AIM-9L','AIM-9M','ASRAAM','AIM-132 ASRAAM','Mk-81','Mk-82','Mk-83','GB-200','GB-500']
