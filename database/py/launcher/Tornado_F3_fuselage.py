...
def CreateDBObject():
    ...
    dbObj.mzClass='Tornado F3 fuselage'
    dbObj.natoClass=''
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.childClassList=['Skyflash','Skyflash SuperTEMP','330 gallon wing tank','AIM-7F','AIM-7M','AIM-7P','ASPIDE-1A']
    dbObj.childCapacityList=[4,4,2,4,4,4,4]
