...
def CreateDBObject():
    ...
    dbObj.mzClass='Hedgehog'
    dbObj.natoClass='Hedgehog'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=696.000000
    ...
    dbObj.payloadClass='RBU-Hedgehog'
    dbObj.payloadQuantity=8
    dbObj.datalinkRange_km=0.000000
    dbObj.acceptsUserCommands=False
    dbObj.detonationRange_m=153.000000
