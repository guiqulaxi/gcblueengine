...
def CreateDBObject():
    ...
    dbObj.childClassList=['AIM-132 ASRAAM','AIM-7*','AIM-7M','AIM-9*','AIM-9M','AIM-9N','AIM-9P','AIM-9X','GBU-12/B','GBU-16/B','GBU-28B/B','Mk-81','Mk-82','Mk-83','Mk-84']
    dbObj.childCapacityList=[2,2,2,2,2,2,2,2,2,2,2,6,6,4,2]
