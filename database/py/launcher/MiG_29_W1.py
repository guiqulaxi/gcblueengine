...
def CreateDBObject():
    ...
    dbObj.childClassList=['FAB-100','FAB-250','FAB-500','R-27R','R-27T','R-60M','R-60MK','R-73','R-73M','R-73M2']
    dbObj.childCapacityList=[6,4,2,2,2,2,2,2,2,2]
