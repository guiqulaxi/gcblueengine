...
def CreateDBObject():
    ...
    dbObj.mzClass='Tornado IDS fuselage fwd/aft'
    dbObj.natoClass=''
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.childClassList=['AGM-65D','AGM-88B','AS.34 Kormoran','AS.34 Kormoran II','Taurus KEPD 350P','GBU-10/B','GBU-15/B','GBU-16/B','GBU-24/B','GBU-24B/B','Mk-81','Mk-82','Mk-83','Mk-84']
