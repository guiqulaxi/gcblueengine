...
def CreateDBObject():
    ...
    dbObj.mzClass='MiG-21-93 OuterPylon'
    dbObj.natoClass=''
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.childClassList=['FAB-100','FAB-250','FAB-500','KAB-500Kr','Kh-25MP','Kh-31P','Kh-66','PTB-400','PTB-490','R-27RE','R-27TE','R-3*','R-60','R-60M','R-73','R-77','S-24B 240mm','S-5K 57mm','S-5K Rocket','S-5M Rocket']
