...
def CreateDBObject():
    ...
    dbObj.childClassList=['1150 Liter Tank','FAB-100','FAB-250','FAB-500','KAB-500KRU','KAB-500Kr','KAB-500R','R-27R','R-27RE','R-27T','R-27TE','R-60M','R-60MK','R-73','R-73M','R-73M2','R-77','R-77PL','R-77T']
    dbObj.childCapacityList=[2,6,6,4,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2]
