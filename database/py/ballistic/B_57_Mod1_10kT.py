...
def CreateDBObject():
    ...
    dbObj.mzClass='B-57 Mod1 10kT'
    dbObj.natoClass='B-57 Mod1 10kT'
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoB-57_10KT.jpg'
    ...
    dbObj.damageModel='Nuclear-10kT'
    ...
    dbObj.detonationRange_m=179.000000
