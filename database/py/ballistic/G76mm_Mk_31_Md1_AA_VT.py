...
def CreateDBObject():
    ...
    dbObj.mzClass='76mm Mk 31 Md1 AA VT'
    dbObj.natoClass='76mm Mk 31 Md1 AA VT'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=5.900000
    ...
    dbObj.damageModel='BlastFrag0.3kg'
    dbObj.damageEffect='ToughWeapon'
    dbObj.launchSpeed_mps=823.000000
    dbObj.targetFlags=10
    dbObj.minLaunchAlt_m=0.000000
    dbObj.maxLaunchAlt_m=99999.000000
    dbObj.minRange_km=0.200000
    dbObj.maxRange_km=13.350000
