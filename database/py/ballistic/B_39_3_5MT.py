...
def CreateDBObject():
    ...
    dbObj.mzClass='B-39 3.5MT'
    dbObj.natoClass='B-39 3.5MT'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=4038.000000
    dbObj.weight_kg=3040.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoB-39_3.5MT.jpg'
    ...
    dbObj.damageModel='Nuclear-3500kT'
    ...
    dbObj.detonationRange_m=430.000000
