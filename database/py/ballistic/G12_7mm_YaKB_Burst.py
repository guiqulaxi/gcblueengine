...
def CreateDBObject():
    ...
    dbObj.mzClass='12.7mm YaKB Burst'
    dbObj.natoClass='12.7mm YaKB Burst'
    ...
    dbObj.notes='4500 rpm 25 round bursthttp://www.fas.org/man/dod-101/sys/ac/row/mi-24.htm'
    ...
    dbObj.launchSpeed_mps=850.000000
    dbObj.targetFlags=7
    ...
    dbObj.burstCount=25
    dbObj.burstDuration_s=0.330000
