...
def CreateDBObject():
    ...
    dbObj.mzClass='S-25C 266mm'
    dbObj.natoClass='S-25C 266mm'
    dbObj.mnModelType=24
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=385.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoS-25C.jpg'
    ...
    dbObj.damageModel='Blast150kg'
    dbObj.damageEffect='ToughWeapon'
    dbObj.launchSpeed_mps=540.000000
    dbObj.targetFlags=5
