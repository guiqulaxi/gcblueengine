...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 4 1kT'
    dbObj.natoClass='Mark 4 1kT'
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 4_1KT.jpg'
    ...
    dbObj.detonationRange_m=126.000000
