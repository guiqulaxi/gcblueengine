...
def CreateDBObject():
    ...
    dbObj.mzClass='125mm 3VBM19 APFSDS'
    dbObj.natoClass='125mm 3VBM19 APFSDS'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=18.900000
    ...
    dbObj.damageModel='SolidPen0.9kg'
    dbObj.damageEffect='ToughWeapon'
    dbObj.launchSpeed_mps=1760.000000
    dbObj.targetFlags=5
