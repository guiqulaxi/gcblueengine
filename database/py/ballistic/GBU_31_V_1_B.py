...
def CreateDBObject():
    ...
    dbObj.mzClass='GBU-31(V)1/B'
    dbObj.natoClass='GBU-31(V)1/B'
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoGBU-31A.jpg'
    dbObj.mz3DModelFileName='mk-84.xml'
    dbObj.notes='modeling this as the GPS/INS guidance version, not the dual-mode version that can do either laser guidance or GPS guidance.  Uses mk-84 as its payload.'
