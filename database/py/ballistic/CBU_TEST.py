...
def CreateDBObject():
    ...
    dbObj.mzClass='CBU-TEST'
    dbObj.natoClass='CBU-TEST'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=3100.000000
    dbObj.weight_kg=925.000000
    ...
    dbObj.notes='DetonationRange_m is altitude AGL that payload is released. Max of 10 for payload quantity'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfDamage=1000.000000
    dbObj.damageModel='Blast10kg'
    ...
    dbObj.clusterCount=200
    dbObj.clusterEffectRadius_m=100.000000
    dbObj.sensorClass=''
