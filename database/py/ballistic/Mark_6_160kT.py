...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 6 160kT'
    dbObj.natoClass='Mark 6 160kT'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=4038.000000
    dbObj.weight_kg=3651.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 6_160KT.jpg'
    ...
    dbObj.damageModel='Nuclear-160kT'
    ...
    dbObj.detonationRange_m=271.000000
