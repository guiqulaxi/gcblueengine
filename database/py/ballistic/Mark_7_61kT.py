...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 7 61kT'
    dbObj.natoClass='Mark 7 61kT'
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 7_61KT.jpg'
    ...
    dbObj.damageModel='Nuclear-62.5kT'
    ...
    dbObj.detonationRange_m=235.000000
