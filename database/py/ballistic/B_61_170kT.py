...
def CreateDBObject():
    ...
    dbObj.mzClass='B-61 170kT'
    dbObj.natoClass='B-61 170kT'
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoB-61_170KT.jpg'
    ...
    dbObj.damageModel='Nuclear-170kT'
    ...
    dbObj.detonationRange_m=273.000000
