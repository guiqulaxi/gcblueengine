...
def CreateDBObject():
    ...
    dbObj.mzClass='120mm M829A2 APFSDS'
    dbObj.natoClass='120mm M829A2 APFSDS'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=18.600000
    ...
    dbObj.launchSpeed_mps=1750.000000
    dbObj.targetFlags=5
