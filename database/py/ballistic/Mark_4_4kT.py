...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 4 4kT'
    dbObj.natoClass='Mark 4 4kT'
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 4_4KT.jpg'
    ...
    dbObj.detonationRange_m=156.000000
