...
def CreateDBObject():
    ...
    dbObj.mzClass='5in FFAR'
    dbObj.natoClass='5in FFAR'
    dbObj.mnModelType=24
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=36.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/ico5IN5FFAR.jpg'
    ...
    dbObj.launchSpeed_mps=217.000000
    dbObj.targetFlags=5
    dbObj.minLaunchAlt_m=0.000000
    dbObj.maxLaunchAlt_m=2000.000000
    dbObj.minRange_km=0.200000
    dbObj.maxRange_km=1.550000
