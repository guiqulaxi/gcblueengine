...
def CreateDBObject():
    ...
    dbObj.mzClass='20mm F2'
    dbObj.natoClass='20mm F2'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=0.108000
    ...
    dbObj.notes='altered to match the alignment of the other weapons.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfDamage=0.280000
    ...
    dbObj.angleError_rad=0.001980
    dbObj.burstCount=3
    dbObj.burstDuration_s=0.225000
