...
def CreateDBObject():
    ...
    dbObj.mzClass='.50 cal bullet air(x2)'
    dbObj.natoClass='.50 cal bullet air(x2)'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=0.060000
    ...
    dbObj.damageModel='SolidPen0.6kg'
    ...
    dbObj.burstCount=2
    dbObj.burstDuration_s=0.300000
