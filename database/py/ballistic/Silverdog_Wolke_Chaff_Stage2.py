...
def CreateDBObject():
    ...
    dbObj.mzClass='Silverdog/Wolke Chaff Stage2'
    dbObj.natoClass='Silverdog/Wolke Chaff Stage2'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=3.100000
    ...
    dbObj.payloadClass='Silverdog/Wolke Chaff Strips'
    dbObj.payloadQuantity=1
    dbObj.datalinkRange_km=0.000000
    dbObj.acceptsUserCommands=False
    dbObj.detonationRange_m=1000.000000
    dbObj.ballisticType=0
    dbObj.angleError_rad=1.000000
    dbObj.burstCount=1
