...
def CreateDBObject():
    ...
    dbObj.mzClass='57mm HCER'
    dbObj.natoClass='57mm HCER'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=2.800000
