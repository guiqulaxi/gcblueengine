...
def CreateDBObject():
    ...
    dbObj.mzClass='20mm HEI Percussion'
    dbObj.natoClass='20mm HEI Percussion'
    ...
    dbObj.mfDamage=0.200000
    dbObj.damageModel='SolidProjectile'
    dbObj.damageEffect='ToughWeapon'
    dbObj.launchSpeed_mps=817.000000
    dbObj.targetFlags=7
    ...
    dbObj.burstCount=4
    dbObj.burstDuration_s=0.282350
