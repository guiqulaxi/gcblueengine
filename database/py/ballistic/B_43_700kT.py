...
def CreateDBObject():
    ...
    dbObj.mzClass='B-43 700kT'
    dbObj.natoClass='B-43 700kT'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=4038.000000
    dbObj.weight_kg=948.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoB-43_700KT.jpg'
    ...
    dbObj.damageModel='Nuclear-700kT'
    ...
    dbObj.detonationRange_m=338.000000
