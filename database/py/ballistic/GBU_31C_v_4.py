...
def CreateDBObject():
    ...
    dbObj.mzClass='GBU-31C(v)4'
    dbObj.natoClass='GBU-31C(v)4'
    dbObj.mnModelType=21
    dbObj.mnType=512
    dbObj.cost=20000.000000
    dbObj.weight_kg=981.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoGBU-31C.jpg'
    dbObj.mz3DModelFileName='mk-84.xml'
    dbObj.notes='modeling this as the GPS/INS guidance version, not the dual-mode version that can do either laser guidance or GPS guidance.  Uses BLU-109/B as its payload.'
