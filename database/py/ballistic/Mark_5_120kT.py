...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 5 120kT'
    dbObj.natoClass='Mark 5 120kT'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=4038.000000
    dbObj.weight_kg=1406.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 5_120KT.jpg'
    ...
    dbObj.damageModel='Nuclear-120kT'
    ...
    dbObj.detonationRange_m=259.000000
