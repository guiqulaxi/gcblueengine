...
def CreateDBObject():
    ...
    dbObj.mzClass='Chaff-Round-1'
    dbObj.natoClass='Chaff-Round-1'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=0.020000
    ...
    dbObj.launchSpeed_mps=200.000000
    ...
    dbObj.payloadClass='Chaff-2'
    dbObj.payloadQuantity=1
    dbObj.datalinkRange_km=0.000000
    dbObj.acceptsUserCommands=False
    dbObj.detonationRange_m=0.000000
    dbObj.ballisticType=4
    dbObj.angleError_rad=0.001810
    dbObj.burstCount=1
