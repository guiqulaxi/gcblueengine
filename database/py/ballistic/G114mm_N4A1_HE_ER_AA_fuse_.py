...
def CreateDBObject():
    ...
    dbObj.mzClass='114mm N4A1 HE-ER(AA fuse)'
    dbObj.natoClass='114mm N4A1 HE-ER(AA fuse)'
    ...
    dbObj.mfDamage=16.639999
    dbObj.damageModel='Blast3kg'
    dbObj.damageEffect='ToughWeapon'
    dbObj.launchSpeed_mps=869.000000
    dbObj.targetFlags=5
    dbObj.minLaunchAlt_m=0.000000
    dbObj.maxLaunchAlt_m=99999.000000
    dbObj.minRange_km=0.200000
    dbObj.maxRange_km=27.500000
