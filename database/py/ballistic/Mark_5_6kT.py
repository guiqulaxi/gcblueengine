...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 5 6kT'
    dbObj.natoClass='Mark 5 6kT'
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 5_6KT.jpg'
    ...
    dbObj.detonationRange_m=165.000000
