...
def CreateDBObject():
    ...
    dbObj.mzClass='57mm Type 59 HE-T'
    dbObj.natoClass='57mm Type 59 HE-T'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=2.400000
    ...
    dbObj.burstCount=1
    dbObj.burstDuration_s=0.352941
