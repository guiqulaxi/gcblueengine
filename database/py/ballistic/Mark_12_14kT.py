...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 12 14kT'
    dbObj.natoClass='Mark 12 14kT'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=4038.000000
    dbObj.weight_kg=522.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 12_14KT.jpg'
    ...
    dbObj.damageModel='Nuclear-14kT'
    ...
    dbObj.detonationRange_m=188.000000
