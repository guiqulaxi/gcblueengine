...
def CreateDBObject():
    ...
    dbObj.mzClass='Gen105AT'
    dbObj.natoClass='Gen105AT'
    ...
    dbObj.notes='maximum range is 8975m, but maximum combat effective is 1500m.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfDamage=0.000000
    dbObj.damageModel='SolidPen0.95kg'
    dbObj.damageEffect='ToughWeapon'
    dbObj.launchSpeed_mps=1173.500000
    dbObj.targetFlags=5
