...
def CreateDBObject():
    ...
    dbObj.mzClass='76mm HE-MOM'
    dbObj.natoClass='76mm HE-MOM'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=6.300000
