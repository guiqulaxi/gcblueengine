...
def CreateDBObject():
    ...
    dbObj.mzClass='45mm F-75 HE'
    dbObj.natoClass='45mm F-75 HE'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=1.400000
