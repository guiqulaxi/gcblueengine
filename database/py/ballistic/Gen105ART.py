...
def CreateDBObject():
    ...
    dbObj.mzClass='Gen105ART'
    dbObj.natoClass='Gen105ART'
    ...
    dbObj.damageModel='Blast3.5kg'
    dbObj.damageEffect='ToughWeapon'
    dbObj.launchSpeed_mps=645.000000
    dbObj.targetFlags=5
    dbObj.minLaunchAlt_m=0.000000
    dbObj.maxLaunchAlt_m=99999.000000
    dbObj.minRange_km=0.000000
    dbObj.maxRange_km=14.500000
