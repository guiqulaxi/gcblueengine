...
def CreateDBObject():
    ...
    dbObj.mzClass='100mm OF-55 FRAG'
    dbObj.natoClass='100mm OF-55 FRAG'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=15.600000
    ...
    dbObj.damageModel='BlastFrag1.2kg'
    dbObj.damageEffect='ToughWeapon'
    dbObj.launchSpeed_mps=1000.000000
    dbObj.targetFlags=5
    dbObj.minLaunchAlt_m=0.000000
    dbObj.maxLaunchAlt_m=99999.000000
    dbObj.minRange_km=0.200000
    dbObj.maxRange_km=24.200001
