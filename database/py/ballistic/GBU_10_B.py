...
def CreateDBObject():
    ...
    dbObj.mzClass='GBU-10/B'
    dbObj.natoClass='GBU-10/B'
    dbObj.mnModelType=21
    dbObj.mnType=512
    dbObj.cost=25000.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoGBU-10.jpg'
    dbObj.mz3DModelFileName='mk-84.xml'
    dbObj.notes='Lofting isn\'t modeled so can\'t only use glide slope as range restriction for now. Range 8 NM according to FAS. Need laser designator on attacking aircraft for this to work.  Uses mk-84 as its payload'
