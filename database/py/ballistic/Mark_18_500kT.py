...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 18 500kT'
    dbObj.natoClass='Mark 18 500kT'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=4038.000000
    dbObj.weight_kg=24000.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 18_500KT.jpg'
    ...
    dbObj.damageModel='Nuclear-13500kT'
