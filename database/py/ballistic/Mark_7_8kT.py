...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 7 8kT'
    dbObj.natoClass='Mark 7 8kT'
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 7_8KT.jpg'
    ...
    dbObj.detonationRange_m=173.000000
