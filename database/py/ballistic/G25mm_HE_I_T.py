...
def CreateDBObject():
    ...
    dbObj.mzClass='25mm HE-I-T'
    dbObj.natoClass='25mm HE-I-T'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=0.281000
