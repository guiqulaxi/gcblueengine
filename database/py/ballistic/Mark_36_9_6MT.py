...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 36 9.6MT'
    dbObj.natoClass='Mark 36 9.6MT'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=4038.000000
    dbObj.weight_kg=7980.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 36_9.6MT.jpg'
    ...
    dbObj.damageModel='Nuclear-9600kT'
