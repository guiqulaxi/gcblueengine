...
def CreateDBObject():
    ...
    dbObj.mzClass='30mm APDS'
    dbObj.natoClass='30mm APDS'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=0.300000
    ...
    dbObj.mfDamage=0.390000
    dbObj.damageModel='SolidProjectile'
    dbObj.damageEffect='ToughWeapon'
    dbObj.launchSpeed_mps=1175.000000
    dbObj.targetFlags=13
