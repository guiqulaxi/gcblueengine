...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 6 26kT'
    dbObj.natoClass='Mark 6 26kT'
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 6_26KT.jpg'
    ...
    dbObj.damageModel='Nuclear-26kT'
    ...
    dbObj.detonationRange_m=206.000000
