...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 5 55kT'
    dbObj.natoClass='Mark 5 55kT'
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 5_55KT.jpg'
    ...
    dbObj.damageModel='Nuclear-55kT'
    ...
    dbObj.detonationRange_m=231.000000
