...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 15 Mod1 1.69MT'
    dbObj.natoClass='Mark 15 Mod1 1.69MT'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=4038.000000
    dbObj.weight_kg=3450.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 15_1.69MT.jpg'
    dbObj.mz3DModelFileName='mk-84.xml'
    dbObj.notes='http://www.joebaugher.com/usattack/newa2_4.html'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfDamage=1000.000000
    dbObj.damageModel='Nuclear-1700kT'
    ...
    dbObj.detonationRange_m=475.000000
