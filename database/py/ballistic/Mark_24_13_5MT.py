...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 24 13.5MT'
    dbObj.natoClass='Mark 24 13.5MT'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=4038.000000
    dbObj.weight_kg=7416.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 24_13.5MT.jpg'
    ...
    dbObj.damageModel='Nuclear-4500kT'
    ...
    dbObj.detonationRange_m=447.000000
