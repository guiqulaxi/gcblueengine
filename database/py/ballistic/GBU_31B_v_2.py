...
def CreateDBObject():
    ...
    dbObj.mzClass='GBU-31B(v)2'
    dbObj.natoClass='GBU-31B(v)2'
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoGBU-31B.jpg'
    dbObj.mz3DModelFileName='mk-84.xml'
    dbObj.notes='modeling this as the GPS/INS guidance version, not the dual-mode version that can do either laser guidance or GPS guidance.  Uses BLU-116/B as its payload.'
