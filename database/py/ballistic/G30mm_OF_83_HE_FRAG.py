...
def CreateDBObject():
    ...
    dbObj.mzClass='30mm OF-83 HE-FRAG'
    dbObj.natoClass='30mm OF-83 HE-FRAG'
    ...
    dbObj.mfDamage=20.559999
    dbObj.damageModel='BlastFrag0.1kg'
    dbObj.damageEffect='ToughWeapon'
    dbObj.launchSpeed_mps=1060.000000
    ...
    dbObj.detonationRange_m=0.500000
    dbObj.ballisticType=0
    dbObj.angleError_rad=0.015000
    dbObj.burstCount=4
