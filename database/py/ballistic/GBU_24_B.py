...
def CreateDBObject():
    ...
    dbObj.mzClass='GBU-24/B'
    dbObj.natoClass='GBU-24/B'
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoGBU-24.jpg'
    dbObj.mz3DModelFileName='mk-84.xml'
    dbObj.notes='Need laser designator on attacking aircraft for this to work.  Uses mk-84 as its payload.'
