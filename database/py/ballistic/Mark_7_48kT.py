...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 7 48kT'
    dbObj.natoClass='Mark 7 48kT'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=4038.000000
    dbObj.weight_kg=764.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 7_48KT.jpg'
    ...
    dbObj.damageModel='Nuclear-47.5kT'
    ...
    dbObj.detonationRange_m=226.000000
