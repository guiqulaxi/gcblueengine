...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 4 30kT'
    dbObj.natoClass='Mark 4 30kT'
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 4_30KT.jpg'
    ...
    dbObj.damageModel='Nuclear-30kT'
    ...
    dbObj.detonationRange_m=211.000000
