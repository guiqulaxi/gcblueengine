...
def CreateDBObject():
    ...
    dbObj.mzClass='S-24B 240mm'
    dbObj.natoClass='S-24B 240mm'
    dbObj.mnModelType=24
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=232.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoS-24B.jpg'
    ...
    dbObj.damageModel='Pen125kg'
    dbObj.damageEffect='ToughWeapon'
    dbObj.launchSpeed_mps=410.000000
    dbObj.targetFlags=5
