...
def CreateDBObject():
    ...
    dbObj.mzClass='152mm HE OF-35'
    dbObj.natoClass='152mm HE OF-35'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=55.000000
    ...
    dbObj.mfDamage=27.900000
    dbObj.damageModel='BlastFrag6kg'
    dbObj.damageEffect='ToughWeapon'
    dbObj.launchSpeed_mps=950.000000
    dbObj.targetFlags=5
    dbObj.minLaunchAlt_m=0.000000
    dbObj.maxLaunchAlt_m=99999.000000
    dbObj.minRange_km=0.200000
    dbObj.maxRange_km=30.125000
