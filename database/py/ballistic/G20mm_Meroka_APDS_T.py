...
def CreateDBObject():
    ...
    dbObj.mzClass='20mm Meroka APDS-T'
    dbObj.natoClass='20mm Meroka APDS-T'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=0.075000
    ...
    dbObj.mfDamage=0.490000
    dbObj.damageModel='SolidProjectile'
    dbObj.damageEffect='ToughWeapon'
    dbObj.launchSpeed_mps=1290.000000
