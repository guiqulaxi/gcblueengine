...
def CreateDBObject():
    ...
    dbObj.mzClass='B-53 2.5MT'
    dbObj.natoClass='B-53 2.5MT'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=4038.000000
    dbObj.weight_kg=4015.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoB-53_2.5MT.jpg'
    ...
    dbObj.damageModel='Nuclear-2500kT'
    ...
    dbObj.detonationRange_m=409.000000
