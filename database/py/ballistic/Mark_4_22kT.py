...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 4 22kT'
    dbObj.natoClass='Mark 4 22kT'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=4038.000000
    dbObj.weight_kg=4900.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 4_22KT.jpg'
    ...
    dbObj.damageModel='Nuclear-22kT'
    ...
    dbObj.detonationRange_m=201.000000
