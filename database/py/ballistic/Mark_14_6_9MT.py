...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 14 6.9MT'
    dbObj.natoClass='Mark 14 6.9MT'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=4038.000000
    dbObj.weight_kg=13380.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1954.000000
    dbObj.finalYear=1954.000000
    dbObj.country=''
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 14_6.9MT.jpg'
    ...
    dbObj.damageModel='Nuclear-6800kT'
