...
def CreateDBObject():
    ...
    dbObj.mzClass='75mm AA'
    dbObj.natoClass='75mm AA'
    ...
    dbObj.mfDamage=3.680000
    dbObj.damageModel='BlastFrag1kg'
    dbObj.damageEffect='ToughWeapon'
    dbObj.launchSpeed_mps=980.000000
    dbObj.targetFlags=7
    dbObj.minLaunchAlt_m=0.000000
    dbObj.maxLaunchAlt_m=99999.000000
    dbObj.minRange_km=0.200000
    dbObj.maxRange_km=13.500000
