...
def CreateDBObject():
    ...
    dbObj.mzClass='Mk-40 FFAR'
    dbObj.natoClass='Mk-40 FFAR'
    dbObj.mnModelType=24
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=6.200000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1940.000000
    dbObj.finalYear=2999.000000
    dbObj.country=''
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMK-40FFAR40.jpg'
    ...
    dbObj.damageModel='Blast1.5kg'
    dbObj.damageEffect='ToughWeapon'
    dbObj.launchSpeed_mps=739.000000
    dbObj.targetFlags=5
