...
def CreateDBObject():
    ...
    dbObj.mzClass='B-43 70kT'
    dbObj.natoClass='B-43 70kT'
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoB-43_70KT.jpg'
    ...
    dbObj.damageModel='Nuclear-70kT'
    ...
    dbObj.detonationRange_m=239.000000
