...
def CreateDBObject():
    ...
    dbObj.mzClass='S-3K 160mm'
    dbObj.natoClass='S-3K 160mm'
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoS-3K.jpg'
    ...
    dbObj.damageModel='Pen7kg'
    dbObj.damageEffect='ToughWeapon'
    dbObj.launchSpeed_mps=370.000000
    dbObj.targetFlags=5
