...
def CreateDBObject():
    ...
    dbObj.mzClass='B-53 1MT'
    dbObj.natoClass='B-53 1MT'
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoB-53_1MT.jpg'
    ...
    dbObj.damageModel='Nuclear-1000kT'
    ...
    dbObj.detonationRange_m=357.000000
