...
def CreateDBObject():
    ...
    dbObj.mzClass='Mark 5 60kT'
    dbObj.natoClass='Mark 5 60kT'
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoMARK 5_60KT.jpg'
    ...
    dbObj.damageModel='Nuclear-60kT'
    ...
    dbObj.detonationRange_m=234.000000
