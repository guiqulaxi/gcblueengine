...
def CreateDBObject():
    ...
    dbObj.mzClass='20mm HS.404'
    dbObj.natoClass='20mm HS.404'
    dbObj.mnModelType=14
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=0.130000
    ...
    dbObj.angleError_rad=0.001880
    dbObj.burstCount=3
    dbObj.burstDuration_s=0.257143
