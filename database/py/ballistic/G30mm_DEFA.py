...
def CreateDBObject():
    ...
    dbObj.mzClass='30mm DEFA'
    dbObj.natoClass='30mm DEFA'
    ...
    dbObj.notes='No data just copied 30mm OP-84 FRAG Tracer AK-306  30mm OP-84 FRAG Tracer AK-306 - Range 4km - Damage 19.61 - ETA 5 Seconds'
    ...
    dbObj.launchSpeed_mps=815.000000
    ...
    dbObj.burstCount=5
    dbObj.burstDuration_s=0.230700
