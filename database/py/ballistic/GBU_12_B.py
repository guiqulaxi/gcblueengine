...
def CreateDBObject():
    ...
    dbObj.mzClass='GBU-12/B'
    dbObj.natoClass='GBU-12/B'
    dbObj.mnModelType=21
    dbObj.mnType=512
    dbObj.cost=0.000000
    dbObj.weight_kg=275.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='ball/icoGBU-12.jpg'
    dbObj.mz3DModelFileName='mk-84.xml'
    dbObj.notes='Need laser designator on attacking aircraft for this to work.  Uses MK-82 as its payload.'
