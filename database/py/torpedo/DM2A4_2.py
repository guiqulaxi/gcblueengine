...
def CreateDBObject():
    ...
    dbObj.mzClass='DM2A4.2'
    dbObj.natoClass='DM2A4.2'
    dbObj.mnModelType=9
    dbObj.mnType=130
    dbObj.cost=750000.000000
    dbObj.weight_kg=953.799988
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='torp/icoDM2A4.2.jpg'
    dbObj.mz3DModelFileName='mk-46.xml'
    dbObj.notes='This is the small size model, with 2 batteries.  weight is assumed(see DM2A4.3).  Depth is assumed(see DM2A4.4).'
    ...
    dbObj.battery_kJ=1531.000000
    dbObj.batteryRate_kW=1.000000
    dbObj.maxSpeed_kts=42.000000
    dbObj.acceleration_ktsps=9.000000
    dbObj.sonarClass='DM2A4 Seeker'
    dbObj.wireGuidance=True
    dbObj.preEnableSpeed_kts=28.000000
    dbObj.weaponType=1
