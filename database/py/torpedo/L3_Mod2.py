...
def CreateDBObject():
    ...
    dbObj.mzClass='L3 Mod2'
    dbObj.natoClass='L3 Mod2'
    dbObj.mnModelType=9
    dbObj.mnType=130
    dbObj.cost=0.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='torp/icoL3.2.jpg'
    ...
    dbObj.battery_kJ=796.299988
    dbObj.batteryRate_kW=1.000000
    dbObj.maxSpeed_kts=31.000000
    dbObj.acceleration_ktsps=3.500000
    dbObj.sonarClass='L3 mod2 Torpedo Sonar'
