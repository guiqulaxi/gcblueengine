...
def CreateDBObject():
    ...
    dbObj.mzClass='Mk-39 Mine'
    dbObj.natoClass='Mk-39 Mine'
    dbObj.mnModelType=9
    dbObj.mnType=138
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='torp/icoMNMK39.jpg'
    ...
    dbObj.detonationRange_m=15.000000
