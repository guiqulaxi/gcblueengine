...
def CreateDBObject():
    ...
    dbObj.mzClass='Mk VIII Mod4'
    dbObj.natoClass='Mk VIII Mod4'
    dbObj.mnModelType=9
    dbObj.mnType=130
    dbObj.cost=0.000000
    dbObj.weight_kg=1566.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='torp/icoMKVIII.4.jpg'
    ...
    dbObj.battery_kJ=187.000000
    dbObj.batteryRate_kW=1.000000
    dbObj.maxSpeed_kts=45.500000
    dbObj.acceleration_ktsps=2.000000
    dbObj.sonarClass=''
    dbObj.wireGuidance=False
    dbObj.preEnableSpeed_kts=45.500000
    dbObj.weaponType=1
