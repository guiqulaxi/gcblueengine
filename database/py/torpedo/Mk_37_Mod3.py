...
def CreateDBObject():
    ...
    dbObj.mzClass='Mk-37 Mod3'
    dbObj.natoClass='Mk-37 Mod3'
    dbObj.mnModelType=9
    dbObj.mnType=130
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='torp/icoMK-37.3.jpg'
    dbObj.mz3DModelFileName='mk-46.xml'
    dbObj.notes='[dewitt] Friedman. World Naval Weapon Systems. improves seeker, otherwise as Mod1.'
    ...
    dbObj.sonarClass='Mk-37 Mod3 Seeker'
