...
def CreateDBObject():
    ...
    dbObj.mzClass='Mk-15 Mod0'
    dbObj.natoClass='Mk-15 Mod0'
    dbObj.mnModelType=9
    dbObj.mnType=130
    dbObj.cost=0.000000
    dbObj.weight_kg=1560.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='torp/icoMK-15.jpg'
    ...
    dbObj.maxRange_km=8.685880
    dbObj.probNoFaults=0.950000
    dbObj.payloadClass=''
    dbObj.payloadQuantity=1
    dbObj.datalinkRange_km=0.000000
    dbObj.acceptsUserCommands=False
    dbObj.detonationRange_m=4.000000
    ...
    dbObj.battery_kJ=504.000000
    dbObj.batteryRate_kW=1.000000
    dbObj.maxSpeed_kts=33.500000
    dbObj.acceleration_ktsps=2.000000
    dbObj.sonarClass=''
    dbObj.wireGuidance=False
    dbObj.preEnableSpeed_kts=33.500000
    dbObj.weaponType=1
