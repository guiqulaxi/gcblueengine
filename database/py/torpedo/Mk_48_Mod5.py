...
def CreateDBObject():
    ...
    dbObj.mzClass='Mk-48 Mod5'
    dbObj.natoClass='Mk-48 Mod5'
    dbObj.mnModelType=9
    dbObj.mnType=130
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='torp/icoMK-48.5.jpg'
    dbObj.mz3DModelFileName='mk-46.xml'
    dbObj.notes='As per Mod4.  Deeper diving, faster, longer ranged.'
    ...
    dbObj.battery_kJ=1694.199951
    dbObj.batteryRate_kW=1.000000
    dbObj.maxSpeed_kts=63.000000
