...
def CreateDBObject():
    ...
    dbObj.mzClass='53-39'
    dbObj.natoClass='53-39'
    dbObj.mnModelType=9
    dbObj.mnType=130
    dbObj.cost=0.000000
    dbObj.weight_kg=1780.000000
    dbObj.volume_m3=1.000000
    dbObj.initialYear=1941.000000
    dbObj.finalYear=1953.000000
    dbObj.country='Russia'
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='torp/ico53-39.jpg'
    ...
    dbObj.maxSpeed_kts=51.000000
    dbObj.acceleration_ktsps=1.500000
    dbObj.sonarClass=''
    dbObj.wireGuidance=False
    dbObj.preEnableSpeed_kts=39.000000
    dbObj.weaponType=1
