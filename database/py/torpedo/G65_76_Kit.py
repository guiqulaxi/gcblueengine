...
def CreateDBObject():
    ...
    dbObj.mzClass='65-76 Kit'
    dbObj.natoClass='65-76 Kit'
    dbObj.mnModelType=9
    dbObj.mnType=130
    ...
    dbObj.finalYear=2002.000000
    dbObj.country='Russia'
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='torp/ico65-76KIT.jpg'
