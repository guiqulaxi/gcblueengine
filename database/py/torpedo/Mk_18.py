...
def CreateDBObject():
    ...
    dbObj.mzClass='Mk-18'
    dbObj.natoClass='Mk-18'
    dbObj.mnModelType=9
    dbObj.mnType=130
    dbObj.cost=0.000000
    dbObj.weight_kg=1379.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='torp/icoTPMK18.jpg'
    ...
    dbObj.battery_kJ=245.000000
    dbObj.batteryRate_kW=1.000000
    dbObj.maxSpeed_kts=29.000000
    dbObj.acceleration_ktsps=29.000000
    dbObj.sonarClass=''
