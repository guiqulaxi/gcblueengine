...
def CreateDBObject():
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='torp/icoDM2A3.jpg'
    ...
    dbObj.battery_kJ=1324.000000
    dbObj.batteryRate_kW=1.000000
    dbObj.maxSpeed_kts=35.000000
    dbObj.acceleration_ktsps=7.000000
    dbObj.sonarClass='DM2A3 Seeker'
