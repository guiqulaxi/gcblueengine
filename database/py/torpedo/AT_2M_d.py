...
def CreateDBObject():
    ...
    dbObj.mzClass='AT-2M.d'
    dbObj.natoClass='AT-2M.d'
    dbObj.mnModelType=9
    dbObj.mnType=130
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='torp/icoAT-2M.jpg'
    dbObj.mz3DModelFileName='mk-46.xml'
    dbObj.notes='seeker capability boosted to 500m effective vs 8TS target.'
