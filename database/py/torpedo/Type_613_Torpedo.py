...
def CreateDBObject():
    ...
    dbObj.mzClass='Type-613 Torpedo'
    dbObj.natoClass='Type-613 Torpedo'
    dbObj.mnModelType=9
    dbObj.mnType=130
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='torp/icoTYPE-613.jpg'
