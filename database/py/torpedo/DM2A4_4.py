...
def CreateDBObject():
    ...
    dbObj.mzClass='DM2A4.4'
    dbObj.natoClass='DM2A4.4'
    dbObj.mnModelType=9
    dbObj.mnType=130
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='torp/icoDM2A4.4.jpg'
    dbObj.mz3DModelFileName='mk-46.xml'
    dbObj.notes='This is the full size model, with all 4 batteries.  I have no info ont he depth its capable of, but given the date of its production, and where the Alfa is based, im assuming a capability to pursue it quite deep.  granting this weapon a 1000m depth capability.'
