...
def CreateDBObject():
    ...
    dbObj.mzClass='VAMPIR NG IIRST'
    dbObj.natoClass='VAMPIR NG IIRST'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Is a staring array upgraded from VAMPIR MB, assuming same capabilites, just dramatically faster update rate.. maximum range assigned based on ref range and 50dBsm target, optical or thermal.'
