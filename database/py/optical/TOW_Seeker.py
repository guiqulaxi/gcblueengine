...
def CreateDBObject():
    ...
    dbObj.mzClass='TOW Seeker'
    dbObj.natoClass='TOW Seeker'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='because the missile is visually guided at very short ranges by an operator, the seeker is being setup as omniscient.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=4.000000
    dbObj.mfRefRange_km=10.000000
