...
def CreateDBObject():
    ...
    dbObj.mzClass='AAS-28 FLIR'
    dbObj.natoClass='AAS-28 FLIR'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
