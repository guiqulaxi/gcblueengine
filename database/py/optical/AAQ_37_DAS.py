...
def CreateDBObject():
    ...
    dbObj.mzClass='AAQ-37 DAS'
    dbObj.natoClass='AAQ-37 DAS'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
