...
def CreateDBObject():
    ...
    dbObj.mzClass='Ka-53A 12in Vigi Photo-4'
    dbObj.natoClass='Ka-53A 12in Vigi Photo-4'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
