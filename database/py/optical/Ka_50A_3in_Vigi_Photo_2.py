...
def CreateDBObject():
    ...
    dbObj.mzClass='Ka-50A 3in Vigi Photo-2'
    dbObj.natoClass='Ka-50A 3in Vigi Photo-2'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='this camera has a focal length of 3in, and is mounted at a 90° depression angle, this camera station has 60% overlap, assumed to be at its peak velocity of 590m/s at an altitude of 12200m.  this results in a field of view of 71.52°.  nominal scan rate for no overlap would be 58.89seconds, 60% overlap is then 23.56s.  as the 12in camera is quoted to be capable of resolving a tennis ball from 40,000ft, this equates to a ref range of 19.5 for the 3in focal length, assuming equivalent film is used.'
    ...
    dbObj.maxElevation_deg=-54.240002
