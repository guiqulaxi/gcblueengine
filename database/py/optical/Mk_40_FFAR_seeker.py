...
def CreateDBObject():
    ...
    dbObj.mzClass='Mk-40 FFAR seeker'
    dbObj.natoClass='Mk-40 FFAR seeker'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.mfMaxRange_km=8500.000000
    dbObj.mfRefRange_km=25.000000
    dbObj.mfFieldOfView_deg=3.000000
    dbObj.minElevation_deg=-90.000000
    dbObj.maxElevation_deg=3.000000
    dbObj.mfScanPeriod_s=0.100000
    dbObj.damageEffect='GenericSensor'
    dbObj.rangeError=1.500000
    dbObj.angleError_deg=2.000000
    dbObj.elevationError_deg=2.000000
