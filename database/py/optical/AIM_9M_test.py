...
def CreateDBObject():
    ...
    dbObj.mzClass='AIM-9M test'
    dbObj.natoClass='AIM-9M test'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='changing the values for testing purposes, max range up from 20 to 200, isSurveilance enabled, mounted as sensor on F-14D as testbed.'
