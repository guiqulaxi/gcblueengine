...
def CreateDBObject():
    ...
    dbObj.mzClass='OD.2 25x 10.6m'
    dbObj.natoClass='OD.2 25x 10.6m'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='See OD.2 25x 3m for how these values are arrived at.  Well trained.'
