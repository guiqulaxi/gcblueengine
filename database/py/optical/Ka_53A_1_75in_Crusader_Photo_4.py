...
def CreateDBObject():
    ...
    dbObj.mzClass='Ka-53A 1.75in Crusader Photo-4'
    dbObj.natoClass='Ka-53A 1.75in Crusader Photo-4'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.mfRefRange_km=7.900000
    dbObj.mfFieldOfView_deg=78.964996
    dbObj.minElevation_deg=-90.000000
    dbObj.maxElevation_deg=19.732500
    dbObj.mfScanPeriod_s=36.529999
