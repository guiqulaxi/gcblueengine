...
def CreateDBObject():
    ...
    dbObj.mzClass='Shafrir-1 IR Seeker'
    dbObj.natoClass='Shafrir-1 IR Seeker'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.mfMaxRange_km=3.800000
    dbObj.mfRefRange_km=0.615000
    dbObj.mfFieldOfView_deg=12.000000
