...
def CreateDBObject():
    ...
    dbObj.mzClass='AGM-65B TV Seeker'
    dbObj.natoClass='AGM-65B TV Seeker'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.mfMaxRange_km=23.600000
    dbObj.mfRefRange_km=4.130000
    dbObj.mfFieldOfView_deg=15.000000
