...
def CreateDBObject():
    ...
    dbObj.mzClass='AS 12 Guidance'
    dbObj.natoClass='AS 12 Guidance'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='given that the missile is guided by an operator, will configure it as essentially omniscient in good conditions.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=20.000000
    dbObj.mfRefRange_km=9.000000
