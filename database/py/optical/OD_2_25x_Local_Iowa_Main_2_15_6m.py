...
def CreateDBObject():
    ...
    dbObj.mzClass='OD.2 25x Local Iowa Main 2 15.6m'
    dbObj.natoClass='OD.2 25x Local Iowa Main 2 15.6m'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='See OD.2 25x 3m for how these values are arrived at.  Well trained.  Assumed to be 15m high.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=23.559999
