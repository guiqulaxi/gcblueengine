...
def CreateDBObject():
    ...
    dbObj.databaseClass='CV-67 (JFK) USS John F Kennedy durability'
    ...
    dbObj.blastEffect[4].effectLevel=4.600000
    ...
    dbObj.blastEffect[6].effectLevel=8.030000
    dbObj.blastEffect[6].damageFactor=0.500000
    dbObj.blastEffect[7].effectLevel=10.400000
    dbObj.blastEffect[7].damageFactor=0.600000
    dbObj.blastEffect[8].effectLevel=13.190000
    ...
    dbObj.blastEffect[10].effectLevel=20.049999
    dbObj.blastEffect[10].damageFactor=0.900000
    dbObj.blastEffect[11].effectLevel=24.129999
    dbObj.blastEffect[11].damageFactor=1.000000
    dbObj.blastEffect[12].effectLevel=30.400000
    ...
    dbObj.waterBlastEffect[1].effectLevel=78.679001
    dbObj.waterBlastEffect[1].damageFactor=0.042000
    dbObj.waterBlastEffect[2].effectLevel=89.429001
    dbObj.waterBlastEffect[2].damageFactor=0.043000
    dbObj.waterBlastEffect[3].effectLevel=101.594002
    dbObj.waterBlastEffect[3].damageFactor=0.045000
    dbObj.waterBlastEffect[4].effectLevel=115.356003
    dbObj.waterBlastEffect[4].damageFactor=0.048000
    dbObj.waterBlastEffect[5].effectLevel=130.917999
    dbObj.waterBlastEffect[5].damageFactor=0.050000
    dbObj.waterBlastEffect[6].effectLevel=148.509003
    dbObj.waterBlastEffect[6].damageFactor=0.053000
    dbObj.waterBlastEffect[7].effectLevel=168.388000
    dbObj.waterBlastEffect[7].damageFactor=0.056000
    dbObj.waterBlastEffect[8].effectLevel=190.847000
    dbObj.waterBlastEffect[8].damageFactor=0.059000
    dbObj.waterBlastEffect[9].effectLevel=216.220001
    dbObj.waterBlastEffect[9].damageFactor=0.062000
    dbObj.waterBlastEffect[10].effectLevel=244.889999
    dbObj.waterBlastEffect[10].damageFactor=0.067000
    dbObj.waterBlastEffect[11].effectLevel=277.294006
    dbObj.waterBlastEffect[11].damageFactor=0.071000
    dbObj.waterBlastEffect[12].effectLevel=313.944000
    dbObj.waterBlastEffect[12].damageFactor=0.077000
    dbObj.waterBlastEffect[13].effectLevel=355.438995
    dbObj.waterBlastEffect[13].damageFactor=0.083000
    dbObj.waterBlastEffect[14].effectLevel=402.497009
    dbObj.waterBlastEffect[14].damageFactor=0.091000
    dbObj.waterBlastEffect[15].effectLevel=455.994995
    dbObj.waterBlastEffect[15].damageFactor=0.100000
    dbObj.waterBlastEffect[16].effectLevel=517.031006
    dbObj.waterBlastEffect[16].damageFactor=0.111000
    dbObj.waterBlastEffect[17].effectLevel=587.036987
    dbObj.waterBlastEffect[17].damageFactor=0.125000
    dbObj.waterBlastEffect[18].effectLevel=667.960999
    dbObj.waterBlastEffect[18].damageFactor=0.143000
    dbObj.waterBlastEffect[19].effectLevel=762.622986
    dbObj.waterBlastEffect[19].damageFactor=0.167000
    dbObj.waterBlastEffect[20].effectLevel=875.419006
    dbObj.waterBlastEffect[20].damageFactor=0.200000
    dbObj.waterBlastEffect[21].effectLevel=1013.934998
    dbObj.waterBlastEffect[21].damageFactor=0.250000
    dbObj.waterBlastEffect[22].effectLevel=1193.239014
    dbObj.waterBlastEffect[22].damageFactor=0.333000
    dbObj.waterBlastEffect[23].effectLevel=1450.480957
    dbObj.waterBlastEffect[23].damageFactor=0.500000
    dbObj.waterBlastEffect[24].effectLevel=1924.317017
    dbObj.waterBlastEffect[24].damageFactor=1.000000
    dbObj.waterBlastEffect[25].effectLevel=2481.789062
    dbObj.waterBlastEffect[25].damageFactor=2.000000
    dbObj.waterBlastEffect[26].effectLevel=3170.741943
    ...
    dbObj.internalEffect[1].damageFactor=0.000240
    dbObj.internalEffect[2].effectLevel=2.000000
    dbObj.internalEffect[2].damageFactor=0.000490
    dbObj.internalEffect[3].effectLevel=4.000000
    dbObj.internalEffect[3].damageFactor=0.000970
    dbObj.internalEffect[4].effectLevel=8.000000
    dbObj.internalEffect[4].damageFactor=0.001940
    dbObj.internalEffect[5].effectLevel=16.000000
    dbObj.internalEffect[5].damageFactor=0.003890
    dbObj.internalEffect[6].effectLevel=32.000000
    dbObj.internalEffect[6].damageFactor=0.007770
    dbObj.internalEffect[7].effectLevel=64.000000
    dbObj.internalEffect[7].damageFactor=0.015540
    dbObj.internalEffect[8].effectLevel=128.000000
    dbObj.internalEffect[8].damageFactor=0.031090
    dbObj.internalEffect[9].effectLevel=256.000000
    dbObj.internalEffect[9].damageFactor=0.062180
    dbObj.internalEffect[10].effectLevel=512.000000
    dbObj.internalEffect[10].damageFactor=0.124350
    dbObj.internalEffect[11].effectLevel=1024.000000
    dbObj.internalEffect[11].damageFactor=0.248700
    dbObj.internalEffect[12].effectLevel=2048.000000
    dbObj.internalEffect[12].damageFactor=0.497400
    dbObj.internalEffect[13].effectLevel=4096.000000
    dbObj.internalEffect[13].damageFactor=0.994810
    dbObj.internalEffect[14].effectLevel=8192.000000
    dbObj.internalEffect[14].damageFactor=1.989750
    return dbObj
