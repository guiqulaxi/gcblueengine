...
def CreateDBObject():
    ...
    dbObj.databaseClass='Pr 641B Som durability'
    ...
    dbObj.blastEffect[6].effectLevel=6.550000
    dbObj.blastEffect[6].damageFactor=0.500000
    dbObj.blastEffect[7].effectLevel=8.240000
    dbObj.blastEffect[7].damageFactor=0.600000
    dbObj.blastEffect[8].effectLevel=10.230000
    ...
    dbObj.blastEffect[10].effectLevel=15.140000
    dbObj.blastEffect[10].damageFactor=0.900000
    dbObj.blastEffect[11].effectLevel=18.059999
    dbObj.blastEffect[11].damageFactor=1.000000
    dbObj.blastEffect[12].effectLevel=22.750000
    ...
    dbObj.waterBlastEffect[1].effectLevel=54.062000
    dbObj.waterBlastEffect[1].damageFactor=0.100000
    dbObj.waterBlastEffect[2].effectLevel=85.255997
    dbObj.waterBlastEffect[2].damageFactor=0.111000
    dbObj.waterBlastEffect[3].effectLevel=132.929993
    dbObj.waterBlastEffect[3].damageFactor=0.125000
    dbObj.waterBlastEffect[4].effectLevel=204.716995
    dbObj.waterBlastEffect[4].damageFactor=0.143000
    dbObj.waterBlastEffect[5].effectLevel=311.065002
    dbObj.waterBlastEffect[5].damageFactor=0.167000
    dbObj.waterBlastEffect[6].effectLevel=465.798004
    dbObj.waterBlastEffect[6].damageFactor=0.200000
    dbObj.waterBlastEffect[7].effectLevel=686.596985
    dbObj.waterBlastEffect[7].damageFactor=0.250000
    dbObj.waterBlastEffect[8].effectLevel=995.732971
    dbObj.waterBlastEffect[8].damageFactor=0.333000
    dbObj.waterBlastEffect[9].effectLevel=1424.380981
    dbObj.waterBlastEffect[9].damageFactor=0.500000
    dbObj.waterBlastEffect[10].effectLevel=2051.580078
    dbObj.waterBlastEffect[10].damageFactor=1.000000
    dbObj.waterBlastEffect[11].effectLevel=2577.076904
    dbObj.waterBlastEffect[11].damageFactor=2.000000
    dbObj.waterBlastEffect[12].effectLevel=3092.846924
    ...
    dbObj.internalEffect[1].damageFactor=0.269960
    dbObj.internalEffect[2].effectLevel=2.000000
    dbObj.internalEffect[2].damageFactor=0.539770
    dbObj.internalEffect[3].effectLevel=4.000000
    dbObj.internalEffect[3].damageFactor=1.079820
    dbObj.internalEffect[4].effectLevel=8.000000
    dbObj.internalEffect[4].damageFactor=2.159710
    dbObj.internalEffect[5].effectLevel=16.000000
    dbObj.internalEffect[5].damageFactor=4.318130
    dbObj.internalEffect[6].effectLevel=32.000000
    dbObj.internalEffect[6].damageFactor=8.635330
    dbObj.internalEffect[7].effectLevel=64.000000
    dbObj.internalEffect[7].damageFactor=17.272579
    return dbObj
