...
def CreateDBObject():
    ...
    dbObj.databaseClass='F2H-3 durability'
    ...
    dbObj.blastEffect[6].effectLevel=3.580000
    ...
    dbObj.blastEffect[8].effectLevel=5.200000
    ...
    dbObj.blastEffect[10].effectLevel=7.350000
    dbObj.blastEffect[10].damageFactor=0.900000
    dbObj.blastEffect[11].effectLevel=8.630000
    dbObj.blastEffect[11].damageFactor=1.000000
    dbObj.blastEffect[12].effectLevel=10.880000
    ...
    dbObj.fragEffect[2].damageFactor=0.035730
    dbObj.fragEffect[3].effectLevel=6000.000000
    dbObj.fragEffect[3].damageFactor=0.071450
    dbObj.fragEffect[4].effectLevel=10000.000000
    dbObj.fragEffect[4].damageFactor=0.119090
    dbObj.fragEffect[5].effectLevel=30000.000000
    dbObj.fragEffect[5].damageFactor=0.357270
    dbObj.fragEffect[6].effectLevel=60000.000000
    dbObj.fragEffect[6].damageFactor=0.714540
    dbObj.fragEffect[7].effectLevel=100000.000000
    dbObj.fragEffect[7].damageFactor=1.190890
    dbObj.fragEffect[8].effectLevel=300000.000000
    dbObj.fragEffect[8].damageFactor=3.572680
    dbObj.fragEffect[9].effectLevel=600000.000000
    dbObj.fragEffect[9].damageFactor=7.145350
    dbObj.fragEffect[10].effectLevel=1000000.000000
    dbObj.fragEffect[10].damageFactor=11.908920
    ...
    dbObj.internalEffect[1].damageFactor=294.563782
    return dbObj
