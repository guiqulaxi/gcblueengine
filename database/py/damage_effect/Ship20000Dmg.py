...
def CreateDBObject():
    ...
    dbObj.databaseClass='Ship20000Dmg'
    ...
    dbObj.blastEffect[2].effectLevel=10.000000
    dbObj.blastEffect[2].damageFactor=1.000000
    dbObj.blastEffect[3].effectLevel=12.600000
    dbObj.blastEffect[3].damageFactor=2.000000
    dbObj.blastEffect[4].effectLevel=12.600000
    dbObj.blastEffect[4].damageFactor=2.000000
    dbObj.blastEffect[5].effectLevel=15.900000
    dbObj.blastEffect[5].damageFactor=4.000000
    dbObj.blastEffect[6].effectLevel=20.000000
    dbObj.blastEffect[6].damageFactor=8.000000
    dbObj.blastEffect[7].effectLevel=25.200001
    ...
    dbObj.waterBlastEffect[2].effectLevel=500.000000
    dbObj.waterBlastEffect[2].damageFactor=0.350000
    dbObj.waterBlastEffect[3].effectLevel=2500.000000
    ...
    dbObj.radEffect[2].effectLevel=29150.000000
    dbObj.radEffect[2].damageFactor=0.000000
    dbObj.radEffect[3].effectLevel=58300.000000
    dbObj.radEffect[3].damageFactor=2.000000
    dbObj.radEffect[4].effectLevel=175000.000000
    ...
    dbObj.internalEffect[1].damageFactor=0.000784
    dbObj.internalEffect[2].effectLevel=1.000000
    dbObj.internalEffect[2].damageFactor=0.001570
    dbObj.internalEffect[3].effectLevel=2.000000
    dbObj.internalEffect[3].damageFactor=0.003130
    dbObj.internalEffect[4].effectLevel=4.000000
    dbObj.internalEffect[4].damageFactor=0.006260
    dbObj.internalEffect[5].effectLevel=8.000000
    dbObj.internalEffect[5].damageFactor=0.012500
    dbObj.internalEffect[6].effectLevel=16.000000
    dbObj.internalEffect[6].damageFactor=0.025000
    dbObj.internalEffect[7].effectLevel=32.000000
    dbObj.internalEffect[7].damageFactor=0.050000
    dbObj.internalEffect[8].effectLevel=64.000000
    dbObj.internalEffect[8].damageFactor=0.100000
    dbObj.internalEffect[9].effectLevel=128.000000
    dbObj.internalEffect[9].damageFactor=0.200000
    dbObj.internalEffect[10].effectLevel=256.000000
    dbObj.internalEffect[10].damageFactor=0.399000
    dbObj.internalEffect[11].effectLevel=512.000000
    dbObj.internalEffect[11].damageFactor=0.797000
    dbObj.internalEffect[12].effectLevel=1024.000000
    dbObj.internalEffect[12].damageFactor=1.590000
    dbObj.internalEffect[13].effectLevel=2048.000000
    dbObj.internalEffect[13].damageFactor=3.190000
    dbObj.internalEffect[14].effectLevel=4096.000000
    dbObj.internalEffect[14].damageFactor=6.370000
    dbObj.internalEffect[15].effectLevel=8192.000000
    dbObj.internalEffect[15].damageFactor=12.700000
    return dbObj
