...
def CreateDBObject():
    ...
    dbObj.databaseClass='F9F-2 durability'
    ...
    dbObj.blastEffect[4].effectLevel=2.460000
    ...
    dbObj.blastEffect[8].effectLevel=5.020000
    ...
    dbObj.blastEffect[10].effectLevel=7.070000
    dbObj.blastEffect[10].damageFactor=0.900000
    dbObj.blastEffect[11].effectLevel=8.290000
    ...
    dbObj.fragEffect[2].damageFactor=0.037560
    dbObj.fragEffect[3].effectLevel=6000.000000
    dbObj.fragEffect[3].damageFactor=0.075130
    dbObj.fragEffect[4].effectLevel=10000.000000
    dbObj.fragEffect[4].damageFactor=0.125220
    dbObj.fragEffect[5].effectLevel=30000.000000
    dbObj.fragEffect[5].damageFactor=0.375650
    dbObj.fragEffect[6].effectLevel=60000.000000
    dbObj.fragEffect[6].damageFactor=0.751300
    dbObj.fragEffect[7].effectLevel=100000.000000
    dbObj.fragEffect[7].damageFactor=1.252160
    dbObj.fragEffect[8].effectLevel=300000.000000
    dbObj.fragEffect[8].damageFactor=3.756480
    dbObj.fragEffect[9].effectLevel=600000.000000
    dbObj.fragEffect[9].damageFactor=7.512960
    dbObj.fragEffect[10].effectLevel=1000000.000000
    dbObj.fragEffect[10].damageFactor=12.521600
    ...
    dbObj.internalEffect[1].damageFactor=333.568573
    return dbObj
