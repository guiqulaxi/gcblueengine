...
def CreateDBObject():
    ...
    dbObj.databaseClass='Hai Shih SS durability'
    ...
    dbObj.blastEffect[6].effectLevel=6.360000
    ...
    dbObj.blastEffect[8].effectLevel=9.870000
    dbObj.blastEffect[8].damageFactor=0.700000
    dbObj.blastEffect[9].effectLevel=12.060000
    dbObj.blastEffect[9].damageFactor=0.800000
    dbObj.blastEffect[10].effectLevel=14.550000
    dbObj.blastEffect[10].damageFactor=0.900000
    dbObj.blastEffect[11].effectLevel=17.320000
    dbObj.blastEffect[11].damageFactor=1.000000
    dbObj.blastEffect[12].effectLevel=21.830000
    ...
    dbObj.waterBlastEffect[1].effectLevel=78.987000
    dbObj.waterBlastEffect[1].damageFactor=0.111000
    dbObj.waterBlastEffect[2].effectLevel=123.153999
    dbObj.waterBlastEffect[2].damageFactor=0.125000
    dbObj.waterBlastEffect[3].effectLevel=189.662003
    dbObj.waterBlastEffect[3].damageFactor=0.143000
    dbObj.waterBlastEffect[4].effectLevel=288.188995
    dbObj.waterBlastEffect[4].damageFactor=0.167000
    dbObj.waterBlastEffect[5].effectLevel=431.542999
    dbObj.waterBlastEffect[5].damageFactor=0.200000
    dbObj.waterBlastEffect[6].effectLevel=636.104980
    dbObj.waterBlastEffect[6].damageFactor=0.250000
    dbObj.waterBlastEffect[7].effectLevel=922.507019
    dbObj.waterBlastEffect[7].damageFactor=0.333000
    dbObj.waterBlastEffect[8].effectLevel=1319.634033
    dbObj.waterBlastEffect[8].damageFactor=0.500000
    dbObj.waterBlastEffect[9].effectLevel=1900.708984
    dbObj.waterBlastEffect[9].damageFactor=1.000000
    dbObj.waterBlastEffect[10].effectLevel=2387.561035
    dbObj.waterBlastEffect[10].damageFactor=2.000000
    dbObj.waterBlastEffect[11].effectLevel=2865.402100
    ...
    dbObj.internalEffect[1].damageFactor=0.300570
    dbObj.internalEffect[2].effectLevel=2.000000
    dbObj.internalEffect[2].damageFactor=0.600800
    dbObj.internalEffect[3].effectLevel=4.000000
    dbObj.internalEffect[3].damageFactor=1.201960
    dbObj.internalEffect[4].effectLevel=8.000000
    dbObj.internalEffect[4].damageFactor=2.403150
    dbObj.internalEffect[5].effectLevel=16.000000
    dbObj.internalEffect[5].damageFactor=4.808570
    dbObj.internalEffect[6].effectLevel=32.000000
    dbObj.internalEffect[6].damageFactor=9.615660
    dbObj.internalEffect[7].effectLevel=64.000000
    dbObj.internalEffect[7].damageFactor=19.230730
    return dbObj
