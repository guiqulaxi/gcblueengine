...
def CreateDBObject():
    ...
    dbObj.databaseClass='AV-8B Harrier II NA durability'
    ...
    dbObj.blastEffect[12].effectLevel=16.110001
    ...
    dbObj.fragEffect[2].damageFactor=0.022520
    ...
    dbObj.fragEffect[4].damageFactor=0.075060
    dbObj.fragEffect[5].effectLevel=30000.000000
    dbObj.fragEffect[5].damageFactor=0.225190
    dbObj.fragEffect[6].effectLevel=60000.000000
    dbObj.fragEffect[6].damageFactor=0.450380
    dbObj.fragEffect[7].effectLevel=100000.000000
    dbObj.fragEffect[7].damageFactor=0.750630
    dbObj.fragEffect[8].effectLevel=300000.000000
    dbObj.fragEffect[8].damageFactor=2.251880
    dbObj.fragEffect[9].effectLevel=600000.000000
    dbObj.fragEffect[9].damageFactor=4.503750
    dbObj.fragEffect[10].effectLevel=1000000.000000
    dbObj.fragEffect[10].damageFactor=7.506260
    dbObj.fragEffect[11].effectLevel=3000000.000000
    dbObj.fragEffect[11].damageFactor=22.518770
    ...
    dbObj.internalEffect[1].damageFactor=93.881630
    return dbObj
