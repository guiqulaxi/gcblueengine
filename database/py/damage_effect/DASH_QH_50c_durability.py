...
def CreateDBObject():
    ...
    dbObj.databaseClass='DASH QH-50c durability'
    ...
    dbObj.blastEffect[5].effectLevel=2.760000
    ...
    dbObj.blastEffect[7].effectLevel=3.770000
    dbObj.blastEffect[7].damageFactor=0.600000
    dbObj.blastEffect[8].effectLevel=4.420000
    dbObj.blastEffect[8].damageFactor=0.700000
    dbObj.blastEffect[9].effectLevel=5.170000
    ...
    dbObj.blastEffect[11].effectLevel=6.980000
    dbObj.blastEffect[11].damageFactor=1.000000
    dbObj.blastEffect[12].effectLevel=8.790000
    ...
    dbObj.fragEffect[2].damageFactor=0.061980
    dbObj.fragEffect[3].effectLevel=6000.000000
    dbObj.fragEffect[3].damageFactor=0.123960
    dbObj.fragEffect[4].effectLevel=10000.000000
    dbObj.fragEffect[4].damageFactor=0.206600
    dbObj.fragEffect[5].effectLevel=30000.000000
    dbObj.fragEffect[5].damageFactor=0.619810
    dbObj.fragEffect[6].effectLevel=60000.000000
    dbObj.fragEffect[6].damageFactor=1.239630
    dbObj.fragEffect[7].effectLevel=100000.000000
    dbObj.fragEffect[7].damageFactor=2.066050
    dbObj.fragEffect[8].effectLevel=300000.000000
    dbObj.fragEffect[8].damageFactor=6.198150
    dbObj.fragEffect[9].effectLevel=600000.000000
    dbObj.fragEffect[9].damageFactor=12.396290
    ...
    dbObj.internalEffect[1].damageFactor=843.489685
    return dbObj
