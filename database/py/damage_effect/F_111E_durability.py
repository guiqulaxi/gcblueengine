...
def CreateDBObject():
    ...
    dbObj.databaseClass='F-111E durability'
    ...
    dbObj.blastEffect[9].effectLevel=10.280000
    ...
    dbObj.blastEffect[11].effectLevel=14.880000
    dbObj.blastEffect[11].damageFactor=1.000000
    dbObj.blastEffect[12].effectLevel=18.750000
    ...
    dbObj.fragEffect[6].damageFactor=0.413480
    dbObj.fragEffect[7].effectLevel=100000.000000
    dbObj.fragEffect[7].damageFactor=0.689130
    dbObj.fragEffect[8].effectLevel=300000.000000
    dbObj.fragEffect[8].damageFactor=2.067400
    dbObj.fragEffect[9].effectLevel=600000.000000
    dbObj.fragEffect[9].damageFactor=4.134800
    dbObj.fragEffect[10].effectLevel=1000000.000000
    dbObj.fragEffect[10].damageFactor=6.891330
    dbObj.fragEffect[11].effectLevel=3000000.000000
    dbObj.fragEffect[11].damageFactor=20.673981
    ...
    dbObj.internalEffect[1].damageFactor=41.578899
    return dbObj
