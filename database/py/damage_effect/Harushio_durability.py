...
def CreateDBObject():
    ...
    dbObj.databaseClass='Harushio durability'
    ...
    dbObj.blastEffect[6].effectLevel=7.190000
    dbObj.blastEffect[6].damageFactor=0.500000
    dbObj.blastEffect[7].effectLevel=9.100000
    dbObj.blastEffect[7].damageFactor=0.600000
    dbObj.blastEffect[8].effectLevel=11.360000
    dbObj.blastEffect[8].damageFactor=0.700000
    dbObj.blastEffect[9].effectLevel=13.970000
    dbObj.blastEffect[9].damageFactor=0.800000
    dbObj.blastEffect[10].effectLevel=16.920000
    dbObj.blastEffect[10].damageFactor=0.900000
    dbObj.blastEffect[11].effectLevel=20.219999
    dbObj.blastEffect[11].damageFactor=1.000000
    dbObj.blastEffect[12].effectLevel=25.480000
    ...
    dbObj.waterBlastEffect[1].effectLevel=55.161999
    dbObj.waterBlastEffect[1].damageFactor=0.100000
    dbObj.waterBlastEffect[2].effectLevel=86.990997
    dbObj.waterBlastEffect[2].damageFactor=0.111000
    dbObj.waterBlastEffect[3].effectLevel=135.634995
    dbObj.waterBlastEffect[3].damageFactor=0.125000
    dbObj.waterBlastEffect[4].effectLevel=208.882996
    dbObj.waterBlastEffect[4].damageFactor=0.143000
    dbObj.waterBlastEffect[5].effectLevel=317.394989
    dbObj.waterBlastEffect[5].damageFactor=0.167000
    dbObj.waterBlastEffect[6].effectLevel=475.276001
    dbObj.waterBlastEffect[6].damageFactor=0.200000
    dbObj.waterBlastEffect[7].effectLevel=700.568970
    dbObj.waterBlastEffect[7].damageFactor=0.250000
    dbObj.waterBlastEffect[8].effectLevel=1015.994995
    dbObj.waterBlastEffect[8].damageFactor=0.333000
    dbObj.waterBlastEffect[9].effectLevel=1453.366943
    dbObj.waterBlastEffect[9].damageFactor=0.500000
    dbObj.waterBlastEffect[10].effectLevel=2093.329102
    dbObj.waterBlastEffect[10].damageFactor=1.000000
    dbObj.waterBlastEffect[11].effectLevel=2629.519043
    dbObj.waterBlastEffect[11].damageFactor=2.000000
    dbObj.waterBlastEffect[12].effectLevel=3155.784912
    ...
    dbObj.internalEffect[1].damageFactor=0.193530
    dbObj.internalEffect[2].effectLevel=2.000000
    dbObj.internalEffect[2].damageFactor=0.387390
    dbObj.internalEffect[3].effectLevel=4.000000
    dbObj.internalEffect[3].damageFactor=0.774700
    dbObj.internalEffect[4].effectLevel=8.000000
    dbObj.internalEffect[4].damageFactor=1.549210
    dbObj.internalEffect[5].effectLevel=16.000000
    dbObj.internalEffect[5].damageFactor=3.097570
    dbObj.internalEffect[6].effectLevel=32.000000
    dbObj.internalEffect[6].damageFactor=6.195190
    dbObj.internalEffect[7].effectLevel=64.000000
    dbObj.internalEffect[7].damageFactor=12.389850
    return dbObj
