...
def CreateDBObject():
    ...
    dbObj.databaseClass='AH-1J Sea Cobra durability'
    ...
    dbObj.blastEffect[6].effectLevel=3.710000
    ...
    dbObj.blastEffect[8].effectLevel=5.330000
    ...
    dbObj.blastEffect[10].effectLevel=7.500000
    dbObj.blastEffect[10].damageFactor=0.900000
    dbObj.blastEffect[11].effectLevel=8.790000
    dbObj.blastEffect[11].damageFactor=1.000000
    dbObj.blastEffect[12].effectLevel=11.070000
    ...
    dbObj.fragEffect[2].damageFactor=0.039610
    dbObj.fragEffect[3].effectLevel=6000.000000
    dbObj.fragEffect[3].damageFactor=0.079220
    dbObj.fragEffect[4].effectLevel=10000.000000
    dbObj.fragEffect[4].damageFactor=0.132030
    dbObj.fragEffect[5].effectLevel=30000.000000
    dbObj.fragEffect[5].damageFactor=0.396090
    dbObj.fragEffect[6].effectLevel=60000.000000
    dbObj.fragEffect[6].damageFactor=0.792170
    dbObj.fragEffect[7].effectLevel=100000.000000
    dbObj.fragEffect[7].damageFactor=1.320290
    dbObj.fragEffect[8].effectLevel=300000.000000
    dbObj.fragEffect[8].damageFactor=3.960860
    dbObj.fragEffect[9].effectLevel=600000.000000
    dbObj.fragEffect[9].damageFactor=7.921710
    dbObj.fragEffect[10].effectLevel=1000000.000000
    dbObj.fragEffect[10].damageFactor=13.202860
    ...
    dbObj.internalEffect[1].damageFactor=332.105682
    return dbObj
