...
def CreateDBObject():
    ...
    dbObj.databaseClass='Rubis AMETHYSTE durability'
    ...
    dbObj.blastEffect[5].effectLevel=5.560000
    ...
    dbObj.blastEffect[7].effectLevel=8.940000
    dbObj.blastEffect[7].damageFactor=0.600000
    dbObj.blastEffect[8].effectLevel=11.150000
    dbObj.blastEffect[8].damageFactor=0.700000
    dbObj.blastEffect[9].effectLevel=13.690000
    ...
    dbObj.blastEffect[11].effectLevel=19.780001
    ...
    dbObj.waterBlastEffect[1].effectLevel=83.235001
    dbObj.waterBlastEffect[1].damageFactor=0.111000
    dbObj.waterBlastEffect[2].effectLevel=129.779007
    dbObj.waterBlastEffect[2].damageFactor=0.125000
    dbObj.waterBlastEffect[3].effectLevel=199.863998
    dbObj.waterBlastEffect[3].damageFactor=0.143000
    dbObj.waterBlastEffect[4].effectLevel=303.691010
    dbObj.waterBlastEffect[4].damageFactor=0.167000
    dbObj.waterBlastEffect[5].effectLevel=454.756012
    dbObj.waterBlastEffect[5].damageFactor=0.200000
    dbObj.waterBlastEffect[6].effectLevel=670.320984
    dbObj.waterBlastEffect[6].damageFactor=0.250000
    dbObj.waterBlastEffect[7].effectLevel=972.127991
    dbObj.waterBlastEffect[7].damageFactor=0.333000
    dbObj.waterBlastEffect[8].effectLevel=1390.614990
    dbObj.waterBlastEffect[8].damageFactor=0.500000
    dbObj.waterBlastEffect[9].effectLevel=2002.946045
    dbObj.waterBlastEffect[9].damageFactor=1.000000
    dbObj.waterBlastEffect[10].effectLevel=2515.985107
    dbObj.waterBlastEffect[10].damageFactor=2.000000
    dbObj.waterBlastEffect[11].effectLevel=3019.529053
    ...
    dbObj.internalEffect[1].damageFactor=0.204180
    dbObj.internalEffect[2].effectLevel=2.000000
    dbObj.internalEffect[2].damageFactor=0.408290
    dbObj.internalEffect[3].effectLevel=4.000000
    dbObj.internalEffect[3].damageFactor=0.816770
    dbObj.internalEffect[4].effectLevel=8.000000
    dbObj.internalEffect[4].damageFactor=1.633420
    dbObj.internalEffect[5].effectLevel=16.000000
    dbObj.internalEffect[5].damageFactor=3.267900
    dbObj.internalEffect[6].effectLevel=32.000000
    dbObj.internalEffect[6].damageFactor=6.536670
    dbObj.internalEffect[7].effectLevel=64.000000
    dbObj.internalEffect[7].damageFactor=13.071380
    return dbObj
