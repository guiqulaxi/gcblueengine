...
def CreateDBObject():
    ...
    dbObj.databaseClass='Ship100Dmg'
    ...
    dbObj.blastEffect[2].effectLevel=6.500000
    dbObj.blastEffect[2].damageFactor=1.000000
    dbObj.blastEffect[3].effectLevel=8.200000
    dbObj.blastEffect[3].damageFactor=2.000000
    dbObj.blastEffect[4].effectLevel=8.200000
    dbObj.blastEffect[4].damageFactor=2.000000
    dbObj.blastEffect[5].effectLevel=10.300000
    dbObj.blastEffect[5].damageFactor=4.000000
    dbObj.blastEffect[6].effectLevel=13.000000
    dbObj.blastEffect[6].damageFactor=8.000000
    dbObj.blastEffect[7].effectLevel=16.400000
    ...
    dbObj.waterBlastEffect[1].effectLevel=30.000000
    ...
    dbObj.radEffect[2].effectLevel=10000.000000
    dbObj.radEffect[2].damageFactor=1.000000
    dbObj.radEffect[3].effectLevel=20000.000000
    ...
    dbObj.internalEffect[1].damageFactor=0.048900
    dbObj.internalEffect[2].effectLevel=1.000000
    dbObj.internalEffect[2].damageFactor=0.097800
    dbObj.internalEffect[3].effectLevel=2.000000
    dbObj.internalEffect[3].damageFactor=0.195000
    dbObj.internalEffect[4].effectLevel=4.000000
    dbObj.internalEffect[4].damageFactor=0.390000
    dbObj.internalEffect[5].effectLevel=8.000000
    dbObj.internalEffect[5].damageFactor=0.781000
    dbObj.internalEffect[6].effectLevel=16.000000
    dbObj.internalEffect[6].damageFactor=1.560000
    dbObj.internalEffect[7].effectLevel=32.000000
    dbObj.internalEffect[7].damageFactor=3.120000
    dbObj.internalEffect[8].effectLevel=64.000000
    dbObj.internalEffect[8].damageFactor=6.240000
    dbObj.internalEffect[9].effectLevel=128.000000
    dbObj.internalEffect[9].damageFactor=12.500000
    dbObj.internalEffect[10].effectLevel=256.000000
    dbObj.internalEffect[10].damageFactor=24.900000
    dbObj.internalEffect[11].effectLevel=512.000000
    dbObj.internalEffect[11].damageFactor=49.000000
    dbObj.internalEffect[12].effectLevel=1024.000000
    dbObj.internalEffect[12].damageFactor=99.500000
    dbObj.internalEffect[13].effectLevel=2048.000000
    dbObj.internalEffect[13].damageFactor=199.000000
    dbObj.internalEffect[14].effectLevel=4096.000000
    dbObj.internalEffect[14].damageFactor=397.000000
    dbObj.internalEffect[15].effectLevel=8192.000000
    dbObj.internalEffect[15].damageFactor=794.000000
    return dbObj
