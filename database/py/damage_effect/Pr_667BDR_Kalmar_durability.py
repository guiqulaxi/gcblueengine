...
def CreateDBObject():
    ...
    dbObj.databaseClass='Pr 667BDR Kalmar durability'
    ...
    dbObj.blastEffect[3].effectLevel=3.510000
    ...
    dbObj.blastEffect[7].effectLevel=9.730000
    dbObj.blastEffect[7].damageFactor=0.600000
    dbObj.blastEffect[8].effectLevel=12.260000
    ...
    dbObj.blastEffect[11].effectLevel=22.180000
    dbObj.blastEffect[11].damageFactor=1.000000
    dbObj.blastEffect[12].effectLevel=27.940001
    ...
    dbObj.waterBlastEffect[1].effectLevel=72.925003
    dbObj.waterBlastEffect[1].damageFactor=0.111000
    dbObj.waterBlastEffect[2].effectLevel=113.703003
    dbObj.waterBlastEffect[2].damageFactor=0.125000
    dbObj.waterBlastEffect[3].effectLevel=175.108002
    dbObj.waterBlastEffect[3].damageFactor=0.143000
    dbObj.waterBlastEffect[4].effectLevel=266.074005
    dbObj.waterBlastEffect[4].damageFactor=0.167000
    dbObj.waterBlastEffect[5].effectLevel=398.427002
    dbObj.waterBlastEffect[5].damageFactor=0.200000
    dbObj.waterBlastEffect[6].effectLevel=587.291016
    dbObj.waterBlastEffect[6].damageFactor=0.250000
    dbObj.waterBlastEffect[7].effectLevel=851.713989
    dbObj.waterBlastEffect[7].damageFactor=0.333000
    dbObj.waterBlastEffect[8].effectLevel=1218.364990
    dbObj.waterBlastEffect[8].damageFactor=0.500000
    dbObj.waterBlastEffect[9].effectLevel=1754.848999
    dbObj.waterBlastEffect[9].damageFactor=1.000000
    dbObj.waterBlastEffect[10].effectLevel=2204.340088
    dbObj.waterBlastEffect[10].damageFactor=2.000000
    dbObj.waterBlastEffect[11].effectLevel=2645.510986
    ...
    dbObj.internalEffect[1].damageFactor=0.161710
    dbObj.internalEffect[2].effectLevel=2.000000
    dbObj.internalEffect[2].damageFactor=0.323480
    dbObj.internalEffect[3].effectLevel=4.000000
    dbObj.internalEffect[3].damageFactor=0.646820
    dbObj.internalEffect[4].effectLevel=8.000000
    dbObj.internalEffect[4].damageFactor=1.293660
    dbObj.internalEffect[5].effectLevel=16.000000
    dbObj.internalEffect[5].damageFactor=2.587800
    dbObj.internalEffect[6].effectLevel=32.000000
    dbObj.internalEffect[6].damageFactor=5.176660
    dbObj.internalEffect[7].effectLevel=64.000000
    dbObj.internalEffect[7].damageFactor=10.352630
    return dbObj
