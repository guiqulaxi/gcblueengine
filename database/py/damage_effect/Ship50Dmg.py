...
def CreateDBObject():
    ...
    dbObj.blastEffect[3].effectLevel=7.600000
    dbObj.blastEffect[3].damageFactor=2.000000
    dbObj.blastEffect[4].effectLevel=7.600000
    dbObj.blastEffect[4].damageFactor=2.000000
    dbObj.blastEffect[5].effectLevel=9.600000
    dbObj.blastEffect[5].damageFactor=4.000000
    dbObj.blastEffect[6].effectLevel=12.100000
    dbObj.blastEffect[6].damageFactor=8.000000
    dbObj.blastEffect[7].effectLevel=15.200000
    ...
    dbObj.waterBlastEffect[2].effectLevel=300.000000
    dbObj.waterBlastEffect[2].damageFactor=0.500000
    dbObj.waterBlastEffect[3].effectLevel=1500.000000
    dbObj.waterBlastEffect[3].damageFactor=1.000000
    dbObj.waterBlastEffect[4].effectLevel=15000.000000
    ...
    dbObj.radEffect[2].effectLevel=8000.000000
    dbObj.radEffect[2].damageFactor=1.000000
    dbObj.radEffect[3].effectLevel=16000.000000
    dbObj.radEffect[3].damageFactor=2.000000
    dbObj.radEffect[4].effectLevel=50000.000000
    ...
    dbObj.internalEffect[1].damageFactor=0.086300
    dbObj.internalEffect[2].effectLevel=1.000000
    dbObj.internalEffect[2].damageFactor=0.173000
    dbObj.internalEffect[3].effectLevel=2.000000
    dbObj.internalEffect[3].damageFactor=0.345000
    dbObj.internalEffect[4].effectLevel=4.000000
    dbObj.internalEffect[4].damageFactor=0.689000
    dbObj.internalEffect[5].effectLevel=8.000000
    dbObj.internalEffect[5].damageFactor=1.380000
    dbObj.internalEffect[6].effectLevel=16.000000
    dbObj.internalEffect[6].damageFactor=2.750000
    dbObj.internalEffect[7].effectLevel=32.000000
    dbObj.internalEffect[7].damageFactor=5.510000
    dbObj.internalEffect[8].effectLevel=64.000000
    dbObj.internalEffect[8].damageFactor=11.000000
    dbObj.internalEffect[9].effectLevel=128.000000
    dbObj.internalEffect[9].damageFactor=22.000000
    dbObj.internalEffect[10].effectLevel=256.000000
    dbObj.internalEffect[10].damageFactor=44.000000
    dbObj.internalEffect[11].effectLevel=512.000000
    dbObj.internalEffect[11].damageFactor=87.900002
    dbObj.internalEffect[12].effectLevel=1024.000000
    dbObj.internalEffect[12].damageFactor=175.000000
    dbObj.internalEffect[13].effectLevel=2048.000000
    dbObj.internalEffect[13].damageFactor=350.000000
    dbObj.internalEffect[14].effectLevel=4096.000000
    dbObj.internalEffect[14].damageFactor=700.000000
    dbObj.internalEffect[15].effectLevel=8192.000000
    dbObj.internalEffect[15].damageFactor=1401.000000
    return dbObj
