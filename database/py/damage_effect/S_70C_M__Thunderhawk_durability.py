...
def CreateDBObject():
    ...
    dbObj.databaseClass='S-70C(M) Thunderhawk durability'
    ...
    dbObj.blastEffect[9].effectLevel=7.540000
    ...
    dbObj.blastEffect[11].effectLevel=10.590000
    dbObj.blastEffect[11].damageFactor=1.000000
    dbObj.blastEffect[12].effectLevel=13.340000
    ...
    dbObj.fragEffect[2].damageFactor=0.030070
    dbObj.fragEffect[3].effectLevel=6000.000000
    dbObj.fragEffect[3].damageFactor=0.060150
    dbObj.fragEffect[4].effectLevel=10000.000000
    dbObj.fragEffect[4].damageFactor=0.100240
    dbObj.fragEffect[5].effectLevel=30000.000000
    dbObj.fragEffect[5].damageFactor=0.300730
    dbObj.fragEffect[6].effectLevel=60000.000000
    dbObj.fragEffect[6].damageFactor=0.601470
    dbObj.fragEffect[7].effectLevel=100000.000000
    dbObj.fragEffect[7].damageFactor=1.002450
    dbObj.fragEffect[8].effectLevel=300000.000000
    dbObj.fragEffect[8].damageFactor=3.007340
    dbObj.fragEffect[9].effectLevel=600000.000000
    dbObj.fragEffect[9].damageFactor=6.014690
    dbObj.fragEffect[10].effectLevel=1000000.000000
    dbObj.fragEffect[10].damageFactor=10.024480
    ...
    dbObj.internalEffect[1].damageFactor=180.329117
    return dbObj
