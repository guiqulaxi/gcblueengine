...
def CreateDBObject():
    ...
    dbObj.databaseClass='Pr 659 durability'
    ...
    dbObj.blastEffect[4].effectLevel=3.930000
    dbObj.blastEffect[4].damageFactor=0.300000
    dbObj.blastEffect[5].effectLevel=4.950000
    dbObj.blastEffect[5].damageFactor=0.400000
    dbObj.blastEffect[6].effectLevel=6.270000
    ...
    dbObj.blastEffect[10].effectLevel=14.480000
    ...
    dbObj.waterBlastEffect[1].effectLevel=59.214001
    dbObj.waterBlastEffect[1].damageFactor=0.100000
    dbObj.waterBlastEffect[2].effectLevel=93.382004
    dbObj.waterBlastEffect[2].damageFactor=0.111000
    dbObj.waterBlastEffect[3].effectLevel=145.600006
    dbObj.waterBlastEffect[3].damageFactor=0.125000
    dbObj.waterBlastEffect[4].effectLevel=224.229004
    dbObj.waterBlastEffect[4].damageFactor=0.143000
    dbObj.waterBlastEffect[5].effectLevel=340.713013
    dbObj.waterBlastEffect[5].damageFactor=0.167000
    dbObj.waterBlastEffect[6].effectLevel=510.194000
    dbObj.waterBlastEffect[6].damageFactor=0.200000
    dbObj.waterBlastEffect[7].effectLevel=752.039001
    dbObj.waterBlastEffect[7].damageFactor=0.250000
    dbObj.waterBlastEffect[8].effectLevel=1090.639038
    dbObj.waterBlastEffect[8].damageFactor=0.333000
    dbObj.waterBlastEffect[9].effectLevel=1560.142944
    dbObj.waterBlastEffect[9].damageFactor=0.500000
    dbObj.waterBlastEffect[10].effectLevel=2247.122070
    dbObj.waterBlastEffect[10].damageFactor=1.000000
    dbObj.waterBlastEffect[11].effectLevel=2822.706055
    dbObj.waterBlastEffect[11].damageFactor=2.000000
    dbObj.waterBlastEffect[12].effectLevel=3387.635986
    ...
    dbObj.internalEffect[1].damageFactor=0.317330
    dbObj.internalEffect[2].effectLevel=2.000000
    dbObj.internalEffect[2].damageFactor=0.634710
    dbObj.internalEffect[3].effectLevel=4.000000
    dbObj.internalEffect[3].damageFactor=1.269050
    dbObj.internalEffect[4].effectLevel=8.000000
    dbObj.internalEffect[4].damageFactor=2.537180
    dbObj.internalEffect[5].effectLevel=16.000000
    dbObj.internalEffect[5].damageFactor=5.075350
    dbObj.internalEffect[6].effectLevel=32.000000
    dbObj.internalEffect[6].damageFactor=10.152390
    return dbObj
