...
def CreateDBObject():
    ...
    dbObj.databaseClass='A-7E durability'
    ...
    dbObj.blastEffect[6].effectLevel=4.370000
    ...
    dbObj.blastEffect[8].effectLevel=6.640000
    ...
    dbObj.blastEffect[11].effectLevel=11.450000
    dbObj.blastEffect[11].damageFactor=1.000000
    dbObj.blastEffect[12].effectLevel=14.430000
    ...
    dbObj.fragEffect[2].damageFactor=0.028170
    dbObj.fragEffect[3].effectLevel=6000.000000
    dbObj.fragEffect[3].damageFactor=0.056330
    dbObj.fragEffect[4].effectLevel=10000.000000
    dbObj.fragEffect[4].damageFactor=0.093890
    dbObj.fragEffect[5].effectLevel=30000.000000
    dbObj.fragEffect[5].damageFactor=0.281670
    dbObj.fragEffect[6].effectLevel=60000.000000
    dbObj.fragEffect[6].damageFactor=0.563340
    dbObj.fragEffect[7].effectLevel=100000.000000
    dbObj.fragEffect[7].damageFactor=0.938910
    dbObj.fragEffect[8].effectLevel=300000.000000
    dbObj.fragEffect[8].damageFactor=2.816720
    dbObj.fragEffect[9].effectLevel=600000.000000
    dbObj.fragEffect[9].damageFactor=5.633430
    dbObj.fragEffect[10].effectLevel=1000000.000000
    dbObj.fragEffect[10].damageFactor=9.389050
    dbObj.fragEffect[11].effectLevel=3000000.000000
    dbObj.fragEffect[11].damageFactor=28.167160
    ...
    dbObj.internalEffect[1].damageFactor=80.546494
    return dbObj
