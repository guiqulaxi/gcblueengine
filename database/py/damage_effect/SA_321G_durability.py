...
def CreateDBObject():
    ...
    dbObj.databaseClass='SA-321G durability'
    ...
    dbObj.blastEffect[10].effectLevel=8.020000
    ...
    dbObj.fragEffect[3].damageFactor=0.067820
    ...
    dbObj.fragEffect[5].damageFactor=0.339120
    dbObj.fragEffect[6].effectLevel=60000.000000
    dbObj.fragEffect[6].damageFactor=0.678230
    dbObj.fragEffect[7].effectLevel=100000.000000
    dbObj.fragEffect[7].damageFactor=1.130390
    dbObj.fragEffect[8].effectLevel=300000.000000
    dbObj.fragEffect[8].damageFactor=3.391170
    dbObj.fragEffect[9].effectLevel=600000.000000
    dbObj.fragEffect[9].damageFactor=6.782340
    dbObj.fragEffect[10].effectLevel=1000000.000000
    dbObj.fragEffect[10].damageFactor=11.303900
    ...
    dbObj.internalEffect[1].damageFactor=242.383286
    return dbObj
