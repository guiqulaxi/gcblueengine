...
def CreateDBObject():
    ...
    dbObj.databaseClass='F-15J durability'
    ...
    dbObj.blastEffect[6].effectLevel=4.860000
    ...
    dbObj.blastEffect[8].effectLevel=7.540000
    ...
    dbObj.blastEffect[10].effectLevel=11.120000
    ...
    dbObj.fragEffect[2].damageFactor=0.020490
    ...
    dbObj.fragEffect[6].damageFactor=0.409710
    dbObj.fragEffect[7].effectLevel=100000.000000
    dbObj.fragEffect[7].damageFactor=0.682850
    dbObj.fragEffect[8].effectLevel=300000.000000
    dbObj.fragEffect[8].damageFactor=2.048540
    dbObj.fragEffect[9].effectLevel=600000.000000
    dbObj.fragEffect[9].damageFactor=4.097070
    dbObj.fragEffect[10].effectLevel=1000000.000000
    dbObj.fragEffect[10].damageFactor=6.828450
    dbObj.fragEffect[11].effectLevel=3000000.000000
    dbObj.fragEffect[11].damageFactor=20.485359
    ...
    dbObj.internalEffect[1].damageFactor=73.768440
    return dbObj
