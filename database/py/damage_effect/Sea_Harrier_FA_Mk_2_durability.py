...
def CreateDBObject():
    ...
    dbObj.databaseClass='Sea Harrier FA.Mk.2 durability'
    ...
    dbObj.blastEffect[5].effectLevel=3.360000
    ...
    dbObj.blastEffect[7].effectLevel=5.080000
    ...
    dbObj.blastEffect[10].effectLevel=8.940000
    dbObj.blastEffect[10].damageFactor=0.900000
    dbObj.blastEffect[11].effectLevel=10.570000
    dbObj.blastEffect[11].damageFactor=1.000000
    dbObj.blastEffect[12].effectLevel=13.320000
    ...
    dbObj.fragEffect[3].damageFactor=0.055630
    dbObj.fragEffect[4].effectLevel=10000.000000
    dbObj.fragEffect[4].damageFactor=0.092710
    dbObj.fragEffect[5].effectLevel=30000.000000
    dbObj.fragEffect[5].damageFactor=0.278130
    dbObj.fragEffect[6].effectLevel=60000.000000
    dbObj.fragEffect[6].damageFactor=0.556250
    dbObj.fragEffect[7].effectLevel=100000.000000
    dbObj.fragEffect[7].damageFactor=0.927090
    dbObj.fragEffect[8].effectLevel=300000.000000
    dbObj.fragEffect[8].damageFactor=2.781270
    dbObj.fragEffect[9].effectLevel=600000.000000
    dbObj.fragEffect[9].damageFactor=5.562540
    dbObj.fragEffect[10].effectLevel=1000000.000000
    dbObj.fragEffect[10].damageFactor=9.270910
    dbObj.fragEffect[11].effectLevel=3000000.000000
    dbObj.fragEffect[11].damageFactor=27.812719
    ...
    dbObj.internalEffect[1].damageFactor=158.036087
    return dbObj
