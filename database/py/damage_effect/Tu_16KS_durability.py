...
def CreateDBObject():
    ...
    dbObj.databaseClass='Tu-16KS durability'
    ...
    dbObj.blastEffect[7].effectLevel=5.490000
    ...
    dbObj.blastEffect[9].effectLevel=8.270000
    ...
    dbObj.blastEffect[11].effectLevel=11.840000
    dbObj.blastEffect[11].damageFactor=1.000000
    dbObj.blastEffect[12].effectLevel=14.920000
    ...
    dbObj.fragEffect[2].damageFactor=0.026440
    dbObj.fragEffect[3].effectLevel=6000.000000
    dbObj.fragEffect[3].damageFactor=0.052880
    dbObj.fragEffect[4].effectLevel=10000.000000
    dbObj.fragEffect[4].damageFactor=0.088130
    dbObj.fragEffect[5].effectLevel=30000.000000
    dbObj.fragEffect[5].damageFactor=0.264380
    dbObj.fragEffect[6].effectLevel=60000.000000
    dbObj.fragEffect[6].damageFactor=0.528760
    dbObj.fragEffect[7].effectLevel=100000.000000
    dbObj.fragEffect[7].damageFactor=0.881260
    dbObj.fragEffect[8].effectLevel=300000.000000
    dbObj.fragEffect[8].damageFactor=2.643790
    dbObj.fragEffect[9].effectLevel=600000.000000
    dbObj.fragEffect[9].damageFactor=5.287570
    dbObj.fragEffect[10].effectLevel=1000000.000000
    dbObj.fragEffect[10].damageFactor=8.812620
    dbObj.fragEffect[11].effectLevel=3000000.000000
    dbObj.fragEffect[11].damageFactor=26.437860
    ...
    dbObj.internalEffect[1].damageFactor=79.108757
    return dbObj
