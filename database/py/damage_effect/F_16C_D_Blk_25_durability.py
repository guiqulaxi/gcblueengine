...
def CreateDBObject():
    ...
    dbObj.databaseClass='F-16C/D Blk 25 durability'
    ...
    dbObj.blastEffect[5].effectLevel=3.820000
    ...
    dbObj.blastEffect[9].effectLevel=8.990000
    ...
    dbObj.blastEffect[11].effectLevel=12.870000
    dbObj.blastEffect[11].damageFactor=1.000000
    dbObj.blastEffect[12].effectLevel=16.219999
    ...
    dbObj.fragEffect[2].damageFactor=0.021820
    dbObj.fragEffect[3].effectLevel=6000.000000
    dbObj.fragEffect[3].damageFactor=0.043630
    dbObj.fragEffect[4].effectLevel=10000.000000
    dbObj.fragEffect[4].damageFactor=0.072720
    dbObj.fragEffect[5].effectLevel=30000.000000
    dbObj.fragEffect[5].damageFactor=0.218170
    dbObj.fragEffect[6].effectLevel=60000.000000
    dbObj.fragEffect[6].damageFactor=0.436340
    dbObj.fragEffect[7].effectLevel=100000.000000
    dbObj.fragEffect[7].damageFactor=0.727240
    dbObj.fragEffect[8].effectLevel=300000.000000
    dbObj.fragEffect[8].damageFactor=2.181720
    dbObj.fragEffect[9].effectLevel=600000.000000
    dbObj.fragEffect[9].damageFactor=4.363450
    dbObj.fragEffect[10].effectLevel=1000000.000000
    dbObj.fragEffect[10].damageFactor=7.272410
    dbObj.fragEffect[11].effectLevel=3000000.000000
    dbObj.fragEffect[11].damageFactor=21.817240
    ...
    dbObj.internalEffect[1].damageFactor=86.491730
    return dbObj
