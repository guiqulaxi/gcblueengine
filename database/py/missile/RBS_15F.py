...
def CreateDBObject():
    ...
    dbObj.mzClass='RBS-15F'
    dbObj.natoClass='RBS-15F'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoRBS-15F.jpg'
    dbObj.mz3DModelFileName='harpoon.xml'
    dbObj.notes='Air launched version of RBS-15M, doesn\'t have the boosters.'
    ...
    dbObj.mfBoostThrust_N=3600.000000
    dbObj.mfBoostTime_s=245.000000
