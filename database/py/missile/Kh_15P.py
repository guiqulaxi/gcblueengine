...
def CreateDBObject():
    ...
    dbObj.mzClass='Kh-15P'
    dbObj.natoClass='AS-16 Kickback ARM'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoKH-15P.jpg'
    ...
    dbObj.detonationRange_m=8.500000
    ...
    dbObj.maSensorClass='Kh-15P Seeker'
