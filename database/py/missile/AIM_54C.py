...
def CreateDBObject():
    ...
    dbObj.mzClass='AIM-54C'
    dbObj.natoClass='AIM-54C'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAIM-54C.jpg'
    dbObj.mz3DModelFileName='am-39.xml'
    dbObj.notes='Digital electronics to improve capabilities against cruise missiles and eccm as well as a reliability increase.  Production begain in 1982 and was not stopped until 1988, with the introduction of the AIM-54C ECCM.  About half of all built missiles are C\'s, in early 2000 only C\'s are in service.'
