...
def CreateDBObject():
    ...
    dbObj.mzClass='R.550 Magic II'
    dbObj.natoClass='R.550 Magic II'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoR.550.2.jpg'
    ...
    dbObj.damageModel='BlastFragAir13.5kg'
    ...
    dbObj.detonationRange_m=6.644747
    ...
    dbObj.mfCdpsub=0.022800
    dbObj.mfCdptran=0.028500
    dbObj.mfCdpsup=0.019000
