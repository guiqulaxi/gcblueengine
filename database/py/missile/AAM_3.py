...
def CreateDBObject():
    ...
    dbObj.mzClass='AAM-3'
    dbObj.natoClass='AAM-3'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=90000.000000
    dbObj.weight_kg=91.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAAM3.jpg'
    ...
    dbObj.mfMaxTurnRate_degps=165.190002
    dbObj.mfCdpsub=0.017000
