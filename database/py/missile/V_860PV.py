...
def CreateDBObject():
    ...
    dbObj.mzClass='V-860PV'
    dbObj.natoClass='V-860PV'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoV-860PV.jpg'
    ...
    dbObj.mfMaxTurnRate_degps=21.860001
    ...
    dbObj.maFlightProfile[0].mfAltitude_m=17000.000000
