...
def CreateDBObject():
    ...
    dbObj.mzClass='AIM-9G'
    dbObj.natoClass='AIM-9G'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=90000.000000
    dbObj.weight_kg=86.599998
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAIM-9G.jpg'
    dbObj.mz3DModelFileName='AIM-9LandM.xml'
    dbObj.notes='produced from 1970 until 1972, 2120 in total, will assume a 3 year service life from 1971 until 1974.'
