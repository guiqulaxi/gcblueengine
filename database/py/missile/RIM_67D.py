...
def CreateDBObject():
    ...
    dbObj.mzClass='RIM-67D'
    dbObj.natoClass='RIM-67D'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoRIM-67D.jpg'
    ...
    dbObj.maFlightProfile[0].mfAltitude_m=12800.000000
