...
def CreateDBObject():
    ...
    dbObj.mzClass='AIM-4A'
    dbObj.natoClass='AIM-4A'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAIM-4A.jpg'
