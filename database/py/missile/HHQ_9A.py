...
def CreateDBObject():
    ...
    dbObj.mzClass='HHQ-9A'
    dbObj.natoClass='HHQ-9A'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=100000.000000
    dbObj.weight_kg=330.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoHHQ-9A.jpg'
    dbObj.mz3DModelFileName='roland-sam.xml'
    dbObj.notes='Contributed by greengills-rewritten by amram.  Bruteforced profiles are so damned irritating.'
    ...
    airDetectionDBObject.RCS_dBsm=-4.600000
    airDetectionDBObject.RCS_Model='MissileRCS1'
    airDetectionDBObject.opticalCrossSection_dBsm=4.210000
    ...
    dbObj.maFlightProfile[0].mfAltitude_m=18025.000000
