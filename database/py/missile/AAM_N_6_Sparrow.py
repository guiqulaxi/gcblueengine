...
def CreateDBObject():
    ...
    dbObj.mzClass='AAM-N-6 Sparrow'
    dbObj.natoClass='AAM-N-6 Sparrow'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAIM-7C.jpg'
    dbObj.mz3DModelFileName='aim-9.xml'
    dbObj.notes='enters service in 1958 with the USN, about 2000 were built between 1958 and 1989, it enters service in 1958, and will stay until 1 year past its replacement, the AIM-7E, so 1964.  Production shifted to the AIM-7E in 1963.'
