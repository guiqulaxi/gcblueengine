...
def CreateDBObject():
    ...
    dbObj.mzClass='SAM-N-7 BT-3A'
    dbObj.natoClass='SAM-N-7 BT-3A'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoSAM-N-7_BT-3A.jpg'
    ...
    dbObj.mfSustThrust_N=40500.000000
    dbObj.mfSustTime_s=19.000000
    dbObj.mfShutdownSpeed_mps=450.000000
    dbObj.maSensorClass='RIM-2D Seeker'
