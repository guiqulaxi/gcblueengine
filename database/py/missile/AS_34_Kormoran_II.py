...
def CreateDBObject():
    ...
    dbObj.mzClass='AS.34 Kormoran II'
    dbObj.natoClass='AS.34 Kormoran II'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=575000.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAS-34II.jpg'
    ...
    airDetectionDBObject.RCS_dBsm=-8.200000
    ...
    dbObj.mfBoostThrust_N=1945.000000
    dbObj.mfBoostTime_s=144.500000
    dbObj.mfSustThrust_N=0.000000
    dbObj.mfSustTime_s=0.000000
    dbObj.mfShutdownSpeed_mps=250.000000
    dbObj.maSensorClass='Kormoran Seeker'
