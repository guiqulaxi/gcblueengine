...
def CreateDBObject():
    ...
    dbObj.mzClass='RIM-116A RAM'
    dbObj.natoClass='RIM-116A RAM'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    dbObj.weight_kg=73.500000
    ...
    dbObj.mfGmax=60.000000
    dbObj.mfMaxTurnRate_degps=59.599998
    dbObj.mfCdpsub=0.006120
    dbObj.mfCdptran=0.007650
    dbObj.mfCdpsup=0.005100
    ...
    dbObj.maSensorClass='RIM-116A/B seeker'
