...
def CreateDBObject():
    ...
    dbObj.mzClass='RIM-24C'
    dbObj.natoClass='RIM-24C'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=300000.000000
    dbObj.weight_kg=550.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoRIM-24C.jpg'
    ...
    dbObj.mfSustThrust_N=28000.000000
    dbObj.mfSustTime_s=14.500000
