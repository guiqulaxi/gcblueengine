...
def CreateDBObject():
    ...
    dbObj.mzClass='RIM-7P(v1)'
    dbObj.natoClass='RIM-7P(v1)'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoRIM-7Pv1.jpg'
    dbObj.mz3DModelFileName='roland-sam.xml'
    dbObj.notes='the (v1) and (v2) versions of the RIM-7P are essential due to how GCB handles its FC requirements, launchers, and missiles.  It is not possible for a seeker limited RIM-7 given an initial nav point to remain angle restricted, it is not possible for a seeker limited RIM-7 to be fired from VLS without the intial nav point.  thus we need two separate missiles.'
