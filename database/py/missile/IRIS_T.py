...
def CreateDBObject():
    ...
    dbObj.mzClass='IRIS-T'
    dbObj.natoClass='IRIS-T'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=90000.000000
    dbObj.weight_kg=87.400002
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoIRIS-T.jpg'
