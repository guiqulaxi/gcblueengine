...
def CreateDBObject():
    ...
    dbObj.mzClass='Python 4'
    dbObj.natoClass='Python 4'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    dbObj.weight_kg=120.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoPYTHON 4.jpg'
    ...
    airDetectionDBObject.RCS_dBsm=-14.900000
