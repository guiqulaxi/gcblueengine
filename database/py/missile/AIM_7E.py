...
def CreateDBObject():
    ...
    dbObj.mzClass='AIM-7E'
    dbObj.natoClass='AIM-7E'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAIM-7E.jpg'
    dbObj.mz3DModelFileName='aim-9.xml'
    dbObj.notes='about 25,000 of these were built, and the production lines stay on this model until replaced by the AIM-7F in 1975.  will assume still in service as late as 1982.'
