...
def CreateDBObject():
    ...
    dbObj.mzClass='UGM-109B'
    dbObj.natoClass='UGM-109B'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoUGM-109B.jpg'
    dbObj.mz3DModelFileName='mm-38.xml'
    dbObj.notes='560 km range. In-service dates are guess.'
    ...
    dbObj.mfSustTime_s=2435.000000
