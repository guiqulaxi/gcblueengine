...
def CreateDBObject():
    ...
    dbObj.mzClass='V759'
    dbObj.natoClass='V759'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    dbObj.weight_kg=2406.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoV-759.jpg'
    dbObj.mz3DModelFileName='aim-9.xml'
    dbObj.notes='test case'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfDamage=12.000000
    dbObj.damageModel='SA-2 200kg Warhead'
    ...
    dbObj.mfCdpsub=0.312000
    dbObj.mfCdptran=0.390000
    dbObj.mfCdpsup=0.260000
    dbObj.mfMcm=0.800000
    dbObj.mfMsupm=1.200000
    dbObj.mfBoostThrust_N=528759.000000
    dbObj.mfBoostTime_s=6.000000
    dbObj.mfSustThrust_N=399000.000000
