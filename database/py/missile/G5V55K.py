...
def CreateDBObject():
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/ico5V55K.jpg'
    ...
    dbObj.maSensorClass='Command Guidance 5V55K seeker'
