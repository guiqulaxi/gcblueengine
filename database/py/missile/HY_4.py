...
def CreateDBObject():
    ...
    dbObj.mzClass='HY-4'
    dbObj.natoClass='CSSC-7 Sadsack'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    dbObj.weight_kg=1740.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoHY4.jpg'
    ...
    airDetectionDBObject.RCS_dBsm=0.010000
    ...
    dbObj.mfCdpsub=0.033120
    dbObj.mfCdptran=0.041400
    dbObj.mfCdpsup=0.027600
    dbObj.mfMcm=0.800000
    dbObj.mfMsupm=1.200000
    dbObj.mfBoostThrust_N=115000.000000
    dbObj.mfBoostTime_s=4.000000
    dbObj.mfSustThrust_N=3915.000000
    dbObj.mfSustTime_s=1054.000000
    ...
    dbObj.maFlightProfile[1].mfAltitude_m=70.000000
