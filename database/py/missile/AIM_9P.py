...
def CreateDBObject():
    ...
    dbObj.mzClass='AIM-9P'
    dbObj.natoClass='AIM-9P'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAIM-9P.jpg'
    dbObj.mz3DModelFileName='AIM-9M Sidewinder.xml'
    dbObj.notes='while intended as an export only model, it has ended up in USAF inventories in extensive numbers.  Over 21,000 were built.  Deliveries begain in 1978.'
    ...
    dbObj.maSensorClass='AIM-9P Seeker'
