...
def CreateDBObject():
    ...
    dbObj.mzClass='Mistral 2'
    dbObj.natoClass='Mistral 2'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoMISTRAL2.jpg'
    dbObj.mz3DModelFileName='roland-sam.xml'
    dbObj.notes='only info I have regarding this is that it achieves mach 3.0 instead of 2, and has a maximum range of 6km instead of 5km.  will simply adjust the speed of the Mistral to match, and if it approximates well enough, will not tamper further.'
    ...
    dbObj.mfCdpsub=0.002640
    dbObj.mfCdptran=0.003000
    dbObj.mfCdpsup=0.002400
    dbObj.mfMcm=0.800000
    dbObj.mfMsupm=1.200000
    dbObj.mfBoostThrust_N=8050.000000
