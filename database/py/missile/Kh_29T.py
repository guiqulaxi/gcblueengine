...
def CreateDBObject():
    ...
    dbObj.mzClass='Kh-29T'
    dbObj.natoClass='Kh-29T'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=125000.000000
    dbObj.weight_kg=688.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoKH-29T.jpg'
    ...
    airDetectionDBObject.opticalCrossSection_dBsm=1.250000
    ...
    dbObj.maSensorClass='Maverick Infrared'
