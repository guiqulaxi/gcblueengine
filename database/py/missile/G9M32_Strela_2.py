...
def CreateDBObject():
    ...
    dbObj.mzClass='9M32 Strela 2'
    dbObj.natoClass='SA-N-5 Grail'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    dbObj.weight_kg=9.800000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/ico9M32.jpg'
    ...
    dbObj.mfCdpsub=0.002004
    dbObj.mfCdptran=0.002550
    dbObj.mfCdpsup=0.001700
    dbObj.mfMcm=0.700000
    dbObj.mfMsupm=1.700000
    dbObj.mfBoostThrust_N=5500.000000
    dbObj.mfBoostTime_s=0.800000
    dbObj.mfSustThrust_N=500.000000
    dbObj.mfSustTime_s=7.700000
    dbObj.mfShutdownSpeed_mps=300.000000
    dbObj.maSensorClass='Strela II IR Seeker'
