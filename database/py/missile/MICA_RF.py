...
def CreateDBObject():
    ...
    dbObj.mzClass='MICA RF'
    dbObj.natoClass='MICA RF'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoMICA RF.jpg'
    ...
    dbObj.mfMaxTurnRate_degps=265.000000
    ...
    dbObj.maSensorClass='MICA R Seeker'
