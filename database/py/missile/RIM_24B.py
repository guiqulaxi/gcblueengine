...
def CreateDBObject():
    ...
    dbObj.mzClass='RIM-24B'
    dbObj.natoClass='RIM-24B'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoRIM-24B.jpg'
    ...
    dbObj.maxRange_km=19.400000
    dbObj.probNoFaults=0.600000
    dbObj.payloadClass=''
    ...
    dbObj.mfSustThrust_N=27000.000000
    dbObj.mfSustTime_s=14.000000
