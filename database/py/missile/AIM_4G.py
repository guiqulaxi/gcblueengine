...
def CreateDBObject():
    ...
    dbObj.mzClass='AIM-4G'
    dbObj.natoClass='AIM-4G'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=90000.000000
    dbObj.weight_kg=66.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAIM-4G.jpg'
    ...
    dbObj.maSensorClass='AIM-4G IR seeker'
