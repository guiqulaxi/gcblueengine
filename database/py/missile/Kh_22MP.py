...
def CreateDBObject():
    ...
    dbObj.mzClass='Kh-22MP'
    dbObj.natoClass='AS-4 Kitchen MP'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoKH-22MP.jpg'
    ...
    dbObj.damageModel='BlastFragMis1000kg'
    ...
    dbObj.detonationRange_m=21.839584
    ...
    dbObj.maSensorClass='Kh-22MP Seeker'
