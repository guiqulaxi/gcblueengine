...
def CreateDBObject():
    ...
    dbObj.mzClass='HY-2BII'
    dbObj.natoClass='CSSC-3 Seersucker'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    dbObj.weight_kg=2988.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoHY2BII.jpg'
    ...
    dbObj.mfBoostThrust_N=145000.000000
    dbObj.mfBoostTime_s=6.000000
    dbObj.mfSustThrust_N=2600.000000
    dbObj.mfSustTime_s=835.000000
    dbObj.mfShutdownSpeed_mps=250.000000
    dbObj.maSensorClass='HY-1JA Seeker'
    ...
    dbObj.maFlightProfile[2].mfAltitude_m=8.000000
