...
def CreateDBObject():
    ...
    dbObj.mzClass='AGM-78D'
    dbObj.natoClass='AGM-78D'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAGM-78D.jpg'
    dbObj.mz3DModelFileName='roland-sam.xml'
    dbObj.notes='the final version, built between 1973 and 76, It brings a better motor and bigger warhead, as well as greater reliability.'
