...
def CreateDBObject():
    ...
    dbObj.mzClass='AGM-65A'
    dbObj.natoClass='AGM-65A'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAGM-65A.jpg'
    dbObj.mz3DModelFileName='am-39.xml'
    dbObj.notes='airforce  tv guided, not night capable.  production ends in 1978, after starting in 1972.  35,000 A/B models were delivered, assuming 40% will be A-models.'
    ...
    dbObj.maSensorClass='AGM-65A TV seeker'
