...
def CreateDBObject():
    ...
    dbObj.mzClass='Derby'
    dbObj.natoClass='Derby'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    dbObj.weight_kg=118.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoDERBY.jpg'
    dbObj.mz3DModelFileName='AIM-9LandM.xml'
    dbObj.notes='Marcos - modified by amram'
    ...
    dbObj.mfCdpsub=0.015000
    dbObj.mfCdptran=0.018000
    dbObj.mfCdpsup=0.012000
    dbObj.mfMcm=0.800000
    dbObj.mfMsupm=1.200000
    dbObj.mfBoostThrust_N=34500.000000
