...
def CreateDBObject():
    ...
    dbObj.mzClass='AGM-62 mk23'
    dbObj.natoClass='AGM-62 mk23'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAGM6223.jpg'
    ...
    dbObj.mfCdpsub=0.025500
    dbObj.mfCdptran=0.025500
    dbObj.mfCdpsup=0.025500
