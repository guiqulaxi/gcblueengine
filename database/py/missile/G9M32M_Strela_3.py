...
def CreateDBObject():
    ...
    dbObj.mzClass='9M32M Strela 3'
    dbObj.natoClass='SA-N-8 Gremlin'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    dbObj.weight_kg=10.300000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/ico9M32M.jpg'
    ...
    dbObj.mfMaxTurnRate_degps=72.800003
    dbObj.mfCdpsub=0.001920
    dbObj.mfCdptran=0.002400
    dbObj.mfCdpsup=0.001600
    dbObj.mfMcm=0.700000
    dbObj.mfMsupm=1.700000
    dbObj.mfBoostThrust_N=5500.000000
    dbObj.mfBoostTime_s=0.800000
    dbObj.mfSustThrust_N=680.000000
    dbObj.mfSustTime_s=6.000000
    dbObj.mfShutdownSpeed_mps=300.000000
    dbObj.maSensorClass='Strela III IR Seeker'
    ...
    dbObj.maFlightProfile[0].mfRange_km=8.000000
