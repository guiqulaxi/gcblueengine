...
def CreateDBObject():
    ...
    dbObj.mzClass='AAM-4b'
    dbObj.natoClass='AAM-4b'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAAM4B.jpg'
    ...
    dbObj.mfSustThrust_N=13000.000000
    dbObj.mfSustTime_s=18.000000
    dbObj.mfShutdownSpeed_mps=500.000000
    dbObj.maSensorClass='AAM-4b Seeker'
    ...
    dbObj.maFlightProfile[1].mfAltitude_m=13000.000000
    dbObj.maFlightProfile[1].mfRange_km=15.000000
