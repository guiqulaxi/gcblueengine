...
def CreateDBObject():
    ...
    dbObj.mzClass='AIM-9C'
    dbObj.natoClass='AIM-9C'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.finalYear=1968.989990
    dbObj.country=''
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAIM-9C.jpg'
    dbObj.mz3DModelFileName='AIM-9LandM.xml'
    dbObj.notes='produced from 1965 to 1967, only 1000 built, will only provide limited qtys of this missile, and those in 1967, and 1968 only.'
    ...
    dbObj.maSensorClass='AIM-9C SARH seeker'
