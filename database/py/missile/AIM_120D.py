...
def CreateDBObject():
    ...
    dbObj.mzClass='AIM-120D'
    dbObj.natoClass='AIM-120D'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAIM-120D.jpg'
    dbObj.mz3DModelFileName='aim-120cd.xml'
    dbObj.notes='Contributed by greengills.  a particularily mean upgrade of the AIM-120C7, among other things it features high off boresight capability, expanded no-escape, and 50% greater efefctive range.  Expected to first arrive in service in late 2007/early 2008.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfDamage=18.000000
    ...
    dbObj.mfBoostThrust_N=48000.000000
    dbObj.mfBoostTime_s=2.000000
    dbObj.mfSustThrust_N=10900.000000
    dbObj.mfSustTime_s=25.000000
    dbObj.mfShutdownSpeed_mps=500.000000
    dbObj.maSensorClass='AIM-120D Seeker'
    ...
    dbObj.maFlightProfile[0].mfAltitude_m=15700.000000
