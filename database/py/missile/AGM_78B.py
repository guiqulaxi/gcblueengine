...
def CreateDBObject():
    ...
    dbObj.mzClass='AGM-78B'
    dbObj.natoClass='AGM-78B'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    dbObj.weight_kg=621.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAGM-78B.jpg'
    dbObj.mz3DModelFileName='roland-sam.xml'
    dbObj.notes='this version brings a new seeker head that can seek any emission, not just a single one as before.  previously multiple seeker heads were needed, and had to be chosen from before the mission, now one missile does all.'
    ...
    dbObj.maSensorClass='AGM-78 seeker'
    ...
    dbObj.maFlightProfile[0].mfRange_km=14.500000
