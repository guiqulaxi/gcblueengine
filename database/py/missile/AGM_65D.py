...
def CreateDBObject():
    ...
    dbObj.mzClass='AGM-65D'
    dbObj.natoClass='AGM-65D'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAGM-65D.jpg'
    dbObj.mz3DModelFileName='am-39.xml'
    dbObj.notes='marine corps  twice seeker range of A model, and capability in night ops finally.  infrared seeker.  IOC in 1986.'
