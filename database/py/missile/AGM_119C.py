...
def CreateDBObject():
    ...
    dbObj.mzClass='AGM-119C'
    dbObj.natoClass='AGM-119C'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAGM-119C.jpg'
    dbObj.mz3DModelFileName='agm-119_markiii.xml'
    dbObj.notes=''
    ...
    dbObj.mfSustTime_s=144.500000
    dbObj.mfShutdownSpeed_mps=220.000000
    dbObj.maSensorClass='AGM-119C Seeker'
