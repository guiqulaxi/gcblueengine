...
def CreateDBObject():
    ...
    dbObj.mzClass='AGM-12B'
    dbObj.natoClass='AGM-12B'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAGM-12B.jpg'
    dbObj.mz3DModelFileName='am-39.xml'
    dbObj.notes='increased range and a more powerful warhead, but was still limited to essentially the same range by the method of guidance.  the pilot needs to see and be ably to fly at the target.  Introduced in 1960, will assume much greater numbers than A and in service until 1974.'
    ...
    airDetectionDBObject.RCS_dBsm=-5.900000
    ...
    dbObj.mfBoostThrust_N=5300.000000
    dbObj.mfBoostTime_s=16.000000
