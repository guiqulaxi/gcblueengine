...
def CreateDBObject():
    ...
    dbObj.mzClass='AIM-9J'
    dbObj.natoClass='AIM-9J'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAIM-9J.jpg'
    dbObj.mz3DModelFileName='AIM-9LandM.xml'
    dbObj.notes='a USAF variant, produced from 1972 until replaced by the AIM-9L in 1978, about 10,000 of them were built, assuming an exit service date 3 years after they were replaced, making it 1981, and entering 1 year after production begins making it 1973.'
    ...
    dbObj.mfMaxTurnRate_degps=165.186005
