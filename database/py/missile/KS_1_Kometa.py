...
def CreateDBObject():
    ...
    dbObj.mzClass='KS-1 Kometa'
    dbObj.natoClass='AS-1 Kennel'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    dbObj.weight_kg=2735.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoKS1.jpg'
    dbObj.mz3DModelFileName='KS-1 Kometa.xml'
    dbObj.notes='Air-to-surface version of KS-1 (AS-1 Kennel)'
