...
def CreateDBObject():
    ...
    dbObj.mzClass='Shafrir 1'
    dbObj.natoClass='Shafrir 1'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    dbObj.weight_kg=65.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1963.000000
    dbObj.finalYear=1969.000000
    dbObj.country=''
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoSHAFRIR1.jpg'
