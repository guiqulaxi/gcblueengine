...
def CreateDBObject():
    ...
    dbObj.mzClass='3M54 Warhead Section'
    dbObj.natoClass='3M54 Warhead Section'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/ico3M54.jpg'
    ...
    airDetectionDBObject.RCS_dBsm=-4.400000
    ...
    dbObj.mfBoostThrust_N=150000.000000
    dbObj.mfBoostTime_s=44.200001
    dbObj.mfSustThrust_N=0.000000
    dbObj.mfSustTime_s=0.000000
    dbObj.mfShutdownSpeed_mps=200.000000
    dbObj.maSensorClass='ARGS-14E Seeker'
