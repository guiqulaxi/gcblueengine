...
def CreateDBObject():
    ...
    dbObj.mzClass='AGM-65B'
    dbObj.natoClass='AGM-65B'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAGM-65B.jpg'
    dbObj.mz3DModelFileName='am-39.xml'
    dbObj.notes='airforce  tv guided, not night capable, greater maginification for greater range but more limited arc than A model.  production ends in 1978, after starting in 1972.  35,000 A/B models were delivered, assuming 60% will be B-models.  Still in service today, as the optical seeker is superior in some instances to the IR or Laser methods.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfDamage=56.000000
    dbObj.damageModel='Pen57.5kg'
