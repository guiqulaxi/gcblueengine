...
def CreateDBObject():
    ...
    dbObj.mzClass='RPK-6 Vodopod'
    dbObj.natoClass='SS-N-15 Starfish'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoRPK-6.jpg'
    ...
    dbObj.maxRange_km=37.000000
    dbObj.probNoFaults=0.850000
    dbObj.payloadClass='UMGT-1M.d'
    ...
    airDetectionDBObject.opticalCrossSection_dBsm=4.660000
