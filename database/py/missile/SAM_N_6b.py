...
def CreateDBObject():
    ...
    dbObj.mzClass='SAM-N-6b'
    dbObj.natoClass='SAM-N-6b'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoSAM-N-6B.jpg'
    ...
    dbObj.maFlightProfile[0].mfRange_km=12.000000
