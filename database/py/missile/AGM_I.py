...
def CreateDBObject():
    ...
    dbObj.maFlightProfile[2].meAltitudeMode=pygcb.teAltitudeMode.AM_DATUM
    dbObj.maFlightProfile[2].meGuidanceMode=pygcb.teGuidanceMode.GM_NAV
    dbObj.maFlightProfile[2].mfAltitude_m=750.000000
    dbObj.maFlightProfile[2].mfRange_km=0.000000
