...
def CreateDBObject():
    ...
    dbObj.mzClass='AGM-88B'
    dbObj.natoClass='AGM-88B'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAGM-88B.jpg'
    dbObj.mz3DModelFileName='agm-88.xml'
    dbObj.notes='production of HARM\'s switched to this model in 1987.  It has the multiple emitter capable block 2 seeker, but an improved guidance section which brings compatibility with the planned block 3 software upgrade.  The navy did not update its HARM\'s, and stayed at block II for the 88B.  Block 3 brings improved ability to update them in the field, and the inclusion of a Pre-Briefed mode, where the missile already knows what target its meant for, and roughly where it is before the aircraft even takes off.  GCB cannot emulate either of these features, thus block III block II and block III are just 88B.  Production begins in 1987, making it available as of 1988.'
