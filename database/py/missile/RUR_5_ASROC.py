...
def CreateDBObject():
    ...
    dbObj.mzClass='RUR-5 ASROC'
    dbObj.natoClass='RUR-5 ASROC'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=300000.000000
    dbObj.weight_kg=487.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoRUR-5.jpg'
    ...
    dbObj.maFlightProfile[1].mfRange_km=0.750000
