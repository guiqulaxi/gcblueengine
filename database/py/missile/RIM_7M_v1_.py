...
def CreateDBObject():
    ...
    dbObj.mzClass='RIM-7M(v1)'
    dbObj.natoClass='RIM-7M(v1)'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoRIM-7Mv1.jpg'
    dbObj.mz3DModelFileName='roland-sam.xml'
    dbObj.notes='the (v1) and (v2) versions of the RIM-7M are essential due to how GCB handles its FC requirements, launchers, and missiles.  It is not possible for a seeker limited RIM-7 given an initial nav point to remain angle restricted, it is not possible for a seeker limited RIM-7 to be fired from VLS without the intial nav point.  thus we need two separate missiles.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfDamage=8.000000
    dbObj.damageModel='BlastFragMis35kg'
    ...
    dbObj.maxRange_km=28.600000
    dbObj.probNoFaults=0.850000
    dbObj.payloadClass=''
    dbObj.payloadQuantity=1
    dbObj.datalinkRange_km=0.000000
    dbObj.acceptsUserCommands=False
    dbObj.detonationRange_m=6.382483
