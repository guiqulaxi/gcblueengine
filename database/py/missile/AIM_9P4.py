...
def CreateDBObject():
    ...
    dbObj.mzClass='AIM-9P4'
    dbObj.natoClass='AIM-9P4'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAIM-9P4.jpg'
    dbObj.mz3DModelFileName='AIM-9M Sidewinder.xml'
    dbObj.notes='Marcos-rebuilt by amram'
    ...
    dbObj.maSensorClass='AIM-9P4 Seeker'
