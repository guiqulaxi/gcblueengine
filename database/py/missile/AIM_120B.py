...
def CreateDBObject():
    ...
    dbObj.mzClass='AIM-120B'
    dbObj.natoClass='AIM-120B'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAIM-120B.jpg'
    dbObj.mz3DModelFileName='aim-120ab.xml'
    dbObj.notes='production begins in 1994.  This missile is little different from the AIM-120A, receiving a new guidance unit, will assume improved reliability.'
    ...
    dbObj.maFlightProfile[0].mfAltitude_m=12900.000000
