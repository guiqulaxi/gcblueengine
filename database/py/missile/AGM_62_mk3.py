...
def CreateDBObject():
    ...
    dbObj.mzClass='AGM-62 mk3'
    dbObj.natoClass='AGM-62 mk3'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAGM623.jpg'
    ...
    dbObj.mfCdpsub=0.016200
    dbObj.mfCdptran=0.016200
    dbObj.mfCdpsup=0.016200
