...
def CreateDBObject():
    ...
    dbObj.mzClass='SCALP Naval'
    dbObj.natoClass='SCALP Naval'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoSCALP.jpg'
    dbObj.mz3DModelFileName='mm-38.xml'
    dbObj.notes='warhead size is unknown, other than that to achieve the much greater range a more efficient engine and smaller warhead are used.'
    ...
    dbObj.mfBoostThrust_N=62000.000000
    dbObj.mfBoostTime_s=6.000000
    dbObj.mfSustThrust_N=12900.000000
    dbObj.mfSustTime_s=3300.000000
