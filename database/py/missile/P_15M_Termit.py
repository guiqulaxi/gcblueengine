...
def CreateDBObject():
    ...
    dbObj.mzClass='P-15M Termit'
    dbObj.natoClass='SS-N-2C Styx'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    ...
    dbObj.notes='P-15U upgraded with a superior IR seeker, and increased range'
    ...
    dbObj.maSensorClass='Snegir IR Seeker'
