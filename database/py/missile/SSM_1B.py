...
def CreateDBObject():
    ...
    dbObj.mzClass='SSM-1B'
    dbObj.natoClass='SSM-1B'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    dbObj.weight_kg=660.000000
    ...
    dbObj.mfSustTime_s=620.000000
    dbObj.mfShutdownSpeed_mps=200.000000
    dbObj.maSensorClass='SSM-1 Seeker'
