...
def CreateDBObject():
    ...
    dbObj.mzClass='AGM-78C'
    dbObj.natoClass='AGM-78C'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAGM-78C.jpg'
    dbObj.mz3DModelFileName='roland-sam.xml'
    dbObj.notes='Mainly a USAF project, it was meant to cut the costs of the  program and to help improve reliability.'
