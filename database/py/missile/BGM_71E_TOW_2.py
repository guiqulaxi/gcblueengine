...
def CreateDBObject():
    ...
    dbObj.mzClass='BGM-71E TOW 2'
    dbObj.natoClass='BGM-71E TOW 2'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=0.000000
    dbObj.weight_kg=22.700001
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoBGM71E.jpg'
    ...
    dbObj.mfCdpsub=0.005500
    dbObj.mfCdptran=0.007500
    dbObj.mfCdpsup=0.005000
    dbObj.mfMcm=0.800000
    dbObj.mfMsupm=1.200000
    dbObj.mfBoostThrust_N=4900.000000
