...
def CreateDBObject():
    ...
    dbObj.mzClass='RPK-7 Veter'
    dbObj.natoClass='SS-N-16 Stallion'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=300000.000000
    dbObj.weight_kg=2850.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoRPK-7.jpg'
    ...
    airDetectionDBObject.opticalCrossSection_dBsm=5.230000
    ...
    dbObj.mfDragArea_sm=6.430000
    dbObj.mfGmax=5.000000
    dbObj.mfMaxTurnRate_degps=28.799999
    dbObj.mfCdpsub=0.360000
    dbObj.mfCdptran=0.450000
    dbObj.mfCdpsup=0.300000
    dbObj.mfMcm=0.800000
    dbObj.mfMsupm=1.200000
    dbObj.mfBoostThrust_N=170000.000000
    dbObj.mfBoostTime_s=2.500000
    dbObj.mfSustThrust_N=21500.000000
    dbObj.mfSustTime_s=452.000000
    dbObj.mfShutdownSpeed_mps=190.000000
    dbObj.maSensorClass=''
