...
def CreateDBObject():
    ...
    dbObj.mzClass='AS.34 Kormoran'
    dbObj.natoClass='AS.34 Kormoran'
    dbObj.mnModelType=5
    dbObj.mnType=64
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoAS-34.jpg'
    ...
    dbObj.mfBoostThrust_N=1765.000000
    dbObj.mfBoostTime_s=99.000000
