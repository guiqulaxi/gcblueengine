...
def CreateDBObject():
    ...
    dbObj.mzClass='RIM-24A'
    dbObj.natoClass='RIM-24A'
    dbObj.mnModelType=5
    dbObj.mnType=64
    dbObj.cost=300000.000000
    dbObj.weight_kg=580.000000
    ...
    dbObj.designation=''
    dbObj.imageList=''
    dbObj.iconFileName='mis/icoRIM-24A.jpg'
    ...
    dbObj.mfBoostTime_s=2.900000
    dbObj.mfSustThrust_N=24000.000000
    dbObj.mfSustTime_s=12.500000
