...
def CreateDBObject():
    ...
    dbObj.mzClass='Dagaie D Flares'
    dbObj.natoClass='Dagaie D Flares'
    dbObj.mnModelType=16
    dbObj.mnType=36
    dbObj.cost=0.000000
    dbObj.weight_kg=1.470000
    ...
    dbObj.subType='Chaff'
    dbObj.lifeSpan_s=45.000000
    dbObj.effectiveness=5.000000
    dbObj.maxSpeed_mps=1.200000
