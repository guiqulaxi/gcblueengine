...
def CreateDBObject():
    ...
    dbObj.mzClass='MG-104 Decoy'
    dbObj.natoClass='MG-104 Decoy'
    ...
    dbObj.notes='endurance 30 min at 25 kt, 80 min at 15 kt, 120 min at 12 kt'
