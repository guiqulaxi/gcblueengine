...
def CreateDBObject():
    ...
    dbObj.mzClass='SLQ-32A(v)3 ECM'
    dbObj.natoClass='SLQ-32A(v)3 ECM'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Jams on H thorugh J bands, capable of range gate pull off and azimuth gate pull off.  Each 90° sector is covered continuously by 32 beams, with a total radiated power of 1MW, yielding 31.25kW per beam, or 44.95dB radiated power in each beam.  Improved algorythms for superior missile jamming capability'
    ...
    dbObj.effectivenessRating=0.700000
