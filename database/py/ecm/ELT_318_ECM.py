...
def CreateDBObject():
    ...
    dbObj.mzClass='ELT 318 ECM'
    dbObj.natoClass='ELT 318 ECM'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='I have zero info on the capabilities of this noise jammer, assuming 120kW output.'
