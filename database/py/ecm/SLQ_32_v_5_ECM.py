...
def CreateDBObject():
    ...
    dbObj.mzClass='SLQ-32(v)5 ECM'
    dbObj.natoClass='SLQ-32(v)5 ECM'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Jams on H thorugh J bands, capable of range gate pull off and azimuth gate pull off.  Radiates less power than SLQ-32V(3), assuming this to be 100kW, so radiated power per beam is then 34.95dB'
