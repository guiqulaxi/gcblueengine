...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 985-1'
    dbObj.natoClass='Type 985-1'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Type 984-1 and 984-2 are the Chinese version of Ramses, 984-3 and 984-4 are an S-band modification of Ramses, and Type 985 is an upgraded Type 984-3/984-4'
