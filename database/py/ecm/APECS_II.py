...
def CreateDBObject():
    ...
    dbObj.mzClass='APECS II'
    dbObj.natoClass='APECS II'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='230kW power in up to 30 beams, assuming 15 beams for a per beam effective of 41.8dB radiated power.  unknown angle limits, unknown frequency coverage, assuming it covers from 20ghz down to 100mhz.'
