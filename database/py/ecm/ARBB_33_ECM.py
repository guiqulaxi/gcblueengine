...
def CreateDBObject():
    ...
    dbObj.mzClass='ARBB-33 ECM'
    dbObj.natoClass='ARBB-33 ECM'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Jane\'s abstract: 100 kW output power, 360 deg coverage, and 2 - 4 threats simultaneously'
    ...
    dbObj.ERP_dBW=50.000000
    dbObj.effectivenessRating=0.800000
