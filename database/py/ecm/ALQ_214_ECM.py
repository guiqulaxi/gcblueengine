...
def CreateDBObject():
    ...
    dbObj.mzClass='ALQ-214 ECM'
    dbObj.natoClass='ALQ-214 ECM'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Contributed by greengills.  was setup at 42dB, goal is to prevent it from causing blindness, and to instead merely diminish power.'
