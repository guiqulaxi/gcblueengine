...
def CreateDBObject():
    ...
    dbObj.mzClass='Badger ECM'
    dbObj.natoClass='Badger ECM'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Effectiveness rating is inverse fraction of total bandwidth that jammer can focus power. Use effectivenessRating of 1 for dumb barrage jammer'
