...
def CreateDBObject():
    ...
    dbObj.mzClass='Jammer 100W'
    dbObj.natoClass='Jammer 100W'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Effectiveness rating is inverse fraction of total bandwidth that jammer can focus power. Use effectivenessRating of 1 for dumb barrage jammer. Effectiveness of 100 means this jammer can focus power into 100 MHz of bandwidth (10 GHz / 100)'
    ...
    dbObj.minFrequency_Hz=10.000000
    ...
    dbObj.effectivenessRating=100.000000
