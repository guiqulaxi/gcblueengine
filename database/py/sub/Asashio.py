...
def CreateDBObject():
    ...
    dbObj.mzClass='Asashio'
    dbObj.natoClass='Asashio'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=0.000000
    dbObj.weight_kg=2150000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1966.781982
    dbObj.finalYear=1986.162964
    dbObj.country='Japan'
    ...
    dbObj.damageEffect='Asashio durability'
    dbObj.mnNumLaunchers=8
    dbObj.maLauncherClass=['533mm Japanese Sub Tube Early','533mm Japanese Sub Tube Early','533mm Japanese Sub Tube Early','533mm Japanese Sub Tube Early','533mm Japanese Sub Tube Early','533mm Japanese Sub Tube Early','533mm Japanese Sub Tube Early','533mm Japanese Sub Tube Early']
