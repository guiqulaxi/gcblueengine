...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 053'
    dbObj.natoClass='Romeo'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=0.000000
    ...
    dbObj.damageEffect='Type 053 durability'
    ...
    waterDetectionDBObject.acousticModel='CK160'
