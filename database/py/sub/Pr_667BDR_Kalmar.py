...
def CreateDBObject():
    ...
    dbObj.mzClass='Pr 667BDR Kalmar'
    dbObj.natoClass='Delta III'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=0.000000
    dbObj.weight_kg=10550000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1976.830322
    ...
    dbObj.damageEffect='Pr 667BDR Kalmar durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['SS-N-18 SLBM Module x16','533mm Russian sub tube','533mm Russian sub tube','533mm Russian sub tube','533mm Russian sub tube','406mm torpedo tube','406mm torpedo tube']
    ...
    airDetectionDBObject.RCS_dBsm=13.800000
    airDetectionDBObject.RCS_Model='ShipRCS1'
    airDetectionDBObject.opticalCrossSection_dBsm=7.800000
    airDetectionDBObject.irSignature_dB=11.800000
    ...
    waterDetectionDBObject.TS=18.195000
