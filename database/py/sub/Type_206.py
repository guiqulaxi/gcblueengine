...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 206'
    dbObj.natoClass='Type 206'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=900000000.000000
    dbObj.weight_kg=450000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1973.296997
    dbObj.finalYear=1998.641968
    ...
    dbObj.damageEffect='Type 206 durability'
    ...
    airDetectionDBObject.RCS_dBsm=3.500000
    airDetectionDBObject.RCS_Model='ShipRCS1'
    airDetectionDBObject.opticalCrossSection_dBsm=-2.500000
    airDetectionDBObject.irSignature_dB=1.500000
    ...
    waterDetectionDBObject.acousticModel='GK175'
