...
def CreateDBObject():
    ...
    dbObj.mzClass='SSN 774 Virginia'
    dbObj.natoClass='SSN 774 Virginia'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=2000000000.000000
    dbObj.weight_kg=7900000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=2004.890015
    ...
    sensorPlatformDBObject.sensorClass=['BPS-16','BQQ-5D Active','BQQ-5D Bow Passive','BQQ-6 Port Flank Passive','BQQ-6 Stbd Flank Passive','ESM-1','Periscope-1','TB-16 TA','TB-29 TA']
    ...
    dbObj.damageEffect='SSN 774 Virginia durability'
    ...
    dbObj.maMagazineClass=['SSN774 magazine']
    dbObj.magazineId=[0]
