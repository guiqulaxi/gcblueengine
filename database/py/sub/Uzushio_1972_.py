...
def CreateDBObject():
    ...
    dbObj.mzClass='Uzushio(1972)'
    dbObj.natoClass='Uzushio(1972)'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=0.000000
    dbObj.weight_kg=3600000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1972.900024
    dbObj.finalYear=1991.300049
    dbObj.country='Japan'
    ...
    sensorPlatformDBObject.sensorClass=['Periscope-1','SPR-1 ESM','ZPS-3','ZQQ-2 Active','ZQQ-2 Bow Passive']
