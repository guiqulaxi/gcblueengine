...
def CreateDBObject():
    ...
    dbObj.mzClass='Soryu'
    dbObj.natoClass='Soryu'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=0.000000
    dbObj.weight_kg=3500000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=2009.241943
    ...
    sensorPlatformDBObject.sensorClass=['Periscope-1','ZLA-7 ESM','ZPS-6 AS/SS','ZQQ-7 Active','ZQQ-7 Bow Passive','ZQQ-7 Port Flank Passive','ZQQ-7 Stbd Flank Passive','ZQR-1 TA']
    ...
    dbObj.damageEffect='Soryu durability'
    ...
    waterDetectionDBObject.acousticModel='JK210'
