...
def CreateDBObject():
    ...
    dbObj.mzClass='SSGN 726 Ohio (2008)'
    dbObj.natoClass='SSGN 726 Ohio (2008)'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=1000000000.000000
    dbObj.weight_kg=16600000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=2006.102051
    ...
    dbObj.notes='Renamed from Ohio SSBN to just Ohio. Going to name SSGN conversion as Ohio SSGN'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    sensorPlatformDBObject=pygcb.tcSensorPlatformDBObject()
    sensorPlatformDBObject.sensorClass=['BLQ-10(V)2','BPS-15H','BQQ-6 Bow Passive','BQQ-6 Port Flank Passive','BQQ-6 Stbd Flank Passive','BQS-13 Active','Periscope-1','TB-23 TA']
    ...
    dbObj.maLauncherClass=['533mm Ohio Tube','533mm Ohio Tube','533mm Ohio Tube','533mm Ohio Tube','Ohio SSGN VLS','CSA Mk1','CSA Mk1']
    dbObj.maMagazineClass=['Ohio Torpedo Room']
    dbObj.mnNumMagazines=1
    dbObj.magazineId=[0]
    dbObj.launcherId=[0,1,2,3,4,5,6]
    dbObj.launcherName=['Tube 1','Tube 2','Tube 3','Tube 4','VLS','CM','CM']
    ...
    waterDetectionDBObject.TS=11.755000
