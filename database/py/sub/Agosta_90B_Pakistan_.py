...
def CreateDBObject():
    ...
    dbObj.mzClass='Agosta 90B(Pakistan)'
    dbObj.natoClass='Agosta 90B(Pakistan)'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=0.000000
    dbObj.weight_kg=2050000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1999.681030
    ...
    dbObj.damageEffect='Agosta 90B(Pakistan) durability'
    ...
    waterDetectionDBObject.acousticModel='FK200'
