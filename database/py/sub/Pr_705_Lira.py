...
def CreateDBObject():
    ...
    dbObj.mzClass='Pr 705 Lira'
    dbObj.natoClass='Alfa'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=0.000000
    dbObj.weight_kg=2800000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1971.997314
    dbObj.finalYear=1996.578369
    ...
    sensorPlatformDBObject.sensorClass=['Bukhta ESM','MGK-300 Active','MGK-300 Bow Passive','MRK-50 SS','Periscope-1']
    ...
    dbObj.damageEffect='Pr 705 Lira durability'
    ...
    airDetectionDBObject.RCS_dBsm=9.500000
    airDetectionDBObject.RCS_Model='ShipRCS1'
    airDetectionDBObject.opticalCrossSection_dBsm=3.500000
    airDetectionDBObject.irSignature_dB=7.500000
    ...
    waterDetectionDBObject.TS=11.646000
