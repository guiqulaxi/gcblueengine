...
def CreateDBObject():
    ...
    dbObj.mzClass='Yushio(1987)'
    dbObj.natoClass='Yushio(1987)'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=0.000000
    ...
    sensorPlatformDBObject.sensorClass=['Periscope-1','ZLA-6 ESM','ZPS-6 AS/SS','ZQQ-4 Active','ZQQ-4 Bow Passive','ZQR-1 TA']
