...
def CreateDBObject():
    ...
    dbObj.mzClass='Pr 877EKM Paltus'
    ...
    dbObj.notes='One kilo so far unsold and still in service, presumably its the demo unit used to display what the kilo\'s can do, others are likely buying un-used vessels.'
