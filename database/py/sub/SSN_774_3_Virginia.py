...
def CreateDBObject():
    ...
    dbObj.mzClass='SSN 774.3 Virginia'
    dbObj.natoClass='SSN 774.3 Virginia'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=2000000000.000000
    dbObj.weight_kg=7900000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=2014.813965
    ...
    dbObj.damageEffect='SSN 774.3 Virginia durability'
    ...
    dbObj.maMagazineClass=['SSN774 magazine','SSN774 LPT magazine']
