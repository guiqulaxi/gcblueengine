...
def CreateDBObject():
    ...
    dbObj.mzClass='Pr 636M Vashavyanka(Algeria)'
    dbObj.natoClass='Improved Kilo(Algeria)'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=0.000000
    dbObj.weight_kg=2350000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=2010.244995
    ...
    dbObj.damageEffect='Pr 636M Vashavyanka(China) durability'
    dbObj.mnNumLaunchers=6
    dbObj.maLauncherClass=['533mm 636M Tube','533mm 636M Tube','533mm 636M Tube','533mm 636M Tube','533mm 636M Tube','533mm 636M Tube']
