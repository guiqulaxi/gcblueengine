...
def CreateDBObject():
    ...
    dbObj.mzClass='SSN 688 Los Angeles (1985)'
    dbObj.natoClass='SSN 688 Los Angeles (1985)'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=900000000.000000
    dbObj.weight_kg=6082000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1985.569946
    ...
    sensorPlatformDBObject.sensorClass=['BPS-15F','BQQ-5D Active','BQQ-5D Bow Passive','BQQ-5D Port Flank Passive','BQQ-5D Stbd Flank Passive','ESM-1','Periscope-1','TB-23 TA']
    ...
    dbObj.damageEffect='SSN 688 Los Angeles (1985) durability'
    dbObj.mnNumLaunchers=8
    dbObj.maLauncherClass=['533mm 688 Tube','533mm 688 Tube','533mm 688 Tube','533mm 688 Tube','688 VLS Bank','688 VLS Bank','CSA Mk1','CSA Mk1']
    dbObj.maMagazineClass=['688 magazine']
    dbObj.magazineId=[0]
    dbObj.launcherId=[0,1,2,3,4,5,6,7]
    dbObj.launcherName=['Tube 1','Tube 2','Tube 3','Tube 4','VLS-A','VLS-B','CM','CM']
    dbObj.launcherFOV_deg=[360.000000,360.000000,360.000000,360.000000,360.000000,360.000000,360.000000,360.000000]
    dbObj.launcherAz_deg=[0.000000,0.000000,0.000000,0.000000,0.000000,0.000000,45.000000,315.000000]
    dbObj.launcherEl_deg=[0.000000,0.000000,0.000000,0.000000,90.000000,90.000000,0.000000,0.000000]
    ...
    waterDetectionDBObject.TS=9.500000
    waterDetectionDBObject.TS_Model='SubTSDefault'
    waterDetectionDBObject.acousticModel='AN185'
