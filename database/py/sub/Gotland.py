...
def CreateDBObject():
    ...
    dbObj.mzClass='Gotland'
    dbObj.natoClass='Gotland'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=900000000.000000
    dbObj.weight_kg=1494000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1996.671021
    ...
    sensorPlatformDBObject.sensorClass=['CSU 90-2 Active','CSU 90-2 Bow Passive','CSU 90-2 Port Flank Passive','CSU 90-2 Stbd Flank Passive','ESM-1','Periscope-1','Scanter 2001']
    ...
    dbObj.damageEffect='Gotland durability'
    dbObj.mnNumLaunchers=8
    dbObj.maLauncherClass=['Gotland 400mm','Gotland 400mm','Gotland 400mm','Gotland 400mm','Gotland 533mm','Gotland 533mm','Gotland 533mm','Gotland 533mm']
    dbObj.maMagazineClass=['Gotland Torpedo Racks']
    dbObj.mnNumMagazines=1
    dbObj.magazineId=[0]
    dbObj.launcherId=[0,1,2,3,4,5,6,7]
    dbObj.launcherName=['','','','','','','','']
    dbObj.launcherFOV_deg=[1.000000,1.000000,1.000000,1.000000,1.000000,1.000000,1.000000,1.000000]
    ...
    airDetectionDBObject.opticalCrossSection_dBsm=1.400000
    ...
    waterDetectionDBObject.TS=4.340000
    waterDetectionDBObject.TS_Model='SubTSDefault'
    waterDetectionDBObject.acousticModel='SwK195'
