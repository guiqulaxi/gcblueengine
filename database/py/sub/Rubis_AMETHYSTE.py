...
def CreateDBObject():
    ...
    dbObj.mzClass='Rubis AMETHYSTE'
    dbObj.natoClass='Rubis AMETHYSTE'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=900000000.000000
    dbObj.weight_kg=2410000.000000
    ...
    dbObj.damageEffect='Rubis AMETHYSTE durability'
    ...
    waterDetectionDBObject.TS=5.360000
    waterDetectionDBObject.TS_Model='SubTSDefault'
    waterDetectionDBObject.acousticModel='FN190'
