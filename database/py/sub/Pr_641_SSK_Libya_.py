...
def CreateDBObject():
    ...
    dbObj.mzClass='Pr 641 SSK(Libya)'
    dbObj.natoClass='Foxtrot(Libya)'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=0.000000
    dbObj.weight_kg=1950000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1976.916992
    ...
    dbObj.mfFuelCapacity_kg=15551590.000000
    ...
    dbObj.surfaceSpeed_kts=16.500000
