...
def CreateDBObject():
    ...
    dbObj.mzClass='Natsushio'
    dbObj.natoClass='Natsushio'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=0.000000
    dbObj.weight_kg=790000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1963.494995
    dbObj.finalYear=1978.467041
    dbObj.country='Japan'
    ...
    dbObj.mfFuelCapacity_kg=110600.000000
    dbObj.mfFuelRate_kgps=0.066686
    dbObj.mfToughness=120.000000
    dbObj.damageEffect='Natsushio durability'
