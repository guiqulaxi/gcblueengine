...
def CreateDBObject():
    ...
    dbObj.mzClass='Sodermanland'
    dbObj.natoClass='Sodermanland'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=900000000.000000
    dbObj.weight_kg=1500000.000000
    ...
    dbObj.damageEffect='Sodermanland durability'
    ...
    airDetectionDBObject.RCS_dBsm=7.200000
    airDetectionDBObject.RCS_Model='ShipRCS1'
    airDetectionDBObject.opticalCrossSection_dBsm=1.200000
    ...
    waterDetectionDBObject.acousticModel='SwK205'
