...
def CreateDBObject():
    ...
    dbObj.mzClass='Uzushio'
    dbObj.natoClass='Uzushio'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=0.000000
    dbObj.weight_kg=3600000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1971.056030
    dbObj.finalYear=1988.165039
    dbObj.country='Japan'
    ...
    sensorPlatformDBObject.sensorClass=['Periscope-1','SPR-1 ESM','ZPS-3','ZQQ-1 Active','ZQQ-1 Bow Passive']
