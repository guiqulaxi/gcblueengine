...
def CreateDBObject():
    ...
    dbObj.mzClass='Hayashio'
    dbObj.natoClass='Hayashio'
    dbObj.mnModelType=8
    dbObj.mnType=129
    dbObj.cost=0.000000
    dbObj.weight_kg=750000.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1962.489014
    dbObj.finalYear=1979.223022
    dbObj.country='Japan'
    ...
    dbObj.mfFuelCapacity_kg=105000.000000
    dbObj.mfFuelRate_kgps=0.059089
    dbObj.mfToughness=120.000000
    dbObj.damageEffect='Hayashio durability'
    ...
    dbObj.surfaceSpeed_kts=11.000000
