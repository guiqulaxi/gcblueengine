...
def CreateDBObject():
    ...
    dbObj.mzClass='SOSUS  ARRAY'
    dbObj.natoClass='SOSUS  ARRAY'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.mfMaxRange_km=2500.000000
    dbObj.mfRefRange_km=1.000000
    dbObj.mfFieldOfView_deg=360.000000
    dbObj.minElevation_deg=-90.000000
    dbObj.maxElevation_deg=90.000000
    dbObj.mfScanPeriod_s=300.000000
    dbObj.damageEffect='GenericSensor'
    dbObj.rangeError=1.000000
    dbObj.angleError_deg=2.500000
    dbObj.elevationError_deg=90.000000
    dbObj.minFrequency_Hz=50.000000
    dbObj.maxFrequency_Hz=500.000000
    dbObj.idThreshold_dB=30.000000
