...
def CreateDBObject():
    ...
    dbObj.mzClass='SQS-11 Active'
    dbObj.natoClass='SQS-11 Active'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='http://jproc.ca/sari/asd_et2.html  SQS-11 is just an SQS-10 at lower frequency.'
    ...
    dbObj.minFrequency_Hz=14000.000000
