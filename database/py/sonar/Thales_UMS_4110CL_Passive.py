...
def CreateDBObject():
    ...
    dbObj.mzClass='Thales UMS-4110CL Passive'
    dbObj.natoClass='Thales UMS-4110CL Passive'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='cannot find much for info on this, especially performance, assuming it to be equivalent to SQS-56.'
