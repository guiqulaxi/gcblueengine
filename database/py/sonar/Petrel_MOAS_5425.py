...
def CreateDBObject():
    ...
    dbObj.mzClass='Petrel MOAS 5425'
    dbObj.natoClass='Petrel MOAS 5425'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Mine Avoidance Sonar fitted to Australian ANZAC and Adelaide Class Frigates..  contributed by greengills'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=1.000000
