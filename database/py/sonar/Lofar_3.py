...
def CreateDBObject():
    ...
    dbObj.mzClass='Lofar 3'
    dbObj.natoClass='Lofar 3'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='intended for the Lofar(60) buoy.  as we do not have frequency deendance, will have to settle for increased DI vs Difar.'
