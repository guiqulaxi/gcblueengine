...
def CreateDBObject():
    ...
    dbObj.mzClass='Active Sonar Chinese PB'
    dbObj.natoClass='Active Sonar Chinese PB'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='unknown hull sonar for SHanghai class, copied and downgraded the Duba-25.'
