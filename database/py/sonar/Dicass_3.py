...
def CreateDBObject():
    ...
    dbObj.mzClass='Dicass 3'
    dbObj.natoClass='Dicass 3'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='intended for the Dicass(60) buoy'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=6.500000
    dbObj.mfRefRange_km=1.000000
    dbObj.mfFieldOfView_deg=360.000000
    dbObj.minElevation_deg=-90.000000
    dbObj.maxElevation_deg=90.000000
    dbObj.mfScanPeriod_s=8.430000
    dbObj.damageEffect='GenericSensor'
    dbObj.rangeError=0.075000
    dbObj.angleError_deg=6.846000
