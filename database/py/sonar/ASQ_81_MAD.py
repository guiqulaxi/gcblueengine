...
def CreateDBObject():
    ...
    dbObj.mzClass='ASQ-81 MAD'
    dbObj.natoClass='ASQ-81 MAD'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='made to be incredibly sensitive, but very very short ranged.  maximum range will be about 300m.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=0.300000
    dbObj.mfRefRange_km=1.000000
    dbObj.mfFieldOfView_deg=360.000000
    dbObj.minElevation_deg=-90.000000
    dbObj.maxElevation_deg=90.000000
    dbObj.mfScanPeriod_s=0.120000
