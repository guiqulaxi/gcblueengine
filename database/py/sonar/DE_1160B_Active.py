...
def CreateDBObject():
    ...
    dbObj.mzClass='DE-1160B Active'
    dbObj.natoClass='DE-1160B Active'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='copied from SQS-505 Active'
    ...
    dbObj.minFrequency_Hz=4500.000000
    dbObj.maxFrequency_Hz=5500.000000
