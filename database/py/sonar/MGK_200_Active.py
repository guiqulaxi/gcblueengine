...
def CreateDBObject():
    ...
    dbObj.mzClass='MGK-200 Active'
    dbObj.natoClass='MGK-200 Active'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='I have limited information on the MGK-200 system, assuming it to be slightly superior to MGK-100, going to add 1.5dB to all categories.'
    ...
    dbObj.mfScanPeriod_s=44.872002
    dbObj.damageEffect='GenericSensor'
    dbObj.rangeError=0.047500
