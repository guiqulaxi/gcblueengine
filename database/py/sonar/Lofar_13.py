...
def CreateDBObject():
    ...
    dbObj.mzClass='Lofar 13'
    dbObj.natoClass='Lofar 13'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='intended for the Lofar(10) buoy.  as we do not have frequency deendance, will have to settle for increased DI vs Difar.'
