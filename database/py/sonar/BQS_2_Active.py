...
def CreateDBObject():
    ...
    dbObj.mzClass='BQS-2 Active'
    dbObj.natoClass='BQS-2 Active'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='BQS-2 is essentially just an SQS-10, from before the naming all changed in the early 60\'s.'
