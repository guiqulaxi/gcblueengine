...
def CreateDBObject():
    ...
    dbObj.mzClass='MGK-400V1 Bow Passive'
    ...
    dbObj.notes='Assumed 20% more sensitive, and 10% greater acuity, unknown actual performance.'
    ...
    dbObj.rangeError=0.126000
    dbObj.angleError_deg=1.755000
