...
def CreateDBObject():
    ...
    dbObj.mzClass='Scylla Active'
    dbObj.natoClass='Scylla Active'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Bow and Distributed Sonar Array fitted to the Australian Collins Class SSK.  contributed by greengills'
    ...
    dbObj.rangeError=0.027500
    dbObj.angleError_deg=3.300000
