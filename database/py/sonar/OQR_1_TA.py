...
def CreateDBObject():
    ...
    dbObj.mzClass='OQR-1 TA'
    dbObj.natoClass='OQR-1 TA'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Oki OQR-2 towed array sonar (SQR-19A)'
    ...
    dbObj.rangeError=0.180000
    dbObj.angleError_deg=4.500000
