...
def CreateDBObject():
    ...
    dbObj.mzClass='ZQQ-7 Active'
    dbObj.natoClass='ZQQ-7 Active'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='ZQQ-5 Hughes/Oki sonar active mode'
    ...
    dbObj.rangeError=0.020500
    dbObj.angleError_deg=2.900000
