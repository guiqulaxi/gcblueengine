...
def CreateDBObject():
    ...
    dbObj.mzClass='Type 2050 Passive'
    dbObj.natoClass='Type 2050 Passive'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Due to a shortage of time, im cheating, this is essentially a renamed SQS-53B.'
