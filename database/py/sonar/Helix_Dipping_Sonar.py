...
def CreateDBObject():
    ...
    dbObj.mzClass='Helix Dipping Sonar'
    dbObj.natoClass='Helix Dipping Sonar'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='(Change to real name) Dipping sonar for Ka-28 Helix'
