...
def CreateDBObject():
    ...
    dbObj.mzClass='Gerkules Active'
    dbObj.natoClass='Gerkules Active'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='http://www.alternatewars.com/BBOW/Sonar/SQS_Series.htm'
