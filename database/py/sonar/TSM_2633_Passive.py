...
def CreateDBObject():
    ...
    dbObj.mzClass='TSM 2633 Passive'
    dbObj.natoClass='TSM 2633 Passive'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Performance similar to SQS-23 Passive.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=200.000000
    dbObj.mfRefRange_km=0.900000
    ...
    dbObj.minFrequency_Hz=1000.000000
