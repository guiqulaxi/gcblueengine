...
def CreateDBObject():
    ...
    dbObj.mzClass='Pegas 2M Passive Modes'
    dbObj.natoClass='Buck Toe'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='NATO Buck Toe. Early Russian hull-mounted active/passive sonar.  contributed by greengills'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=11.000000
    dbObj.mfRefRange_km=1.000000
    dbObj.mfFieldOfView_deg=360.000000
    dbObj.minElevation_deg=-90.000000
    dbObj.maxElevation_deg=90.000000
    dbObj.mfScanPeriod_s=25.000000
    dbObj.damageEffect='GenericSensor'
    dbObj.rangeError=10.000000
    dbObj.angleError_deg=3.000000
    dbObj.elevationError_deg=3.000000
