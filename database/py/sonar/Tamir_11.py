...
def CreateDBObject():
    ...
    dbObj.mzClass='Tamir 11'
    dbObj.natoClass='Stag Ear'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='NATO Stag Ear. Early Russian hull-mounted active sonar.  contributed by greengills'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=3.700000
