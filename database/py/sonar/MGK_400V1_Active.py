...
def CreateDBObject():
    ...
    dbObj.mzClass='MGK-400V1 Active'
    ...
    dbObj.notes='MGK-400 Rubikon sonar-active mode.  Assumed 20% more sensitive, and 10% greater acuity, unknown actual performance.'
    ...
    dbObj.mfScanPeriod_s=57.692001
    dbObj.damageEffect='GenericSensor'
    dbObj.rangeError=0.031500
    dbObj.angleError_deg=3.510000
