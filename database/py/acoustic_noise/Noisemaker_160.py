...
def CreateDBObject():
    ...
    dbObj.databaseClass='Noisemaker 160'
    dbObj.xSpeed_kts=[0.000000,5.000000,20.000000,30.000000]
    dbObj.ySL_dB=[160.000000,160.000000,160.000000,160.000000]
    ...
    dbObj.cavitationSL_dB=160.000000
    dbObj.snorkelingSL_dB=160.000000
    dbObj.BuildSLTable()
    return dbObj