...
def CreateDBObject():
    ...
    dbObj.databaseClass='Noisemaker 130'
    dbObj.xSpeed_kts=[0.000000,5.000000,20.000000,30.000000]
    dbObj.ySL_dB=[130.000000,130.000000,130.000000,130.000000]
    ...
    dbObj.cavitationSL_dB=130.000000
    dbObj.snorkelingSL_dB=130.000000
    dbObj.BuildSLTable()
    return dbObj