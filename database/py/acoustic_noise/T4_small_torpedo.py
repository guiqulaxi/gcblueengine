...
def CreateDBObject():
    ...
    dbObj.databaseClass='T4:small torpedo'
    dbObj.xSpeed_kts=[10.000000,20.000000,40.000000,80.000000]
    dbObj.ySL_dB=[104.500000,104.500000,116.000000,139.000000]
    ...
    dbObj.cavitationSL_dB=139.000000
    dbObj.snorkelingSL_dB=139.000000
    dbObj.BuildSLTable()
    return dbObj