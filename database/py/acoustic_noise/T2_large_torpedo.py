...
def CreateDBObject():
    ...
    dbObj.databaseClass='T2:large torpedo'
    dbObj.xSpeed_kts=[10.000000,20.000000,40.000000,80.000000]
    dbObj.ySL_dB=[105.500000,105.500000,120.000000,149.000000]
    ...
    dbObj.cavitationSL_dB=149.000000
    dbObj.snorkelingSL_dB=149.000000
    dbObj.BuildSLTable()
    return dbObj