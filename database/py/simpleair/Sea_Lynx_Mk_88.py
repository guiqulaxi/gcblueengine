...
def CreateDBObject():
    ...
    dbObj.mzClass='Sea Lynx Mk 88'
    dbObj.natoClass='Sea Lynx Mk 88'
    dbObj.mnModelType=6
    dbObj.mnType=34
    ...
    dbObj.iconFileName='air/AdvicoLynxMk88.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['AQS-18 DS Active','AQS-18 DS Passive','ESM-1','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c']
    ...
    dbObj.damageEffect='Sea Lynx Mk 88 durability'
