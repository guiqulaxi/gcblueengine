...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoE2C.jpg'
    dbObj.mz3DModelFileName='e2c.xml'
    dbObj.notes='should add group 1 and group 2 versions'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    sensorPlatformDBObject=pygcb.tcSensorPlatformDBObject()
    sensorPlatformDBObject.sensorClass=['ALR-59 ESM','APS-125','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c']
    ...
    dbObj.damageEffect='E-2C durability'
