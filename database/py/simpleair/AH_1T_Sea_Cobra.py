...
def CreateDBObject():
    ...
    dbObj.mzClass='AH-1T Sea Cobra'
    dbObj.natoClass='AH-1T Sea Cobra'
    dbObj.mnModelType=6
    dbObj.mnType=34
    dbObj.cost=16000000.000000
    dbObj.weight_kg=3641.000000
    ...
    dbObj.iconFileName='air/AdvicoAH1T.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['APR-44 RWR','Eyeball 20/10.n','Eyeball 20/10b.n','Eyeball 20/10c.n','TOW Operator.n']
    ...
    dbObj.damageEffect='AH-1T Sea Cobra durability'
    ...
    dbObj.maxTakeoffWeight_kg=6349.000000
    dbObj.maxAltitude_m=2255.000000
