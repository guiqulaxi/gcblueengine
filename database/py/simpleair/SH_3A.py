...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoSH3A.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['AQS-13B DS Active','AQS-13B DS Passive','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c']
    ...
    dbObj.damageEffect='SH-3A durability'
