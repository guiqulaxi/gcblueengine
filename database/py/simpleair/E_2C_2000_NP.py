...
def CreateDBObject():
    ...
    dbObj.mzClass='E-2C 2000 NP'
    dbObj.natoClass='E-2C 2000 NP'
    dbObj.mnModelType=4
    dbObj.mnType=33
    ...
    dbObj.iconFileName='air/AdvicoE2CNP2K.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ALR-73 ESM','APS-145','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000]
    dbObj.AddComponent(sensorPlatformDBObject)
    dbObj.mfMaxSpeed_kts=340.000000
    dbObj.mfAccel_ktsps=10.000000
    dbObj.mfTurnRate_degps=8.000000
    dbObj.mfFuelCapacity_kg=5384.000000
    dbObj.mfFuelRate_kgps=0.278000
    dbObj.mfToughness=4.000000
    dbObj.damageEffect='E-2C 2000 NP durability'
