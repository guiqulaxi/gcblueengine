...
def CreateDBObject():
    ...
    dbObj.mzClass='Lynx HAS.Mk.2'
    dbObj.natoClass='Lynx HAS.Mk.2'
    dbObj.mnModelType=6
    dbObj.mnType=34
    ...
    sensorPlatformDBObject.sensorClass=['ESM-1','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c','Seaspray Mk1']
    ...
    dbObj.damageEffect='Lynx HAS.Mk.2 durability'
