...
def CreateDBObject():
    ...
    dbObj.mzClass='AEW aircraft'
    dbObj.natoClass='AEW aircraft'
    dbObj.mnModelType=4
    dbObj.mnType=33
    ...
    sensorPlatformDBObject.sensorClass=['AEW radar','ESM-4']
    ...
    dbObj.damageEffect='AEW aircraft durability'
    ...
    airDetectionDBObject.opticalCrossSection_dBsm=15.620000
