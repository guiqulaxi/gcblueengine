...
def CreateDBObject():
    ...
    dbObj.mzClass='AH-1J Sea Cobra'
    dbObj.natoClass='AH-1J Sea Cobra'
    dbObj.mnModelType=6
    dbObj.mnType=34
    dbObj.cost=16000000.000000
    dbObj.weight_kg=2998.000000
    ...
    dbObj.iconFileName='air/AdvicoAH1J.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['APR-44 RWR','Eyeball 20/10.n','Eyeball 20/10b.n','Eyeball 20/10c.n']
    ...
    dbObj.damageEffect='AH-1J Sea Cobra durability'
    dbObj.mnNumLaunchers=7
    dbObj.maLauncherClass=['20mm M197 Chain Gun Cobra','AH-1J Pylon','AH-1J Pylon','AH-1J Pylon','AH-1J Pylon','ALE-39 CMD','ALE-39 CMD']
    ...
    dbObj.maxTakeoffWeight_kg=4525.000000
    dbObj.maxAltitude_m=3475.000000
    dbObj.climbRate_mps=33.000000
    dbObj.gmax=2.500000
