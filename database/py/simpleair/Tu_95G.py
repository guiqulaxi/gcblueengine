...
def CreateDBObject():
    ...
    dbObj.mzClass='Tu-95G'
    dbObj.natoClass='Tu-95G'
    dbObj.mnModelType=4
    dbObj.mnType=33
    ...
    dbObj.iconFileName='air/AdvicoTU95G.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['AEW radar 2','ESM-11','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c']
    ...
    dbObj.damageEffect='Tu-95G durability'
