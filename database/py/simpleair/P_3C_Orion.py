...
def CreateDBObject():
    ...
    dbObj.mzClass='P-3C Orion'
    dbObj.natoClass='P-3C Orion'
    dbObj.mnModelType=4
    dbObj.mnType=33
    dbObj.cost=36000000.000000
    dbObj.weight_kg=27890.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1968.699951
    dbObj.finalYear=2999.000000
    dbObj.country='USA'
    dbObj.designation='ASuW'
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoP3C.JPG'
    ...
    sensorPlatformDBObject.sensorClass=['AAS-36 LLTV','ALR-66 RWR','APS-116','ASQ-81 MAD','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,180.000000,0.000000,0.000000,0.000000]
    ...
    dbObj.damageEffect='P-3C Orion durability'
    dbObj.mnNumLaunchers=9
    dbObj.maLauncherClass=['17 DICASS Launcher','17 LOFAR Launcher','50 DIFAR Launcher','P-3 9-18','P-3 10-17','P-3 11-16','P-3 12-15','P-3 13-14','P-3 Bay']
