...
def CreateDBObject():
    ...
    dbObj.mzClass='SH-14D (94)'
    dbObj.natoClass='SH-14D (94)'
    dbObj.mnModelType=6
    dbObj.mnType=34
    ...
    sensorPlatformDBObject.sensorClass=['AWARE-4','DUAV-4A DS Active','DUAV-4A DS Passive','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c','Sea Spray Mk3']
    ...
    dbObj.damageEffect='SH-14D (94) durability'
