...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoS3A.JPG'
    ...
    sensorPlatformDBObject.sensorClass=['ALR-47 ESM','APS-116','ASQ-81 MAD','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c']
    ...
    dbObj.damageEffect='S-3A durability'
    dbObj.mnNumLaunchers=5
    dbObj.maLauncherClass=['12 DICASS Launcher','12 LOFAR Launcher','36 DIFAR Launcher','S-3 Weapon Bay','S-3 Weapon Bay']
