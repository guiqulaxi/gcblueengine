...
def CreateDBObject():
    ...
    dbObj.mzClass='SH-14B'
    dbObj.natoClass='SH-14B'
    dbObj.mnModelType=6
    dbObj.mnType=34
    ...
    sensorPlatformDBObject.sensorClass=['DUAV-4 DS Active','DUAV-4 DS Passive','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c','Sea Spray Mk3']
    ...
    dbObj.damageEffect='SH-14B durability'
