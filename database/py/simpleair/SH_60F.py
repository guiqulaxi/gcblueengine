...
def CreateDBObject():
    ...
    dbObj.mzClass='SH-60F'
    dbObj.natoClass='SH-60F'
    dbObj.mnModelType=6
    dbObj.mnType=34
    ...
    dbObj.iconFileName='air/AdvicoSH60F.JPG'
    dbObj.mz3DModelFileName='s-70.xml'
    dbObj.notes='60F does not have APS-124 or ALQ-142 ESM that 60B. Need to add AAS-44 FLIR for later aircraft. http://everything2.com/title/SH-60B%252FF+Seahawk'
    ...
    dbObj.damageEffect='SH-60F durability'
