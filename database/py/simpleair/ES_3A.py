...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoES3A.jpg'
    dbObj.mz3DModelFileName='s3viking.xml'
    dbObj.notes=''
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    sensorPlatformDBObject=pygcb.tcSensorPlatformDBObject()
    sensorPlatformDBObject.sensorClass=['ALR-76 ESM','ALR-81 ESM','APS-116','ASQ-81 MAD','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c','OR-263 FLIR']
    ...
    dbObj.damageEffect='ES-3A durability'
    dbObj.mnNumLaunchers=3
    dbObj.maLauncherClass=['6 LOFAR Launcher','27 DIFAR Launcher','27 DICASS Launcher']
