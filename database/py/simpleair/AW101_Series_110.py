...
def CreateDBObject():
    ...
    dbObj.mzClass='AW101 Series 110'
    dbObj.natoClass='AW101 Series 110'
    dbObj.mnModelType=6
    dbObj.mnType=34
    ...
    dbObj.iconFileName='air/AdvicoAW101.jpg'
    dbObj.mz3DModelFileName='s-70.xml'
    dbObj.notes='3222 liters internal fuel though AW brochure states 4096 litres for self-sealing 4-tank install'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    sensorPlatformDBObject=pygcb.tcSensorPlatformDBObject()
    sensorPlatformDBObject.sensorClass=['ELT-156X RWR','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c','Galiflir FLIR','Helras Mk2 DS Active','Helras Mk2 DS Passive','MM/APS-784']
    ...
    dbObj.mfFuelCapacity_kg=2610.000000
    dbObj.mfFuelRate_kgps=0.161400
    dbObj.mfToughness=4.000000
    dbObj.damageEffect='AW101 Series 110 durability'
    dbObj.mnNumLaunchers=4
    dbObj.maLauncherClass=['AW101 Pylon','AW101 Pylon','CM Ejector','CM Ejector']
    ...
    dbObj.maxTakeoffWeight_kg=15600.000000
