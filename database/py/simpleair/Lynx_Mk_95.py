...
def CreateDBObject():
    ...
    dbObj.mzClass='Lynx Mk.95'
    dbObj.natoClass='Lynx Mk.95'
    dbObj.mnModelType=6
    dbObj.mnType=34
    ...
    dbObj.iconFileName='air/AdvicoLynxMk95.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ESM-1','HS 312 DS Active','HS 312 DS Passive','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c','Seaspray Mk1']
    ...
    dbObj.damageEffect='Lynx Mk.95 durability'
