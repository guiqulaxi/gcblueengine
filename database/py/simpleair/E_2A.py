...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoE2A.jpg'
    dbObj.mz3DModelFileName='e2c.xml'
    dbObj.notes='given the problems, corrosion among them and the aircraft having been around for 7 years, i am assuing the other 10 aircraft that were not uprated were simply scrappe'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    sensorPlatformDBObject=pygcb.tcSensorPlatformDBObject()
    sensorPlatformDBObject.sensorClass=['APS-96','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c']
    ...
    dbObj.damageEffect='E-2A durability'
