...
def CreateDBObject():
    ...
    dbObj.mzClass='AP-3C Orion'
    dbObj.natoClass='AP-3C Orion'
    dbObj.mnModelType=4
    dbObj.mnType=33
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoAP3C.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['AMES-C ESM','ASQ-81 MAD','EL/M-2022(v)3','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c','Star Safire III EO','Star Safire III IR']
    sensorPlatformDBObject.sensorAz=[0.000000,180.000000,0.000000,0.000000,0.000000,0.000000,0.000000,0.000000]
    ...
    dbObj.damageEffect='AP-3C Orion durability'
