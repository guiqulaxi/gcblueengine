...
def CreateDBObject():
    ...
    dbObj.mzClass='P-3M Orion'
    dbObj.natoClass='P-3M Orion'
    dbObj.mnModelType=4
    dbObj.mnType=33
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoP3M.JPG'
    ...
    sensorPlatformDBObject.sensorClass=['AMES-C ESM','ASQ-81 MAD','EL/M-2022','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c']
    sensorPlatformDBObject.sensorAz=[0.000000,180.000000,0.000000,0.000000,0.000000,0.000000]
    ...
    dbObj.damageEffect='P-3M Orion durability'
