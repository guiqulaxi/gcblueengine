...
def CreateDBObject():
    ...
    dbObj.mzClass='C-2B'
    dbObj.natoClass='C-2B'
    dbObj.mnModelType=4
    dbObj.mnType=33
    dbObj.cost=80000000.000000
    dbObj.weight_kg=15310.000000
    ...
    dbObj.iconFileName='air/AdvicoC2B.jpg'
    ...
    dbObj.mfMaxSpeed_kts=355.000000
    ...
    dbObj.damageEffect='C-2B durability'
    ...
    airDetectionDBObject.opticalCrossSection_dBsm=11.050000
