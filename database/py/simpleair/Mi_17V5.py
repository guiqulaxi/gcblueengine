...
def CreateDBObject():
    ...
    dbObj.mzClass='Mi-17V5'
    dbObj.natoClass='Mi-17V5'
    dbObj.mnModelType=6
    dbObj.mnType=34
    dbObj.cost=0.000000
    dbObj.weight_kg=7340.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1900.000000
    dbObj.finalYear=2999.000000
    dbObj.country='Russia'
    dbObj.designation='Attack'
    dbObj.imageList='mi17.jpg'
    dbObj.iconFileName='air/AdvicoMI17V5.JPG'
    ...
    dbObj.mfMaxSpeed_kts=130.000000
    dbObj.mfAccel_ktsps=8.000000
    dbObj.mfTurnRate_degps=15.000000
    dbObj.mfFuelCapacity_kg=3000.000000
    dbObj.mfFuelRate_kgps=0.300000
    dbObj.mfToughness=0.000000
    dbObj.damageEffect='Mi-17V5 durability'
    dbObj.mnNumLaunchers=1
    dbObj.maLauncherClass=['ASO-2V']
    ...
    airDetectionDBObject.opticalCrossSection_dBsm=6.630000
