...
def CreateDBObject():
    ...
    dbObj.mzClass='Wessex HAS.1'
    dbObj.natoClass='Wessex HAS.1'
    dbObj.mnModelType=6
    dbObj.mnType=34
    dbObj.cost=0.000000
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoWessex1.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c','Type 194 DS Active']
    ...
    dbObj.damageEffect='Wessex HAS.1 durability'
