...
def CreateDBObject():
    ...
    dbObj.mzClass='P-3C AIP Orion'
    dbObj.natoClass='P-3C AIP Orion'
    dbObj.mnModelType=4
    dbObj.mnType=33
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoP3CAIP.JPG'
    ...
    sensorPlatformDBObject.sensorClass=['AAS-36 FLIR','AAS-36 LLTV','ALR-66 RWR','APS-137','ASQ-81 MAD','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c']
    ...
    dbObj.damageEffect='P-3C AIP Orion durability'
