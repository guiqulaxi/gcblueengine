...
def CreateDBObject():
    ...
    dbObj.mzClass='C-130J'
    dbObj.natoClass='C-130J'
    dbObj.mnModelType=4
    dbObj.mnType=33
    dbObj.cost=0.000000
    ...
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoC130J.jpg'
    ...
    dbObj.maxTakeoffWeight_kg=79378.000000
