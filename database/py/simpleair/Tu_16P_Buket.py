...
def CreateDBObject():
    ...
    dbObj.mzClass='Tu-16P Buket'
    dbObj.natoClass='Badger J'
    dbObj.mnModelType=4
    dbObj.mnType=33
    ...
    dbObj.imageList='tu16.jpg'
    dbObj.iconFileName='air/AdvicoTU16P.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['Badger ECM','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c','Type 245 SS/FC']
    ...
    dbObj.mfFuelRate_kgps=0.620890
    dbObj.mfToughness=20.000000
    dbObj.damageEffect='Tu-16P Buket durability'
