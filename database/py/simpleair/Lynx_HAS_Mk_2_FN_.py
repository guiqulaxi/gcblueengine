...
def CreateDBObject():
    ...
    dbObj.mzClass='Lynx HAS.Mk.2(FN)'
    dbObj.natoClass='Lynx HAS.Mk.2(FN)'
    dbObj.mnModelType=6
    dbObj.mnType=34
    ...
    dbObj.iconFileName='air/AdvicoLynxHAS2.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ESM-1','DUAV-4A DS Active','DUAV-4A DS Passive','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c','Seaspray Mk1']
    ...
    dbObj.damageEffect='Lynx HAS.Mk.2(FN) durability'
