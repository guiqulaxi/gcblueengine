...
def CreateDBObject():
    ...
    dbObj.mzClass='CASA CN-235MP-200 ELINT'
    dbObj.natoClass='CASA CN-235MP-200 ELINT'
    dbObj.mnModelType=4
    dbObj.mnType=33
    dbObj.cost=0.000000
    dbObj.weight_kg=11750.000000
    ...
    dbObj.iconFileName='air/AdvicoCN235MP200EW.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['APS-504(V)5','ELINT Persuader','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c','WESCAM MX20']
    ...
    dbObj.damageEffect='CASA CN-235MP-200 ELINT durability'
    ...
    dbObj.maxTakeoffWeight_kg=15700.000000
