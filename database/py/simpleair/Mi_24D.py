...
def CreateDBObject():
    ...
    dbObj.mzClass='Mi-24D'
    dbObj.natoClass='Mi-24 Hind D'
    dbObj.mnModelType=6
    dbObj.mnType=34
    ...
    dbObj.iconFileName='air/AdvicoMI24D.JPG'
    dbObj.mz3DModelFileName='s-70.xml'
    dbObj.notes='1200 liter internal aux tank for fuel and 2 x 500 liter external options'
    ...
    dbObj.damageEffect='Mi-24D durability'
