...
def CreateDBObject():
    ...
    dbObj.mzClass='AB 212.ASW'
    dbObj.natoClass='AB 212.ASW'
    dbObj.mnModelType=6
    dbObj.mnType=34
    dbObj.cost=0.000000
    ...
    dbObj.notes='rebuild for the Italians, duplicated and then modified from Marcos Viniegra AB212ASW'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    sensorPlatformDBObject=pygcb.tcSensorPlatformDBObject()
    sensorPlatformDBObject.sensorClass=['APS-706','AQS-18 DS Active','AQS-18 DS Passive','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c','PRT-405']
    ...
    dbObj.damageEffect='AB 212.ASW durability'
    dbObj.mnNumLaunchers=2
    dbObj.maLauncherClass=['AB 212.ASW Launcher','AB 212.ASW Launcher']
