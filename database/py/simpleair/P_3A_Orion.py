...
def CreateDBObject():
    ...
    dbObj.mzClass='P-3A Orion'
    dbObj.natoClass='P-3A Orion'
    dbObj.mnModelType=4
    dbObj.mnType=33
    ...
    dbObj.imageList='P-3A.jpg'
    dbObj.iconFileName='air/AdvicoP3A.JPG'
    ...
    dbObj.damageEffect='P-3A Orion durability'
