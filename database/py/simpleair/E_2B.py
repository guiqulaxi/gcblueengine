...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoE2B.jpg'
    dbObj.mz3DModelFileName='e2c.xml'
    dbObj.notes='many of the early E-2B\'s were really E-2A\'s with upgraded sensors, computers, and a solution to the corrosion problem they faced.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    sensorPlatformDBObject=pygcb.tcSensorPlatformDBObject()
    sensorPlatformDBObject.sensorClass=['APS-125','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c']
    ...
    dbObj.damageEffect='E-2B durability'
