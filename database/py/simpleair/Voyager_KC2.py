...
def CreateDBObject():
    ...
    dbObj.mzClass='Voyager KC2'
    dbObj.natoClass='Voyager KC2'
    dbObj.mnModelType=4
    dbObj.mnType=33
    dbObj.cost=0.000000
    ...
    dbObj.iconFileName='air/AdvicoVoyagerKC2.jpg'
    ...
    dbObj.damageEffect='Voyager KC2 durability'
