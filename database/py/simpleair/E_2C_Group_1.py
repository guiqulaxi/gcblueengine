...
def CreateDBObject():
    ...
    dbObj.mzClass='E-2C Group 1'
    dbObj.natoClass='E-2C Group 1'
    dbObj.mnModelType=4
    dbObj.mnType=33
    ...
    dbObj.iconFileName='air/AdvicoE2C1.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['ALR-73 ESM','APS-139','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c']
    ...
    dbObj.damageEffect='E-2C Group 1 durability'
