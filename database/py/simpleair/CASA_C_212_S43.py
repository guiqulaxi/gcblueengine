...
def CreateDBObject():
    ...
    dbObj.mzClass='CASA C-212-S43'
    dbObj.natoClass='CASA C-212-S43'
    dbObj.mnModelType=4
    dbObj.mnType=33
    dbObj.cost=0.000000
    ...
    dbObj.iconFileName='air/AdvicoC212S43.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['AN/AAQ-22','APS-128D','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,0.000000,0.000000,0.000000]
    dbObj.AddComponent(sensorPlatformDBObject)
    dbObj.mfMaxSpeed_kts=200.000000
    dbObj.mfAccel_ktsps=8.000000
    dbObj.mfTurnRate_degps=10.000000
    dbObj.mfFuelCapacity_kg=1731.000000
    dbObj.mfFuelRate_kgps=0.140000
    dbObj.mfToughness=0.000000
    dbObj.damageEffect='CASA C-212-S43 durability'
    ...
    dbObj.maxTakeoffWeight_kg=7700.000000
