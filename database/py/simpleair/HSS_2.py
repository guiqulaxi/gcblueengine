...
def CreateDBObject():
    ...
    dbObj.iconFileName='air/AdvicoHSS2.jpg'
    dbObj.mz3DModelFileName='s-70.xml'
    dbObj.notes='See SH-3H for source material, HSS-2 is a Japanese license built SH-3.'
    ...
    dbObj.damageEffect='HSS-2 durability'
