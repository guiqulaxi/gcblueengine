...
def CreateDBObject():
    ...
    dbObj.mzClass='P-3B Orion'
    dbObj.natoClass='P-3B Orion'
    dbObj.mnModelType=4
    dbObj.mnType=33
    dbObj.cost=36000000.000000
    dbObj.weight_kg=27890.000000
    dbObj.volume_m3=0.000000
    dbObj.initialYear=1965.719971
    dbObj.finalYear=2999.000000
    dbObj.country='USA'
    dbObj.designation='ASuW'
    dbObj.imageList=''
    dbObj.iconFileName='air/AdvicoP3B.JPG'
    ...
    sensorPlatformDBObject.sensorClass=['ALR-66 RWR','APS-116','ASQ-81 MAD','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c']
    sensorPlatformDBObject.sensorAz=[0.000000,0.000000,180.000000,0.000000,0.000000,0.000000]
    ...
    dbObj.damageEffect='P-3B Orion durability'
