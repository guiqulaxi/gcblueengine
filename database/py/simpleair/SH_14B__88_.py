...
def CreateDBObject():
    ...
    dbObj.mzClass='SH-14B (88)'
    dbObj.natoClass='SH-14B (88)'
    dbObj.mnModelType=6
    dbObj.mnType=34
    ...
    dbObj.iconFileName='air/AdvicoSH14B.jpg'
    ...
    sensorPlatformDBObject.sensorClass=['DUAV-4A DS Active','DUAV-4A DS Passive','Eyeball 20/10','Eyeball 20/10b','Eyeball 20/10c','Sea Spray Mk3']
    ...
    dbObj.damageEffect='SH-14B (88) durability'
