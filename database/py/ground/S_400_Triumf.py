...
def CreateDBObject():
    ...
    dbObj.mzClass='S-400 Triumf'
    dbObj.natoClass='SA-21A Growler'
    ...
    sensorPlatformDBObject.sensorClass=['64N6E2','92N2','Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h']
    ...
    dbObj.maLauncherClass=['S-400 Triumf Launcher','S-400 Triumf Launcher','S-400 Triumf Launcher','S-400 Triumf Launcher']
    dbObj.maMagazineClass=['S-400 Triumf Store']
    dbObj.magazineId=[0]
    ...
    dbObj.launcherFireControl=['92N2','92N2','92N2','92N2']
