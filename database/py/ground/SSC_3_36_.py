...
def CreateDBObject():
    ...
    dbObj.mzClass='SSC-3(36)'
    dbObj.natoClass='SSC-3(36)'
    ...
    dbObj.maLauncherClass=['SSC-3 launcher','SSC-3 launcher','SSC-3 launcher','SSC-3 launcher','SSC-3 launcher','SSC-3 launcher']
    dbObj.maMagazineClass=['SSC-3 Store 36']
    dbObj.magazineId=[0]
