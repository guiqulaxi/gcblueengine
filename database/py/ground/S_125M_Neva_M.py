...
def CreateDBObject():
    ...
    dbObj.maLauncherClass=['S-125M Neva-M Launcher','S-125M Neva-M Launcher','S-125M Neva-M Launcher','S-125M Neva-M Launcher']
    dbObj.maMagazineClass=['S-125M Neva-M Store']
    dbObj.magazineId=[0]
