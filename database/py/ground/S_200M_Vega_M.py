...
def CreateDBObject():
    ...
    dbObj.maLauncherClass=['S-200M Vega-M Launcher','S-200M Vega-M Launcher','S-200M Vega-M Launcher','S-200M Vega-M Launcher','S-200M Vega-M Launcher','S-200M Vega-M Launcher']
    dbObj.maMagazineClass=['S-200M Vega-M Store']
    dbObj.magazineId=[0]
