...
def CreateDBObject():
    ...
    sensorPlatformDBObject.sensorClass=['5N62m2','Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h','P-35']
    ...
    dbObj.maLauncherClass=['S-200V Vega Launcher','S-200V Vega Launcher','S-200V Vega Launcher','S-200V Vega Launcher','S-200V Vega Launcher','S-200V Vega Launcher']
    dbObj.maMagazineClass=['S-200V Vega Store']
    dbObj.magazineId=[0]
