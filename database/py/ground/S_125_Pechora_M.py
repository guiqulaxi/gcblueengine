...
def CreateDBObject():
    ...
    dbObj.mzClass='S-125 Pechora-M'
    dbObj.natoClass='S-125 Pechora-M'
    ...
    dbObj.maLauncherClass=['S-125 Pechora-M Launcher','S-125 Pechora-M Launcher','S-125 Pechora-M Launcher','S-125 Pechora-M Launcher']
    dbObj.maMagazineClass=['S-125 Pechora-M Store']
    dbObj.magazineId=[0]
