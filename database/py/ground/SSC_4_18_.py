...
def CreateDBObject():
    ...
    dbObj.mzClass='SSC-4(18)'
    dbObj.natoClass='SSC-4(18)'
    ...
    dbObj.maLauncherClass=['SSC-4 launcher','SSC-4 launcher','SSC-4 launcher']
    dbObj.maMagazineClass=['SSC-4 Store 18']
    ...
    dbObj.launcherEl_deg=[30.000000,0.000000,0.000000]
    dbObj.launcherFireControl=['','','']
    dbObj.launcherFireControl2=['','','']
    dbObj.launcherIsReloadable=[True,False,False]
    airDetectionDBObject=pygcb.tcAirDetectionDBObject()
    airDetectionDBObject.RCS_dBsm=22.552999
    airDetectionDBObject.RCS_Model='Default'
    airDetectionDBObject.opticalCrossSection_dBsm=22.552999
    airDetectionDBObject.irSignature_dB=22.552999
