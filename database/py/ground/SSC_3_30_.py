...
def CreateDBObject():
    ...
    dbObj.mzClass='SSC-3(30)'
    dbObj.natoClass='SSC-3(30)'
    ...
    dbObj.maLauncherClass=['SSC-3 launcher','SSC-3 launcher','SSC-3 launcher','SSC-3 launcher','SSC-3 launcher']
    dbObj.maMagazineClass=['SSC-3 Store 30']
    dbObj.magazineId=[0]
