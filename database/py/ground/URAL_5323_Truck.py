...
def CreateDBObject():
    ...
    dbObj.mzClass='URAL-5323 Truck'
    dbObj.natoClass='URAL-5323 Truck'
    dbObj.mnModelType=17
    dbObj.mnType=258
    dbObj.cost=0.000000
    dbObj.weight_kg=21450.000000
    ...
    dbObj.mfMaxSpeed_kts=45.900002
    dbObj.mfAccel_ktsps=5.000000
    dbObj.mfTurnRate_degps=10.000000
    dbObj.mfFuelCapacity_kg=1329.000000
