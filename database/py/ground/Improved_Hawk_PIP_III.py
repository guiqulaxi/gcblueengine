...
def CreateDBObject():
    ...
    dbObj.mzClass='Improved Hawk PIP III'
    dbObj.natoClass='Improved Hawk PIP III'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20','Eyeball 20/20b','Eyeball 20/20c','Eyeball 20/20d','MPQ-50','MPQ-61']
    ...
    dbObj.maLauncherClass=['Improved Hawk PIP III Launcher','Improved Hawk PIP III Launcher','Improved Hawk PIP III Launcher']
    ...
    dbObj.launcherFireControl=['MPQ-61','MPQ-61','MPQ-61']
