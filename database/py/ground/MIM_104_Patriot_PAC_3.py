...
def CreateDBObject():
    ...
    dbObj.mzClass='MIM-104 Patriot PAC-3'
    dbObj.natoClass='Patriot PAC-3'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h','MPQ-53 Passive','MPQ-53']
    ...
    dbObj.maLauncherClass=['MIM-104 Patriot PAC-3 Launcher','MIM-104 Patriot PAC-3 Launcher','MIM-104 Patriot PAC-3 Launcher','MIM-104 Patriot PAC-3 Launcher','MIM-104 Patriot PAC-3 Launcher','MIM-104 Patriot PAC-3 Launcher']
    dbObj.maMagazineClass=['MIM-104 Patriot PAC-3 Store']
    dbObj.magazineId=[0]
    ...
    dbObj.launcherFireControl=['MPQ-53','MPQ-53','MPQ-53','MPQ-53','MPQ-53','MPQ-53']
