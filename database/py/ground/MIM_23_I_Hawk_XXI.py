...
def CreateDBObject():
    ...
    dbObj.mzClass='MIM-23 I-Hawk XXI'
    dbObj.natoClass='I-Hawk XXI'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h','MPQ-61','MPQ-64']
    ...
    dbObj.maLauncherClass=['MIM-23 I-Hawk XXI Launcher','MIM-23 I-Hawk XXI Launcher','MIM-23 I-Hawk XXI Launcher','MIM-23 I-Hawk XXI Launcher','MIM-23 I-Hawk XXI Launcher','MIM-23 I-Hawk XXI Launcher']
    dbObj.maMagazineClass=['MIM-23 I-Hawk XXI Store']
    dbObj.magazineId=[0]
