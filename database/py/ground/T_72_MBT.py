...
def CreateDBObject():
    ...
    dbObj.mzClass='T-72 MBT'
    dbObj.natoClass='T-72 MBT'
    ...
    dbObj.notes='road speed 60km, off road speed assumed to be 36km, road range 550km, off road range 440km, main fuel 1000 liters.'
    ...
    dbObj.mfFuelCapacity_kg=803.000000
    dbObj.mfFuelRate_kgps=0.021629
