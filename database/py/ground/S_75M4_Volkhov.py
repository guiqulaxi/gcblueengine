...
def CreateDBObject():
    ...
    dbObj.mzClass='S-75M4 Volkhov'
    dbObj.natoClass='S-75M4 Volkhov'
    ...
    dbObj.maLauncherClass=['S-75M4 Volkhov Launcher','S-75M4 Volkhov Launcher','S-75M4 Volkhov Launcher','S-75M4 Volkhov Launcher','S-75M4 Volkhov Launcher','S-75M4 Volkhov Launcher']
    dbObj.maMagazineClass=['S-75M4 Volkhov Store']
    dbObj.magazineId=[0]
