...
def CreateDBObject():
    ...
    dbObj.mzClass='9K33M3 OSA-AKM'
    dbObj.natoClass='SA-8B Gecko'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h','Land Roll']
    ...
    dbObj.maLauncherClass=['9K33M3 OSA-AKM Launcher','9K33M3 OSA-AKM Launcher','9K33M3 OSA-AKM Launcher','9K33M3 OSA-AKM Launcher']
    dbObj.maMagazineClass=['9K33M3 OSA-AKM Store']
    ...
    dbObj.launcherFireControl=['Land Roll','Land Roll','Land Roll','Land Roll']
