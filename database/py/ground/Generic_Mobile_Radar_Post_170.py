...
def CreateDBObject():
    ...
    dbObj.mzClass='Generic Mobile Radar Post 170'
    dbObj.natoClass='Generic Mobile Radar Post 170'
    ...
    sensorPlatformDBObject.sensorClass=['Generic radar 170']
    ...
    dbObj.mfFuelRate_kgps=0.032000
