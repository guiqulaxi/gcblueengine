...
def CreateDBObject():
    ...
    dbObj.mzClass='URAL-375D Truck'
    dbObj.natoClass='URAL-375D Truck'
    dbObj.mnModelType=17
    dbObj.mnType=258
    dbObj.cost=0.000000
    dbObj.weight_kg=8400.000000
    ...
    dbObj.mfMaxSpeed_kts=41.040001
    dbObj.mfAccel_ktsps=5.000000
    dbObj.mfTurnRate_degps=10.000000
    dbObj.mfFuelCapacity_kg=660.799988
