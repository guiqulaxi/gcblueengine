...
def CreateDBObject():
    ...
    dbObj.mzClass='ZSU-23-4V Shilka'
    dbObj.natoClass='ZSU-23-4V Shilka'
    ...
    dbObj.maLauncherClass=['ZSU-23-4V Shilka Launcher']
    dbObj.maMagazineClass=['ZSU-23-4V Shilka Store']
    dbObj.magazineId=[0]
    dbObj.launcherId=[0]
    dbObj.launcherName=['']
