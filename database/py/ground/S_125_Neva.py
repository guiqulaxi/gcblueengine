...
def CreateDBObject():
    ...
    dbObj.mzClass='S-125 Neva'
    dbObj.natoClass='SA-3A Goa'
    ...
    dbObj.maLauncherClass=['S-125 Neva Launcher','S-125 Neva Launcher','S-125 Neva Launcher','S-125 Neva Launcher']
    dbObj.maMagazineClass=['S-125 Neva Store']
