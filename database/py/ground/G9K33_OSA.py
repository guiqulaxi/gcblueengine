...
def CreateDBObject():
    ...
    dbObj.mzClass='9K33 OSA'
    dbObj.natoClass='SA-8A Gecko'
    ...
    dbObj.maLauncherClass=['9K33 OSA Launcher','9K33 OSA Launcher','9K33 OSA Launcher','9K33 OSA Launcher']
    ...
    dbObj.launcherAz_deg=[30.000000,30.000000,30.000000,30.000000]
