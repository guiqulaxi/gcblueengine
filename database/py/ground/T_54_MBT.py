...
def CreateDBObject():
    ...
    dbObj.mzClass='T-54 MBT'
    dbObj.natoClass='T-54 MBT'
    ...
    dbObj.notes='road speed 50km, off road speed assumed 29km, road range 720km, off road range assumed 520km, main fuel 812 liters, auxiliary assumed 400 liters.'
    ...
    dbObj.mfFuelCapacity_kg=973.000000
    dbObj.mfFuelRate_kgps=0.018254
