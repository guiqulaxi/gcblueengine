...
def CreateDBObject():
    ...
    dbObj.mzClass='S-300V1'
    dbObj.natoClass='SA-12 Giant'
    ...
    dbObj.maLauncherClass=['S-300V1 Launcher','S-300V1 Launcher','S-300V1 Launcher','S-300V1 Launcher']
    dbObj.maMagazineClass=['S-300V1 Store']
