...
def CreateDBObject():
    ...
    dbObj.mzClass='SSC-4(36)'
    dbObj.natoClass='SSC-4(36)'
    ...
    dbObj.damageEffect='Generic7'
    dbObj.mnNumLaunchers=5
    dbObj.maLauncherClass=['SSC-4 launcher','SSC-4 launcher','SSC-4 launcher','SSC-4 launcher','SSC-4 launcher']
    dbObj.maMagazineClass=['SSC-4 Store 36']
    dbObj.magazineId=[0]
    ...
    dbObj.launcherEl_deg=[30.000000,0.000000,0.000000,0.000000,0.000000]
    dbObj.launcherFireControl=['','','','','']
    dbObj.launcherFireControl2=['','','','','']
    dbObj.launcherIsReloadable=[True,False,False,False,False]
