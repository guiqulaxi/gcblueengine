...
def CreateDBObject():
    ...
    dbObj.mzClass='S-75 Desna'
    dbObj.natoClass='SA-2C Guideline'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h','P-8','RSN-75-C']
    ...
    dbObj.maLauncherClass=['S-75 Desna Launcher','S-75 Desna Launcher','S-75 Desna Launcher','S-75 Desna Launcher','S-75 Desna Launcher','S-75 Desna Launcher']
    dbObj.maMagazineClass=['S-75 Desna Store']
