...
def CreateDBObject():
    ...
    dbObj.mzClass='SSC-4(30)'
    dbObj.natoClass='SSC-4(30)'
    ...
    dbObj.maMagazineClass=['SSC-4 Store 30']
    ...
    airDetectionDBObject.RCS_dBsm=24.150000
    airDetectionDBObject.RCS_Model='Default'
    airDetectionDBObject.opticalCrossSection_dBsm=24.150000
    airDetectionDBObject.irSignature_dB=24.150000
