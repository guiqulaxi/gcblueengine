...
def CreateDBObject():
    ...
    dbObj.mzClass='SSC-4(12)'
    dbObj.natoClass='SSC-4(12)'
    ...
    dbObj.damageEffect='Generic5'
    dbObj.mnNumLaunchers=2
    dbObj.maLauncherClass=['SSC-4 launcher','SSC-4 launcher']
    dbObj.maMagazineClass=['SSC-4 Store 12']
    ...
    dbObj.launcherEl_deg=[30.000000,0.000000]
    dbObj.launcherFireControl=['','']
    dbObj.launcherFireControl2=['','']
    dbObj.launcherIsReloadable=[True,False]
    airDetectionDBObject=pygcb.tcAirDetectionDBObject()
    airDetectionDBObject.RCS_dBsm=21.459999
    airDetectionDBObject.RCS_Model='Default'
    airDetectionDBObject.opticalCrossSection_dBsm=21.459999
