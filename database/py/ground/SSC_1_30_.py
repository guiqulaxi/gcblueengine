...
def CreateDBObject():
    ...
    dbObj.mzClass='SSC-1(30)'
    dbObj.natoClass='SSC-1(30)'
    ...
    dbObj.maLauncherClass=['SSC-1 launcher','SSC-1 launcher','SSC-1 launcher','SSC-1 launcher','SSC-1 launcher']
    dbObj.maMagazineClass=['SSC-1 Store 30']
    dbObj.magazineId=[0]
