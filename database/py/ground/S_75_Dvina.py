...
def CreateDBObject():
    ...
    dbObj.mzClass='S-75 Dvina'
    dbObj.natoClass='SA-2A Guideline'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h','P-8','RSN-75-A']
    ...
    dbObj.maLauncherClass=['S-75 Dvina Launcher','S-75 Dvina Launcher','S-75 Dvina Launcher','S-75 Dvina Launcher','S-75 Dvina Launcher','S-75 Dvina Launcher']
    dbObj.maMagazineClass=['S-75 Dvina Store']
    dbObj.magazineId=[0]
    ...
    dbObj.launcherFireControl=['RSN-75-A','RSN-75-A','RSN-75-A','RSN-75-A','RSN-75-A','RSN-75-A']
