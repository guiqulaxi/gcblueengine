...
def CreateDBObject():
    ...
    dbObj.mzClass='S-200VE Vega-E'
    dbObj.natoClass='SA-5B Gammon'
    ...
    sensorPlatformDBObject.sensorClass=['5N62m2','Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h','P-50']
    ...
    dbObj.maLauncherClass=['S-200VE Vega-E Launcher','S-200VE Vega-E Launcher','S-200VE Vega-E Launcher','S-200VE Vega-E Launcher','S-200VE Vega-E Launcher','S-200VE Vega-E Launcher']
    dbObj.maMagazineClass=['S-200VE Vega-E Store']
    dbObj.magazineId=[0]
    ...
    dbObj.launcherFireControl=['5N62m2','5N62m2','5N62m2','5N62m2','5N62m2','5N62m2']
