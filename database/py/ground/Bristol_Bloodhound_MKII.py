...
def CreateDBObject():
    ...
    dbObj.mzClass='Bristol Bloodhound MKII'
    dbObj.natoClass='Bloodhound Mk.II'
    ...
    dbObj.maLauncherClass=['Bristol Bloodhound MKII Launcher','Bristol Bloodhound MKII Launcher','Bristol Bloodhound MKII Launcher','Bristol Bloodhound MKII Launcher','Bristol Bloodhound MKII Launcher','Bristol Bloodhound MKII Launcher','Bristol Bloodhound MKII Launcher','Bristol Bloodhound MKII Launcher']
    dbObj.maMagazineClass=['Bristol Bloodhound MKII Store']
    dbObj.magazineId=[0]
