...
def CreateDBObject():
    ...
    dbObj.maLauncherClass=['S-300PM-1 Launcher','S-300PM-1 Launcher','S-300PM-1 Launcher','S-300PM-1 Launcher']
    dbObj.maMagazineClass=['S-300PM-1 Store']
    dbObj.magazineId=[0]
