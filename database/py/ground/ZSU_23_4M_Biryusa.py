...
def CreateDBObject():
    ...
    dbObj.mzClass='ZSU-23-4M Biryusa'
    dbObj.natoClass='ZSU-23-4M Biryusa'
    ...
    dbObj.maLauncherClass=['ZSU-23-4M Biryusa Launcher']
    dbObj.maMagazineClass=['ZSU-23-4M Biryusa Store']
