...
def CreateDBObject():
    ...
    dbObj.mzClass='SSC-2(30)'
    dbObj.natoClass='SSC-2(30)'
    ...
    dbObj.maLauncherClass=['SSC-2 launcher','SSC-2 launcher','SSC-2 launcher','SSC-2 launcher','SSC-2 launcher']
    dbObj.maMagazineClass=['SSC-2 Store 30']
    dbObj.magazineId=[0]
