...
def CreateDBObject():
    ...
    dbObj.mzClass='S-75M2 Volkhov'
    dbObj.natoClass='SA-2E Guideline'
    ...
    dbObj.maLauncherClass=['S-75M2 Volkhov Launcher','S-75M2 Volkhov Launcher','S-75M2 Volkhov Launcher','S-75M2 Volkhov Launcher','S-75M2 Volkhov Launcher','S-75M2 Volkhov Launcher']
    dbObj.maMagazineClass=['S-75M2 Volkhov Store']
