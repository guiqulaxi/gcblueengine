...
def CreateDBObject():
    ...
    dbObj.mzClass='SSC-2(36)'
    dbObj.natoClass='SSC-2(36)'
    ...
    dbObj.maLauncherClass=['SSC-2 launcher','SSC-2 launcher','SSC-2 launcher','SSC-2 launcher','SSC-2 launcher','SSC-2 launcher']
    dbObj.maMagazineClass=['SSC-2 Store 36']
    dbObj.magazineId=[0]
