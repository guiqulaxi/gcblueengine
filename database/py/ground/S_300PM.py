...
def CreateDBObject():
    ...
    dbObj.mzClass='S-300PM'
    dbObj.natoClass='SA-10C Grumble'
    ...
    sensorPlatformDBObject.sensorClass=['30N6E','36D6','Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h']
    ...
    dbObj.maLauncherClass=['S-300PM Launcher','S-300PM Launcher','S-300PM Launcher','S-300PM Launcher']
    dbObj.maMagazineClass=['S-300PM Store']
    dbObj.magazineId=[0]
