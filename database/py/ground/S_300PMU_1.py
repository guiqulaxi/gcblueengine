...
def CreateDBObject():
    ...
    dbObj.mzClass='S-300PMU-1'
    dbObj.natoClass='SA-20A Gargoyle'
    ...
    dbObj.maLauncherClass=['S-300PMU-1 Launcher','S-300PMU-1 Launcher','S-300PMU-1 Launcher','S-300PMU-1 Launcher']
    dbObj.maMagazineClass=['S-300PMU-1 Store']
    dbObj.magazineId=[0]
