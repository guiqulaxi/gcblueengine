...
def CreateDBObject():
    ...
    dbObj.mzClass='MIM-104 Patriot'
    dbObj.natoClass='Patriot'
    ...
    dbObj.maLauncherClass=['MIM-104 Patriot Launcher','MIM-104 Patriot Launcher','MIM-104 Patriot Launcher','MIM-104 Patriot Launcher','MIM-104 Patriot Launcher','MIM-104 Patriot Launcher']
    dbObj.maMagazineClass=['MIM-104 Patriot Store']
    dbObj.magazineId=[0]
