...
def CreateDBObject():
    ...
    dbObj.mzClass='T-55 MBT'
    dbObj.natoClass='T-55 MBT'
    ...
    dbObj.notes='road speed 50km, off road speed assumed 30km, road range 650km, off road range assumed 520km, main fuel 960 liters, auxiliary assumed 400 liters.'
    ...
    dbObj.mfMaxSpeed_kts=21.327999
    dbObj.mfAccel_ktsps=2.100000
    dbObj.mfTurnRate_degps=10.000000
    dbObj.mfFuelCapacity_kg=1092.000000
    dbObj.mfFuelRate_kgps=0.020483
    dbObj.mfToughness=0.000000
    dbObj.damageEffect='Generic4'
    dbObj.mnNumLaunchers=3
    dbObj.maLauncherClass=['105mm generic tank cannon','100mm D-10T','12.7mm NSV']
