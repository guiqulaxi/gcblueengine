...
def CreateDBObject():
    ...
    dbObj.mzClass='SSC-X(18) (Generic)'
    dbObj.natoClass='SSC-X(18) (Generic)'
    ...
    dbObj.maLauncherClass=['Generic SSM launcher','Generic SSM launcher','Generic SSM launcher']
    dbObj.maMagazineClass=['Generic Store (18)']
