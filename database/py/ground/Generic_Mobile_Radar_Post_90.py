...
def CreateDBObject():
    ...
    dbObj.mzClass='Generic Mobile Radar Post 90'
    dbObj.natoClass='Generic Mobile Radar Post 90'
    ...
    sensorPlatformDBObject.sensorClass=['Generic radar 90']
    sensorPlatformDBObject.sensorAz=[0.000000]
    dbObj.AddComponent(sensorPlatformDBObject)
    dbObj.mfMaxSpeed_kts=34.799999
