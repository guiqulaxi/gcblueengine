...
def CreateDBObject():
    ...
    dbObj.mzClass='S-75M3 Volkhov'
    dbObj.natoClass='SA-2F Guideline'
    ...
    dbObj.notes='10OCT2010 Dewitt - changed radar to RSN-75-F, since -E didnt exist in db'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    sensorPlatformDBObject=pygcb.tcSensorPlatformDBObject()
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h','P-12','RSN-75-F']
    ...
    dbObj.maLauncherClass=['S-75M3 Volkhov Launcher','S-75M3 Volkhov Launcher','S-75M3 Volkhov Launcher','S-75M3 Volkhov Launcher','S-75M3 Volkhov Launcher','S-75M3 Volkhov Launcher']
    dbObj.maMagazineClass=['S-75M3 Volkhov Store']
    dbObj.magazineId=[0]
    ...
    dbObj.launcherFireControl=['RSN-75-F','RSN-75-F','RSN-75-F','RSN-75-F','RSN-75-F','RSN-75-F']
