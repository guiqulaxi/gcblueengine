...
def CreateDBObject():
    ...
    dbObj.mzClass='SSC-X(36) (Generic)'
    dbObj.natoClass='SSC-X(36) (Generic)'
    ...
    dbObj.maLauncherClass=['Generic SSM launcher','Generic SSM launcher','Generic SSM launcher','Generic SSM launcher','Generic SSM launcher','Generic SSM launcher']
    dbObj.maMagazineClass=['Generic Store (36)']
    dbObj.magazineId=[0]
    ...
    dbObj.launcherEl_deg=[30.000000,30.000000,30.000000,30.000000,30.000000,30.000000]
    dbObj.launcherFireControl=['','','','','','']
    dbObj.launcherFireControl2=['','','','','','']
    dbObj.launcherIsReloadable=[True,True,True,True,True,True]
    airDetectionDBObject=pygcb.tcAirDetectionDBObject()
    airDetectionDBObject.RCS_dBsm=24.770000
    airDetectionDBObject.RCS_Model='Default'
    airDetectionDBObject.opticalCrossSection_dBsm=24.770000
    airDetectionDBObject.irSignature_dB=24.770000
