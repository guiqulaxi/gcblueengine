...
def CreateDBObject():
    ...
    dbObj.maLauncherClass=['2K12 Kub Launcher','2K12 Kub Launcher','2K12 Kub Launcher','2K12 Kub Launcher']
    dbObj.maMagazineClass=['2K12 Kub Store']
    dbObj.magazineId=[0]
