...
def CreateDBObject():
    ...
    dbObj.mzClass='S-300PMU'
    dbObj.natoClass='SA-10B Grumble'
    ...
    sensorPlatformDBObject.sensorClass=['30N6','36D6','Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h']
    ...
    dbObj.maLauncherClass=['S-300PMU Launcher','S-300PMU Launcher','S-300PMU Launcher','S-300PMU Launcher']
    dbObj.maMagazineClass=['S-300PMU Store']
    dbObj.magazineId=[0]
