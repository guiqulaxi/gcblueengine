...
def CreateDBObject():
    ...
    dbObj.mzClass='MIM-23 I-Hawk Phase3'
    dbObj.natoClass='I-Hawk Phase 3'
    ...
    dbObj.maLauncherClass=['MIM-23 I-Hawk Phase3 Launcher','MIM-23 I-Hawk Phase3 Launcher','MIM-23 I-Hawk Phase3 Launcher','MIM-23 I-Hawk Phase3 Launcher','MIM-23 I-Hawk Phase3 Launcher','MIM-23 I-Hawk Phase3 Launcher']
    dbObj.maMagazineClass=['MIM-23 I-Hawk Phase3 Store']
    dbObj.magazineId=[1]
