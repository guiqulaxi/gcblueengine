...
def CreateDBObject():
    ...
    dbObj.mzClass='T-64 MBT'
    dbObj.natoClass='T-64 MBT'
    ...
    dbObj.notes='road speed 60.5km, off road speed assumed to be 36.3km, road range 700km, off road range assumed to be 560km, main fuel 1310 liters.'
    ...
    dbObj.mfMaxSpeed_kts=26.129999
    dbObj.mfAccel_ktsps=2.600000
    dbObj.mfTurnRate_degps=10.000000
    dbObj.mfFuelCapacity_kg=1052.000000
    dbObj.mfFuelRate_kgps=0.022448
