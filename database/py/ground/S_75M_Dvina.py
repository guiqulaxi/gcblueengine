...
def CreateDBObject():
    ...
    dbObj.mzClass='S-75M Dvina'
    dbObj.natoClass='SA-2B Guideline'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h','P-8','RSN-75-B']
    ...
    dbObj.maLauncherClass=['S-75M Dvina Launcher','S-75M Dvina Launcher','S-75M Dvina Launcher','S-75M Dvina Launcher','S-75M Dvina Launcher','S-75M Dvina Launcher']
    dbObj.maMagazineClass=['S-75M Dvina Store']
    dbObj.magazineId=[0]
    ...
    dbObj.launcherFireControl=['RSN-75-B','RSN-75-B','RSN-75-B','RSN-75-B','RSN-75-B','RSN-75-B']
