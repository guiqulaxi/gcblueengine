...
def CreateDBObject():
    ...
    dbObj.mzClass='S-75M Volkhov'
    dbObj.natoClass='SA-2D Guideline'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h','P-12','RSN-75-C']
    ...
    dbObj.maLauncherClass=['S-75M Volkhov Launcher','S-75M Volkhov Launcher','S-75M Volkhov Launcher','S-75M Volkhov Launcher','S-75M Volkhov Launcher','S-75M Volkhov Launcher']
    dbObj.maMagazineClass=['S-75M Volkhov Store']
    dbObj.magazineId=[0]
    ...
    dbObj.launcherFireControl=['RSN-75-C','RSN-75-C','RSN-75-C','RSN-75-C','RSN-75-C','RSN-75-C']
