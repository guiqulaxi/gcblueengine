...
def CreateDBObject():
    ...
    dbObj.mzClass='2K11 Krug-M'
    dbObj.natoClass='SA-4A Ganef'
    ...
    dbObj.maLauncherClass=['2K11 Krug-M Launcher','2K11 Krug-M Launcher','2K11 Krug-M Launcher']
    dbObj.maMagazineClass=['2K11 Krug-M Store']
    dbObj.magazineId=[0]
