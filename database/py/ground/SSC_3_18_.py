...
def CreateDBObject():
    ...
    dbObj.mzClass='SSC-3(18)'
    dbObj.natoClass='SSC-3(18)'
    ...
    dbObj.maLauncherClass=['SSC-3 launcher','SSC-3 launcher','SSC-3 launcher']
    dbObj.maMagazineClass=['SSC-3 Store 18']
    ...
    dbObj.launcherEl_deg=[30.000000,30.000000,30.000000]
