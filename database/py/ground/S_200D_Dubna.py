...
def CreateDBObject():
    ...
    dbObj.mzClass='S-200D Dubna'
    dbObj.natoClass='SA-5C Gammon'
    ...
    dbObj.maLauncherClass=['S-200D Dubna Launcher','S-200D Dubna Launcher','S-200D Dubna Launcher','S-200D Dubna Launcher','S-200D Dubna Launcher','S-200D Dubna Launcher']
    dbObj.maMagazineClass=['S-200D Dubna Store']
    dbObj.magazineId=[0]
