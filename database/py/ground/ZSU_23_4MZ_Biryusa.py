...
def CreateDBObject():
    ...
    dbObj.mzClass='ZSU-23-4MZ Biryusa'
    dbObj.natoClass='ZSU-23-4MZ Biryusa'
    ...
    dbObj.maLauncherClass=['ZSU-23-4MZ Biryusa Launcher']
    dbObj.maMagazineClass=['ZSU-23-4MZ Biryusa Store']
    dbObj.magazineId=[0]
    dbObj.launcherId=[0]
    dbObj.launcherName=['']
