...
def CreateDBObject():
    ...
    dbObj.maLauncherClass=['S-300PT-1 Launcher','S-300PT-1 Launcher','S-300PT-1 Launcher','S-300PT-1 Launcher']
    dbObj.maMagazineClass=['S-300PT-1 Store']
    dbObj.magazineId=[0]
