...
def CreateDBObject():
    ...
    dbObj.mzClass='S-300PM-2 Favorit'
    dbObj.natoClass='SA-20B Gargoyle'
    ...
    sensorPlatformDBObject.sensorClass=['30N6E','96L6','Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h']
    ...
    dbObj.maLauncherClass=['S-300PM-2 Favorit Launcher','S-300PM-2 Favorit Launcher','S-300PM-2 Favorit Launcher','S-300PM-2 Favorit Launcher']
    dbObj.maMagazineClass=['S-300PM-2 Favorit Store']
    dbObj.magazineId=[0]
    ...
    dbObj.launcherEl_deg=[90.000000,90.000000,90.000000,90.000000]
    dbObj.launcherFireControl=['30N6E','30N6E','30N6E','30N6E']
