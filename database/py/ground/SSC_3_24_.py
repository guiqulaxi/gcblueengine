...
def CreateDBObject():
    ...
    dbObj.mzClass='SSC-3(24)'
    dbObj.natoClass='SSC-3(24)'
    ...
    dbObj.maLauncherClass=['SSC-3 launcher','SSC-3 launcher','SSC-3 launcher','SSC-3 launcher']
    dbObj.maMagazineClass=['SSC-3 Store 24']
    dbObj.magazineId=[0]
