...
def CreateDBObject():
    ...
    dbObj.mzClass='SSC-2(24)'
    dbObj.natoClass='SSC-2(24)'
    ...
    dbObj.maLauncherClass=['SSC-2 launcher','SSC-2 launcher','SSC-2 launcher','SSC-2 launcher']
    dbObj.maMagazineClass=['SSC-2 Store 24']
    dbObj.magazineId=[0]
