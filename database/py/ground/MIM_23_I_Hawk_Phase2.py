...
def CreateDBObject():
    ...
    dbObj.mzClass='MIM-23 I-Hawk Phase2'
    dbObj.natoClass='I-Hawk Phase 2'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h','MPQ-50','MPQ-55','MPQ-57']
    ...
    dbObj.maLauncherClass=['MIM-23 I-Hawk Phase2 Launcher','MIM-23 I-Hawk Phase2 Launcher','MIM-23 I-Hawk Phase2 Launcher','MIM-23 I-Hawk Phase2 Launcher','MIM-23 I-Hawk Phase2 Launcher','MIM-23 I-Hawk Phase2 Launcher']
    dbObj.maMagazineClass=['MIM-23 Hawk Store','MIM-23 I-Hawk Phase2 Store']
    ...
    dbObj.launcherFireControl=['MPQ-57','MPQ-57','MPQ-57','MPQ-57','MPQ-57','MPQ-57']
