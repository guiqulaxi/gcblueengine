...
def CreateDBObject():
    ...
    dbObj.maLauncherClass=['S-200 Vega Launcher','S-200 Vega Launcher','S-200 Vega Launcher','S-200 Vega Launcher','S-200 Vega Launcher','S-200 Vega Launcher']
    dbObj.maMagazineClass=['S-200 Vega Store']
    dbObj.magazineId=[0]
