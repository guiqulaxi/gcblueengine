...
def CreateDBObject():
    ...
    dbObj.mzClass='SSC-1(36)'
    dbObj.natoClass='SSC-1(36)'
    ...
    dbObj.maLauncherClass=['SSC-1 launcher','SSC-1 launcher','SSC-1 launcher','SSC-1 launcher','SSC-1 launcher','SSC-1 launcher']
    dbObj.maMagazineClass=['SSC-1 Store 36']
    dbObj.magazineId=[0]
