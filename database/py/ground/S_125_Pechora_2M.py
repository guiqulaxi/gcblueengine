...
def CreateDBObject():
    ...
    dbObj.mzClass='S-125 Pechora-2M'
    dbObj.natoClass='S-125 Pechora-2M'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h','P-15','SNR-125']
    ...
    dbObj.maLauncherClass=['S-125 Pechora-2M Launcher','S-125 Pechora-2M Launcher','S-125 Pechora-2M Launcher','S-125 Pechora-2M Launcher']
    dbObj.maMagazineClass=['S-125 Pechora-2M Store']
    ...
    dbObj.launcherFireControl=['SNR-125','SNR-125','SNR-125','SNR-125']
