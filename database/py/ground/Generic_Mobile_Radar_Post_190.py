...
def CreateDBObject():
    ...
    dbObj.mzClass='Generic Mobile Radar Post 190'
    dbObj.natoClass='Generic Mobile Radar Post 190'
    ...
    sensorPlatformDBObject.sensorClass=['Generic radar 190']
    sensorPlatformDBObject.sensorAz=[0.000000]
    dbObj.AddComponent(sensorPlatformDBObject)
    dbObj.mfMaxSpeed_kts=32.299999
