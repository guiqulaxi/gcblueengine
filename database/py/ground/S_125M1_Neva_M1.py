...
def CreateDBObject():
    ...
    dbObj.mzClass='S-125M1 Neva-M1'
    dbObj.natoClass='SA-3B Goa'
    ...
    dbObj.maLauncherClass=['S-125M1 Neva-M1 Launcher','S-125M1 Neva-M1 Launcher','S-125M1 Neva-M1 Launcher','S-125M1 Neva-M1 Launcher']
    dbObj.maMagazineClass=['S-125M1 Neva-M1 Store']
    dbObj.magazineId=[0]
