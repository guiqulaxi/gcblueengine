...
def CreateDBObject():
    ...
    dbObj.maLauncherClass=['2K11 Krug-M3 Launcher','2K11 Krug-M3 Launcher','2K11 Krug-M3 Launcher']
    dbObj.maMagazineClass=['2K11 Krug-M3 Store']
    dbObj.magazineId=[0]
