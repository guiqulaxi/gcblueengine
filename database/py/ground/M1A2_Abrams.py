...
def CreateDBObject():
    ...
    dbObj.mzClass='M1A2 Abrams'
    dbObj.natoClass='M1A2 Abrams'
    ...
    dbObj.mfFuelCapacity_kg=1900.000000
    dbObj.mfFuelRate_kgps=0.063880
    dbObj.mfToughness=0.000000
    dbObj.damageEffect='Generic6'
    dbObj.mnNumLaunchers=2
    dbObj.maLauncherClass=['120mm M256A1','0.50in(12.7mm) Browning M2(270)']
