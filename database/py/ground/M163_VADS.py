...
def CreateDBObject():
    ...
    dbObj.mzClass='M163 VADS'
    dbObj.natoClass='M163 VADS'
    ...
    dbObj.mfMaxSpeed_kts=34.750000
    dbObj.mfAccel_ktsps=3.500000
    dbObj.mfTurnRate_degps=10.000000
    dbObj.mfFuelCapacity_kg=412.500000
    dbObj.mfFuelRate_kgps=0.031900
    dbObj.mfToughness=0.000000
    dbObj.damageEffect='Generic3'
    dbObj.mnNumLaunchers=1
    dbObj.maLauncherClass=['20mm M169 Vulcan']
