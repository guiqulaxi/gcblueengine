...
def CreateDBObject():
    ...
    dbObj.mzClass='2K12E Kvadrat'
    dbObj.natoClass='SA-6A Gainful'
    ...
    sensorPlatformDBObject.sensorClass=['1S91','Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h','P-15']
    ...
    dbObj.maLauncherClass=['2K12E Kvadrat Launcher','2K12E Kvadrat Launcher','2K12E Kvadrat Launcher','2K12E Kvadrat Launcher']
    dbObj.maMagazineClass=['2K12E Kvadrat Store']
    dbObj.magazineId=[0]
    ...
    dbObj.launcherFireControl=['1S91','1S91','1S91','1S91']
