...
def CreateDBObject():
    ...
    dbObj.mzClass='ZSU-23-4M2 Biryusa'
    dbObj.natoClass='ZSU-23-4M2 Biryusa'
    ...
    dbObj.maLauncherClass=['ZSU-23-4M2 Biryusa Launcher']
    dbObj.maMagazineClass=['ZSU-23-4M2 Biryusa Store']
    dbObj.magazineId=[0]
    dbObj.launcherId=[0]
    dbObj.launcherName=['']
