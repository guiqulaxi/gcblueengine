...
def CreateDBObject():
    ...
    dbObj.mzClass='Airstrip, Small (Russia)'
    dbObj.natoClass='Airstrip, Small (Russia)'
    ...
    airDetectionDBObject.opticalCrossSection_dBsm=45.000000
    ...
    dbObj.flightportClass='Airstrip-2'
