...
def CreateDBObject():
    ...
    dbObj.mzClass='T-62 MBT'
    dbObj.natoClass='T-62 MBT'
    ...
    dbObj.notes='road speed 50km, off road speed 29km, road range 650km, off road range 450km, main fuel 675 liters, external 285 liters, auxiliary 400 liters.'
    ...
    dbObj.mfFuelRate_kgps=0.021786
    dbObj.mfToughness=0.000000
    dbObj.damageEffect='Generic4'
    dbObj.mnNumLaunchers=3
    dbObj.maLauncherClass=['105mm generic tank cannon','115mm U-5TS','12.7mm NSV']
