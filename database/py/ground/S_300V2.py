...
def CreateDBObject():
    ...
    dbObj.mzClass='S-300V2'
    dbObj.natoClass='SA-12 Gladiator'
    ...
    sensorPlatformDBObject.sensorClass=['9S15','9S32','Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h']
    ...
    dbObj.maLauncherClass=['S-300V2 Launcher','S-300V2 Launcher','S-300V2 Launcher','S-300V2 Launcher']
    dbObj.maMagazineClass=['S-300V2 Store']
    dbObj.magazineId=[0]
    ...
    dbObj.launcherFireControl=['9S32','9S32','9S32','9S32']
