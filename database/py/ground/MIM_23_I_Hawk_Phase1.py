...
def CreateDBObject():
    ...
    dbObj.mzClass='MIM-23 I-Hawk Phase1'
    dbObj.natoClass='I-Hawk Phase 1'
    ...
    sensorPlatformDBObject.sensorClass=['Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h','MPQ-46','MPQ-48','MPQ-50']
    ...
    dbObj.maLauncherClass=['MIM-23 I-Hawk Phase1 Launcher','MIM-23 I-Hawk Phase1 Launcher','MIM-23 I-Hawk Phase1 Launcher','MIM-23 I-Hawk Phase1 Launcher','MIM-23 I-Hawk Phase1 Launcher','MIM-23 I-Hawk Phase1 Launcher']
    dbObj.maMagazineClass=['MIM-23 I-Hawk Phase1 Store']
    dbObj.magazineId=[1]
    ...
    dbObj.launcherFireControl=['MPQ-46','MPQ-46','MPQ-46','MPQ-46','MPQ-46','MPQ-46']
