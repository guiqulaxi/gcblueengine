...
def CreateDBObject():
    ...
    dbObj.mzClass='S-300PT-1A'
    dbObj.natoClass='SA-10A Grumble'
    ...
    sensorPlatformDBObject.sensorClass=['30N6','76N6','Eyeball 20/20e','Eyeball 20/20f','Eyeball 20/20g','Eyeball 20/20h']
    ...
    dbObj.maLauncherClass=['S-300PT-1A Launcher','S-300PT-1A Launcher','S-300PT-1A Launcher','S-300PT-1A Launcher']
    dbObj.maMagazineClass=['S-300PT-1A Store']
    dbObj.magazineId=[0]
    ...
    dbObj.launcherFireControl=['30N6','30N6','30N6','30N6']
