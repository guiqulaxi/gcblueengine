...
def CreateDBObject():
    ...
    dbObj.maLauncherClass=['9K37 Gang Launcher','9K37 Gang Launcher','9K37 Gang Launcher','9K37 Gang Launcher']
    dbObj.maMagazineClass=['9K37 Gang Store']
    dbObj.magazineId=[0]
