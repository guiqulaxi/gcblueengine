...
def CreateDBObject():
    ...
    dbObj.mzClass='ZSU-23-4V1 Shilka'
    dbObj.natoClass='ZSU-23-4V1 Shilka'
    ...
    dbObj.maLauncherClass=['ZSU-23-4V1 Shilka Launcher']
    dbObj.maMagazineClass=['ZSU-23-4V1 Shilka Store']
