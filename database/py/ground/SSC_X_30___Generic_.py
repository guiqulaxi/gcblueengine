...
def CreateDBObject():
    ...
    dbObj.mzClass='SSC-X(30) (Generic)'
    dbObj.natoClass='SSC-X(30) (Generic)'
    ...
    dbObj.maLauncherClass=['Generic SSM launcher','Generic SSM launcher','Generic SSM launcher','Generic SSM launcher','Generic SSM launcher']
    dbObj.maMagazineClass=['Generic Store (30)']
    ...
    dbObj.launcherEl_deg=[30.000000,30.000000,30.000000,30.000000,30.000000]
