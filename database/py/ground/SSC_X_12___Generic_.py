...
def CreateDBObject():
    ...
    dbObj.mzClass='SSC-X(12) (Generic)'
    dbObj.natoClass='SSC-X(12) (Generic)'
    ...
    dbObj.maLauncherClass=['Generic SSM launcher','Generic SSM launcher']
    dbObj.maMagazineClass=['Generic Store (12)']
