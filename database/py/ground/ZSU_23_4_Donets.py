...
def CreateDBObject():
    ...
    dbObj.mzClass='ZSU-23-4 Donets'
    dbObj.natoClass='ZSU-23-4 Donets'
    ...
    dbObj.maLauncherClass=['ZSU-23-4 Donets Launcher','ZSU-23-4 Donets Launcher 2']
    dbObj.maMagazineClass=['ZSU-23-4 Donets Store']
    dbObj.magazineId=[0]
