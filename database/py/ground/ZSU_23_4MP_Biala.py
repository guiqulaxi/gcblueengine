...
def CreateDBObject():
    ...
    dbObj.mzClass='ZSU-23-4MP Biala'
    dbObj.natoClass='ZSU-23-4MP Biala'
    ...
    dbObj.maLauncherClass=['ZSU-23-4MP Biala Launcher','ZSU-23-4MP Biala Launcher 2']
    dbObj.maMagazineClass=['ZSU-23-4MP Biala Store']
    dbObj.magazineId=[0]
