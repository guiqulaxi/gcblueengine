...
def CreateDBObject():
    ...
    dbObj.mzClass='Generic Mobile Radar Post 150'
    dbObj.natoClass='Generic Mobile Radar Post 150'
    ...
    sensorPlatformDBObject.sensorClass=['Generic radar 150']
    sensorPlatformDBObject.sensorAz=[0.000000]
    dbObj.AddComponent(sensorPlatformDBObject)
    dbObj.mfMaxSpeed_kts=33.599998
