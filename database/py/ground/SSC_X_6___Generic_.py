...
def CreateDBObject():
    ...
    dbObj.mzClass='SSC-X(6) (Generic)'
    dbObj.natoClass='SSC-X(6) (Generic)'
    ...
    dbObj.maLauncherClass=['Generic SSM launcher']
    dbObj.maMagazineClass=['Generic Store (6)']
    ...
    dbObj.launcherEl_deg=[30.000000]
