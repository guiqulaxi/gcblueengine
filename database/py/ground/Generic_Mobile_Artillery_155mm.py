...
def CreateDBObject():
    ...
    dbObj.mzClass='Generic Mobile Artillery 155mm'
    dbObj.natoClass='Generic Mobile Artillery 155mm'
    ...
    dbObj.maLauncherClass=['12.7 mm (0.5in) Degtjarev DShK M38 Heavy Machine Gun','155mm generic Arty cannon']
