...
def CreateDBObject():
    ...
    dbObj.mzClass='Burke Helo Deck'
    dbObj.natoClass='Burke Helo Deck'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.spotInfo[0].y=-63.000000
    dbObj.spotInfo[0].z=5.000000
    ...
    dbObj.spotInfo[1].y=-38.000000
    dbObj.spotInfo[1].z=2.000000
