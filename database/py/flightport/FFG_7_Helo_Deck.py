...
def CreateDBObject():
    ...
    dbObj.mzClass='FFG-7 Helo Deck'
    dbObj.natoClass='FFG-7 Helo Deck'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.spotInfo[0].y=-28.000000
    dbObj.spotInfo[0].z=7.700000
    ...
    dbObj.spotInfo[1].y=-49.000000
    dbObj.spotInfo[1].z=6.400000
