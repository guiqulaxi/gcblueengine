...
def CreateDBObject():
    ...
    dbObj.mzClass='ARBR 21'
    dbObj.natoClass='ARBR 21'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Naval Institute Guide to World Naval Systems: 0 deg to +45 deg elevation coverage, -68 dBm sensitivity. Reference range at 10 GHz is about 200 m for 0 dBi receive antenna.'
