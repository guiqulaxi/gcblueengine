...
def CreateDBObject():
    ...
    dbObj.mzClass='ARBR 16'
    dbObj.natoClass='ARBR 16'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='is a copy from the SLQ-32 entry except in angle error whichi s known to be 5-6°.'
