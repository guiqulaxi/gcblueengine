...
def CreateDBObject():
    ...
    dbObj.mzClass='SLQ-32 Equivalent'
    dbObj.natoClass='SLQ-32 Equivalent'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='I am using this ESm as a stand in for those ships that i do not know which ESM they use, but trust it to be quite sensitive.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=700.000000
    dbObj.mfRefRange_km=1.400000
