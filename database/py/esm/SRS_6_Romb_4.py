...
def CreateDBObject():
    ...
    dbObj.mzClass='SRS-6 Romb 4'
    dbObj.natoClass='SRS-6 Romb 4'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Setting this up as a new breed of ESM receiver.  bearing only, highly accurate in bearing, near zero range information.  test this against a target with cross bearing to see if the targets can be fired on.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=2000.000000
