...
def CreateDBObject():
    ...
    dbObj.mzClass='Sky Guardian RWR'
    dbObj.natoClass='Sky Guardian RWR'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Am stripping range determination ability, few ESM\'s can do this, most by processing multiple bearings over time and producing a form of TMA.'
    dbObj.length_m=1.000000
    dbObj.width_m=1.000000
    dbObj.height_m=1.000000
    dbObj.mfMaxRange_km=300.000000
    dbObj.mfRefRange_km=0.450000
