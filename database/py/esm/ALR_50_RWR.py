...
def CreateDBObject():
    ...
    dbObj.mzClass='ALR-50 RWR'
    dbObj.natoClass='ALR-50 RWR'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='previous model to ALR-67 in the hornet series.  unknown details, going to assume general inferiority.  Am stripping range determination ability, few ESM\'s can do this, most by processing multiple bearings over time and producing a form of TMA.'
