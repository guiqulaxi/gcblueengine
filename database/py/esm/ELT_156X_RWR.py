...
def CreateDBObject():
    ...
    dbObj.mzClass='ELT-156X RWR'
    dbObj.natoClass='ELT-156X RWR'
    dbObj.mnModelType=0
    dbObj.mnType=0
    dbObj.cost=0.000000
    ...
    dbObj.notes='Started with F-22 RWR and degraded. (V2) is version for helicopters but didnt make a separate version--don\'t have data to distinguish one from the other'
